...
! SUBSTRATE DECOMPOSITION BY MICROBIAL POPULATIONS
  ...
  real(r8) :: ECNH         !efficiency CO2 conversion to biomass by ammonia oxidizers,[-]
  real(r8) :: ECNO         !efficiency CO2 conversion to biomass by nitrite oxidizers,[-]
  real(r8) :: ECHO         !efficiency CO2 conversion to biomass by methane oxidizers,[-]
