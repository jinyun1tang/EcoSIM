...
implicit none
  ...
  real(r8) :: DFVP14,DFVPO4
  real(r8) :: DFVN4B,DFVN3B,DFVNOB,DFVN2B,DFVP1B,DFVPOB
...
!
  IF(FLWRM1.GT.0.0_r8)THEN
    ...
    ENDDO
    RFLCOS=VFLW*AZMAX1(CO2S2(0,NY,NX))
    RFLCHS=VFLW*AZMAX1(CH4S2(0,NY,NX))
    RFLOXS=VFLW*AZMAX1(OXYS2(0,NY,NX))
    RFLNGS=VFLW*AZMAX1(Z2GS2(0,NY,NX))
    RFLN2S=VFLW*AZMAX1(Z2OS2(0,NY,NX))
    RFLHGS=VFLW*AZMAX1(H2GS2(0,NY,NX))
    RFLNH4=VFLW*AZMAX1(ZNH4S2(0,NY,NX))*VLNH4(NU(NY,NX),NY,NX)
    RFLNH3=VFLW*AZMAX1(ZNH3S2(0,NY,NX))*VLNH4(NU(NY,NX),NY,NX)
    RFLNO3=VFLW*AZMAX1(ZNO3S2(0,NY,NX))*VLNO3(NU(NY,NX),NY,NX)
    RFLNO2=VFLW*AZMAX1(ZNO2S2(0,NY,NX))*VLNO3(NU(NY,NX),NY,NX)
    RFLP14=VFLW*AZMAX1(H1PO42(0,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
    RFLPO4=VFLW*AZMAX1(H2PO42(0,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
    RFLN4B=VFLW*AZMAX1(ZNH4S2(0,NY,NX))*VLNHB(NU(NY,NX),NY,NX)
    RFLN3B=VFLW*AZMAX1(ZNH3S2(0,NY,NX))*VLNHB(NU(NY,NX),NY,NX)
    RFLNOB=VFLW*AZMAX1(ZNO3S2(0,NY,NX))*VLNOB(NU(NY,NX),NY,NX)
    RFLN2B=VFLW*AZMAX1(ZNO2S2(0,NY,NX))*VLNOB(NU(NY,NX),NY,NX)
    RFLP1B=VFLW*AZMAX1(H1PO42(0,NY,NX))*VLPOB(NU(NY,NX),NY,NX)
    RFLPOB=VFLW*AZMAX1(H2PO42(0,NY,NX))*VLPOB(NU(NY,NX),NY,NX)
!
...
!
  ELSE
    ...
    ENDDO
    RFLCOS=VFLW*AZMAX1(CO2S2(NU(NY,NX),NY,NX))
    RFLCHS=VFLW*AZMAX1(CH4S2(NU(NY,NX),NY,NX))
    RFLOXS=VFLW*AZMAX1(OXYS2(NU(NY,NX),NY,NX))
    RFLNGS=VFLW*AZMAX1(Z2GS2(NU(NY,NX),NY,NX))
    RFLN2S=VFLW*AZMAX1(Z2OS2(NU(NY,NX),NY,NX))
    RFLHGS=VFLW*AZMAX1(H2GS2(NU(NY,NX),NY,NX))
    RFLNH4=VFLW*AZMAX1(ZNH4S2(NU(NY,NX),NY,NX))
    RFLNH3=VFLW*AZMAX1(ZNH3S2(NU(NY,NX),NY,NX))
    RFLNO3=VFLW*AZMAX1(ZNO3S2(NU(NY,NX),NY,NX))
    RFLNO2=VFLW*AZMAX1(ZNO2S2(NU(NY,NX),NY,NX))
    RFLP14=VFLW*AZMAX1(H1PO42(NU(NY,NX),NY,NX))
    RFLPO4=VFLW*AZMAX1(H2PO42(NU(NY,NX),NY,NX))
    RFLN4B=VFLW*AZMAX1(ZNH4B2(NU(NY,NX),NY,NX))
    RFLN3B=VFLW*AZMAX1(ZNH3B2(NU(NY,NX),NY,NX))
    RFLNOB=VFLW*AZMAX1(ZNO3B2(NU(NY,NX),NY,NX))
    RFLN2B=VFLW*AZMAX1(ZNO2B2(NU(NY,NX),NY,NX))
    RFLP1B=VFLW*AZMAX1(H1POB2(NU(NY,NX),NY,NX))
    RFLPOB=VFLW*AZMAX1(H2POB2(NU(NY,NX),NY,NX))
  ENDIF
...
!
  IF(FINHM(M,NU(NY,NX),NY,NX).GT.0.0_r8)THEN
    ...
    ENDDO
    RFLCOS=VFLW*AZMAX1(CO2SH2(NU(NY,NX),NY,NX))
    RFLCHS=VFLW*AZMAX1(CH4SH2(NU(NY,NX),NY,NX))
    RFLOXS=VFLW*AZMAX1(OXYSH2(NU(NY,NX),NY,NX))
    RFLNGS=VFLW*AZMAX1(Z2GSH2(NU(NY,NX),NY,NX))
    RFLN2S=VFLW*AZMAX1(Z2OSH2(NU(NY,NX),NY,NX))
    RFLHGS=VFLW*AZMAX1(H2GSH2(NU(NY,NX),NY,NX))
    RFLNH4=VFLW*AZMAX1(ZNH4H2(NU(NY,NX),NY,NX))*VLNH4(NU(NY,NX),NY,NX)
    RFLNH3=VFLW*AZMAX1(ZNH3H2(NU(NY,NX),NY,NX))*VLNH4(NU(NY,NX),NY,NX)
    RFLNO3=VFLW*AZMAX1(ZNO3H2(NU(NY,NX),NY,NX))*VLNO3(NU(NY,NX),NY,NX)
    RFLNO2=VFLW*AZMAX1(ZNO2H2(NU(NY,NX),NY,NX))*VLNO3(NU(NY,NX),NY,NX)
    RFLP14=VFLW*AZMAX1(H1P4H2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
    RFLPO4=VFLW*AZMAX1(H2P4H2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
    RFLN4B=VFLW*AZMAX1(ZN4BH2(NU(NY,NX),NY,NX))*VLNHB(NU(NY,NX),NY,NX)
    RFLN3B=VFLW*AZMAX1(ZN3BH2(NU(NY,NX),NY,NX))*VLNHB(NU(NY,NX),NY,NX)
    RFLNOB=VFLW*AZMAX1(ZNOBH2(NU(NY,NX),NY,NX))*VLNOB(NU(NY,NX),NY,NX)
    RFLN2B=VFLW*AZMAX1(ZN2BH2(NU(NY,NX),NY,NX))*VLNOB(NU(NY,NX),NY,NX)
    RFLP1B=VFLW*AZMAX1(H1PBH2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
    RFLPOB=VFLW*AZMAX1(H2PBH2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
!
...
!
  ELSEIF(FINHM(M,NU(NY,NX),NY,NX).LT.0.0_r8)THEN
    ...
    RFLN2S=VFLW*AZMAX1(Z2OS2(NU(NY,NX),NY,NX))
    RFLHGS=VFLW*AZMAX1(H2GS2(NU(NY,NX),NY,NX))
    RFLNH4=VFLW*AZMAX1(ZNH4S2(NU(NY,NX),NY,NX))*VLNH4(NU(NY,NX),NY,NX)
    RFLNH3=VFLW*AZMAX1(ZNH3S2(NU(NY,NX),NY,NX))*VLNH4(NU(NY,NX),NY,NX)
    RFLNO3=VFLW*AZMAX1(ZNO3S2(NU(NY,NX),NY,NX))*VLNO3(NU(NY,NX),NY,NX)
    RFLNO2=VFLW*AZMAX1(ZNO2S2(NU(NY,NX),NY,NX))*VLNO3(NU(NY,NX),NY,NX)
    RFLP14=VFLW*AZMAX1(H1PO42(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
    RFLPO4=VFLW*AZMAX1(H2PO42(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
    RFLN4B=VFLW*AZMAX1(ZNH4B2(NU(NY,NX),NY,NX))*VLNHB(NU(NY,NX),NY,NX)
    RFLN3B=VFLW*AZMAX1(ZNH3B2(NU(NY,NX),NY,NX))*VLNHB(NU(NY,NX),NY,NX)
    RFLNOB=VFLW*AZMAX1(ZNO3B2(NU(NY,NX),NY,NX))*VLNOB(NU(NY,NX),NY,NX)
    RFLN2B=VFLW*AZMAX1(ZNO2B2(NU(NY,NX),NY,NX))*VLNOB(NU(NY,NX),NY,NX)
    RFLP1B=VFLW*AZMAX1(H1POB2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
    RFLPOB=VFLW*AZMAX1(H2POB2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
!
...
!
  IF(VOLWHM(M,NU(NY,NX),NY,NX).GT.ZEROS2(NY,NX))THEN
    ...
    ENDDO
    DFVCOS=XNPH*(AZMAX1(CO2SH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(CO2S2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
    DFVCHS=XNPH*(AZMAX1(CH4SH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(CH4S2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
    DFVOXS=XNPH*(AZMAX1(OXYSH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(OXYS2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
    DFVNGS=XNPH*(AZMAX1(Z2GSH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(Z2GS2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
    DFVN2S=XNPH*(AZMAX1(Z2OSH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(Z2OS2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
    DFVHGS=XNPH*(AZMAX1(H2GSH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(H2GS2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
    DFVNH4=XNPH*(AZMAX1(ZNH4H2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(ZNH4S2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLNH4(NU(NY,NX),NY,NX)
    DFVNH3=XNPH*(AZMAX1(ZNH3H2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(ZNH3S2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLNH4(NU(NY,NX),NY,NX)
    DFVNO3=XNPH*(AZMAX1(ZNO3H2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(ZNO3S2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLNO3(NU(NY,NX),NY,NX)
    DFVNO2=XNPH*(AZMAX1(ZNO2H2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(ZNO2S2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLNO3(NU(NY,NX),NY,NX)
    DFVP14=XNPH*(AZMAX1(H1P4H2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(H1PO42(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLPO4(NU(NY,NX),NY,NX)
    DFVPO4=XNPH*(AZMAX1(H2P4H2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(H2PO42(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLPO4(NU(NY,NX),NY,NX)
    DFVN4B=XNPH*(AZMAX1(ZN4BH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(ZNH4B2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLNHB(NU(NY,NX),NY,NX)
    DFVN3B=XNPH*(AZMAX1(ZN3BH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(ZNH3B2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLNHB(NU(NY,NX),NY,NX)
    DFVNOB=XNPH*(AZMAX1(ZNOBH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(ZNO3B2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLNOB(NU(NY,NX),NY,NX)
    DFVN2B=XNPH*(AZMAX1(ZN2BH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(ZNO2B2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLNOB(NU(NY,NX),NY,NX)
    DFVP1B=XNPH*(AZMAX1(H1PBH2(NU(NY,NX),NY,NX)) &
      *VOLWM(M,NU(NY,NX),NY,NX)-AZMAX1(H1POB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT &
      *VLPOB(NU(NY,NX),NY,NX)
    DFVPOB=XNPH*(AZMAX1(H2PBH2(NU(NY,NX),NY,NX)) &
...
!
  ...
  IF(QRM(M,N2,N1).GT.ZEROS(N2,N1))THEN
    ...
    ENDDO
    RQRCOS0(N2,N1)=VFLW*AZMAX1(CO2S2(0,N2,N1))
    RQRCHS0(N2,N1)=VFLW*AZMAX1(CH4S2(0,N2,N1))
    RQROXS0(N2,N1)=VFLW*AZMAX1(OXYS2(0,N2,N1))
    RQRNGS0(N2,N1)=VFLW*AZMAX1(Z2GS2(0,N2,N1))
    RQRN2S0(N2,N1)=VFLW*AZMAX1(Z2OS2(0,N2,N1))
    RQRHGS0(N2,N1)=VFLW*AZMAX1(H2GS2(0,N2,N1))
    RQRNH40(N2,N1)=VFLW*AZMAX1(ZNH4S2(0,N2,N1))
    RQRNH30(N2,N1)=VFLW*AZMAX1(ZNH3S2(0,N2,N1))
    RQRNO30(N2,N1)=VFLW*AZMAX1(ZNO3S2(0,N2,N1))
    RQRNO20(N2,N1)=VFLW*AZMAX1(ZNO2S2(0,N2,N1))
...
!
  IF(VOLT(0,NY,NX).GT.ZEROS2(NY,NX) &
    ...
    RCODFG(0,NY,NX)=DFGS(M,0,NY,NX)*(AMAX1(ZEROS(NY,NX),CO2G0)*VOLWCO(0,NY,NX) &
      -AMAX1(ZEROS(NY,NX),CO2S2(0,NY,NX)+RCODXR)*VOLPM(M,0,NY,NX))/VOLCOR(NY,NX)
    RCHDFG(0,NY,NX)=DFGS(M,0,NY,NX)*(AMAX1(ZEROS(NY,NX),CH4G0)*VOLWCH(0,NY,NX) &
      -AMAX1(ZEROS(NY,NX),CH4S2(0,NY,NX)+RCHDXR)*VOLPM(M,0,NY,NX))/VOLCHR(NY,NX)
    ROXDFG(0,NY,NX)=DFGS(M,0,NY,NX)*(AMAX1(ZEROS(NY,NX),OXYG0)*VOLWOX(0,NY,NX) &
      -AMAX1(ZEROS(NY,NX),OXYS2(0,NY,NX)+ROXDXR)*VOLPM(M,0,NY,NX))/VOLOXR(NY,NX)
    RNGDFG(0,NY,NX)=DFGS(M,0,NY,NX)*(AMAX1(ZEROS(NY,NX),Z2GG0)*VOLWNG(0,NY,NX) &
      -AMAX1(ZEROS(NY,NX),Z2GS2(0,NY,NX)+RNGDXR)*VOLPM(M,0,NY,NX))/VOLNGR(NY,NX)
    RN2DFG(0,NY,NX)=DFGS(M,0,NY,NX)*(AMAX1(ZEROS(NY,NX),Z2OG0)*VOLWN2(0,NY,NX) &
      -AMAX1(ZEROS(NY,NX),Z2OS2(0,NY,NX)+RN2DXR)*VOLPM(M,0,NY,NX))/VOLN2R(NY,NX)
    RN3DFG(0,NY,NX)=DFGS(M,0,NY,NX)*(AMAX1(ZEROS(NY,NX),ZN3G0)*VOLWN3(0,NY,NX) &
      -AMAX1(ZEROS(NY,NX),ZNH3S2(0,NY,NX)+RN3DXR)*VOLPM(M,0,NY,NX))/VOLN3R(NY,NX)
    CNH3S0=AZMAX1((ZNH3S2(0,NY,NX)+RN3DFG(0,NY,NX)))/VOLWXA(0,NY,NX)
    CNH4S0=AZMAX1(ZNH4S2(0,NY,NX))/VOLWXA(0,NY,NX)
    RHGDFG(0,NY,NX)=DFGS(M,0,NY,NX)*(AMAX1(ZEROS(NY,NX),H2GG0)*VOLWHG(0,NY,NX) &
      -AMAX1(ZEROS(NY,NX),H2GS2(0,NY,NX)+RHGDXR)*VOLPM(M,0,NY,NX))/VOLHGR(NY,NX)
...
!------------------------------------------------------------------------------------------
  ...
  IF(VOLT(0,NY,NX).GT.ZEROS2(NY,NX).AND.VOLWM(M,0,NY,NX).GT.ZEROS2(NY,NX))THEN
    ...
    ENDDO
    CCO2S1=AZMAX1(CO2S2(0,NY,NX)/VOLWM(M,0,NY,NX))
    CCH4S1=AZMAX1(CH4S2(0,NY,NX)/VOLWM(M,0,NY,NX))
    COXYS1=AZMAX1(OXYS2(0,NY,NX)/VOLWM(M,0,NY,NX))
    CZ2GS1=AZMAX1(Z2GS2(0,NY,NX)/VOLWM(M,0,NY,NX))
    CZ2OS1=AZMAX1(Z2OS2(0,NY,NX)/VOLWM(M,0,NY,NX))
    CH2GS1=AZMAX1(H2GS2(0,NY,NX)/VOLWM(M,0,NY,NX))
    CNH4S1=AZMAX1(ZNH4S2(0,NY,NX)/VOLWM(M,0,NY,NX))
    CNH3S1=AZMAX1(ZNH3S2(0,NY,NX)/VOLWM(M,0,NY,NX))
    CNO3S1=AZMAX1(ZNO3S2(0,NY,NX)/VOLWM(M,0,NY,NX))
    CNO2S1=AZMAX1(ZNO2S2(0,NY,NX)/VOLWM(M,0,NY,NX))
    CP14S1=AZMAX1(H1PO42(0,NY,NX)/VOLWM(M,0,NY,NX))
    CPO4S1=AZMAX1(H2PO42(0,NY,NX)/VOLWM(M,0,NY,NX))
!
...
!
  IF(VOLWM(M,NU(NY,NX),NY,NX).GT.ZEROS2(NY,NX))THEN
    ...
    ENDDO
    CCO2S2=AZMAX1(CO2S2(NU(NY,NX),NY,NX)/VOLWM(M,NU(NY,NX),NY,NX))
    CCH4S2=AZMAX1(CH4S2(NU(NY,NX),NY,NX)/VOLWM(M,NU(NY,NX),NY,NX))
    COXYS2=AZMAX1(OXYS2(NU(NY,NX),NY,NX)/VOLWM(M,NU(NY,NX),NY,NX))
    CZ2GS2=AZMAX1(Z2GS2(NU(NY,NX),NY,NX)/VOLWM(M,NU(NY,NX),NY,NX))
    CZ2OS2=AZMAX1(Z2OS2(NU(NY,NX),NY,NX)/VOLWM(M,NU(NY,NX),NY,NX))
    CH2GS2=AZMAX1(H2GS2(NU(NY,NX),NY,NX)/VOLWM(M,NU(NY,NX),NY,NX))
    IF(VOLWMA(NU(NY,NX),NY,NX).GT.ZEROS2(NY,NX))THEN
      CNH3S2=AZMAX1(ZNH3S2(NU(NY,NX),NY,NX)/VOLWMA(NU(NY,NX),NY,NX))
      CNH4S2=AZMAX1(ZNH4S2(NU(NY,NX),NY,NX)/VOLWMA(NU(NY,NX),NY,NX))
    ELSE
      CNH3S2=0.0_r8
      CNH4S2=0.0_r8
    ENDIF
    IF(VOLWOA.GT.ZEROS2(NY,NX))THEN
      CNO3S2=AZMAX1(ZNO3S2(NU(NY,NX),NY,NX)/VOLWOA)
      CNO2S2=AZMAX1(ZNO2S2(NU(NY,NX),NY,NX)/VOLWOA)
    ELSE
      CNO3S2=0.0_r8
      CNO2S2=0.0_r8
    ENDIF
    IF(VOLWPA.GT.ZEROS2(NY,NX))THEN
      CP14S2=AZMAX1(H1PO42(NU(NY,NX),NY,NX)/VOLWPA)
      CPO4S2=AZMAX1(H2PO42(NU(NY,NX),NY,NX)/VOLWPA)
    ELSE
      CP14S2=0.0_r8
      CPO4S2=0.0_r8
    ENDIF
    IF(VOLWMB(NU(NY,NX),NY,NX).GT.ZEROS2(NY,NX))THEN
      CNH3B2=AZMAX1(ZNH3B2(NU(NY,NX),NY,NX)/VOLWMB(NU(NY,NX),NY,NX))
      CNH4B2=AZMAX1(ZNH4B2(NU(NY,NX),NY,NX)/VOLWMB(NU(NY,NX),NY,NX))
    ELSE
      CNH3B2=CNH3S2
      CNH4B2=CNH4S2
    ENDIF
    IF(VOLWOB.GT.ZEROS2(NY,NX))THEN
      CNO3B2=AZMAX1(ZNO3B2(NU(NY,NX),NY,NX)/VOLWOB)
      CNO2B2=AZMAX1(ZNO2B2(NU(NY,NX),NY,NX)/VOLWOB)
    ELSE
      CNO3B2=CNO3S2
      CNO2B2=CNO2S2
    ENDIF
    IF(VOLWPB.GT.ZEROS2(NY,NX))THEN
      CP14B2=AZMAX1(H1POB2(NU(NY,NX),NY,NX)/VOLWPB)
      CPO4B2=AZMAX1(H2POB2(NU(NY,NX),NY,NX)/VOLWPB)
    ELSE
      CP14B2=CP14S2
      CPO4B2=CPO4S2
    ENDIF
...
!     DFGS*=effective solute diffusivity
!
    CCO2GQ=(PARG(M,NY,NX)*AtmGgms(idg_CO2,NY,NX)*GSolbility(idg_CO2,NU(NY,NX),NY,NX) &
      +DFGSCO*CCO2S2)/(DFGSCO+PARG(M,NY,NX))
    CCH4GQ=(PARG(M,NY,NX)*AtmGgms(idg_CH4,NY,NX)*GSolbility(idg_CH4,NU(NY,NX),NY,NX) &
      +DFGSCH*CCH4S2)/(DFGSCH+PARG(M,NY,NX))
    COXYGQ=(PARG(M,NY,NX)*AtmGgms(idg_O2,NY,NX)*GSolbility(idg_O2,NU(NY,NX),NY,NX) &
      +DFGSOX*COXYS2)/(DFGSOX+PARG(M,NY,NX))
    CZ2GGQ=(PARG(M,NY,NX)*AtmGgms(idg_N2,NY,NX)*GSolbility(idg_N2,NU(NY,NX),NY,NX) &
      +DFGSNG*CZ2GS2)/(DFGSNG+PARG(M,NY,NX))
    CZ2OGQ=(PARG(M,NY,NX)*AtmGgms(idg_N2O,NY,NX)*GSolbility(idg_N2O,NU(NY,NX),NY,NX) &
      +DFGSN2*CZ2OS2)/(DFGSN2+PARG(M,NY,NX))
    CZN3GQ=(PARG(M,NY,NX)*AtmGgms(idg_NH3,NY,NX)*GSolbility(idg_NH3,NU(NY,NX),NY,NX) &
      +DFGSN3*CNH3S2)/(DFGSN3+PARG(M,NY,NX))
    CZN3BQ=(PARG(M,NY,NX)*AtmGgms(idg_NH3,NY,NX)*GSolbility(idg_NH3,NU(NY,NX),NY,NX) &
      +DFGSN3*CNH3B2)/(DFGSN3+PARG(M,NY,NX))
    CH2GGQ=(PARG(M,NY,NX)*AtmGgms(idg_H2,NY,NX)*GSolbility(idg_H2,NU(NY,NX),NY,NX) &
...
!
  ...
  IF(FLQM(3,NU(NY,NX),NY,NX).GT.0.0_r8)THEN
    ...
    ELSE
      VFLW=-VFLWX
    ENDIF
    RFLCOG=VFLW*AZMAX1(CO2G2(NU(NY,NX),NY,NX))
    RFLCHG=VFLW*AZMAX1(CH4G2(NU(NY,NX),NY,NX))
    RFLOXG=VFLW*AZMAX1(OXYG2(NU(NY,NX),NY,NX))
    RFLNGG=VFLW*AZMAX1(Z2GG2(NU(NY,NX),NY,NX))
    RFLN2G=VFLW*AZMAX1(Z2OG2(NU(NY,NX),NY,NX))
    RFLN3G=VFLW*AZMAX1(ZN3G2(NU(NY,NX),NY,NX))
    RFLH2G=VFLW*AZMAX1(H2GG2(NU(NY,NX),NY,NX))
  ELSE
...
!     VOLPM=air-filled porosity
!
    CCO2G2=AZMAX1(CO2G2(NU(NY,NX),NY,NX)/VOLPM(M,NU(NY,NX),NY,NX))
    CCH4G2=AZMAX1(CH4G2(NU(NY,NX),NY,NX)/VOLPM(M,NU(NY,NX),NY,NX))
    COXYG2=AZMAX1(OXYG2(NU(NY,NX),NY,NX)/VOLPM(M,NU(NY,NX),NY,NX))
    CZ2GG2=AZMAX1(Z2GG2(NU(NY,NX),NY,NX)/VOLPM(M,NU(NY,NX),NY,NX))
    CZ2OG2=AZMAX1(Z2OG2(NU(NY,NX),NY,NX)/VOLPM(M,NU(NY,NX),NY,NX))
    CNH3G2=AZMAX1(ZN3G2(NU(NY,NX),NY,NX)/VOLPM(M,NU(NY,NX),NY,NX))
    CH2GG2=AZMAX1(H2GG2(NU(NY,NX),NY,NX)/VOLPM(M,NU(NY,NX),NY,NX))
!
!     EQUILIBRIUM CONCENTRATIONS AT SOIL SURFACE AT WHICH
...
!
  ...
  *VOLPM(M,NU(NY,NX),NY,NX))/VOLNGT(NY,NX)
  ...
  IF(VOLN3T(NY,NX).GT.ZEROS2(NY,NX).AND.VOLWXA(NU(NY,NX),NY,NX).GT.ZEROS2(NY,NX))THEN
    ...
    CNH3S0=AZMAX1((ZNH3S2(NU(NY,NX),NY,NX) &
      +RN3DFG(NU(NY,NX),NY,NX))/VOLWXA(NU(NY,NX),NY,NX))
    CNH4S0=AZMAX1(ZNH4S2(NU(NY,NX),NY,NX))/VOLWXA(NU(NY,NX),NY,NX)
  ELSE
    RN3DFG(NU(NY,NX),NY,NX)=0.0_r8
  ENDIF
  IF(VOLNBT(NY,NX).GT.ZEROS2(NY,NX).AND.VOLWXB(NU(NY,NX),NY,NX).GT.ZEROS2(NY,NX))THEN
    ...
    CNH3B0=AZMAX1((ZNH3B2(NU(NY,NX),NY,NX) &
      +RNBDFG(NU(NY,NX),NY,NX))/VOLWXB(NU(NY,NX),NY,NX))
    CNH4B0=AZMAX1(ZNH4B2(NU(NY,NX),NY,NX))/VOLWXB(NU(NY,NX),NY,NX)
  ELSE
    RNBDFG(NU(NY,NX),NY,NX)=0.0_r8
  ENDIF
