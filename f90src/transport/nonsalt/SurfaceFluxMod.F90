...
!
  ELSE
    ...
    RFLN3B=VFLW*AZMAX1(trc_solml2(ids_NH3B,NU(NY,NX),NY,NX))
...
!
  ...
  ENDDO
  RPoreSolFlx(idg_CO2,3,0,NY,NX)=RCOFL0(NY,NX)+RCOFLS0-RFLCOS-DFVCOS
  RPoreSolFlx(idg_CH4,3,0,NY,NX)=RCHFL0(NY,NX)+RCHFLS0-RFLCHS-DFVCHS
  RPoreSolFlx(idg_O2,3,0,NY,NX)=ROXFL0(NY,NX)+ROXFLS0-RFLOXS-DFVOXS
  RPoreSolFlx(idg_N2,3,0,NY,NX)=RNGFL0(NY,NX)+RNGFLS0-RFLNGS-DFVNGS
  RPoreSolFlx(idg_N2O,3,0,NY,NX)=RN2FL0(NY,NX)+RN2FLS0-RFLN2S-DFVN2S
  RPoreSolFlx(idg_H2,3,0,NY,NX)=RHGFL0(NY,NX)-RFLHGS-DFVHGS
  RPoreSolFlx(ids_NH4,3,0,NY,NX)=RN4FL0(NY,NX)+RN4FLW0-RFLNH4-DFVNH4-RFLN4B-DFVN4B
  RPoreSolFlx(idg_NH3,3,0,NY,NX)=RN3FL0(NY,NX)+RN3FLW0-RFLNH3-DFVNH3-RFLN3B-DFVN3B
  RPoreSolFlx(ids_NO3,3,0,NY,NX)=RNOFL0(NY,NX)+RNOFLW0-RFLNO3-DFVNO3-RFLNOB-DFVNOB
  RPoreSolFlx(ids_NO2,3,0,NY,NX)=RNXFL0(NY,NX)-RFLNO2-DFVNO2-RFLN2B-DFVN2B
  RPoreSolFlx(ids_H1PO4,3,0,NY,NX)=RH1PF0(NY,NX)+RH1PFS0-RFLP14-DFVP14-RFLP1B-DFVP1B
  RPoreSolFlx(ids_H2PO4,3,0,NY,NX)=RH2PF0(NY,NX)+RH2PFS0-RFLPO4-DFVPO4-RFLPOB-DFVPOB
  RPoreSolFlx(idg_CO2,3,NU(NY,NX),NY,NX)=RCOFL1(NY,NX)+RCOFLS1+RFLCOS+DFVCOS

  RPoreSolFlx(idg_CH4,3,NU(NY,NX),NY,NX)=RCHFL1(NY,NX)+RCHFLS1+RFLCHS+DFVCHS
  RPoreSolFlx(idg_O2,3,NU(NY,NX),NY,NX)=ROXFL1(NY,NX)+ROXFLS1+RFLOXS+DFVOXS
  RPoreSolFlx(idg_N2,3,NU(NY,NX),NY,NX)=RNGFL1(NY,NX)+RNGFLS1+RFLNGS+DFVNGS
  RPoreSolFlx(idg_N2O,3,NU(NY,NX),NY,NX)=RN2FL1(NY,NX)+RN2FLS1+RFLN2S+DFVN2S
  RPoreSolFlx(idg_H2,3,NU(NY,NX),NY,NX)=RHGFL1(NY,NX)+RFLHGS+DFVHGS
  RPoreSolFlx(ids_NH4,3,NU(NY,NX),NY,NX)=RN4FL1(NY,NX)+RN4FLW1+RFLNH4+DFVNH4
  RPoreSolFlx(idg_NH3,3,NU(NY,NX),NY,NX)=RN3FL1(NY,NX)+RN3FLW1+RFLNH3+DFVNH3
  RPoreSolFlx(ids_NO3,3,NU(NY,NX),NY,NX)=RNOFL1(NY,NX)+RNOFLW1+RFLNO3+DFVNO3
  RPoreSolFlx(ids_NO2,3,NU(NY,NX),NY,NX)=RNXFL1(NY,NX)+RFLNO2+DFVNO2
  RPoreSolFlx(ids_H1PO4,3,NU(NY,NX),NY,NX)=RH1PF1(NY,NX)+RH1PFS1+RFLP14+DFVP14
  RPoreSolFlx(ids_H2PO4,3,NU(NY,NX),NY,NX)=RH2PF1(NY,NX)+RH2PFS1+RFLPO4+DFVPO4
  RPoreSolFlx(ids_NH4B,3,NU(NY,NX),NY,NX)=RN4FL2(NY,NX)+RN4FLB1+RFLN4B+DFVN4B
  RPoreSolFlx(ids_NH3B,3,NU(NY,NX),NY,NX)=RN3FL2(NY,NX)+RN3FLB1+RFLN3B+DFVN3B
  RPoreSolFlx(ids_NO3B,3,NU(NY,NX),NY,NX)=RNOFL2(NY,NX)+RNOFLB1+RFLNOB+DFVNOB
  RPoreSolFlx(ids_NO2B,3,NU(NY,NX),NY,NX)=RNXFL2(NY,NX)+RFLN2B+DFVN2B
  RPoreSolFlx(ids_H1PO4B,3,NU(NY,NX),NY,NX)=RH1BF2(NY,NX)+RH1BFB1+RFLP1B+DFVP1B
  RPoreSolFlx(ids_H2PO4B,3,NU(NY,NX),NY,NX)=RH2BF2(NY,NX)+RH2BFB1+RFLPOB+DFVPOB
!
...
!
  IF(FINHM(M,NU(NY,NX),NY,NX).GT.0.0_r8)THEN
    ...
    ENDDO
    RFLCOS=VFLW*AZMAX1(trc_soHml2(idg_CO2,NU(NY,NX),NY,NX))
    RFLCHS=VFLW*AZMAX1(trc_soHml2(idg_CH4,NU(NY,NX),NY,NX))
    RFLOXS=VFLW*AZMAX1(trc_soHml2(idg_O2,NU(NY,NX),NY,NX))
    RFLNGS=VFLW*AZMAX1(trc_soHml2(idg_N2,NU(NY,NX),NY,NX))
    RFLN2S=VFLW*AZMAX1(trc_soHml2(idg_N2O,NU(NY,NX),NY,NX))
    RFLHGS=VFLW*AZMAX1(trc_soHml2(idg_H2,NU(NY,NX),NY,NX))
    RFLNH4=VFLW*AZMAX1(trc_soHml2(ids_NH4,NU(NY,NX),NY,NX))*VLNH4(NU(NY,NX),NY,NX)
    RFLNH3=VFLW*AZMAX1(trc_soHml2(idg_NH3,NU(NY,NX),NY,NX))*VLNH4(NU(NY,NX),NY,NX)
    RFLNO3=VFLW*AZMAX1(trc_soHml2(ids_NO3,NU(NY,NX),NY,NX))*VLNO3(NU(NY,NX),NY,NX)
    RFLNO2=VFLW*AZMAX1(trc_soHml2(ids_NO2,NU(NY,NX),NY,NX))*VLNO3(NU(NY,NX),NY,NX)
    RFLP14=VFLW*AZMAX1(trc_soHml2(ids_H1PO4,NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
    RFLPO4=VFLW*AZMAX1(trc_soHml2(ids_H2PO4,NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
    RFLN4B=VFLW*AZMAX1(trc_soHml2(ids_NH4B,NU(NY,NX),NY,NX))*VLNHB(NU(NY,NX),NY,NX)
    RFLN3B=VFLW*AZMAX1(trc_soHml2(ids_NH3B,NU(NY,NX),NY,NX))*VLNHB(NU(NY,NX),NY,NX)
    RFLNOB=VFLW*AZMAX1(trc_soHml2(ids_NO3B,NU(NY,NX),NY,NX))*VLNOB(NU(NY,NX),NY,NX)
    RFLN2B=VFLW*AZMAX1(trc_soHml2(ids_NO2B,NU(NY,NX),NY,NX))*VLNOB(NU(NY,NX),NY,NX)
    RFLP1B=VFLW*AZMAX1(trc_soHml2(ids_H1PO4B,NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
    RFLPOB=VFLW*AZMAX1(trc_soHml2(ids_H2PO4B,NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
!
...
!
  ELSEIF(FINHM(M,NU(NY,NX),NY,NX).LT.0.0_r8)THEN
    ...
    RFLN2S=VFLW*AZMAX1(trc_solml2(idg_N2O,NU(NY,NX),NY,NX))
    RFLHGS=VFLW*AZMAX1(trc_solml2(idg_H2,NU(NY,NX),NY,NX))
    RFLNH4=VFLW*AZMAX1(trc_solml2(ids_NH4,NU(NY,NX),NY,NX))*VLNH4(NU(NY,NX),NY,NX)
    RFLNH3=VFLW*AZMAX1(trc_solml2(idg_NH3,NU(NY,NX),NY,NX))*VLNH4(NU(NY,NX),NY,NX)
    RFLNO3=VFLW*AZMAX1(trc_solml2(ids_NO3,NU(NY,NX),NY,NX))*VLNO3(NU(NY,NX),NY,NX)
    RFLNO2=VFLW*AZMAX1(trc_solml2(ids_NO2,NU(NY,NX),NY,NX))*VLNO3(NU(NY,NX),NY,NX)
    RFLP14=VFLW*AZMAX1(trc_solml2(ids_H1PO4,NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
    RFLPO4=VFLW*AZMAX1(trc_solml2(ids_H2PO4,NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
    RFLN4B=VFLW*AZMAX1(trc_solml2(ids_NH4B,NU(NY,NX),NY,NX))*VLNHB(NU(NY,NX),NY,NX)
    RFLN3B=VFLW*AZMAX1(trc_solml2(ids_NH3B,NU(NY,NX),NY,NX))*VLNHB(NU(NY,NX),NY,NX)
    RFLNOB=VFLW*AZMAX1(trc_solml2(ids_NO3B,NU(NY,NX),NY,NX))*VLNOB(NU(NY,NX),NY,NX)
    RFLN2B=VFLW*AZMAX1(trc_solml2(ids_NO2B,NU(NY,NX),NY,NX))*VLNOB(NU(NY,NX),NY,NX)
    RFLP1B=VFLW*AZMAX1(trc_solml2(ids_H1PO4B,NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
    RFLPOB=VFLW*AZMAX1(trc_solml2(ids_H2PO4B,NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
!
...
!
  IF(VOLWM(M,NU(NY,NX),NY,NX).GT.ZEROS2(NY,NX))THEN
    ...
    IF(VOLWMB(NU(NY,NX),NY,NX).GT.ZEROS2(NY,NX))THEN
      CNH3B2=AZMAX1(trc_solml2(ids_NH3B,NU(NY,NX),NY,NX)/VOLWMB(NU(NY,NX),NY,NX))
...
!
    ...
    DifuscG(idg_CO2,3,NU(NY,NX),NY,NX)=DFLG2*CGSGL2(NU(NY,NX),NY,NX)
    DifuscG(idg_CH4,3,NU(NY,NX),NY,NX)=DFLG2*CHSGL2(NU(NY,NX),NY,NX)
    DifuscG(idg_O2,3,NU(NY,NX),NY,NX)=DFLG2*OGSGL2(NU(NY,NX),NY,NX)
    DifuscG(idg_N2,3,NU(NY,NX),NY,NX)=DFLG2*ZGSGL2(NU(NY,NX),NY,NX)
    DifuscG(idg_N2O,3,NU(NY,NX),NY,NX)=DFLG2*Z2SGL2(NU(NY,NX),NY,NX)
    DifuscG(idg_NH3,3,NU(NY,NX),NY,NX)=DFLG2*ZHSGL2(NU(NY,NX),NY,NX)
    DifuscG(idg_H2,3,NU(NY,NX),NY,NX)=DFLG2*HGSGL2(NU(NY,NX),NY,NX)
!
  ...
  IF(VOLNBT(NY,NX).GT.ZEROS2(NY,NX).AND.VOLWXB(NU(NY,NX),NY,NX).GT.ZEROS2(NY,NX))THEN
    RNBDFG(NU(NY,NX),NY,NX)=DFGS(M,NU(NY,NX),NY,NX) &
      ...
      *VOLWNB(NU(NY,NX),NY,NX)-AMAX1(ZEROS(NY,NX) &
      ,trc_solml2(ids_NH3B,NU(NY,NX),NY,NX)+RNBDXS) &
      *VOLPMB(NU(NY,NX),NY,NX))/VOLNBT(NY,NX)
    CNH3B0=AZMAX1((trc_solml2(ids_NH3B,NU(NY,NX),NY,NX) &
