...
! ----------------------------------------------------------------------
  ...
  IF(NN.EQ.1.AND.FLWM(M,N,M6,M5,M4).GT.0.0 &
    ...
    enddo
    RCOFLS(N,M6,M5,M4)=VFLW*AZMAX1(CO2S2(M3,M2,M1))
    RCHFLS(N,M6,M5,M4)=VFLW*AZMAX1(CH4S2(M3,M2,M1))
    ROXFLS(N,M6,M5,M4)=VFLW*AZMAX1(OXYS2(M3,M2,M1))
    RNGFLS(N,M6,M5,M4)=VFLW*AZMAX1(Z2GS2(M3,M2,M1))
    RN2FLS(N,M6,M5,M4)=VFLW*AZMAX1(Z2OS2(M3,M2,M1))
    RHGFLS(N,M6,M5,M4)=VFLW*AZMAX1(H2GS2(M3,M2,M1))
    RN4FLW(N,M6,M5,M4)=VFLW*AZMAX1(ZNH4S2(M3,M2,M1))*VLNH4(M3,M2,M1)
    RN3FLW(N,M6,M5,M4)=VFLW*AZMAX1(ZNH3S2(M3,M2,M1))*VLNH4(M3,M2,M1)
    RNOFLW(N,M6,M5,M4)=VFLW*AZMAX1(ZNO3S2(M3,M2,M1))*VLNO3(M3,M2,M1)
    RNXFLS(N,M6,M5,M4)=VFLW*AZMAX1(ZNO2S2(M3,M2,M1))*VLNO3(M3,M2,M1)
    RH1PFS(N,M6,M5,M4)=VFLW*AZMAX1(H1PO42(M3,M2,M1))*VLPO4(M3,M2,M1)
    RH2PFS(N,M6,M5,M4)=VFLW*AZMAX1(H2PO42(M3,M2,M1))*VLPO4(M3,M2,M1)
    RN4FLB(N,M6,M5,M4)=VFLW*AZMAX1(ZNH4B2(M3,M2,M1))*VLNHB(M3,M2,M1)
    RN3FLB(N,M6,M5,M4)=VFLW*AZMAX1(ZNH3B2(M3,M2,M1))*VLNHB(M3,M2,M1)
    RNOFLB(N,M6,M5,M4)=VFLW*AZMAX1(ZNO3B2(M3,M2,M1))*VLNOB(M3,M2,M1)
    RNXFLB(N,M6,M5,M4)=VFLW*AZMAX1(ZNO2B2(M3,M2,M1))*VLNOB(M3,M2,M1)
    RH2BFB(N,M6,M5,M4)=VFLW*AZMAX1(H2POB2(M3,M2,M1))*VLPOB(M3,M2,M1)
!
...
!
  IF(NN.EQ.1.AND.FLWHM(M,N,M6,M5,M4).GT.0.0 &
    ...
    enddo
    RCOFHS(N,M6,M5,M4)=VFLW*AZMAX1(CO2SH2(M3,M2,M1))
    RCHFHS(N,M6,M5,M4)=VFLW*AZMAX1(CH4SH2(M3,M2,M1))
    ROXFHS(N,M6,M5,M4)=VFLW*AZMAX1(OXYSH2(M3,M2,M1))
    RNGFHS(N,M6,M5,M4)=VFLW*AZMAX1(Z2GSH2(M3,M2,M1))
    RN2FHS(N,M6,M5,M4)=VFLW*AZMAX1(Z2OSH2(M3,M2,M1))
    RHGFHS(N,M6,M5,M4)=VFLW*AZMAX1(H2GSH2(M3,M2,M1))
    RN4FHW(N,M6,M5,M4)=VFLW*AZMAX1(ZNH4H2(M3,M2,M1))*VLNH4(M3,M2,M1)
    RN3FHW(N,M6,M5,M4)=VFLW*AZMAX1(ZNH3H2(M3,M2,M1))*VLNH4(M3,M2,M1)
    RNOFHW(N,M6,M5,M4)=VFLW*AZMAX1(ZNO3H2(M3,M2,M1))*VLNO3(M3,M2,M1)
    RNXFHS(N,M6,M5,M4)=VFLW*AZMAX1(ZNO2H2(M3,M2,M1))*VLNO3(M3,M2,M1)
    RH1PHS(N,M6,M5,M4)=VFLW*AZMAX1(H1P4H2(M3,M2,M1))*VLPO4(M3,M2,M1)
    RH2PHS(N,M6,M5,M4)=VFLW*AZMAX1(H2P4H2(M3,M2,M1))*VLPO4(M3,M2,M1)
    RN4FHB(N,M6,M5,M4)=VFLW*AZMAX1(ZN4BH2(M3,M2,M1))*VLNHB(M3,M2,M1)
    RN3FHB(N,M6,M5,M4)=VFLW*AZMAX1(ZN3BH2(M3,M2,M1))*VLNHB(M3,M2,M1)
    RNOFHB(N,M6,M5,M4)=VFLW*AZMAX1(ZNOBH2(M3,M2,M1))*VLNOB(M3,M2,M1)
    RNXFHB(N,M6,M5,M4)=VFLW*AZMAX1(ZN2BH2(M3,M2,M1))*VLNOB(M3,M2,M1)
    RH1BHB(N,M6,M5,M4)=VFLW*AZMAX1(H1PBH2(M3,M2,M1))*VLPOB(M3,M2,M1)
    RH2BHB(N,M6,M5,M4)=VFLW*AZMAX1(H2PBH2(M3,M2,M1))*VLPOB(M3,M2,M1)
!
...
!
    ...
    IF(NN.EQ.1.AND.FLGM.LT.0.0.OR.NN.EQ.2.AND.FLGM.GT.0.0)THEN
      ...
      ELSE
        VFLW=0.0_r8
      ENDIF
      RCOFLG(N,M6,M5,M4)=VFLW*AZMAX1(CO2G2(M3,M2,M1))
      RCHFLG(N,M6,M5,M4)=VFLW*AZMAX1(CH4G2(M3,M2,M1))
      ROXFLG(N,M6,M5,M4)=VFLW*AZMAX1(OXYG2(M3,M2,M1))
      RNGFLG(N,M6,M5,M4)=VFLW*AZMAX1(Z2GG2(M3,M2,M1))
      RN2FLG(N,M6,M5,M4)=VFLW*AZMAX1(Z2OG2(M3,M2,M1))
      RN3FLG(N,M6,M5,M4)=VFLW*AZMAX1(ZN3G2(M3,M2,M1))
      RHGFLG(N,M6,M5,M4)=VFLW*AZMAX1(H2GG2(M3,M2,M1))
!
