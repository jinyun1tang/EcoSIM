...
! ----------------------------------------------------------------------
  ...
  IF(NN.EQ.1.AND.FLWM(M,N,M6,M5,M4).GT.0.0 &
    ...
    enddo
    RCOFLS(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(idg_CO2,M3,M2,M1))
    RCHFLS(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(idg_CH4,M3,M2,M1))
    ROXFLS(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(idg_O2,M3,M2,M1))
    RNGFLS(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(idg_N2,M3,M2,M1))
    RN2FLS(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(idg_N2O,M3,M2,M1))
    RHGFLS(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(idg_H2,M3,M2,M1))

    RN4FLW(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(ids_NH4,M3,M2,M1))*VLNH4(M3,M2,M1)
    RN3FLW(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(idg_NH3,M3,M2,M1))*VLNH4(M3,M2,M1)
    RNOFLW(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(ids_NO3,M3,M2,M1))*VLNO3(M3,M2,M1)
    RNXFLS(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(ids_NO2,M3,M2,M1))*VLNO3(M3,M2,M1)
    RH1PFS(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(ids_H1PO4,M3,M2,M1))*VLPO4(M3,M2,M1)
    RH2PFS(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(ids_H2PO4,M3,M2,M1))*VLPO4(M3,M2,M1)
    RN4FLB(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(ids_NH4B,M3,M2,M1))*VLNHB(M3,M2,M1)
    RN3FLB(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(ids_NH3B,M3,M2,M1))*VLNHB(M3,M2,M1)
    RNOFLB(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(ids_NO3B,M3,M2,M1))*VLNOB(M3,M2,M1)
    RNXFLB(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(ids_NO2B,M3,M2,M1))*VLNOB(M3,M2,M1)
    RH2BFB(N,M6,M5,M4)=VFLW*AZMAX1(trc_solml2(ids_H2PO4B,M3,M2,M1))*VLPOB(M3,M2,M1)
!
