...
!
    ...
    TQSH1P(NY,NX)=0.0_r8
    TQSH2P(NY,NX)=0.0_r8
    trc_solml2(ids_NH4,0,NY,NX)=trc_solml2(ids_NH4,0,NY,NX)-RN4SK2(0,NY,NX)
    trc_solml2(idg_NH3,0,NY,NX)=trc_solml2(idg_NH3,0,NY,NX)-RN3SK2(0,NY,NX)
    trc_solml2(ids_NO3,0,NY,NX)=trc_solml2(ids_NO3,0,NY,NX)-RNOSK2(0,NY,NX)
    trc_solml2(ids_NO2,0,NY,NX)=trc_solml2(ids_NO2,0,NY,NX)-RNXSK2(0,NY,NX)
    trc_solml2(ids_H2PO4,0,NY,NX)=trc_solml2(ids_H2PO4,0,NY,NX)-RHPSK2(0,NY,NX)
    trc_solml2(ids_H1PO4,0,NY,NX)=trc_solml2(ids_H1PO4,0,NY,NX)-R1PSK2(0,NY,NX)
    ROXSK2(0,NY,NX)=ROXSK(M,0,NY,NX)*XNPT
  ENDIF
  trc_solml2(idg_CO2,0,NY,NX)=trc_solml2(idg_CO2,0,NY,NX)-RCOSK2(0,NY,NX)
  trc_solml2(idg_CH4,0,NY,NX)=trc_solml2(idg_CH4,0,NY,NX)-RCHSK2(0,NY,NX)
  trc_solml2(idg_O2,0,NY,NX)=trc_solml2(idg_O2,0,NY,NX)-ROXSK2(0,NY,NX)
  trc_solml2(idg_N2,0,NY,NX)=trc_solml2(idg_N2,0,NY,NX)-RNGSK2(0,NY,NX)
  trc_solml2(idg_N2O,0,NY,NX)=trc_solml2(idg_N2O,0,NY,NX)-RN2SK2(0,NY,NX)
  trc_solml2(idg_H2,0,NY,NX)=trc_solml2(idg_H2,0,NY,NX)-RHGSK2(0,NY,NX)
  trc_gasml2(idg_NH3,0,NY,NX)=trc_gasml2(idg_NH3,0,NY,NX)-RNHSK2(0,NY,NX)
!
...
!
!
      trc_solml2(ids_NH4,L,NY,NX)=trc_solml2(ids_NH4,L,NY,NX)-RN4SK2(L,NY,NX)
      trc_solml2(idg_NH3,L,NY,NX)=trc_solml2(idg_NH3,L,NY,NX)-RN3SK2(L,NY,NX)
      trc_solml2(ids_NO3,L,NY,NX)=trc_solml2(ids_NO3,L,NY,NX)-RNOSK2(L,NY,NX)
      trc_solml2(ids_NO2,L,NY,NX)=trc_solml2(ids_NO2,L,NY,NX)-RNXSK2(L,NY,NX)
      trc_solml2(ids_H2PO4,L,NY,NX)=trc_solml2(ids_H2PO4,L,NY,NX)-RHPSK2(L,NY,NX)
      trc_solml2(ids_H1PO4,L,NY,NX)=trc_solml2(ids_H1PO4,L,NY,NX)-R1PSK2(L,NY,NX)
      trc_solml2(ids_NH4B,L,NY,NX)=trc_solml2(ids_NH4B,L,NY,NX)-R4BSK2(L,NY,NX)
      trc_solml2(idg_NH3B,L,NY,NX)=trc_solml2(idg_NH3B,L,NY,NX)-R3BSK2(L,NY,NX)
      trc_solml2(ids_NO3B,L,NY,NX)=trc_solml2(ids_NO3B,L,NY,NX)-RNBSK2(L,NY,NX)
      trc_solml2(ids_NO2B,L,NY,NX)=trc_solml2(ids_NO2B,L,NY,NX)-RNZSK2(L,NY,NX)
      trc_solml2(ids_H2PO4B,L,NY,NX)=trc_solml2(ids_H2PO4B,L,NY,NX)-RHBSK2(L,NY,NX)
      trc_solml2(ids_H1PO4B,L,NY,NX)=trc_solml2(ids_H1PO4B,L,NY,NX)-R1BSK2(L,NY,NX)
...
!
    ...
    trc_solml2(idg_CO2,L,NY,NX)=trc_solml2(idg_CO2,L,NY,NX)-RCOSK2(L,NY,NX)
    trc_solml2(idg_CH4,L,NY,NX)=trc_solml2(idg_CH4,L,NY,NX)-RCHSK2(L,NY,NX)
    trc_solml2(idg_O2,L,NY,NX)=trc_solml2(idg_O2,L,NY,NX)-ROXSK2(L,NY,NX)
    trc_solml2(idg_N2,L,NY,NX)=trc_solml2(idg_N2,L,NY,NX)-RNGSK2(L,NY,NX)
    trc_solml2(idg_N2O,L,NY,NX)=trc_solml2(idg_N2O,L,NY,NX)-RN2SK2(L,NY,NX)
    trc_solml2(idg_H2,L,NY,NX)=trc_solml2(idg_H2,L,NY,NX)-RHGSK2(L,NY,NX)
    trc_gasml2(idg_NH3,L,NY,NX)=trc_gasml2(idg_NH3,L,NY,NX)-RNHSK2(L,NY,NX)
  ENDDO
...
!
  IF(FLWM(M,N,N6,N5,N4).GT.0.0_r8)THEN
    ...
    ENDDO
    RFLCOS=VFLW*AZMAX1(trc_solml2(idg_CO2,N3,N2,N1))
    RFLCHS=VFLW*AZMAX1(trc_solml2(idg_CH4,N3,N2,N1))
    RFLOXS=VFLW*AZMAX1(trc_solml2(idg_O2,N3,N2,N1))
    RFLNGS=VFLW*AZMAX1(trc_solml2(idg_N2,N3,N2,N1))
    RFLN2S=VFLW*AZMAX1(trc_solml2(idg_N2O,N3,N2,N1))
    RFLHGS=VFLW*AZMAX1(trc_solml2(idg_H2,N3,N2,N1))
    RFLNH4=VFLW*AZMAX1(trc_solml2(ids_NH4,N3,N2,N1))
    RFLNH3=VFLW*AZMAX1(trc_solml2(idg_NH3,N3,N2,N1))
    RFLNO3=VFLW*AZMAX1(trc_solml2(ids_NO3,N3,N2,N1))
    RFLNO2=VFLW*AZMAX1(trc_solml2(ids_NO2,N3,N2,N1))
    RFLP14=VFLW*AZMAX1(trc_solml2(ids_H1PO4,N3,N2,N1))
    RFLPO4=VFLW*AZMAX1(trc_solml2(ids_H2PO4,N3,N2,N1))
    RFLN4B=VFLW*AZMAX1(trc_solml2(ids_NH4B,N3,N2,N1))
    RFLN3B=VFLW*AZMAX1(trc_solml2(idg_NH3B,N3,N2,N1))
    RFLNOB=VFLW*AZMAX1(trc_solml2(ids_NO3B,N3,N2,N1))
    RFLN2B=VFLW*AZMAX1(trc_solml2(ids_NO2B,N3,N2,N1))
    RFLP1B=VFLW*AZMAX1(trc_solml2(ids_H1PO4B,N3,N2,N1))
    RFLPOB=VFLW*AZMAX1(trc_solml2(ids_H2PO4B,N3,N2,N1))
!
...
!
  ELSE
    ...
    ENDDO D9815
    RFLCOS=VFLW*AZMAX1(trc_solml2(idg_CO2,N6,N5,N4))
    RFLCHS=VFLW*AZMAX1(trc_solml2(idg_CH4,N6,N5,N4))
    RFLOXS=VFLW*AZMAX1(trc_solml2(idg_O2,N6,N5,N4))
    RFLNGS=VFLW*AZMAX1(trc_solml2(idg_N2,N6,N5,N4))
    RFLN2S=VFLW*AZMAX1(trc_solml2(idg_N2O,N6,N5,N4))
    RFLHGS=VFLW*AZMAX1(trc_solml2(idg_H2,N6,N5,N4))
    RFLNH4=VFLW*AZMAX1(trc_solml2(ids_NH4,N6,N5,N4))
    RFLNH3=VFLW*AZMAX1(trc_solml2(idg_NH3,N6,N5,N4))
    RFLNO3=VFLW*AZMAX1(trc_solml2(ids_NO3,N6,N5,N4))
    RFLNO2=VFLW*AZMAX1(trc_solml2(ids_NO2,N6,N5,N4))
    RFLP14=VFLW*AZMAX1(trc_solml2(ids_H1PO4,N6,N5,N4))
    RFLPO4=VFLW*AZMAX1(trc_solml2(ids_H2PO4,N6,N5,N4))
    RFLN4B=VFLW*AZMAX1(trc_solml2(ids_NH4B,N6,N5,N4))
    RFLN3B=VFLW*AZMAX1(trc_solml2(idg_NH3B,N6,N5,N4))
    RFLNOB=VFLW*AZMAX1(trc_solml2(ids_NO3B,N6,N5,N4))
    RFLN2B=VFLW*AZMAX1(trc_solml2(ids_NO2B,N6,N5,N4))
    RFLP1B=VFLW*AZMAX1(trc_solml2(ids_H1PO4B,N6,N5,N4))
    RFLPOB=VFLW*AZMAX1(trc_solml2(ids_H2PO4B,N6,N5,N4))
  ENDIF

  RPoreSolFlx(idg_CO2,N,N6,N5,N4)=RFLCOS
  RPoreSolFlx(idg_CH4,N,N6,N5,N4)=RFLCHS
  RPoreSolFlx(idg_O2,N,N6,N5,N4)=RFLOXS
  RPoreSolFlx(idg_N2,N,N6,N5,N4)=RFLNGS
  RPoreSolFlx(idg_N2O,N,N6,N5,N4)=RFLN2S
  RPoreSolFlx(idg_H2,N,N6,N5,N4)=RFLHGS
  RPoreSolFlx(ids_NH4,N,N6,N5,N4)=RFLNH4
  RPoreSolFlx(idg_NH3,N,N6,N5,N4)=RFLNH3
  RPoreSolFlx(ids_NO3,N,N6,N5,N4)=RFLNO3
  RPoreSolFlx(ids_NO2,N,N6,N5,N4)=RFLNO2
  RPoreSolFlx(ids_H1PO4,N,N6,N5,N4)=RFLP14
  RPoreSolFlx(ids_H2PO4,N,N6,N5,N4)=RFLPO4
  RPoreSolFlx(ids_NH4B,N,N6,N5,N4)=RFLN4B
  RPoreSolFlx(idg_NH3B,N,N6,N5,N4)=RFLN3B
  RPoreSolFlx(ids_NO3B,N,N6,N5,N4)=RFLNOB
  RPoreSolFlx(ids_NO2B,N,N6,N5,N4)=RFLN2B
  RPoreSolFlx(ids_H1PO4B,N,N6,N5,N4)=RFLP1B
  RPoreSolFlx(ids_H2PO4B,N,N6,N5,N4)=RFLPOB
...
!
    ...
    SDifFlx(ids_NH4)=SDifc(ids_NH4)*(CNH4S1-CNH4S2)*AMIN1(VLNH4(N3,N2,N1),VLNH4(N6,N5,N4))
    SDifFlx(idg_NH3)=SDifc(idg_NH3)*(CNH3S1-CNH3S2)*AMIN1(VLNH4(N3,N2,N1),VLNH4(N6,N5,N4))
    SDifFlx(ids_NO3)=SDifc(ids_NO3)*(CNO3S1-CNO3S2)*AMIN1(VLNO3(N3,N2,N1),VLNO3(N6,N5,N4))
    SDifFlx(ids_NO2)=SDifc(ids_NO2)*(CNO2S1-CNO2S2)*AMIN1(VLNO3(N3,N2,N1),VLNO3(N6,N5,N4))
    SDifFlx(ids_H1PO4)=SDifc(ids_H1PO4)*(CP14S1-CP14S2)*AMIN1(VLPO4(N3,N2,N1),VLPO4(N6,N5,N4))
    SDifFlx(ids_H2PO4)=SDifc(ids_H2PO4)*(CPO4S1-CPO4S2)*AMIN1(VLPO4(N3,N2,N1),VLPO4(N6,N5,N4))
    SDifFlx(ids_NH4B)=SDifc(ids_NH4B)*(CNH4B1-CNH4B2)*AMIN1(VLNHB(N3,N2,N1),VLNHB(N6,N5,N4))
    SDifFlx(idg_NH3B)=SDifc(idg_NH3B)*(CNH3B1-CNH3B2)*AMIN1(VLNHB(N3,N2,N1),VLNHB(N6,N5,N4))
    SDifFlx(ids_NO3)=SDifc(ids_NO3)*(CNO3B1-CNO3B2)*AMIN1(VLNOB(N3,N2,N1),VLNOB(N6,N5,N4))
    SDifFlx(ids_NO2)=SDifc(ids_NO3)*(CNO2B1-CNO2B2)*AMIN1(VLNOB(N3,N2,N1),VLNOB(N6,N5,N4))
    SDifFlx(ids_H1PO4B)=SDifc(ids_H1PO4B)*(CP14B1-CP14B2)*AMIN1(VLPOB(N3,N2,N1),VLPOB(N6,N5,N4))
    SDifFlx(ids_H2PO4B)=SDifc(ids_H2PO4B)*(CPO4B1-CPO4B2)*AMIN1(VLPOB(N3,N2,N1),VLPOB(N6,N5,N4))
  ELSE
    D9905: DO K=1,jcplx
      DFVOC(K)=0.0_r8
      DFVON(K)=0.0_r8
  ...
  DO NTS=ids_beg,ids_end
    RPoreSolFlx(NTS,N,N6,N5,N4)=RPoreSolFlx(NTS,N,N6,N5,N4)+SDifFlx(NTS)
  ENDDO
...
!
    IF(N.EQ.3.AND.VOLAH(N6,N5,N4).GT.VOLWHM(M,N6,N5,N4))THEN
      ...
      ENDDO D9800
      RFHCOS=VFLW*AZMAX1((trc_soHml2(idg_CO2,N3,N2,N1)-AZMIN1(RporeSoXFlx(idg_CO2,NU(N2,N1),N2,N1))))
      RFHCHS=VFLW*AZMAX1((trc_soHml2(idg_CH4,N3,N2,N1)-AZMIN1(RporeSoXFlx(idg_CH4,NU(N2,N1),N2,N1))))
      RFHOXS=VFLW*AZMAX1((trc_soHml2(idg_O2,N3,N2,N1)-AZMIN1(RporeSoXFlx(idg_O2,NU(N2,N1),N2,N1))))
      RFHNGS=VFLW*AZMAX1((trc_soHml2(idg_N2,N3,N2,N1)-AZMIN1(RporeSoXFlx(idg_N2,NU(N2,N1),N2,N1))))
      RFHN2S=VFLW*AZMAX1((trc_soHml2(idg_N2O,N3,N2,N1)-AZMIN1(RporeSoXFlx(idg_N2O,NU(N2,N1),N2,N1))))
      RFHHGS=VFLW*AZMAX1((trc_soHml2(idg_H2,N3,N2,N1)-AZMIN1(RporeSoXFlx(idg_H2,NU(N2,N1),N2,N1))))
      RFHNH4=VFLW*AZMAX1((trc_soHml2(ids_NH4,N3,N2,N1)-AZMIN1(RporeSoXFlx(ids_NH4,NU(N2,N1),N2,N1)*VLNH4(N3,N2,N1))))*VLNH4(N6,N5,N4)
      RFHNH3=VFLW*AZMAX1((trc_soHml2(idg_NH3,N3,N2,N1)-AZMIN1(RporeSoXFlx(idg_NH3,NU(N2,N1),N2,N1)*VLNH4(N3,N2,N1))))*VLNH4(N6,N5,N4)
      RFHNO3=VFLW*AZMAX1((trc_soHml2(ids_NO3,N3,N2,N1)-AZMIN1(RporeSoXFlx(ids_NO3,NU(N2,N1),N2,N1)*VLNO3(N3,N2,N1))))*VLNO3(N6,N5,N4)
      RFHNO2=VFLW*AZMAX1((trc_soHml2(ids_NO2,N3,N2,N1)-AZMIN1(RporeSoXFlx(ids_NO2,NU(N2,N1),N2,N1)*VLNO3(N3,N2,N1))))*VLNO3(N6,N5,N4)
      RFHP14=VFLW*AZMAX1((trc_soHml2(ids_H1PO4,N3,N2,N1)-AZMIN1(RporeSoXFlx(ids_H1PO4,NU(N2,N1),N2,N1)*VLPO4(N3,N2,N1))))*VLPO4(N6,N5,N4)
      RFHPO4=VFLW*AZMAX1((trc_soHml2(ids_H2PO4,N3,N2,N1)-AZMIN1(RporeSoXFlx(ids_H2PO4,NU(N2,N1),N2,N1)*VLPO4(N3,N2,N1))))*VLPO4(N6,N5,N4)
      RFHN4B=VFLW*AZMAX1((trc_soHml2(ids_NH4B,N3,N2,N1)-AZMIN1(RporeSoXFlx(ids_NH4B,NU(N2,N1),N2,N1)*VLNHB(N3,N2,N1))))*VLNHB(N6,N5,N4)
      RFHN3B=VFLW*AZMAX1((trc_soHml2(idg_NH3B,N3,N2,N1)-AZMIN1(RporeSoXFlx(idg_NH3B,NU(N2,N1),N2,N1)*VLNHB(N3,N2,N1))))*VLNHB(N6,N5,N4)
      RFHNOB=VFLW*AZMAX1((trc_soHml2(ids_NO3B,N3,N2,N1)-AZMIN1(RporeSoXFlx(ids_NO3B,NU(N2,N1),N2,N1)*VLNOB(N3,N2,N1))))*VLNOB(N6,N5,N4)
      RFHN2B=VFLW*AZMAX1((trc_soHml2(ids_NO2B,N3,N2,N1)-AZMIN1(RporeSoXFlx(ids_NO2B,NU(N2,N1),N2,N1)*VLNOB(N3,N2,N1))))*VLNOB(N6,N5,N4)
      RFHP1B=VFLW*AZMAX1((trc_soHml2(ids_H1PO4B,N3,N2,N1)-AZMIN1(RporeSoXFlx(ids_H1PO4B,NU(N2,N1),N2,N1)*VLPOB(N3,N2,N1))))*VLPOB(N6,N5,N4)
      RFHPOB=VFLW*AZMAX1((trc_soHml2(ids_H2PO4B,N3,N2,N1)-AZMIN1(RporeSoXFlx(ids_H2PO4B,NU(N2,N1),N2,N1)*VLPOB(N3,N2,N1))))*VLPOB(N6,N5,N4)
!
!     OTHERWISE
!
    ELSE
      ...
      ENDDO D9850
      RFHCOS=VFLW*AZMAX1(trc_soHml2(idg_CO2,N3,N2,N1))
      RFHCHS=VFLW*AZMAX1(trc_soHml2(idg_CH4,N3,N2,N1))
      RFHOXS=VFLW*AZMAX1(trc_soHml2(idg_O2,N3,N2,N1))
      RFHNGS=VFLW*AZMAX1(trc_soHml2(idg_N2,N3,N2,N1))
      RFHN2S=VFLW*AZMAX1(trc_soHml2(idg_N2O,N3,N2,N1))
      RFHHGS=VFLW*AZMAX1(trc_soHml2(idg_H2,N3,N2,N1))
      RFHNH4=VFLW*AZMAX1(trc_soHml2(ids_NH4,N3,N2,N1))*VLNH4(N6,N5,N4)
      RFHNH3=VFLW*AZMAX1(trc_soHml2(idg_NH3,N3,N2,N1))*VLNH4(N6,N5,N4)
      RFHNO3=VFLW*AZMAX1(trc_soHml2(ids_NO3,N3,N2,N1))*VLNO3(N6,N5,N4)
      RFHNO2=VFLW*AZMAX1(trc_soHml2(ids_NO2,N3,N2,N1))*VLNO3(N6,N5,N4)
      RFHP14=VFLW*AZMAX1(trc_soHml2(ids_H1PO4,N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHPO4=VFLW*AZMAX1(trc_soHml2(ids_H2PO4,N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHN4B=VFLW*AZMAX1(trc_soHml2(ids_NH4B,N3,N2,N1))*VLNHB(N6,N5,N4)
      RFHN3B=VFLW*AZMAX1(trc_soHml2(idg_NH3B,N3,N2,N1))*VLNHB(N6,N5,N4)
      RFHNOB=VFLW*AZMAX1(trc_soHml2(ids_NO3B,N3,N2,N1))*VLNOB(N6,N5,N4)
      RFHN2B=VFLW*AZMAX1(trc_soHml2(ids_NO2B,N3,N2,N1))*VLNOB(N6,N5,N4)
      RFHP1B=VFLW*AZMAX1(trc_soHml2(ids_H1PO4B,N3,N2,N1))*VLPOB(N6,N5,N4)
      RFHPOB=VFLW*AZMAX1(trc_soHml2(ids_H2PO4B,N3,N2,N1))*VLPOB(N6,N5,N4)
    ENDIF
!
...
!
  ELSEIF(FLWHM(M,N,N6,N5,N4).LT.0.0_r8)THEN
    ...
    ENDDO D9665
    RFHCOS=VFLW*AZMAX1(trc_soHml2(idg_CO2,N6,N5,N4))
    RFHCHS=VFLW*AZMAX1(trc_soHml2(idg_CH4,N6,N5,N4))
    RFHOXS=VFLW*AZMAX1(trc_soHml2(idg_O2,N6,N5,N4))
    RFHNGS=VFLW*AZMAX1(trc_soHml2(idg_N2,N6,N5,N4))
    RFHN2S=VFLW*AZMAX1(trc_soHml2(idg_N2O,N6,N5,N4))
    RFHHGS=VFLW*AZMAX1(trc_soHml2(idg_H2,N6,N5,N4))
    RFHNH4=VFLW*AZMAX1(trc_soHml2(ids_NH4,N6,N5,N4))*VLNH4(N6,N5,N4)
    RFHNH3=VFLW*AZMAX1(trc_soHml2(idg_NH3,N6,N5,N4))*VLNH4(N6,N5,N4)
    RFHNO3=VFLW*AZMAX1(trc_soHml2(ids_NO3,N6,N5,N4))*VLNO3(N6,N5,N4)
    RFHNO2=VFLW*AZMAX1(trc_soHml2(ids_NO2,N6,N5,N4))*VLNO3(N6,N5,N4)
    RFHP14=VFLW*AZMAX1(trc_soHml2(ids_H1PO4,N6,N5,N4))*VLPO4(N6,N5,N4)
    RFHPO4=VFLW*AZMAX1(trc_soHml2(ids_H2PO4,N6,N5,N4))*VLPO4(N6,N5,N4)
    RFHN4B=VFLW*AZMAX1(trc_soHml2(ids_NH4B,N6,N5,N4))*VLNHB(N6,N5,N4)
    RFHN3B=VFLW*AZMAX1(trc_soHml2(idg_NH3B,N6,N5,N4))*VLNHB(N6,N5,N4)
    RFHNOB=VFLW*AZMAX1(trc_soHml2(ids_NO3B,N6,N5,N4))*VLNOB(N6,N5,N4)
    RFHN2B=VFLW*AZMAX1(trc_soHml2(ids_NO2B,N6,N5,N4))*VLNOB(N6,N5,N4)
    RFHP1B=VFLW*AZMAX1(trc_soHml2(ids_H1PO4B,N6,N5,N4))*VLPOB(N6,N5,N4)
    RFHPOB=VFLW*AZMAX1(trc_soHml2(ids_H2PO4B,N6,N5,N4))*VLPOB(N6,N5,N4)
  ELSE
!
!     NO MACROPORE FLUX
!
  ...
  RPoreSoHFlx(idg_CO2,N,N6,N5,N4)=RFHCOS
  RPoreSoHFlx(idg_CH4,N,N6,N5,N4)=RFHCHS
  RPoreSoHFlx(idg_O2,N,N6,N5,N4)=RFHOXS
  RPoreSoHFlx(idg_N2,N,N6,N5,N4)=RFHNGS
  RPoreSoHFlx(idg_N2O,N,N6,N5,N4)=RFHN2S
  RPoreSoHFlx(idg_H2,N,N6,N5,N4)=RFHHGS
  RPoreSoHFlx(ids_NH4,N,N6,N5,N4)=RFHNH4
  RPoreSoHFlx(idg_NH3,N,N6,N5,N4)=RFHNH3
  RPoreSoHFlx(ids_NO3,N,N6,N5,N4)=RFHNO3
  RPoreSoHFlx(ids_NO2,N,N6,N5,N4)=RFHNO2
  RPoreSoHFlx(ids_H1PO4,N,N6,N5,N4)=RFHP14
  RPoreSoHFlx(ids_H2PO4,N,N6,N5,N4)=RFHPO4
  RPoreSoHFlx(ids_NH4B,N,N6,N5,N4)=RFHN4B
  RPoreSoHFlx(idg_NH3B,N,N6,N5,N4)=RFHN3B
  RPoreSoHFlx(ids_NO3B,N,N6,N5,N4)=RFHNOB
  RPoreSoHFlx(ids_NO2B,N,N6,N5,N4)=RFHN2B
  RPoreSoHFlx(ids_H1PO4B,N,N6,N5,N4)=RFHP1B
  RPoreSoHFlx(ids_H2PO4B,N,N6,N5,N4)=RFHPOB
...
!
    ...
    SDifHFlx(ids_NH4)=SDifc(ids_NH4)*(CNH4SH1-CNH4SH2)*AMIN1(VLNH4(N3,N2,N1),VLNH4(N6,N5,N4))
    SDifHFlx(idg_NH3)=SDifc(idg_NH3)*(CNH3SH1-CNH3SH2)*AMIN1(VLNH4(N3,N2,N1),VLNH4(N6,N5,N4))
    SDifHFlx(ids_NO3)=SDifc(ids_NO3)*(CNO3SH1-CNO3SH2)*AMIN1(VLNO3(N3,N2,N1),VLNO3(N6,N5,N4))
    SDifHFlx(ids_NO2)=SDifc(ids_NO2)*(CNO2SH1-CNO2SH2)*AMIN1(VLNO3(N3,N2,N1),VLNO3(N6,N5,N4))
    SDifHFlx(ids_H1PO4)=SDifc(ids_H1PO4)*(CP14SH1-CP14SH2)*AMIN1(VLPO4(N3,N2,N1),VLPO4(N6,N5,N4))
    SDifHFlx(ids_H2PO4)=SDifc(ids_H2PO4)*(CPO4SH1-CPO4SH2)*AMIN1(VLPO4(N3,N2,N1),VLPO4(N6,N5,N4))
    SDifHFlx(ids_NH4B)=SDifc(ids_NH4B)*(CNH4BH1-CNH4BH2)*AMIN1(VLNHB(N3,N2,N1),VLNHB(N6,N5,N4))
    SDifHFlx(idg_NH3B)=SDifc(idg_NH3B)*(CNH3BH1-CNH3BH2)*AMIN1(VLNHB(N3,N2,N1),VLNHB(N6,N5,N4))
    SDifHFlx(ids_NO3B)=SDifc(ids_NO3B)*(CNO3BH1-CNO3BH2)*AMIN1(VLNOB(N3,N2,N1),VLNOB(N6,N5,N4))
    SDifHFlx(ids_NO2B)=SDifc(ids_NO2B)*(CNO2BH1-CNO2BH2)*AMIN1(VLNOB(N3,N2,N1),VLNOB(N6,N5,N4))
    SDifHFlx(ids_H1PO4B)=SDifc(ids_H1PO4B)*(CP14BH1-CP14BH2)*AMIN1(VLPOB(N3,N2,N1),VLPOB(N6,N5,N4))
    SDifHFlx(ids_H2PO4B)=SDifc(ids_H2PO4B)*(CPO4BH1-CPO4BH2)*AMIN1(VLPOB(N3,N2,N1),VLPOB(N6,N5,N4))
  ELSE
    D9780: DO K=1,jcplx
      DFHOC(K)=0.0_r8
      DFHON(K)=0.0_r8
  ...
  ENDIF
  DO NTS = ids_beg,ids_end
    RPoreSoHFlx(NTS,N,N6,N5,N4)=RPoreSoHFlx(NTS,N,N6,N5,N4)+SDifHFlx(NTS)
  ENDDO
...
9755  CONTINUE
  XCOFLS(N,N6,N5,N4)=XCOFLS(N,N6,N5,N4)+RPoreSolFlx(idg_CO2,N,N6,N5,N4)
  XCHFLS(N,N6,N5,N4)=XCHFLS(N,N6,N5,N4)+RPoreSolFlx(idg_CH4,N,N6,N5,N4)
  XOXFLS(N,N6,N5,N4)=XOXFLS(N,N6,N5,N4)+RPoreSolFlx(idg_O2,N,N6,N5,N4)
  XNGFLS(N,N6,N5,N4)=XNGFLS(N,N6,N5,N4)+RPoreSolFlx(idg_N2,N,N6,N5,N4)
  XN2FLS(N,N6,N5,N4)=XN2FLS(N,N6,N5,N4)+RPoreSolFlx(idg_N2O,N,N6,N5,N4)
  XHGFLS(N,N6,N5,N4)=XHGFLS(N,N6,N5,N4)+RPoreSolFlx(idg_H2,N,N6,N5,N4)
  XN4FLW(N,N6,N5,N4)=XN4FLW(N,N6,N5,N4)+RPoreSolFlx(ids_NH4,N,N6,N5,N4)
  XN3FLW(N,N6,N5,N4)=XN3FLW(N,N6,N5,N4)+RPoreSolFlx(idg_NH3,N,N6,N5,N4)
  XNOFLW(N,N6,N5,N4)=XNOFLW(N,N6,N5,N4)+RPoreSolFlx(ids_NO3,N,N6,N5,N4)
  XNXFLS(N,N6,N5,N4)=XNXFLS(N,N6,N5,N4)+RPoreSolFlx(ids_NO2,N,N6,N5,N4)
  XH1PFS(N,N6,N5,N4)=XH1PFS(N,N6,N5,N4)+RPoreSolFlx(ids_H1PO4,N,N6,N5,N4)
  XH2PFS(N,N6,N5,N4)=XH2PFS(N,N6,N5,N4)+RPoreSolFlx(ids_H2PO4,N,N6,N5,N4)
  XN4FLB(N,N6,N5,N4)=XN4FLB(N,N6,N5,N4)+RPoreSolFlx(ids_NH4B,N,N6,N5,N4)
  XN3FLB(N,N6,N5,N4)=XN3FLB(N,N6,N5,N4)+RPoreSolFlx(idg_NH3B,N,N6,N5,N4)
  XNOFLB(N,N6,N5,N4)=XNOFLB(N,N6,N5,N4)+RPoreSolFlx(ids_NO3B,N,N6,N5,N4)
  XNXFLB(N,N6,N5,N4)=XNXFLB(N,N6,N5,N4)+RPoreSolFlx(ids_NO2B,N,N6,N5,N4)
  XH2BFB(N,N6,N5,N4)=XH2BFB(N,N6,N5,N4)+RPoreSolFlx(ids_H2PO4B,N,N6,N5,N4)

  XCOFHS(N,N6,N5,N4)=XCOFHS(N,N6,N5,N4)+RPoreSoHFlx(idg_CO2,N,N6,N5,N4)
  XCHFHS(N,N6,N5,N4)=XCHFHS(N,N6,N5,N4)+RPoreSoHFlx(idg_CH4,N,N6,N5,N4)
  XOXFHS(N,N6,N5,N4)=XOXFHS(N,N6,N5,N4)+RPoreSoHFlx(idg_O2,N,N6,N5,N4)
  XNGFHS(N,N6,N5,N4)=XNGFHS(N,N6,N5,N4)+RPoreSoHFlx(idg_N2,N,N6,N5,N4)
  XN2FHS(N,N6,N5,N4)=XN2FHS(N,N6,N5,N4)+RPoreSoHFlx(idg_N2O,N,N6,N5,N4)
  XHGFHS(N,N6,N5,N4)=XHGFHS(N,N6,N5,N4)+RPoreSoHFlx(idg_H2,N,N6,N5,N4)
  XN4FHW(N,N6,N5,N4)=XN4FHW(N,N6,N5,N4)+RPoreSoHFlx(ids_NH4,N,N6,N5,N4)
  XN3FHW(N,N6,N5,N4)=XN3FHW(N,N6,N5,N4)+RPoreSoHFlx(idg_NH3,N,N6,N5,N4)
  XNOFHW(N,N6,N5,N4)=XNOFHW(N,N6,N5,N4)+RPoreSoHFlx(ids_NO3,N,N6,N5,N4)
  XNXFHS(N,N6,N5,N4)=XNXFHS(N,N6,N5,N4)+RPoreSoHFlx(ids_NO2,N,N6,N5,N4)
  XH1PHS(N,N6,N5,N4)=XH1PHS(N,N6,N5,N4)+RPoreSoHFlx(ids_H1PO4,N,N6,N5,N4)
  XH2PHS(N,N6,N5,N4)=XH2PHS(N,N6,N5,N4)+RPoreSoHFlx(ids_H2PO4,N,N6,N5,N4)
  XN4FHB(N,N6,N5,N4)=XN4FHB(N,N6,N5,N4)+RPoreSoHFlx(ids_NH4B,N,N6,N5,N4)
  XN3FHB(N,N6,N5,N4)=XN3FHB(N,N6,N5,N4)+RPoreSoHFlx(idg_NH3B,N,N6,N5,N4)
  XNOFHB(N,N6,N5,N4)=XNOFHB(N,N6,N5,N4)+RPoreSoHFlx(ids_NO3B,N,N6,N5,N4)
  XNXFHB(N,N6,N5,N4)=XNXFHB(N,N6,N5,N4)+RPoreSoHFlx(ids_NO2B,N,N6,N5,N4)
  XH1BHB(N,N6,N5,N4)=XH1BHB(N,N6,N5,N4)+RPoreSoHFlx(ids_H1PO4B,N,N6,N5,N4)
  XH2BHB(N,N6,N5,N4)=XH2BHB(N,N6,N5,N4)+RPoreSoHFlx(ids_H2PO4B,N,N6,N5,N4)
...
!
  ...
  ENDDO D9945
  XCOFXS(N6,N5,N4)=XCOFXS(N6,N5,N4)+RporeSoXFlx(idg_CO2,N6,N5,N4)
  XCHFXS(N6,N5,N4)=XCHFXS(N6,N5,N4)+RporeSoXFlx(idg_CH4,N6,N5,N4)
  XOXFXS(N6,N5,N4)=XOXFXS(N6,N5,N4)+RporeSoXFlx(idg_O2,N6,N5,N4)
  XNGFXS(N6,N5,N4)=XNGFXS(N6,N5,N4)+RporeSoXFlx(idg_N2,N6,N5,N4)
  XN2FXS(N6,N5,N4)=XN2FXS(N6,N5,N4)+RporeSoXFlx(idg_N2O,N6,N5,N4)
  XHGFXS(N6,N5,N4)=XHGFXS(N6,N5,N4)+RporeSoXFlx(idg_H2,N6,N5,N4)
  XN4FXW(N6,N5,N4)=XN4FXW(N6,N5,N4)+RporeSoXFlx(ids_NH4,N6,N5,N4)
  XN3FXW(N6,N5,N4)=XN3FXW(N6,N5,N4)+RporeSoXFlx(idg_NH3,N6,N5,N4)
  XNOFXW(N6,N5,N4)=XNOFXW(N6,N5,N4)+RporeSoXFlx(ids_NO3,N6,N5,N4)
  XNXFXS(N6,N5,N4)=XNXFXS(N6,N5,N4)+RporeSoXFlx(ids_NO2,N6,N5,N4)
  XH1PXS(N6,N5,N4)=XH1PXS(N6,N5,N4)+RporeSoXFlx(ids_H1PO4,N6,N5,N4)
  XH2PXS(N6,N5,N4)=XH2PXS(N6,N5,N4)+RporeSoXFlx(ids_H2PO4,N6,N5,N4)
  XN4FXB(N6,N5,N4)=XN4FXB(N6,N5,N4)+RporeSoXFlx(ids_NH4B,N6,N5,N4)
  XN3FXB(N6,N5,N4)=XN3FXB(N6,N5,N4)+RporeSoXFlx(idg_NH3B,N6,N5,N4)
  XNOFXB(N6,N5,N4)=XNOFXB(N6,N5,N4)+RporeSoXFlx(ids_NO3B,N6,N5,N4)
  XNXFXB(N6,N5,N4)=XNXFXB(N6,N5,N4)+RporeSoXFlx(ids_NO2B,N6,N5,N4)
  XH1BXB(N6,N5,N4)=XH1BXB(N6,N5,N4)+RporeSoXFlx(ids_H1PO4B,N6,N5,N4)
  XH2BXB(N6,N5,N4)=XH2BXB(N6,N5,N4)+RporeSoXFlx(ids_H2PO4B,N6,N5,N4)
...
9970  CONTINUE
    RFLCOS=VFLW*AZMAX1(trc_soHml2(idg_CO2,N6,N5,N4))
    RFLCHS=VFLW*AZMAX1(trc_soHml2(idg_CH4,N6,N5,N4))
    RFLOXS=VFLW*AZMAX1(trc_soHml2(idg_O2,N6,N5,N4))
    RFLNGS=VFLW*AZMAX1(trc_soHml2(idg_N2,N6,N5,N4))
    RFLN2S=VFLW*AZMAX1(trc_soHml2(idg_N2O,N6,N5,N4))
    RFLHGS=VFLW*AZMAX1(trc_soHml2(idg_H2,N6,N5,N4))
    RFLNH4=VFLW*AZMAX1(trc_soHml2(ids_NH4,N6,N5,N4))*VLNH4(N6,N5,N4)
    RFLNH3=VFLW*AZMAX1(trc_soHml2(idg_NH3,N6,N5,N4))*VLNH4(N6,N5,N4)
    RFLNO3=VFLW*AZMAX1(trc_soHml2(ids_NO3,N6,N5,N4))*VLNO3(N6,N5,N4)
    RFLNO2=VFLW*AZMAX1(trc_soHml2(ids_NO2,N6,N5,N4))*VLNO3(N6,N5,N4)
    RFLP14=VFLW*AZMAX1(trc_soHml2(ids_H1PO4,N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLPO4=VFLW*AZMAX1(trc_soHml2(ids_H2PO4,N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLN4B=VFLW*AZMAX1(trc_soHml2(ids_NH4B,N6,N5,N4))*VLNHB(N6,N5,N4)
    RFLN3B=VFLW*AZMAX1(trc_soHml2(idg_NH3B,N6,N5,N4))*VLNHB(N6,N5,N4)
    RFLNOB=VFLW*AZMAX1(trc_soHml2(ids_NO3B,N6,N5,N4))*VLNOB(N6,N5,N4)
    RFLN2B=VFLW*AZMAX1(trc_soHml2(ids_NO2B,N6,N5,N4))*VLNOB(N6,N5,N4)
    RFLP1B=VFLW*AZMAX1(trc_soHml2(ids_H1PO4B,N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLPOB=VFLW*AZMAX1(trc_soHml2(ids_H2PO4B,N6,N5,N4))*VLPOB(N6,N5,N4)
!
...
9965  CONTINUE
    ...
    RFLN2S=VFLW*AZMAX1(trc_solml2(idg_N2O,N6,N5,N4))
    RFLHGS=VFLW*AZMAX1(trc_solml2(idg_H2,N6,N5,N4))
    RFLNH4=VFLW*AZMAX1(trc_solml2(ids_NH4,N6,N5,N4))*VLNH4(N6,N5,N4)
    RFLNH3=VFLW*AZMAX1(trc_solml2(idg_NH3,N6,N5,N4))*VLNH4(N6,N5,N4)
    RFLNO3=VFLW*AZMAX1(trc_solml2(ids_NO3,N6,N5,N4))*VLNO3(N6,N5,N4)
    RFLNO2=VFLW*AZMAX1(trc_solml2(ids_NO2,N6,N5,N4))*VLNO3(N6,N5,N4)
    RFLP14=VFLW*AZMAX1(trc_solml2(ids_H1PO4,N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLPO4=VFLW*AZMAX1(trc_solml2(ids_H2PO4,N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLN4B=VFLW*AZMAX1(trc_solml2(ids_NH4B,N6,N5,N4))*VLNHB(N6,N5,N4)
    RFLN3B=VFLW*AZMAX1(trc_solml2(idg_NH3B,N6,N5,N4))*VLNHB(N6,N5,N4)
    RFLNOB=VFLW*AZMAX1(trc_solml2(ids_NO3B,N6,N5,N4))*VLNOB(N6,N5,N4)
    RFLN2B=VFLW*AZMAX1(trc_solml2(ids_NO2B,N6,N5,N4))*VLNOB(N6,N5,N4)
    RFLP1B=VFLW*AZMAX1(trc_solml2(ids_H1PO4B,N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLPOB=VFLW*AZMAX1(trc_solml2(ids_H2PO4B,N6,N5,N4))*VLPOB(N6,N5,N4)
!
...
!
  ELSE
    ...
    RFLPOB=0.0_r8
  ENDIF
  RporeSoXFlx(idg_CO2,N6,N5,N4)=RFLCOS
  RporeSoXFlx(idg_CH4,N6,N5,N4)=RFLCHS
  RporeSoXFlx(idg_O2,N6,N5,N4)=RFLOXS
  RporeSoXFlx(idg_N2,N6,N5,N4)=RFLNGS
  RporeSoXFlx(idg_N2O,N6,N5,N4)=RFLN2S
  RporeSoXFlx(idg_H2,N6,N5,N4)=RFLHGS
  RporeSoXFlx(ids_NH4,N6,N5,N4)=RFLNH4
  RporeSoXFlx(idg_NH3,N6,N5,N4)=RFLNH3
  RporeSoXFlx(ids_NO3,N6,N5,N4)=RFLNO3
  RporeSoXFlx(ids_NO2,N6,N5,N4)=RFLNO2
  RporeSoXFlx(ids_H1PO4,N6,N5,N4)=RFLP14
  RporeSoXFlx(ids_H2PO4,N6,N5,N4)=RFLPO4
  RporeSoXFlx(ids_NH4B,N6,N5,N4)=RFLN4B
  RporeSoXFlx(idg_NH3B,N6,N5,N4)=RFLN3B
  RporeSoXFlx(ids_NO3B,N6,N5,N4)=RFLNOB
  RporeSoXFlx(ids_NO2B,N6,N5,N4)=RFLN2B
  RporeSoXFlx(ids_H1PO4B,N6,N5,N4)=RFLP1B
  RporeSoXFlx(ids_H2PO4B,N6,N5,N4)=RFLPOB
!
...
!
  IF(VOLWHM(M,N6,N5,N4).GT.ZEROS2(N5,N4))THEN
    ...
    ENDDO D9955
    DFVCOS=XNPH*(AZMAX1(trc_soHml2(idg_CO2,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(idg_CO2,N6,N5,N4))*VOLWHS)/VOLWT
    DFVCHS=XNPH*(AZMAX1(trc_soHml2(idg_CH4,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(idg_CH4,N6,N5,N4))*VOLWHS)/VOLWT
    DFVOXS=XNPH*(AZMAX1(trc_soHml2(idg_O2,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(idg_O2,N6,N5,N4))*VOLWHS)/VOLWT
    DFVNGS=XNPH*(AZMAX1(trc_soHml2(idg_N2,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(idg_N2,N6,N5,N4))*VOLWHS)/VOLWT
    DFVN2S=XNPH*(AZMAX1(trc_soHml2(idg_N2O,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(idg_N2O,N6,N5,N4))*VOLWHS)/VOLWT
    DFVHGS=XNPH*(AZMAX1(trc_soHml2(idg_H2,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(idg_H2,N6,N5,N4))*VOLWHS)/VOLWT
    DFVNH4=XNPH*(AZMAX1(trc_soHml2(ids_NH4,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_NH4,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNH4(N6,N5,N4)
    DFVNH3=XNPH*(AZMAX1(trc_soHml2(idg_NH3,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(idg_NH3,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNH4(N6,N5,N4)
    DFVNO3=XNPH*(AZMAX1(trc_soHml2(ids_NO3,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_NO3,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNO3(N6,N5,N4)
    DFVNO2=XNPH*(AZMAX1(trc_soHml2(ids_NO2,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_NO2,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNO3(N6,N5,N4)
    DFVP14=XNPH*(AZMAX1(trc_soHml2(ids_H1PO4,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_H1PO4,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
    DFVPO4=XNPH*(AZMAX1(trc_soHml2(ids_H2PO4,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_H2PO4,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
    DFVN4B=XNPH*(AZMAX1(trc_soHml2(ids_NH4B,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_NH4B,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNHB(N6,N5,N4)
    DFVN3B=XNPH*(AZMAX1(trc_soHml2(idg_NH3B,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(idg_NH3B,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNHB(N6,N5,N4)
    DFVNOB=XNPH*(AZMAX1(trc_soHml2(ids_NO3B,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_NO3B,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNOB(N6,N5,N4)
    DFVN2B=XNPH*(AZMAX1(trc_soHml2(ids_NO2B,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_NO2B,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNOB(N6,N5,N4)
    DFVP1B=XNPH*(AZMAX1(trc_soHml2(ids_H1PO4B,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_H1PO4B,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
    DFVPOB=XNPH*(AZMAX1(trc_soHml2(ids_H2PO4B,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_H2PO4B,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
  ELSE
    D9975: DO K=1,jcplx
      DFVOC(K)=0.0_r8
    ...
    DFVPOB=0.0_r8
  ENDIF
  RporeSoXFlx(idg_CO2,N6,N5,N4)=RporeSoXFlx(idg_CO2,N6,N5,N4)+DFVCOS
  RporeSoXFlx(idg_CH4,N6,N5,N4)=RporeSoXFlx(idg_CH4,N6,N5,N4)+DFVCHS
  RporeSoXFlx(idg_O2,N6,N5,N4)=RporeSoXFlx(idg_O2,N6,N5,N4)+DFVOXS
  RporeSoXFlx(idg_N2,N6,N5,N4)=RporeSoXFlx(idg_N2,N6,N5,N4)+DFVNGS
  RporeSoXFlx(idg_N2O,N6,N5,N4)=RporeSoXFlx(idg_N2O,N6,N5,N4)+DFVN2S
  RporeSoXFlx(idg_H2,N6,N5,N4)=RporeSoXFlx(idg_H2,N6,N5,N4)+DFVHGS
  RporeSoXFlx(ids_NH4,N6,N5,N4)=RporeSoXFlx(ids_NH4,N6,N5,N4)+DFVNH4
  RporeSoXFlx(idg_NH3,N6,N5,N4)=RporeSoXFlx(idg_NH3,N6,N5,N4)+DFVNH3
  RporeSoXFlx(ids_NO3,N6,N5,N4)=RporeSoXFlx(ids_NO3,N6,N5,N4)+DFVNO3
  RporeSoXFlx(ids_NO2,N6,N5,N4)=RporeSoXFlx(ids_NO2,N6,N5,N4)+DFVNO2
  RporeSoXFlx(ids_H1PO4,N6,N5,N4)=RporeSoXFlx(ids_H1PO4,N6,N5,N4)+DFVP14
  RporeSoXFlx(ids_H2PO4,N6,N5,N4)=RporeSoXFlx(ids_H2PO4,N6,N5,N4)+DFVPO4
  RporeSoXFlx(ids_NH4B,N6,N5,N4)=RporeSoXFlx(ids_NH4B,N6,N5,N4)+DFVN4B
  RporeSoXFlx(idg_NH3B,N6,N5,N4)=RporeSoXFlx(idg_NH3B,N6,N5,N4)+DFVN3B
  RporeSoXFlx(ids_NO3B,N6,N5,N4)=RporeSoXFlx(ids_NO3B,N6,N5,N4)+DFVNOB
  RporeSoXFlx(ids_NO2B,N6,N5,N4)=RporeSoXFlx(ids_NO2B,N6,N5,N4)+DFVN2B
  RporeSoXFlx(ids_H1PO4B,N6,N5,N4)=RporeSoXFlx(ids_H1PO4B,N6,N5,N4)+DFVP1B
  RporeSoXFlx(ids_H2PO4B,N6,N5,N4)=RporeSoXFlx(ids_H2PO4B,N6,N5,N4)+DFVPOB
!
...
!
  IF(N3.GE.NUM(N2,N1).AND.M.NE.MX)THEN
    ...
    IF(THETW1.GT.THETY(N3,N2,N1).AND.IFLGB.EQ.0)THEN
      ...
      SCO2X=catomw*GSolbility(idg_CO2,N3,N2,N1)  !conver into carbon g C/mol
      SCH4X=catomw*GSolbility(idg_CH4,N3,N2,N1)
...
!
      IF(N3.EQ.NU(N2,N1))THEN
        VCO2G2=(trc_solml2(idg_CO2,N3,N2,N1)+RGasSSVol(idg_CO2,NY,NX))/SCO2X
        VCH4G2=(trc_solml2(idg_CH4,N3,N2,N1)+RGasSSVol(idg_CH4,NY,NX))/SCH4X
        VOXYG2=(trc_solml2(idg_O2,N3,N2,N1)+RGasSSVol(idg_O2,NY,NX))/SOXYX
        VZ2GG2=(trc_solml2(idg_N2,N3,N2,N1)+RGasSSVol(idg_N2,NY,NX))/SN2GX
        VZ2OG2=(trc_solml2(idg_N2O,N3,N2,N1)+RGasSSVol(idg_N2O,NY,NX))/SN2OX
        VNH3G2=(trc_solml2(idg_NH3,N3,N2,N1)+RGasSSVol(idg_NH3,NY,NX))/SNH3X
        VNHBG2=(trc_solml2(idg_NH3B,N3,N2,N1)+RGasSSVol(idg_NH3B,NY,NX))/SNH3X
        VH2GG2=(trc_solml2(idg_H2,N3,N2,N1)+RGasSSVol(idg_H2,NY,NX))/SH2GX
      ELSE
        VCO2G2=trc_solml2(idg_CO2,N3,N2,N1)/SCO2X
        VCH4G2=trc_solml2(idg_CH4,N3,N2,N1)/SCH4X
        VOXYG2=trc_solml2(idg_O2,N3,N2,N1)/SOXYX
        VZ2GG2=trc_solml2(idg_N2,N3,N2,N1)/SN2GX
        VZ2OG2=trc_solml2(idg_N2O,N3,N2,N1)/SN2OX
        VNH3G2=trc_solml2(idg_NH3,N3,N2,N1)/SNH3X
        VNHBG2=trc_solml2(idg_NH3B,N3,N2,N1)/SNH3X
        VH2GG2=trc_solml2(idg_H2,N3,N2,N1)/SH2GX
      ENDIF
!
...
!     RFL*G=convective gas flux
  ...
  RCOFLG(N,N6,N5,N4)=DFVGG(idg_CO2)
  RCHFLG(N,N6,N5,N4)=DFVGG(idg_CH4)
  ROXFLG(N,N6,N5,N4)=DFVGG(idg_O2)
  RNGFLG(N,N6,N5,N4)=DFVGG(idg_N2)
  RN2FLG(N,N6,N5,N4)=DFVGG(idg_N2O)
  RN3FLG(N,N6,N5,N4)=DFVGG(idg_NH3)
  RHGFLG(N,N6,N5,N4)=DFVGG(idg_H2)
...
! ----------------------------------------------------------------------
  ...
  integer, intent(in) :: M,N,N1,N2,N3,N4,N5,N6
  real(r8) :: RGasAdv(idg_beg:idg_end)
  real(r8) :: VFLW,FLQW
  integer :: NTG
!
...
!
  ...
  IF(FLQW.GT.0.0_r8)THEN
    ...
    DO NTG=idg_beg,idg_end-1
      RGasAdv(NTG)=VFLW*AZMAX1(trc_gasml2(NTG,N6,N5,N4))
    ENDDO
  ELSE
    ...
    ENDIF
    DO NTG=idg_beg,idg_end-1
      RGasAdv(NTG)=VFLW*AZMAX1(trc_gasml2(NTG,N3,N2,N1))
    ENDDO
  ENDIF
!     R*FLG=total convective+diffusive gas flux
!     gas code:*CO*=CO2,*OX*=O2,*CH*=CH4,*NG*=N2,*N2*=N2O,*NH*=NH3,*HG*=H2
...
!     RFL*G=convective gas flux
!
  RCOFLG(N,N6,N5,N4)=RCOFLG(N,N6,N5,N4)+RGasAdv(idg_CO2)
  RCHFLG(N,N6,N5,N4)=RCHFLG(N,N6,N5,N4)+RGasAdv(idg_CH4)
  ROXFLG(N,N6,N5,N4)=ROXFLG(N,N6,N5,N4)+RGasAdv(idg_O2)
  RNGFLG(N,N6,N5,N4)=RNGFLG(N,N6,N5,N4)+RGasAdv(idg_N2)
  RN2FLG(N,N6,N5,N4)=RN2FLG(N,N6,N5,N4)+RGasAdv(idg_N2O)
  RN3FLG(N,N6,N5,N4)=RN3FLG(N,N6,N5,N4)+RGasAdv(idg_NH3)
  RHGFLG(N,N6,N5,N4)=RHGFLG(N,N6,N5,N4)+RGasAdv(idg_H2)
  ...
  IF(N.EQ.3)THEN
    IF(THETPM(M,N6,N5,N4).GT.THETX)THEN
      ...
      IF(VOLPMA(N6,N5,N4).GT.ZEROS2(N5,N4).AND.VOLWXA(N6,N5,N4).GT.ZEROS2(N5,N4))THEN
        ...
        CNH3S0=AZMAX1((trc_solml2(idg_NH3,N6,N5,N4)+RGasDSFlx(idg_NH3,N6,N5,N4))/VOLWXA(N6,N5,N4))
      ...
      IF(VOLPMB(N6,N5,N4).GT.ZEROS2(N5,N4).AND.VOLWXB(N6,N5,N4).GT.ZEROS2(N5,N4))THEN
        ...
        CNH3B0=AZMAX1((trc_solml2(idg_NH3B,N6,N5,N4)+RGasDSFlx(idg_NH3B,N6,N5,N4))/VOLWXB(N6,N5,N4))
...
!
      XCODFG(N6,N5,N4)=XCODFG(N6,N5,N4)+RGasDSFlx(idg_CO2,N6,N5,N4)
      XCHDFG(N6,N5,N4)=XCHDFG(N6,N5,N4)+RGasDSFlx(idg_CH4,N6,N5,N4)
      XOXDFG(N6,N5,N4)=XOXDFG(N6,N5,N4)+RGasDSFlx(idg_O2,N6,N5,N4)
      XNGDFG(N6,N5,N4)=XNGDFG(N6,N5,N4)+RGasDSFlx(idg_N2,N6,N5,N4)
      XN2DFG(N6,N5,N4)=XN2DFG(N6,N5,N4)+RGasDSFlx(idg_N2O,N6,N5,N4)
      XN3DFG(N6,N5,N4)=XN3DFG(N6,N5,N4)+RGasDSFlx(idg_NH3,N6,N5,N4)
      XNBDFG(N6,N5,N4)=XNBDFG(N6,N5,N4)+RGasDSFlx(idg_NH3B,N6,N5,N4)
      XHGDFG(N6,N5,N4)=XHGDFG(N6,N5,N4)+RGasDSFlx(idg_H2,N6,N5,N4)
    ELSE
      RGasDSFlx(idg_CO2,N6,N5,N4)=0.0_r8
      RGasDSFlx(idg_CH4,N6,N5,N4)=0.0_r8
      RGasDSFlx(idg_O2,N6,N5,N4)=0.0_r8
      RGasDSFlx(idg_N2,N6,N5,N4)=0.0_r8
      RGasDSFlx(idg_N2O,N6,N5,N4)=0.0_r8
      RGasDSFlx(idg_NH3,N6,N5,N4)=0.0_r8
      RGasDSFlx(idg_NH3B,N6,N5,N4)=0.0_r8
      RGasDSFlx(idg_H2,N6,N5,N4)=0.0_r8
    ENDIF
  ENDIF
...
! ----------------------------------------------------------------------
  ...
  ENDDO D9750
  RPoreSolFlx(idg_CO2,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(idg_CH4,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(idg_O2,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(idg_N2,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(idg_N2O,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(idg_H2,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(ids_NH4,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(idg_NH3,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(ids_NO3,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(ids_NO2,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(ids_H1PO4,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(ids_H2PO4,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(ids_NH4B,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(idg_NH3B,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(ids_NO3B,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(ids_NO2B,N,N6,N5,N4)=0.0_r8
  RPoreSolFlx(ids_H2PO4B,N,N6,N5,N4)=0.0_r8

  RPoreSoHFlx(ids_beg:ids_end,N,N6,N5,N4)=0.0_r8
...
! ----------------------------------------------------------------------
  ...
  DifuscG(idg_CO2,N,N3,N2,N1)=0.0_r8
  DifuscG(idg_CH4,N,N3,N2,N1)=0.0_r8
  DifuscG(idg_O2,N,N3,N2,N1)=0.0_r8
  DifuscG(idg_N2,N,N3,N2,N1)=0.0_r8
  DifuscG(idg_N2O,N,N3,N2,N1)=0.0_r8
  DifuscG(idg_NH3,N,N3,N2,N1)=0.0_r8
  DifuscG(idg_H2,N,N3,N2,N1)=0.0_r8
  D9751: DO K=1,jcplx
  ...
  ENDDO D9751
  RPoreSolFlx(idg_CO2,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(idg_CH4,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(idg_O2,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(idg_N2,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(idg_N2O,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(idg_H2,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(ids_NH4,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(idg_NH3,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(ids_NO3,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(ids_NO2,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(ids_H1PO4,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(ids_H2PO4,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(ids_NH4B,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(idg_NH3B,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(ids_NO3B,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(ids_NO2B,N,N3,N2,N1)=0.0_r8
  RPoreSolFlx(ids_H2PO4B,N,N3,N2,N1)=0.0_r8

  RPoreSoHFlx(ids_beg:ids_end,N,N3,N2,N1)=0.0_r8
