module InsideTranspMod
  ...
  real(r8) :: RFHOXS
  real(r8) :: RFHCOS
  real(r8) :: RFHCHS,RFHNGS,RFHN2S,RFHHGS,RFHNH4,RFHNH3
  ...
  real(r8) :: DFHCHS,DFHCOS,DFHOXS,DFHNGS,DFHHGS
  real(r8) :: DFVHGG,DFVN3G
  real(r8) :: DFVN2G,DFHN4B,DFHN3B,DFHNOB,DFHN2B,DFHP1B,DFHPOB
  real(r8) :: DFHNH4,DFHNH3,DFHNO3,DFHNO2,DFHP14,DFHPO4,DFHN2S
...
!
  IF(FLWM(M,N,N6,N5,N4).GT.0.0_r8)THEN
    ...
    ENDIF
    DO  K=0,jcplx1
      RFLOC(K)=VFLW*AMAX1(0.0_r8,OQC2(K,N3,N2,N1))
      RFLON(K)=VFLW*AMAX1(0.0_r8,OQN2(K,N3,N2,N1))
      RFLOP(K)=VFLW*AMAX1(0.0_r8,OQP2(K,N3,N2,N1))
      RFLOA(K)=VFLW*AMAX1(0.0_r8,OQA2(K,N3,N2,N1))
    ENDDO
    RFLCOS=VFLW*AMAX1(0.0_r8,CO2S2(N3,N2,N1))
    RFLCHS=VFLW*AMAX1(0.0_r8,CH4S2(N3,N2,N1))
    RFLOXS=VFLW*AMAX1(0.0_r8,OXYS2(N3,N2,N1))
    RFLNGS=VFLW*AMAX1(0.0_r8,Z2GS2(N3,N2,N1))
    RFLN2S=VFLW*AMAX1(0.0_r8,Z2OS2(N3,N2,N1))
    RFLHGS=VFLW*AMAX1(0.0_r8,H2GS2(N3,N2,N1))
    RFLNH4=VFLW*AMAX1(0.0_r8,ZNH4S2(N3,N2,N1))
    RFLNH3=VFLW*AMAX1(0.0_r8,ZNH3S2(N3,N2,N1))
    RFLNO3=VFLW*AMAX1(0.0_r8,ZNO3S2(N3,N2,N1))
    RFLNO2=VFLW*AMAX1(0.0_r8,ZNO2S2(N3,N2,N1))
    RFLP14=VFLW*AMAX1(0.0_r8,H1PO42(N3,N2,N1))
    RFLPO4=VFLW*AMAX1(0.0_r8,H2PO42(N3,N2,N1))
    RFLN4B=VFLW*AMAX1(0.0_r8,ZNH4B2(N3,N2,N1))
    RFLN3B=VFLW*AMAX1(0.0_r8,ZNH3B2(N3,N2,N1))
    RFLNOB=VFLW*AMAX1(0.0_r8,ZNO3B2(N3,N2,N1))
    RFLN2B=VFLW*AMAX1(0.0_r8,ZNO2B2(N3,N2,N1))
    RFLP1B=VFLW*AMAX1(0.0_r8,H1POB2(N3,N2,N1))
    RFLPOB=VFLW*AMAX1(0.0_r8,H2POB2(N3,N2,N1))
!
...
!
  ELSE
    ...
    ENDIF
    DO 9815 K=0,jcplx1
      RFLOC(K)=VFLW*AMAX1(0.0_r8,OQC2(K,N6,N5,N4))
      RFLON(K)=VFLW*AMAX1(0.0_r8,OQN2(K,N6,N5,N4))
      RFLOP(K)=VFLW*AMAX1(0.0_r8,OQP2(K,N6,N5,N4))
      RFLOA(K)=VFLW*AMAX1(0.0_r8,OQA2(K,N6,N5,N4))
9815  CONTINUE
    RFLCOS=VFLW*AMAX1(0.0_r8,CO2S2(N6,N5,N4))
    RFLCHS=VFLW*AMAX1(0.0_r8,CH4S2(N6,N5,N4))
    RFLOXS=VFLW*AMAX1(0.0_r8,OXYS2(N6,N5,N4))
    RFLNGS=VFLW*AMAX1(0.0_r8,Z2GS2(N6,N5,N4))
    RFLN2S=VFLW*AMAX1(0.0_r8,Z2OS2(N6,N5,N4))
    RFLHGS=VFLW*AMAX1(0.0_r8,H2GS2(N6,N5,N4))
    RFLNH4=VFLW*AMAX1(0.0_r8,ZNH4S2(N6,N5,N4))
    RFLNH3=VFLW*AMAX1(0.0_r8,ZNH3S2(N6,N5,N4))
    RFLNO3=VFLW*AMAX1(0.0_r8,ZNO3S2(N6,N5,N4))
    RFLNO2=VFLW*AMAX1(0.0_r8,ZNO2S2(N6,N5,N4))
    RFLP14=VFLW*AMAX1(0.0_r8,H1PO42(N6,N5,N4))
    RFLPO4=VFLW*AMAX1(0.0_r8,H2PO42(N6,N5,N4))
    RFLN4B=VFLW*AMAX1(0.0_r8,ZNH4B2(N6,N5,N4))
    RFLN3B=VFLW*AMAX1(0.0_r8,ZNH3B2(N6,N5,N4))
    RFLNOB=VFLW*AMAX1(0.0_r8,ZNO3B2(N6,N5,N4))
    RFLN2B=VFLW*AMAX1(0.0_r8,ZNO2B2(N6,N5,N4))
    RFLP1B=VFLW*AMAX1(0.0_r8,H1POB2(N6,N5,N4))
    RFLPOB=VFLW*AMAX1(0.0_r8,H2POB2(N6,N5,N4))
  ENDIF
...
!
    DO 9810 K=0,jcplx1
      COQC1(K)=AMAX1(0.0_r8,OQC2(K,N3,N2,N1)/VOLWM(M,N3,N2,N1))
      COQN1(K)=AMAX1(0.0_r8,OQN2(K,N3,N2,N1)/VOLWM(M,N3,N2,N1))
      COQP1(K)=AMAX1(0.0_r8,OQP2(K,N3,N2,N1)/VOLWM(M,N3,N2,N1))
      COQA1(K)=AMAX1(0.0_r8,OQA2(K,N3,N2,N1)/VOLWM(M,N3,N2,N1))
      COQC2(K)=AMAX1(0.0_r8,OQC2(K,N6,N5,N4)/VOLWM(M,N6,N5,N4))
      COQN2(K)=AMAX1(0.0_r8,OQN2(K,N6,N5,N4)/VOLWM(M,N6,N5,N4))
      COQP2(K)=AMAX1(0.0_r8,OQP2(K,N6,N5,N4)/VOLWM(M,N6,N5,N4))
      COQA2(K)=AMAX1(0.0_r8,OQA2(K,N6,N5,N4)/VOLWM(M,N6,N5,N4))
9810  CONTINUE
    CCO2S1=AMAX1(0.0_r8,CO2S2(N3,N2,N1)/VOLWM(M,N3,N2,N1))
    CCH4S1=AMAX1(0.0_r8,CH4S2(N3,N2,N1)/VOLWM(M,N3,N2,N1))
    COXYS1=AMAX1(0.0_r8,OXYS2(N3,N2,N1)/VOLWM(M,N3,N2,N1))
    CZ2GS1=AMAX1(0.0_r8,Z2GS2(N3,N2,N1)/VOLWM(M,N3,N2,N1))
    CZ2OS1=AMAX1(0.0_r8,Z2OS2(N3,N2,N1)/VOLWM(M,N3,N2,N1))
    CH2GS1=AMAX1(0.0_r8,H2GS2(N3,N2,N1)/VOLWM(M,N3,N2,N1))
    IF(VOLW4A.GT.ZEROS2(N2,N1))THEN
      CNH4S1=AMAX1(0.0_r8,ZNH4S2(N3,N2,N1)/VOLW4A)
      CNH3S1=AMAX1(0.0_r8,ZNH3S2(N3,N2,N1)/VOLW4A)
    ELSE
      CNH4S1=0.0_r8
      CNH3S1=0.0_r8
    ENDIF
    IF(VOLW3A.GT.ZEROS2(N2,N1))THEN
      CNO3S1=AMAX1(0.0_r8,ZNO3S2(N3,N2,N1)/VOLW3A)
      CNO2S1=AMAX1(0.0_r8,ZNO2S2(N3,N2,N1)/VOLW3A)
    ELSE
      CNO3S1=0.0_r8
      CNO2S1=0.0_r8
    ENDIF
    IF(VOLW2A.GT.ZEROS2(N2,N1))THEN
      CP14S1=AMAX1(0.0_r8,H1PO42(N3,N2,N1)/VOLW2A)
      CPO4S1=AMAX1(0.0_r8,H2PO42(N3,N2,N1)/VOLW2A)
    ELSE
      CP14S1=0.0_r8
      CPO4S1=0.0_r8
    ENDIF
    IF(VOLW4B.GT.ZEROS2(N2,N1))THEN
      CNH4B1=AMAX1(0.0_r8,ZNH4B2(N3,N2,N1)/VOLW4B)
      CNH3B1=AMAX1(0.0_r8,ZNH3B2(N3,N2,N1)/VOLW4B)
    ELSE
      CNH4B1=0.0_r8
      CNH3B1=0.0_r8
    ENDIF
    IF(VOLW3B.GT.ZEROS2(N2,N1))THEN
      CNO3B1=AMAX1(0.0_r8,ZNO3B2(N3,N2,N1)/VOLW3B)
      CNO2B1=AMAX1(0.0_r8,ZNO2B2(N3,N2,N1)/VOLW3B)
    ELSE
      CNO3B1=CNO3S1
      CNO2B1=CNO2S1
    ENDIF
    IF(VOLW2B.GT.ZEROS2(N2,N1))THEN
      CP14B1=AMAX1(0.0_r8,H1POB2(N3,N2,N1)/VOLW2B)
      CPO4B1=AMAX1(0.0_r8,H2POB2(N3,N2,N1)/VOLW2B)
    ELSE
      CP14B1=CP14S1
      CPO4B1=CPO4S1
    ENDIF
    CCO2S2=AMAX1(0.0_r8,CO2S2(N6,N5,N4)/VOLWM(M,N6,N5,N4))
    CCH4S2=AMAX1(0.0_r8,CH4S2(N6,N5,N4)/VOLWM(M,N6,N5,N4))
    COXYS2=AMAX1(0.0_r8,OXYS2(N6,N5,N4)/VOLWM(M,N6,N5,N4))
    CZ2GS2=AMAX1(0.0_r8,Z2GS2(N6,N5,N4)/VOLWM(M,N6,N5,N4))
    CZ2OS2=AMAX1(0.0_r8,Z2OS2(N6,N5,N4)/VOLWM(M,N6,N5,N4))
    CH2GS2=AMAX1(0.0_r8,H2GS2(N6,N5,N4)/VOLWM(M,N6,N5,N4))
    IF(VOLWMA(N6,N5,N4).GT.ZEROS2(N5,N4))THEN
      CNH3S2=AMAX1(0.0_r8,ZNH3S2(N6,N5,N4)/VOLWMA(N6,N5,N4))
      CNH4S2=AMAX1(0.0_r8,ZNH4S2(N6,N5,N4)/VOLWMA(N6,N5,N4))
    ELSE
      CNH3S2=0.0_r8
      CNH4S2=0.0_r8
    ENDIF
    IF(VOLWOA.GT.ZEROS2(N5,N4))THEN
      CNO3S2=AMAX1(0.0_r8,ZNO3S2(N6,N5,N4)/VOLWOA)
      CNO2S2=AMAX1(0.0_r8,ZNO2S2(N6,N5,N4)/VOLWOA)
    ELSE
      CNO3S2=0.0_r8
      CNO2S2=0.0_r8
    ENDIF
    IF(VOLWPA.GT.ZEROS2(N5,N4))THEN
      CP14S2=AMAX1(0.0_r8,H1PO42(N6,N5,N4)/VOLWPA)
      CPO4S2=AMAX1(0.0_r8,H2PO42(N6,N5,N4)/VOLWPA)
    ELSE
      CP14S2=0.0_r8
      CPO4S2=0.0_r8
    ENDIF
    IF(VOLWMB(N6,N5,N4).GT.ZEROS2(N5,N4))THEN
      CNH3B2=AMAX1(0.0_r8,ZNH3B2(N6,N5,N4)/VOLWMB(N6,N5,N4))
      CNH4B2=AMAX1(0.0_r8,ZNH4B2(N6,N5,N4)/VOLWMB(N6,N5,N4))
    ELSE
      CNH3B2=CNH3S2
      CNH4B2=CNH4S2
    ENDIF
    IF(VOLWOB.GT.ZEROS2(N5,N4))THEN
      CNO3B2=AMAX1(0.0_r8,ZNO3B2(N6,N5,N4)/VOLWOB)
      CNO2B2=AMAX1(0.0_r8,ZNO2B2(N6,N5,N4)/VOLWOB)
    ELSE
      CNO3B2=CNO3S2
      CNO2B2=CNO2S2
    ENDIF
    IF(VOLWPB.GT.ZEROS2(N5,N4))THEN
      CP14B2=AMAX1(0.0_r8,H1POB2(N6,N5,N4)/VOLWPB)
      CPO4B2=AMAX1(0.0_r8,H2POB2(N6,N5,N4)/VOLWPB)
    ELSE
      CP14B2=CP14S2
      CPO4B2=CPO4S2
    ENDIF
...
!
    IF(VOLWHM(M,N3,N2,N1).GT.ZEROS2(N2,N1))THEN
      VFLW=AMAX1(0.0_r8,AMIN1(VFLWX,FLWHM(M,N,N6,N5,N4)/VOLWHM(M,N3,N2,N1)))
    ELSE
      VFLW=VFLWX
    ENDIF
!
...
!
    IF(N.EQ.3.AND.VOLAH(N6,N5,N4).GT.VOLWHM(M,N6,N5,N4))THEN
      DO 9800 K=0,jcplx1
        RFHOC(K)=VFLW*AMAX1(0.0_r8,(OQCH2(K,N3,N2,N1)-AMIN1(0.0_r8,ROCFXS(K,NU(N2,N1),N2,N1))))
        RFHON(K)=VFLW*AMAX1(0.0_r8,(OQNH2(K,N3,N2,N1)-AMIN1(0.0_r8,RONFXS(K,NU(N2,N1),N2,N1))))
        RFHOP(K)=VFLW*AMAX1(0.0_r8,(OQPH2(K,N3,N2,N1)-AMIN1(0.0_r8,ROPFXS(K,NU(N2,N1),N2,N1))))
        RFHOA(K)=VFLW*AMAX1(0.0_r8,(OQAH2(K,N3,N2,N1)-AMIN1(0.0_r8,ROAFXS(K,NU(N2,N1),N2,N1))))
9800  CONTINUE
      RFHCOS=VFLW*AMAX1(0.0_r8,(CO2SH2(N3,N2,N1)-AMIN1(0.0_r8,RCOFXS(NU(N2,N1),N2,N1))))
      RFHCHS=VFLW*AMAX1(0.0_r8,(CH4SH2(N3,N2,N1)-AMIN1(0.0_r8,RCHFXS(NU(N2,N1),N2,N1))))
      RFHOXS=VFLW*AMAX1(0.0_r8,(OXYSH2(N3,N2,N1)-AMIN1(0.0_r8,ROXFXS(NU(N2,N1),N2,N1))))
      RFHNGS=VFLW*AMAX1(0.0_r8,(Z2GSH2(N3,N2,N1)-AMIN1(0.0_r8,RNGFXS(NU(N2,N1),N2,N1))))
      RFHN2S=VFLW*AMAX1(0.0_r8,(Z2OSH2(N3,N2,N1)-AMIN1(0.0_r8,RN2FXS(NU(N2,N1),N2,N1))))
      RFHHGS=VFLW*AMAX1(0.0_r8,(H2GSH2(N3,N2,N1)-AMIN1(0.0_r8,RHGFXS(NU(N2,N1),N2,N1))))
      RFHNH4=VFLW*AMAX1(0.0_r8,(ZNH4H2(N3,N2,N1) &
        -AMIN1(0.0_r8,RN4FXW(NU(N2,N1),N2,N1)*VLNH4(N3,N2,N1))))*VLNH4(N6,N5,N4)
      RFHNH3=VFLW*AMAX1(0.0_r8,(ZNH3H2(N3,N2,N1) &
        -AMIN1(0.0_r8,RN3FXW(NU(N2,N1),N2,N1)*VLNH4(N3,N2,N1))))*VLNH4(N6,N5,N4)
      RFHNO3=VFLW*AMAX1(0.0_r8,(ZNO3H2(N3,N2,N1) &
        -AMIN1(0.0_r8,RNOFXW(NU(N2,N1),N2,N1)*VLNO3(N3,N2,N1))))*VLNO3(N6,N5,N4)
      RFHNO2=VFLW*AMAX1(0.0_r8,(ZNO2H2(N3,N2,N1) &
        -AMIN1(0.0_r8,RNXFXS(NU(N2,N1),N2,N1)*VLNO3(N3,N2,N1))))*VLNO3(N6,N5,N4)
      RFHP14=VFLW*AMAX1(0.0_r8,(H1P4H2(N3,N2,N1) &
        -AMIN1(0.0_r8,RH1PXS(NU(N2,N1),N2,N1)*VLPO4(N3,N2,N1))))*VLPO4(N6,N5,N4)
      RFHPO4=VFLW*AMAX1(0.0_r8,(H2P4H2(N3,N2,N1) &
        -AMIN1(0.0_r8,RH2PXS(NU(N2,N1),N2,N1)*VLPO4(N3,N2,N1))))*VLPO4(N6,N5,N4)
      RFHN4B=VFLW*AMAX1(0.0_r8,(ZN4BH2(N3,N2,N1) &
        -AMIN1(0.0_r8,RN4FXB(NU(N2,N1),N2,N1)*VLNHB(N3,N2,N1))))*VLNHB(N6,N5,N4)
      RFHN3B=VFLW*AMAX1(0.0_r8,(ZN3BH2(N3,N2,N1) &
        -AMIN1(0.0_r8,RN3FXB(NU(N2,N1),N2,N1)*VLNHB(N3,N2,N1))))*VLNHB(N6,N5,N4)
      RFHNOB=VFLW*AMAX1(0.0_r8,(ZNOBH2(N3,N2,N1) &
        -AMIN1(0.0_r8,RNOFXB(NU(N2,N1),N2,N1)*VLNOB(N3,N2,N1))))*VLNOB(N6,N5,N4)
      RFHN2B=VFLW*AMAX1(0.0_r8,(ZN2BH2(N3,N2,N1) &
        -AMIN1(0.0_r8,RNXFXB(NU(N2,N1),N2,N1)*VLNOB(N3,N2,N1))))*VLNOB(N6,N5,N4)
      RFHP1B=VFLW*AMAX1(0.0_r8,(H1PBH2(N3,N2,N1) &
        -AMIN1(0.0_r8,RH1BXB(NU(N2,N1),N2,N1)*VLPOB(N3,N2,N1))))*VLPOB(N6,N5,N4)
      RFHPOB=VFLW*AMAX1(0.0_r8,(H2PBH2(N3,N2,N1) &
        -AMIN1(0.0_r8,RH2BXB(NU(N2,N1),N2,N1)*VLPOB(N3,N2,N1))))*VLPOB(N6,N5,N4)
!
!     OTHERWISE
!
    ELSE
      DO 9850 K=0,jcplx1
        RFHOC(K)=VFLW*AMAX1(0.0_r8,OQCH2(K,N3,N2,N1))
        RFHON(K)=VFLW*AMAX1(0.0_r8,OQNH2(K,N3,N2,N1))
        RFHOP(K)=VFLW*AMAX1(0.0_r8,OQPH2(K,N3,N2,N1))
        RFHOA(K)=VFLW*AMAX1(0.0_r8,OQAH2(K,N3,N2,N1))
9850  CONTINUE
      RFHCOS=VFLW*AMAX1(0.0_r8,CO2SH2(N3,N2,N1))
      RFHCHS=VFLW*AMAX1(0.0_r8,CH4SH2(N3,N2,N1))
      RFHOXS=VFLW*AMAX1(0.0_r8,OXYSH2(N3,N2,N1))
      RFHNGS=VFLW*AMAX1(0.0_r8,Z2GSH2(N3,N2,N1))
      RFHN2S=VFLW*AMAX1(0.0_r8,Z2OSH2(N3,N2,N1))
      RFHHGS=VFLW*AMAX1(0.0_r8,H2GSH2(N3,N2,N1))
      RFHNH4=VFLW*AMAX1(0.0_r8,ZNH4H2(N3,N2,N1))*VLNH4(N6,N5,N4)
      RFHNH3=VFLW*AMAX1(0.0_r8,ZNH3H2(N3,N2,N1))*VLNH4(N6,N5,N4)
      RFHNO3=VFLW*AMAX1(0.0_r8,ZNO3H2(N3,N2,N1))*VLNO3(N6,N5,N4)
      RFHNO2=VFLW*AMAX1(0.0_r8,ZNO2H2(N3,N2,N1))*VLNO3(N6,N5,N4)
      RFHP14=VFLW*AMAX1(0.0_r8,H1P4H2(N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHPO4=VFLW*AMAX1(0.0_r8,H2P4H2(N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHN4B=VFLW*AMAX1(0.0_r8,ZN4BH2(N3,N2,N1))*VLNHB(N6,N5,N4)
      RFHN3B=VFLW*AMAX1(0.0_r8,ZN3BH2(N3,N2,N1))*VLNHB(N6,N5,N4)
      RFHNOB=VFLW*AMAX1(0.0_r8,ZNOBH2(N3,N2,N1))*VLNOB(N6,N5,N4)
      RFHN2B=VFLW*AMAX1(0.0_r8,ZN2BH2(N3,N2,N1))*VLNOB(N6,N5,N4)
      RFHP1B=VFLW*AMAX1(0.0_r8,H1PBH2(N3,N2,N1))*VLPOB(N6,N5,N4)
      RFHPOB=VFLW*AMAX1(0.0_r8,H2PBH2(N3,N2,N1))*VLPOB(N6,N5,N4)
    ENDIF
!
...
!
  ELSEIF(FLWHM(M,N,N6,N5,N4).LT.0.0_r8)THEN
    IF(VOLWHM(M,N6,N5,N4).GT.ZEROS2(N5,N4))THEN
      VFLW=AMIN1(0.0_r8,AMAX1(-VFLWX,FLWHM(M,N,N6,N5,N4)/VOLWHM(M,N6,N5,N4)))
    ELSE
      VFLW=-VFLWX
    ENDIF
    DO 9665 K=0,jcplx1
      RFHOC(K)=VFLW*AMAX1(0.0_r8,OQCH2(K,N6,N5,N4))
      RFHON(K)=VFLW*AMAX1(0.0_r8,OQNH2(K,N6,N5,N4))
      RFHOP(K)=VFLW*AMAX1(0.0_r8,OQPH2(K,N6,N5,N4))
      RFHOA(K)=VFLW*AMAX1(0.0_r8,OQAH2(K,N6,N5,N4))
9665  CONTINUE
    RFHCOS=VFLW*AMAX1(0.0_r8,CO2SH2(N6,N5,N4))
    RFHCHS=VFLW*AMAX1(0.0_r8,CH4SH2(N6,N5,N4))
    RFHOXS=VFLW*AMAX1(0.0_r8,OXYSH2(N6,N5,N4))
    RFHNGS=VFLW*AMAX1(0.0_r8,Z2GSH2(N6,N5,N4))
    RFHN2S=VFLW*AMAX1(0.0_r8,Z2OSH2(N6,N5,N4))
    RFHHGS=VFLW*AMAX1(0.0_r8,H2GSH2(N6,N5,N4))
    RFHNH4=VFLW*AMAX1(0.0_r8,ZNH4H2(N6,N5,N4))*VLNH4(N6,N5,N4)
    RFHNH3=VFLW*AMAX1(0.0_r8,ZNH3H2(N6,N5,N4))*VLNH4(N6,N5,N4)
    RFHNO3=VFLW*AMAX1(0.0_r8,ZNO3H2(N6,N5,N4))*VLNO3(N6,N5,N4)
    RFHNO2=VFLW*AMAX1(0.0_r8,ZNO2H2(N6,N5,N4))*VLNO3(N6,N5,N4)
    RFHP14=VFLW*AMAX1(0.0_r8,H1P4H2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFHPO4=VFLW*AMAX1(0.0_r8,H2P4H2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFHN4B=VFLW*AMAX1(0.0_r8,ZN4BH2(N6,N5,N4))*VLNHB(N6,N5,N4)
    RFHN3B=VFLW*AMAX1(0.0_r8,ZN3BH2(N6,N5,N4))*VLNHB(N6,N5,N4)
    RFHNOB=VFLW*AMAX1(0.0_r8,ZNOBH2(N6,N5,N4))*VLNOB(N6,N5,N4)
    RFHN2B=VFLW*AMAX1(0.0_r8,ZN2BH2(N6,N5,N4))*VLNOB(N6,N5,N4)
    RFHP1B=VFLW*AMAX1(0.0_r8,H1PBH2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFHPOB=VFLW*AMAX1(0.0_r8,H2PBH2(N6,N5,N4))*VLPOB(N6,N5,N4)
  ELSE
!
!     NO MACROPORE FLUX
!
...
!
    ...
    DO 9790 K=0,jcplx1
      COQCH1(K)=AMAX1(0.0_r8,OQCH2(K,N3,N2,N1)/VOLWHM(M,N3,N2,N1))
      COQNH1(K)=AMAX1(0.0_r8,OQNH2(K,N3,N2,N1)/VOLWHM(M,N3,N2,N1))
      COQPH1(K)=AMAX1(0.0_r8,OQPH2(K,N3,N2,N1)/VOLWHM(M,N3,N2,N1))
      COQAH1(K)=AMAX1(0.0_r8,OQAH2(K,N3,N2,N1)/VOLWHM(M,N3,N2,N1))
      COQCH2(K)=AMAX1(0.0_r8,OQCH2(K,N6,N5,N4)/VOLWHM(M,N6,N5,N4))
      COQNH2(K)=AMAX1(0.0_r8,OQNH2(K,N6,N5,N4)/VOLWHM(M,N6,N5,N4))
      COQPH2(K)=AMAX1(0.0_r8,OQPH2(K,N6,N5,N4)/VOLWHM(M,N6,N5,N4))
      COQAH2(K)=AMAX1(0.0_r8,OQAH2(K,N6,N5,N4)/VOLWHM(M,N6,N5,N4))
9790  CONTINUE
    CCO2SH1=AMAX1(0.0_r8,CO2SH2(N3,N2,N1)/VOLWHM(M,N3,N2,N1))
    CCH4SH1=AMAX1(0.0_r8,CH4SH2(N3,N2,N1)/VOLWHM(M,N3,N2,N1))
    COXYSH1=AMAX1(0.0_r8,OXYSH2(N3,N2,N1)/VOLWHM(M,N3,N2,N1))
    CZ2GSH1=AMAX1(0.0_r8,Z2GSH2(N3,N2,N1)/VOLWHM(M,N3,N2,N1))
    CZ2OSH1=AMAX1(0.0_r8,Z2OSH2(N3,N2,N1)/VOLWHM(M,N3,N2,N1))
    CH2GSH1=AMAX1(0.0_r8,H2GSH2(N3,N2,N1)/VOLWHM(M,N3,N2,N1))
    IF(VOLH4A.GT.ZEROS2(N2,N1))THEN
      CNH4SH1=AMAX1(0.0_r8,ZNH4H2(N3,N2,N1)/VOLH4A)
      CNH3SH1=AMAX1(0.0_r8,ZNH3H2(N3,N2,N1)/VOLH4A)
    ELSE
      CNH4SH1=0.0_r8
      CNH3SH1=0.0_r8
    ENDIF
    IF(VOLH3A.GT.ZEROS2(N2,N1))THEN
      CNO3SH1=AMAX1(0.0_r8,ZNO3H2(N3,N2,N1)/VOLH3A)
      CNO2SH1=AMAX1(0.0_r8,ZNO2H2(N3,N2,N1)/VOLH3A)
    ELSE
      CNO3SH1=0.0_r8
      CNO2SH1=0.0_r8
    ENDIF
    IF(VOLH2A.GT.ZEROS2(N2,N1))THEN
      CP14SH1=AMAX1(0.0_r8,H1P4H2(N3,N2,N1)/VOLH2A)
      CPO4SH1=AMAX1(0.0_r8,H2P4H2(N3,N2,N1)/VOLH2A)
    ELSE
      CP14SH1=0.0_r8
      CPO4SH1=0.0_r8
    ENDIF
    IF(VOLH4B.GT.ZEROS2(N2,N1))THEN
      CNH4BH1=AMAX1(0.0_r8,ZN4BH2(N3,N2,N1)/VOLH4B)
      CNH3BH1=AMAX1(0.0_r8,ZN3BH2(N3,N2,N1)/VOLH4B)
    ELSE
      CNH4BH1=CNH4SH1
      CNH3BH1=CNH3SH1
    ENDIF
    IF(VOLH3B.GT.ZEROS2(N2,N1))THEN
      CNO3BH1=AMAX1(0.0_r8,ZNOBH2(N3,N2,N1)/VOLH3B)
      CNO2BH1=AMAX1(0.0_r8,ZN2BH2(N3,N2,N1)/VOLH3B)
    ELSE
      CNO3BH1=CNO3SH1
      CNO2BH1=CNO2SH1
    ENDIF
    IF(VOLH2B.GT.ZEROS2(N2,N1))THEN
      CP14BH1=AMAX1(0.0_r8,H1PBH2(N3,N2,N1)/VOLH2B)
      CPO4BH1=AMAX1(0.0_r8,H2PBH2(N3,N2,N1)/VOLH2B)
    ELSE
      CP14BH1=CP14SH1
      CPO4BH1=CPO4SH1
    ENDIF
    CCO2SH2=AMAX1(0.0_r8,CO2SH2(N6,N5,N4)/VOLWHM(M,N6,N5,N4))
    CCH4SH2=AMAX1(0.0_r8,CH4SH2(N6,N5,N4)/VOLWHM(M,N6,N5,N4))
    COXYSH2=AMAX1(0.0_r8,OXYSH2(N6,N5,N4)/VOLWHM(M,N6,N5,N4))
    CZ2GSH2=AMAX1(0.0_r8,Z2GSH2(N6,N5,N4)/VOLWHM(M,N6,N5,N4))
    CZ2OSH2=AMAX1(0.0_r8,Z2OSH2(N6,N5,N4)/VOLWHM(M,N6,N5,N4))
    CH2GSH2=AMAX1(0.0_r8,H2GSH2(N6,N5,N4)/VOLWHM(M,N6,N5,N4))
    VOLHMA=VOLWHM(M,N6,N5,N4)*VLNH4(N6,N5,N4)
    IF(VOLHMA.GT.ZEROS2(N5,N4))THEN
      CNH4SH2=AMAX1(0.0_r8,ZNH4H2(N6,N5,N4)/VOLHMA)
      CNH3SH2=AMAX1(0.0_r8,ZNH3H2(N6,N5,N4)/VOLHMA)
    ELSE
      CNH4SH2=0.0_r8
      CNH3SH2=0.0_r8
    ENDIF
    ...
    IF(VOLHOA.GT.ZEROS2(N5,N4))THEN
      CNO3SH2=AMAX1(0.0_r8,ZNO3H2(N6,N5,N4)/VOLHOA)
      CNO2SH2=AMAX1(0.0_r8,ZNO2H2(N6,N5,N4)/VOLHOA)
    ELSE
      CNO3SH2=0.0_r8
      CNO2SH2=0.0_r8
    ENDIF
    ...
    IF(VOLHPA.GT.ZEROS2(N5,N4))THEN
      CP14SH2=AMAX1(0.0_r8,H1P4H2(N6,N5,N4)/VOLHPA)
      CPO4SH2=AMAX1(0.0_r8,H2P4H2(N6,N5,N4)/VOLHPA)
    ELSE
      CP14SH2=0.0_r8
      CPO4SH2=0.0_r8
    ENDIF
    ...
    IF(VOLHMB.GT.ZEROS2(N5,N4))THEN
      CNH4BH2=AMAX1(0.0_r8,ZN4BH2(N6,N5,N4)/VOLHMB)
      CNH3BH2=AMAX1(0.0_r8,ZN3BH2(N6,N5,N4)/VOLHMB)
    ELSE
      CNH4BH2=CNH4SH2
      CNH3BH2=CNH3SH2
    ENDIF
    ...
    IF(VOLHOB.GT.ZEROS2(N5,N4))THEN
      CNO3BH2=AMAX1(0.0_r8,ZNOBH2(N6,N5,N4)/VOLHOB)
      CNO2BH2=AMAX1(0.0_r8,ZN2BH2(N6,N5,N4)/VOLHOB)
    ELSE
      CNO3BH2=CNO3SH2
      CNO2BH2=CNO2SH2
    ENDIF
    ...
    IF(VOLHPB.GT.ZEROS2(N5,N4))THEN
      CP14BH2=AMAX1(0.0_r8,H1PBH2(N6,N5,N4)/VOLHPB)
      CPO4BH2=AMAX1(0.0_r8,H2PBH2(N6,N5,N4)/VOLHPB)
    ELSE
      CP14BH2=CP14SH2
      CPO4BH2=CPO4SH2
    ENDIF
...
! ----------------------------------------------------------------------
  ...
  THETW1(N6,N5,N4)=AMAX1(0.0_r8,safe_adb(VOLWM(M,N6,N5,N4),VOLY(N6,N5,N4)))
...
!
  IF(FINHM(M,N6,N5,N4).GT.0.0_r8)THEN
    IF(VOLWHM(M,N6,N5,N4).GT.ZEROS2(N5,N4))THEN
      VFLW=AMAX1(0.0_r8,AMIN1(VFLWX,FINHM(M,N6,N5,N4)/VOLWHM(M,N6,N5,N4)))
    ELSE
      VFLW=VFLWX
    ENDIF
    DO 9970 K=0,jcplx1
      RFLOC(K)=VFLW*AMAX1(0.0_r8,OQCH2(K,N6,N5,N4))
      RFLON(K)=VFLW*AMAX1(0.0_r8,OQNH2(K,N6,N5,N4))
      RFLOP(K)=VFLW*AMAX1(0.0_r8,OQPH2(K,N6,N5,N4))
      RFLOA(K)=VFLW*AMAX1(0.0_r8,OQAH2(K,N6,N5,N4))
9970  CONTINUE
    RFLCOS=VFLW*AMAX1(0.0_r8,CO2SH2(N6,N5,N4))
    RFLCHS=VFLW*AMAX1(0.0_r8,CH4SH2(N6,N5,N4))
    RFLOXS=VFLW*AMAX1(0.0_r8,OXYSH2(N6,N5,N4))
    RFLNGS=VFLW*AMAX1(0.0_r8,Z2GSH2(N6,N5,N4))
    RFLN2S=VFLW*AMAX1(0.0_r8,Z2OSH2(N6,N5,N4))
    RFLHGS=VFLW*AMAX1(0.0_r8,H2GSH2(N6,N5,N4))
    RFLNH4=VFLW*AMAX1(0.0_r8,ZNH4H2(N6,N5,N4))*VLNH4(N6,N5,N4)
    RFLNH3=VFLW*AMAX1(0.0_r8,ZNH3H2(N6,N5,N4))*VLNH4(N6,N5,N4)
    RFLNO3=VFLW*AMAX1(0.0_r8,ZNO3H2(N6,N5,N4))*VLNO3(N6,N5,N4)
    RFLNO2=VFLW*AMAX1(0.0_r8,ZNO2H2(N6,N5,N4))*VLNO3(N6,N5,N4)
    RFLP14=VFLW*AMAX1(0.0_r8,H1P4H2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLPO4=VFLW*AMAX1(0.0_r8,H2P4H2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLN4B=VFLW*AMAX1(0.0_r8,ZN4BH2(N6,N5,N4))*VLNHB(N6,N5,N4)
    RFLN3B=VFLW*AMAX1(0.0_r8,ZN3BH2(N6,N5,N4))*VLNHB(N6,N5,N4)
    RFLNOB=VFLW*AMAX1(0.0_r8,ZNOBH2(N6,N5,N4))*VLNOB(N6,N5,N4)
    RFLN2B=VFLW*AMAX1(0.0_r8,ZN2BH2(N6,N5,N4))*VLNOB(N6,N5,N4)
    RFLP1B=VFLW*AMAX1(0.0_r8,H1PBH2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLPOB=VFLW*AMAX1(0.0_r8,H2PBH2(N6,N5,N4))*VLPOB(N6,N5,N4)
!
!     MICROPORE TO MACROPORE TRANSFER
!
  ELSEIF(FINHM(M,N6,N5,N4).LT.0.0_r8)THEN
    IF(VOLWM(M,N6,N5,N4).GT.ZEROS2(N5,N4))THEN
      VFLW=AMIN1(0.0_r8,AMAX1(-VFLWX,FINHM(M,N6,N5,N4)/VOLWM(M,N6,N5,N4)))
    ELSE
      VFLW=-VFLWX
    ENDIF
    DO 9965 K=0,jcplx1
...
9965  CONTINUE
    ...
    RFLN2S=VFLW*AMAX1(0.0_r8,Z2OS2(N6,N5,N4))
    RFLHGS=VFLW*AMAX1(0.0_r8,H2GS2(N6,N5,N4))
    RFLNH4=VFLW*AMAX1(0.0_r8,ZNH4S2(N6,N5,N4))*VLNH4(N6,N5,N4)
    RFLNH3=VFLW*AMAX1(0.0_r8,ZNH3S2(N6,N5,N4))*VLNH4(N6,N5,N4)
    RFLNO3=VFLW*AMAX1(0.0_r8,ZNO3S2(N6,N5,N4))*VLNO3(N6,N5,N4)
    RFLNO2=VFLW*AMAX1(0.0_r8,ZNO2S2(N6,N5,N4))*VLNO3(N6,N5,N4)
    RFLP14=VFLW*AMAX1(0.0_r8,H1PO42(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLPO4=VFLW*AMAX1(0.0_r8,H2PO42(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLN4B=VFLW*AMAX1(0.0_r8,ZNH4B2(N6,N5,N4))*VLNHB(N6,N5,N4)
    RFLN3B=VFLW*AMAX1(0.0_r8,ZNH3B2(N6,N5,N4))*VLNHB(N6,N5,N4)
    RFLNOB=VFLW*AMAX1(0.0_r8,ZNO3B2(N6,N5,N4))*VLNOB(N6,N5,N4)
    RFLN2B=VFLW*AMAX1(0.0_r8,ZNO2B2(N6,N5,N4))*VLNOB(N6,N5,N4)
    RFLP1B=VFLW*AMAX1(0.0_r8,H1POB2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLPOB=VFLW*AMAX1(0.0_r8,H2POB2(N6,N5,N4))*VLPOB(N6,N5,N4)
!
...
!
  IF(VOLWHM(M,N6,N5,N4).GT.ZEROS2(N5,N4))THEN
    ...
    DO 9955 K=0,jcplx1
      DFVOC(K)=XNPH*(AMAX1(0.0_r8,OQCH2(K,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
        -AMAX1(0.0_r8,OQC2(K,N6,N5,N4))*VOLWHS)/VOLWT
      DFVON(K)=XNPH*(AMAX1(0.0_r8,OQNH2(K,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
        -AMAX1(0.0_r8,OQN2(K,N6,N5,N4))*VOLWHS)/VOLWT
      DFVOP(K)=XNPH*(AMAX1(0.0_r8,OQPH2(K,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
        -AMAX1(0.0_r8,OQP2(K,N6,N5,N4))*VOLWHS)/VOLWT
      DFVOA(K)=XNPH*(AMAX1(0.0_r8,OQAH2(K,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
        -AMAX1(0.0_r8,OQA2(K,N6,N5,N4))*VOLWHS)/VOLWT
9955  CONTINUE
    DFVCOS=XNPH*(AMAX1(0.0_r8,CO2SH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,CO2S2(N6,N5,N4))*VOLWHS)/VOLWT
    DFVCHS=XNPH*(AMAX1(0.0_r8,CH4SH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,CH4S2(N6,N5,N4))*VOLWHS)/VOLWT
    DFVOXS=XNPH*(AMAX1(0.0_r8,OXYSH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,OXYS2(N6,N5,N4))*VOLWHS)/VOLWT
    DFVNGS=XNPH*(AMAX1(0.0_r8,Z2GSH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,Z2GS2(N6,N5,N4))*VOLWHS)/VOLWT
    DFVN2S=XNPH*(AMAX1(0.0_r8,Z2OSH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,Z2OS2(N6,N5,N4))*VOLWHS)/VOLWT
    DFVHGS=XNPH*(AMAX1(0.0_r8,H2GSH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,H2GS2(N6,N5,N4))*VOLWHS)/VOLWT
    DFVNH4=XNPH*(AMAX1(0.0_r8,ZNH4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,ZNH4S2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNH4(N6,N5,N4)
    DFVNH3=XNPH*(AMAX1(0.0_r8,ZNH3H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,ZNH3S2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNH4(N6,N5,N4)
    DFVNO3=XNPH*(AMAX1(0.0_r8,ZNO3H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,ZNO3S2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNO3(N6,N5,N4)
    DFVNO2=XNPH*(AMAX1(0.0_r8,ZNO2H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,ZNO2S2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNO3(N6,N5,N4)
    DFVP14=XNPH*(AMAX1(0.0_r8,H1P4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,H1PO42(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
    DFVPO4=XNPH*(AMAX1(0.0_r8,H2P4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,H2PO42(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
    DFVN4B=XNPH*(AMAX1(0.0_r8,ZN4BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,ZNH4B2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNHB(N6,N5,N4)
    DFVN3B=XNPH*(AMAX1(0.0_r8,ZN3BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,ZNH3B2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNHB(N6,N5,N4)
    DFVNOB=XNPH*(AMAX1(0.0_r8,ZNOBH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,ZNO3B2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNOB(N6,N5,N4)
    DFVN2B=XNPH*(AMAX1(0.0_r8,ZN2BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,ZNO2B2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNOB(N6,N5,N4)
    DFVP1B=XNPH*(AMAX1(0.0_r8,H1PBH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,H1POB2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
    DFVPOB=XNPH*(AMAX1(0.0_r8,H2PBH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AMAX1(0.0_r8,H2POB2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
  ELSE
    DO 9975 K=0,jcplx1
      DFVOC(K)=0.0_r8
...
!
  IF(N3.GE.NUM(N2,N1).AND.M.NE.MX)THEN
    THETW1=AMAX1(0.0_r8,safe_adb(VOLWM(M,N3,N2,N1),VOLY(N3,N2,N1)))
    IF(THETW1.GT.THETY(N3,N2,N1).AND.IFLGB.EQ.0)THEN
      SCO2X=12.0_r8*SCO2L(N3,N2,N1)  !conver into carbon g C/mol
      SCH4X=12.0_r8*SCH4L(N3,N2,N1)
...
!
      VTATM=AMAX1(0.0_r8,1.2194E+04_r8*VOLWM(M,N3,N2,N1)/TKS(N3,N2,N1))
...
!
      IF(VTGAS.GT.VTATM)THEN
        ...
        RCOBBL(N3,N2,N1)=AMIN1(0.0_r8,DVTGAS*VCO2G2/VTGAS)*SCO2X
        RCHBBL(N3,N2,N1)=AMIN1(0.0_r8,DVTGAS*VCH4G2/VTGAS)*SCH4X
        ROXBBL(N3,N2,N1)=AMIN1(0.0_r8,DVTGAS*VOXYG2/VTGAS)*SOXYX
        RNGBBL(N3,N2,N1)=AMIN1(0.0_r8,DVTGAS*VZ2GG2/VTGAS)*SN2GX
        RN2BBL(N3,N2,N1)=AMIN1(0.0_r8,DVTGAS*VZ2OG2/VTGAS)*SN2OX
        RN3BBL(N3,N2,N1)=AMIN1(0.0_r8,DVTGAS*VNH3G2/VTGAS)*SNH3X
        RNBBBL(N3,N2,N1)=AMIN1(0.0_r8,DVTGAS*VNHBG2/VTGAS)*SNH3X
        RHGBBL(N3,N2,N1)=AMIN1(0.0_r8,DVTGAS*VH2GG2/VTGAS)*SH2GX
!
!     ACCUMULATE HOURLY FLUXES FOR USE IN REDIST.F
!
...
!             :*ZN3*=NH3,*H2G*=H2
!
  DFLG2=2.0_r8*AMAX1(0.0_r8,THETPM(M,N3,N2,N1))*POROQ &
    *THETPM(M,N3,N2,N1)/POROS(N3,N2,N1) &
    *AREA(N,N3,N2,N1)/DLYR(N,N3,N2,N1)
  DFLGL=2.0_r8*AMAX1(0.0_r8,THETPM(M,N6,N5,N4))*POROQ &
...
!
  CCO2G1=AMAX1(0.0_r8,CO2G2(N3,N2,N1)/VOLPM(M,N3,N2,N1))
  CCH4G1=AMAX1(0.0_r8,CH4G2(N3,N2,N1)/VOLPM(M,N3,N2,N1))
  COXYG1=AMAX1(0.0_r8,OXYG2(N3,N2,N1)/VOLPM(M,N3,N2,N1))
  CZ2GG1=AMAX1(0.0_r8,Z2GG2(N3,N2,N1)/VOLPM(M,N3,N2,N1))
  CZ2OG1=AMAX1(0.0_r8,Z2OG2(N3,N2,N1)/VOLPM(M,N3,N2,N1))
  CNH3G1=AMAX1(0.0_r8,ZN3G2(N3,N2,N1)/VOLPM(M,N3,N2,N1))
  CH2GG1=AMAX1(0.0_r8,H2GG2(N3,N2,N1)/VOLPM(M,N3,N2,N1))
  CCO2G2=AMAX1(0.0_r8,CO2G2(N6,N5,N4)/VOLPM(M,N6,N5,N4))
  CCH4G2=AMAX1(0.0_r8,CH4G2(N6,N5,N4)/VOLPM(M,N6,N5,N4))
  COXYG2=AMAX1(0.0_r8,OXYG2(N6,N5,N4)/VOLPM(M,N6,N5,N4))
  CZ2GG2=AMAX1(0.0_r8,Z2GG2(N6,N5,N4)/VOLPM(M,N6,N5,N4))
  CZ2OG2=AMAX1(0.0_r8,Z2OG2(N6,N5,N4)/VOLPM(M,N6,N5,N4))
  CNH3G2=AMAX1(0.0_r8,ZN3G2(N6,N5,N4)/VOLPM(M,N6,N5,N4))
  CH2GG2=AMAX1(0.0_r8,H2GG2(N6,N5,N4)/VOLPM(M,N6,N5,N4))
!
...
!
  ...
  IF(FLQW.GT.0.0_r8)THEN
    IF(VOLPM(M,N6,N5,N4).GT.ZEROS2(N5,N4))THEN
      VFLW=-AMAX1(0.0_r8,AMIN1(VFLWX,FLQW/VOLPM(M,N6,N5,N4)))
    ELSE
      VFLW=-VFLWX
    ENDIF
    RFLCOG=VFLW*AMAX1(0.0_r8,CO2G2(N6,N5,N4))
    RFLCHG=VFLW*AMAX1(0.0_r8,CH4G2(N6,N5,N4))
    RFLOXG=VFLW*AMAX1(0.0_r8,OXYG2(N6,N5,N4))
    RFLNGG=VFLW*AMAX1(0.0_r8,Z2GG2(N6,N5,N4))
    RFLN2G=VFLW*AMAX1(0.0_r8,Z2OG2(N6,N5,N4))
    RFLN3G=VFLW*AMAX1(0.0_r8,ZN3G2(N6,N5,N4))
    RFLH2G=VFLW*AMAX1(0.0_r8,H2GG2(N6,N5,N4))
  ELSE
    IF(VOLPM(M,N3,N2,N1).GT.ZEROS2(N2,N1))THEN
      VFLW=-AMIN1(0.0_r8,AMAX1(-VFLWX,FLQW/VOLPM(M,N3,N2,N1)))
    ELSE
      VFLW=VFLWX
    ENDIF
    RFLCOG=VFLW*AMAX1(0.0_r8,CO2G2(N3,N2,N1))
    RFLCHG=VFLW*AMAX1(0.0_r8,CH4G2(N3,N2,N1))
    RFLOXG=VFLW*AMAX1(0.0_r8,OXYG2(N3,N2,N1))
    RFLNGG=VFLW*AMAX1(0.0_r8,Z2GG2(N3,N2,N1))
    RFLN2G=VFLW*AMAX1(0.0_r8,Z2OG2(N3,N2,N1))
    RFLN3G=VFLW*AMAX1(0.0_r8,ZN3G2(N3,N2,N1))
    RFLH2G=VFLW*AMAX1(0.0_r8,H2GG2(N3,N2,N1))
  ENDIF
  ...
  IF(N.EQ.3)THEN
    IF(THETPM(M,N6,N5,N4).GT.THETX)THEN
      ...
      IF(VOLPMA(N6,N5,N4).GT.ZEROS2(N5,N4).AND.VOLWXA(N6,N5,N4).GT.ZEROS2(N5,N4))THEN
        ...
        CNH3S0=AMAX1(0.0_r8,(ZNH3S2(N6,N5,N4)+RN3DFG(N6,N5,N4))/VOLWXA(N6,N5,N4))
        CNH4S0=AMAX1(0.0_r8,ZNH4S2(N6,N5,N4))/VOLWXA(N6,N5,N4)
      ELSE
      ...
      IF(VOLPMB(N6,N5,N4).GT.ZEROS2(N5,N4).AND.VOLWXB(N6,N5,N4).GT.ZEROS2(N5,N4))THEN
        ...
        CNH3B0=AMAX1(0.0_r8,(ZNH3B2(N6,N5,N4)+RNBDFG(N6,N5,N4))/VOLWXB(N6,N5,N4))
        CNH4B0=AMAX1(0.0_r8,ZNH4B2(N6,N5,N4))/VOLWXB(N6,N5,N4)
      ELSE
