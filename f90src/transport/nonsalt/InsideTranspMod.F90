...
!
      ...
      VFLW=AMIN1(0.0_r8,AMAX1(-VFLWX,FLWM(M,N,N6,N5,N4) &
      /VOLWM(M,N6,N5,N4)))
      ELSE
      VFLW=-VFLWX
      ENDIF
...
!
      ...
      -AMIN1(0.0_r8,ROCFXS(K,NU(N2,N1),N2,N1))))
      RFHON(K)=VFLW*AMAX1(0.0_r8,(OQNH2(K,N3,N2,N1) &
      -AMIN1(0.0_r8,RONFXS(K,NU(N2,N1),N2,N1))))
      RFHOP(K)=VFLW*AMAX1(0.0_r8,(OQPH2(K,N3,N2,N1) &
      -AMIN1(0.0_r8,ROPFXS(K,NU(N2,N1),N2,N1))))
      RFHOA(K)=VFLW*AMAX1(0.0_r8,(OQAH2(K,N3,N2,N1) &
      -AMIN1(0.0_r8,ROAFXS(K,NU(N2,N1),N2,N1))))
9800  CONTINUE
      RFHCOS=VFLW*AMAX1(0.0_r8,(CO2SH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RCOFXS(NU(N2,N1),N2,N1))))
      RFHCHS=VFLW*AMAX1(0.0_r8,(CH4SH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RCHFXS(NU(N2,N1),N2,N1))))
      RFHOXS=VFLW*AMAX1(0.0_r8,(OXYSH2(N3,N2,N1) &
      -AMIN1(0.0_r8,ROXFXS(NU(N2,N1),N2,N1))))
      RFHNGS=VFLW*AMAX1(0.0_r8,(Z2GSH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RNGFXS(NU(N2,N1),N2,N1))))
      RFHN2S=VFLW*AMAX1(0.0_r8,(Z2OSH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RN2FXS(NU(N2,N1),N2,N1))))
      RFHHGS=VFLW*AMAX1(0.0_r8,(H2GSH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RHGFXS(NU(N2,N1),N2,N1))))
      RFHNH4=VFLW*AMAX1(0.0_r8,(ZNH4H2(N3,N2,N1) &
      -AMIN1(0.0_r8,RN4FXW(NU(N2,N1),N2,N1)*VLNH4(N3,N2,N1)))) &
      *VLNH4(N6,N5,N4)
      RFHNH3=VFLW*AMAX1(0.0_r8,(ZNH3H2(N3,N2,N1) &
      -AMIN1(0.0_r8,RN3FXW(NU(N2,N1),N2,N1)*VLNH4(N3,N2,N1)))) &
      *VLNH4(N6,N5,N4)
      RFHNO3=VFLW*AMAX1(0.0_r8,(ZNO3H2(N3,N2,N1) &
      -AMIN1(0.0_r8,RNOFXW(NU(N2,N1),N2,N1)*VLNO3(N3,N2,N1)))) &
      *VLNO3(N6,N5,N4)
      RFHNO2=VFLW*AMAX1(0.0_r8,(ZNO2H2(N3,N2,N1) &
      -AMIN1(0.0_r8,RNXFXS(NU(N2,N1),N2,N1)*VLNO3(N3,N2,N1)))) &
      *VLNO3(N6,N5,N4)
      RFHP14=VFLW*AMAX1(0.0_r8,(H1P4H2(N3,N2,N1) &
      -AMIN1(0.0_r8,RH1PXS(NU(N2,N1),N2,N1)*VLPO4(N3,N2,N1)))) &
      *VLPO4(N6,N5,N4)
      RFHPO4=VFLW*AMAX1(0.0_r8,(H2P4H2(N3,N2,N1) &
      -AMIN1(0.0_r8,RH2PXS(NU(N2,N1),N2,N1)*VLPO4(N3,N2,N1)))) &
      *VLPO4(N6,N5,N4)
      RFHN4B=VFLW*AMAX1(0.0_r8,(ZN4BH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RN4FXB(NU(N2,N1),N2,N1)*VLNHB(N3,N2,N1)))) &
      *VLNHB(N6,N5,N4)
      RFHN3B=VFLW*AMAX1(0.0_r8,(ZN3BH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RN3FXB(NU(N2,N1),N2,N1)*VLNHB(N3,N2,N1)))) &
      *VLNHB(N6,N5,N4)
      RFHNOB=VFLW*AMAX1(0.0_r8,(ZNOBH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RNOFXB(NU(N2,N1),N2,N1)*VLNOB(N3,N2,N1)))) &
      *VLNOB(N6,N5,N4)
      RFHN2B=VFLW*AMAX1(0.0_r8,(ZN2BH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RNXFXB(NU(N2,N1),N2,N1)*VLNOB(N3,N2,N1)))) &
      *VLNOB(N6,N5,N4)
      RFHP1B=VFLW*AMAX1(0.0_r8,(H1PBH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RH1BXB(NU(N2,N1),N2,N1)*VLPOB(N3,N2,N1)))) &
      *VLPOB(N6,N5,N4)
      RFHPOB=VFLW*AMAX1(0.0_r8,(H2PBH2(N3,N2,N1) &
      -AMIN1(0.0_r8,RH2BXB(NU(N2,N1),N2,N1)*VLPOB(N3,N2,N1)))) &
      *VLPOB(N6,N5,N4)
!
!     OTHERWISE
!
...
!             :*ZN3*=NH3,*H2G*=H2
!
      DFLG2=2.0*AMAX1(0.0_r8,THETPM(M,N3,N2,N1))*POROQ &
      *THETPM(M,N3,N2,N1)/POROS(N3,N2,N1) &
      *AREA(N,N3,N2,N1)/DLYR(N,N3,N2,N1)
      DFLGL=2.0*AMAX1(0.0_r8,THETPM(M,N6,N5,N4))*POROQ &
...
!
      ...
      VFLW=-AMAX1(0.0_r8,AMIN1(VFLWX,FLQM(N,N6,N5,N4) &
      /VOLPM(M,N6,N5,N4)))
      ELSE
      VFLW=-VFLWX
      ENDIF
      ...
      IF(VOLPM(M,N3,N2,N1).GT.ZEROS2(N2,N1))THEN
        VFLW=-AMIN1(0.0_r8,AMAX1(-VFLWX,FLQM(N,N6,N5,N4)/VOLPM(M,N3,N2,N1)))
      ELSE
        VFLW=VFLWX
      ENDIF
...
!
      ...
      CNH3S0=AMAX1(0.0_r8,(ZNH3S2(N6,N5,N4)+RN3DFG(N6,N5,N4)) &
      /VOLWXA(N6,N5,N4))
      CNH4S0=AMAX1(0.0_r8,ZNH4S2(N6,N5,N4)) &
      /VOLWXA(N6,N5,N4)
      ELSE
      ...
      CNH3B0=AMAX1(0.0_r8,(ZNH3B2(N6,N5,N4)+RNBDFG(N6,N5,N4)) &
      /VOLWXB(N6,N5,N4))
...
!
      VTATM=AMAX1(0.0_r8,1.2194E+04*VOLWM(M,N3,N2,N1)/TKS(N3,N2,N1))
