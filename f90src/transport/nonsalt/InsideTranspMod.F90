...
!
      ...
      trc_solml2(ids_NH3B,L,NY,NX)=trc_solml2(ids_NH3B,L,NY,NX)-R3BSK2(L,NY,NX)
...
!
  IF(FLWM(M,N,N6,N5,N4).GT.0.0_r8)THEN
    ...
    RFLN3B=VFLW*AZMAX1(trc_solml2(ids_NH3B,N3,N2,N1))
...
!
  ELSE
    ...
    RFLN3B=VFLW*AZMAX1(trc_solml2(ids_NH3B,N6,N5,N4))
  ...
  RPoreSolFlx(ids_NH3B,N,N6,N5,N4)=RFLN3B
...
!
    ...
    IF(VOLW4B.GT.ZEROS2(N2,N1))THEN
      ...
      CNH3B1=AZMAX1(trc_solml2(ids_NH3B,N3,N2,N1)/VOLW4B)
    ELSE
      CNH4B1=0.0_r8
      CNH3B1=0.0_r8
    ENDIF
    ...
    IF(VOLWMB(N6,N5,N4).GT.ZEROS2(N5,N4))THEN
      CNH3B2=AZMAX1(trc_solml2(ids_NH3B,N6,N5,N4)/VOLWMB(N6,N5,N4))
...
!
    ...
    SDifc(idg_NH3)=(ZNSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTH(N,N6,N5,N4)
    SDifc(ids_NH4)=SDifc(idg_NH3);
    SDifc(ids_NH4B)=SDifc(ids_NH4);SDifc(ids_NH3B)=SDifc(idg_NH3)
    SDifc(ids_NO3)=(ZOSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTH(N,N6,N5,N4)
    SDifc(ids_NO3B)=SDifc(ids_NO3)
    SDifc(ids_NO2)=SDifc(ids_NO3);SDifc(ids_NO2B)=SDifc(ids_NO2)
    SDifc(ids_H1PO4)=(POSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTH(N,N6,N5,N4)
    SDifc(ids_H2PO4)=SDifc(ids_H1PO4)
    SDifc(ids_H1PO4B)=SDifc(ids_H1PO4)
    SDifc(ids_H2PO4B)=SDifc(ids_H2PO4)
    SDifc(idg_CO2)=(CLSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTH(N,N6,N5,N4)
    SDifc(idg_CH4)=(CQSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTH(N,N6,N5,N4)
    SDifc(idg_O2)=(OLSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTH(N,N6,N5,N4)
    SDifc(idg_N2)=(ZLSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTH(N,N6,N5,N4)
    SDifc(idg_N2O)=(ZVSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTH(N,N6,N5,N4)
    SDifc(idg_H2)=(HLSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTH(N,N6,N5,N4)
...
!
    ...
    SDifFlx(ids_NH3B)=SDifc(ids_NH3B)*(CNH3B1-CNH3B2)*AMIN1(VLNHB(N3,N2,N1),VLNHB(N6,N5,N4))
  ...
  ENDDO
!  RPoreSolFlx(idg_CO2,N,N6,N5,N4)=RPoreSolFlx(idg_CO2,N,N6,N5,N4)+SDifFlx(idg_CO2)
!  RPoreSolFlx(idg_CH4,N,N6,N5,N4)=RPoreSolFlx(idg_CH4,N,N6,N5,N4)+SDifFlx(idg_CH4)
!  RPoreSolFlx(idg_O2,N,N6,N5,N4)=RPoreSolFlx(idg_O2,N,N6,N5,N4)+SDifFlx(idg_O2)
!  RPoreSolFlx(idg_N2,N,N6,N5,N4)=RPoreSolFlx(idg_N2,N,N6,N5,N4)+SDifFlx(idg_N2)
!  RPoreSolFlx(idg_N2O,N,N6,N5,N4)=RPoreSolFlx(idg_N2O,N,N6,N5,N4)+SDifFlx(idg_N2O)
!  RPoreSolFlx(idg_H2,N,N6,N5,N4)=RPoreSolFlx(idg_H2,N,N6,N5,N4)+SDifFlx(idg_H2)
!  RPoreSolFlx(ids_NH4,N,N6,N5,N4)=RPoreSolFlx(ids_NH4,N,N6,N5,N4)+SDifFlx(ids_NH4)
!  RPoreSolFlx(idg_NH3,N,N6,N5,N4)=RPoreSolFlx(idg_NH3,N,N6,N5,N4)+SDifFlx(idg_NH3)
!  RPoreSolFlx(ids_NO3,N,N6,N5,N4)=RPoreSolFlx(ids_NO3,N,N6,N5,N4)+SDifFlx(ids_NO3)
!  RPoreSolFlx(ids_NO2,N,N6,N5,N4)=RPoreSolFlx(ids_NO2,N,N6,N5,N4)+SDifFlx(ids_NO2)
!  RPoreSolFlx(ids_H1PO4,N,N6,N5,N4)=RPoreSolFlx(ids_H1PO4,N,N6,N5,N4)+SDifFlx(ids_H1PO4)
!  RPoreSolFlx(ids_H2PO4,N,N6,N5,N4)=RPoreSolFlx(ids_H2PO4,N,N6,N5,N4)+SDifFlx(ids_H2PO4)
!  RPoreSolFlx(ids_NH4B,N,N6,N5,N4)=RPoreSolFlx(ids_NH4B,N,N6,N5,N4)+SDifFlx(ids_NH4B)
!  RPoreSolFlx(ids_NH3B,N,N6,N5,N4)=RPoreSolFlx(ids_NH3B,N,N6,N5,N4)+SDifFlx(ids_NH3B)
!  RPoreSolFlx(ids_NO3B,N,N6,N5,N4)=RPoreSolFlx(ids_NO3B,N,N6,N5,N4)+SDifFlx(ids_NO3B)
!  RPoreSolFlx(ids_NO2B,N,N6,N5,N4)=RPoreSolFlx(ids_NO2B,N,N6,N5,N4)+SDifFlx(ids_NO2B)
!  RPoreSolFlx(ids_H1PO4B,N,N6,N5,N4)=RPoreSolFlx(ids_H1PO4B,N,N6,N5,N4)+SDifFlx(ids_H1PO4B)
!  RPoreSolFlx(ids_H2PO4B,N,N6,N5,N4)=RPoreSolFlx(ids_H2PO4B,N,N6,N5,N4)+SDifFlx(ids_H2PO4B)
...
!
    IF(N.EQ.3.AND.VOLAH(N6,N5,N4).GT.VOLWHM(M,N6,N5,N4))THEN
      ...
      ENDDO D9800
      RFHCOS=VFLW*AZMAX1((trc_soHml2(idg_CO2,N3,N2,N1)-AZMIN1(RCOFXS(NU(N2,N1),N2,N1))))
      RFHCHS=VFLW*AZMAX1((trc_soHml2(idg_CH4,N3,N2,N1)-AZMIN1(RCHFXS(NU(N2,N1),N2,N1))))
      RFHOXS=VFLW*AZMAX1((trc_soHml2(idg_O2,N3,N2,N1)-AZMIN1(ROXFXS(NU(N2,N1),N2,N1))))
      RFHNGS=VFLW*AZMAX1((trc_soHml2(idg_N2,N3,N2,N1)-AZMIN1(RNGFXS(NU(N2,N1),N2,N1))))
      RFHN2S=VFLW*AZMAX1((trc_soHml2(idg_N2O,N3,N2,N1)-AZMIN1(RN2FXS(NU(N2,N1),N2,N1))))
      RFHHGS=VFLW*AZMAX1((trc_soHml2(idg_H2,N3,N2,N1)-AZMIN1(RHGFXS(NU(N2,N1),N2,N1))))
      RFHNH4=VFLW*AZMAX1((trc_soHml2(ids_NH4,N3,N2,N1)-AZMIN1(RN4FXW(NU(N2,N1),N2,N1)*VLNH4(N3,N2,N1))))*VLNH4(N6,N5,N4)
      RFHNH3=VFLW*AZMAX1((trc_soHml2(idg_NH3,N3,N2,N1)-AZMIN1(RN3FXW(NU(N2,N1),N2,N1)*VLNH4(N3,N2,N1))))*VLNH4(N6,N5,N4)
      RFHNO3=VFLW*AZMAX1((trc_soHml2(ids_NO3,N3,N2,N1)-AZMIN1(RNOFXW(NU(N2,N1),N2,N1)*VLNO3(N3,N2,N1))))*VLNO3(N6,N5,N4)
      RFHNO2=VFLW*AZMAX1((trc_soHml2(ids_NO2,N3,N2,N1)-AZMIN1(RNXFXS(NU(N2,N1),N2,N1)*VLNO3(N3,N2,N1))))*VLNO3(N6,N5,N4)
      RFHP14=VFLW*AZMAX1((trc_soHml2(ids_H1PO4,N3,N2,N1)-AZMIN1(RH1PXS(NU(N2,N1),N2,N1)*VLPO4(N3,N2,N1))))*VLPO4(N6,N5,N4)
      RFHPO4=VFLW*AZMAX1((trc_soHml2(ids_H2PO4,N3,N2,N1)-AZMIN1(RH2PXS(NU(N2,N1),N2,N1)*VLPO4(N3,N2,N1))))*VLPO4(N6,N5,N4)
      RFHN4B=VFLW*AZMAX1((trc_soHml2(ids_NH4B,N3,N2,N1)-AZMIN1(RN4FXB(NU(N2,N1),N2,N1)*VLNHB(N3,N2,N1))))*VLNHB(N6,N5,N4)
      RFHN3B=VFLW*AZMAX1((trc_soHml2(ids_NH3B,N3,N2,N1)-AZMIN1(RN3FXB(NU(N2,N1),N2,N1)*VLNHB(N3,N2,N1))))*VLNHB(N6,N5,N4)
      RFHNOB=VFLW*AZMAX1((trc_soHml2(ids_NO3B,N3,N2,N1)-AZMIN1(RNOFXB(NU(N2,N1),N2,N1)*VLNOB(N3,N2,N1))))*VLNOB(N6,N5,N4)
      RFHN2B=VFLW*AZMAX1((trc_soHml2(ids_NO2B,N3,N2,N1)-AZMIN1(RNXFXB(NU(N2,N1),N2,N1)*VLNOB(N3,N2,N1))))*VLNOB(N6,N5,N4)
      RFHP1B=VFLW*AZMAX1((trc_soHml2(ids_H1PO4B,N3,N2,N1)-AZMIN1(RH1BXB(NU(N2,N1),N2,N1)*VLPOB(N3,N2,N1))))*VLPOB(N6,N5,N4)
      RFHPOB=VFLW*AZMAX1((trc_soHml2(ids_H2PO4B,N3,N2,N1)-AZMIN1(RH2BXB(NU(N2,N1),N2,N1)*VLPOB(N3,N2,N1))))*VLPOB(N6,N5,N4)
!
!     OTHERWISE
!
    ELSE
      ...
      RFHN3B=VFLW*AZMAX1(trc_soHml2(ids_NH3B,N3,N2,N1))*VLNHB(N6,N5,N4)
...
!
  ELSEIF(FLWHM(M,N,N6,N5,N4).LT.0.0_r8)THEN
    ...
    RFHN3B=VFLW*AZMAX1(trc_soHml2(ids_NH3B,N6,N5,N4))*VLNHB(N6,N5,N4)
...
!
  ...
  RPoreSoHFlx(ids_NH3B,N,N6,N5,N4)=RFHN3B
...
!
    ...
    IF(VOLH4B.GT.ZEROS2(N2,N1))THEN
      ...
      CNH3BH1=AZMAX1(trc_soHml2(ids_NH3B,N3,N2,N1)/VOLH4B)
    ELSE
      CNH4BH1=CNH4SH1
      CNH3BH1=CNH3SH1
    ENDIF
    ...
    IF(VOLHMB.GT.ZEROS2(N5,N4))THEN
      ...
      CNH3BH2=AZMAX1(trc_soHml2(ids_NH3B,N6,N5,N4)/VOLHMB)
    ELSE
      CNH4BH2=CNH4SH2
      CNH3BH2=CNH3SH2
    ENDIF
...
!
    ...
    SDifHFlx(ids_NH3B)=SDifc(ids_NH3B)*(CNH3BH1-CNH3BH2)*AMIN1(VLNHB(N3,N2,N1),VLNHB(N6,N5,N4))
...
9755  CONTINUE
  ...
  XN3FLB(N,N6,N5,N4)=XN3FLB(N,N6,N5,N4)+RPoreSolFlx(ids_NH3B,N,N6,N5,N4)
  ...
  XN3FHB(N,N6,N5,N4)=XN3FHB(N,N6,N5,N4)+RPoreSoHFlx(ids_NH3B,N,N6,N5,N4)
...
9970  CONTINUE
    ...
    RFLN3B=VFLW*AZMAX1(trc_soHml2(ids_NH3B,N6,N5,N4))*VLNHB(N6,N5,N4)
...
9965  CONTINUE
    ...
    RFLN3B=VFLW*AZMAX1(trc_solml2(ids_NH3B,N6,N5,N4))*VLNHB(N6,N5,N4)
...
!
  IF(VOLWHM(M,N6,N5,N4).GT.ZEROS2(N5,N4))THEN
    ...
    DFVN4B=XNPH*(AZMAX1(trc_soHml2(ids_NH4B,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      ...
      *VLNHB(N6,N5,N4)
    DFVN3B=XNPH*(AZMAX1(trc_soHml2(ids_NH3B,N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(trc_solml2(ids_NH3B,N6,N5,N4))*VOLWHS)/VOLWT &
      *VLNHB(N6,N5,N4)
...
!
      IF(N3.EQ.NU(N2,N1))THEN
        VCO2G2=(trc_solml2(idg_CO2,N3,N2,N1)+RCODFS(NY,NX))/SCO2X
        VCH4G2=(trc_solml2(idg_CH4,N3,N2,N1)+RCHDFS(NY,NX))/SCH4X
        VOXYG2=(trc_solml2(idg_O2,N3,N2,N1)+ROXDFS(NY,NX))/SOXYX
        VZ2GG2=(trc_solml2(idg_N2,N3,N2,N1)+RNGDFS(NY,NX))/SN2GX
        VZ2OG2=(trc_solml2(idg_N2O,N3,N2,N1)+RN2DFS(NY,NX))/SN2OX
        VNH3G2=(trc_solml2(idg_NH3,N3,N2,N1)+RN3DFS(NY,NX))/SNH3X
        VNHBG2=(trc_solml2(ids_NH3B,N3,N2,N1)+RNBDFS(NY,NX))/SNH3X
        VH2GG2=(trc_solml2(idg_H2,N3,N2,N1)+RHGDFS(NY,NX))/SH2GX
      ELSE
        ...
        VNHBG2=trc_solml2(ids_NH3B,N3,N2,N1)/SNH3X
...
!             :*ZN3*=NH3,*H2G*=H2
!
  DifuscG(idg_CO2,N,N6,N5,N4)=(CNDC1*CNDC2)/(CNDC1+CNDC2)
  DifuscG(idg_CH4,N,N6,N5,N4)=(CND41*CND42)/(CND41+CND42)
  DifuscG(idg_O2,N,N6,N5,N4)=(CNDO1*CNDO2)/(CNDO1+CNDO2)
  DifuscG(idg_N2,N,N6,N5,N4)=(CNDG1*CNDG2)/(CNDG1+CNDG2)
  DifuscG(idg_N2O,N,N6,N5,N4)=(CND21*CND22)/(CND21+CND22)
  DifuscG(idg_NH3,N,N6,N5,N4)=(CNDH1*CNDH2)/(CNDH1+CNDH2)
  DifuscG(idg_H2,N,N6,N5,N4)=(CNHG1*CNHG2)/(CNHG1+CNHG2)
!
...
!
  ...
  DO NGT=idg_beg,idg_end
    trc_gasc1(NGT)=AZMAX1(trc_gasml2(NGT,N3,N2,N1)/VOLPM(M,N3,N2,N1))
    trc_gasc2(NGT)=AZMAX1(trc_gasml2(NGT,N6,N5,N4)/VOLPM(M,N6,N5,N4))
    DFVGG(NGT)=DifuscG(NGT,N,N6,N5,N4)*(trc_gasc1(NGT)-trc_gasc2(NGT))
  ENDDO
...
!
  ...
  IF(FLQW.GT.0.0_r8)THEN
    ...
    ELSE
      VFLW=-VFLWX
    ENDIF
    RFLCOG=VFLW*AZMAX1(trc_gasml2(idg_CO2,N6,N5,N4))
    RFLCHG=VFLW*AZMAX1(trc_gasml2(idg_CH4,N6,N5,N4))
    RFLOXG=VFLW*AZMAX1(trc_gasml2(idg_O2,N6,N5,N4))
    RFLNGG=VFLW*AZMAX1(trc_gasml2(idg_N2,N6,N5,N4))
    RFLN2G=VFLW*AZMAX1(trc_gasml2(idg_N2O,N6,N5,N4))
    RFLN3G=VFLW*AZMAX1(trc_gasml2(idg_NH3,N6,N5,N4))
    RFLH2G=VFLW*AZMAX1(trc_gasml2(idg_H2,N6,N5,N4))
  ELSE
    ...
    ELSE
      VFLW=VFLWX
    ENDIF
    RFLCOG=VFLW*AZMAX1(trc_gasml2(idg_CO2,N3,N2,N1))
    RFLCHG=VFLW*AZMAX1(trc_gasml2(idg_CH4,N3,N2,N1))
    RFLOXG=VFLW*AZMAX1(trc_gasml2(idg_O2,N3,N2,N1))
    RFLNGG=VFLW*AZMAX1(trc_gasml2(idg_N2,N3,N2,N1))
    RFLN2G=VFLW*AZMAX1(trc_gasml2(idg_N2O,N3,N2,N1))
    RFLN3G=VFLW*AZMAX1(trc_gasml2(idg_NH3,N3,N2,N1))
    RFLH2G=VFLW*AZMAX1(trc_gasml2(idg_H2,N3,N2,N1))
  ENDIF
!     R*FLG=total convective+diffusive gas flux
!     gas code:*CO*=CO2,*OX*=O2,*CH*=CH4,*NG*=N2,*N2*=N2O,*NH*=NH3,*HG*=H2
!     DFV*G=diffusive gas flux
    ...
    IF(THETPM(M,N6,N5,N4).GT.THETX)THEN
      ...
      IF(VOLPMB(N6,N5,N4).GT.ZEROS2(N5,N4).AND.VOLWXB(N6,N5,N4).GT.ZEROS2(N5,N4))THEN
        RNBDFG(N6,N5,N4)=DFGS(M,N6,N5,N4)*(AMAX1(ZEROS(N5,N4) &
          ...
          -trc_solml2(ids_NH3B,N6,N5,N4)*VOLPMB(N6,N5,N4)) &
          /(VOLWNB(N6,N5,N4)+VOLPMB(N6,N5,N4))
        CNH3B0=AZMAX1((trc_solml2(ids_NH3B,N6,N5,N4)+RNBDFG(N6,N5,N4))/VOLWXB(N6,N5,N4))
...
! ----------------------------------------------------------------------
  ...
  RPoreSolFlx(ids_NH3B,N,N6,N5,N4)=0.0_r8
...
! ----------------------------------------------------------------------
  ...
  RPoreSolFlx(ids_NH3B,N,N3,N2,N1)=0.0_r8
