...
!     *H2,*2=macropore,micropore solute content
  ...
  DFVNAC=XNPH*(AZMAX1(ZNACH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZNAC2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVH0P=XNPH*(AZMAX1(H0P4H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(H0PO42(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVH3P=XNPH*(AZMAX1(H3P4H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(H3PO42(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVF1P=XNPH*(AZMAX1(ZF1PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZFE1P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVF2P=XNPH*(AZMAX1(ZF2PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZFE2P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVC0P=XNPH*(AZMAX1(ZC0PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZCA0P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVC1P=XNPH*(AZMAX1(ZC1PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZCA1P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVC2P=XNPH*(AZMAX1(ZC2PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZCA2P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVM1P=XNPH*(AZMAX1(ZM1PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZMG1P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVH0B=XNPH*(AZMAX1(H0PBH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(H0POB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVH3B=XNPH*(AZMAX1(H3PBH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(H3POB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVF1B=XNPH*(AZMAX1(ZF1BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZF1PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVF2B=XNPH*(AZMAX1(ZF2BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZF2PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVC0B=XNPH*(AZMAX1(ZC0BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZC0PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVC1B=XNPH*(AZMAX1(ZC1BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZC1PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVC2B=XNPH*(AZMAX1(ZC2BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZC2PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVM1B=XNPH*(AZMAX1(ZM1BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(ZM1PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
...
!
    IF(N.EQ.3.AND.VOLAH(N6,N5,N4).GT.VOLWHM(M,N6,N5,N4))THEN
      ...
      RFHH0P=VFLW*AZMAX1((H0P4H2(N3,N2,N1)-AZMIN1(RH0PXS(NU(N2,N1),N2,N1))))*VLPO4(N3,N2,N1)
      RFHH3P=VFLW*AZMAX1((H3P4H2(N3,N2,N1)-AZMIN1(RH3PXS(NU(N2,N1),N2,N1))))*VLPO4(N3,N2,N1)
      RFHF1P=VFLW*AZMAX1((ZF1PH2(N3,N2,N1)-AZMIN1(RF1PXS(NU(N2,N1),N2,N1))))*VLPO4(N3,N2,N1)
      RFHF2P=VFLW*AZMAX1((ZF2PH2(N3,N2,N1)-AZMIN1(RF2PXS(NU(N2,N1),N2,N1))))*VLPO4(N3,N2,N1)
      RFHC0P=VFLW*AZMAX1((ZC0PH2(N3,N2,N1)-AZMIN1(RC0PXS(NU(N2,N1),N2,N1))))*VLPO4(N3,N2,N1)
      RFHC1P=VFLW*AZMAX1((ZC1PH2(N3,N2,N1)-AZMIN1(RC1PXS(NU(N2,N1),N2,N1))))*VLPO4(N3,N2,N1)
      RFHC2P=VFLW*AZMAX1((ZC2PH2(N3,N2,N1)-AZMIN1(RC2PXS(NU(N2,N1),N2,N1))))*VLPO4(N3,N2,N1)
      RFHM1P=VFLW*AZMAX1((ZM1PH2(N3,N2,N1)-AZMIN1(RM1PXS(NU(N2,N1),N2,N1))))*VLPO4(N3,N2,N1)
      RFHH0B=VFLW*AZMAX1((H0PBH2(N3,N2,N1)-AZMIN1(RH0BXB(NU(N2,N1),N2,N1))))*VLPOB(N3,N2,N1)
      RFHH3B=VFLW*AZMAX1((H3PBH2(N3,N2,N1)-AZMIN1(RH3BXB(NU(N2,N1),N2,N1))))*VLPOB(N3,N2,N1)
      RFHF1B=VFLW*AZMAX1((ZF1BH2(N3,N2,N1)-AZMIN1(RF1BXB(NU(N2,N1),N2,N1))))*VLPOB(N3,N2,N1)
      RFHF2B=VFLW*AZMAX1((ZF2BH2(N3,N2,N1)-AZMIN1(RF2BXB(NU(N2,N1),N2,N1))))*VLPOB(N3,N2,N1)
      RFHC0B=VFLW*AZMAX1((ZC0BH2(N3,N2,N1)-AZMIN1(RC0BXB(NU(N2,N1),N2,N1))))*VLPOB(N3,N2,N1)
      RFHC1B=VFLW*AZMAX1((ZC1BH2(N3,N2,N1)-AZMIN1(RC1BXB(NU(N2,N1),N2,N1))))*VLPOB(N3,N2,N1)
      RFHC2B=VFLW*AZMAX1((ZC2BH2(N3,N2,N1)-AZMIN1(RC2BXB(NU(N2,N1),N2,N1))))*VLPOB(N3,N2,N1)
      RFHM1B=VFLW*AZMAX1((ZM1BH2(N3,N2,N1)-AZMIN1(RM1BXB(NU(N2,N1),N2,N1))))*VLPOB(N3,N2,N1)
!
!     OTHERWISE
!
    ELSE
...
!
  IF(FINHM(M,N6,N5,N4).GT.0.0)THEN
    ...
    RFLH0P=VFLW*AZMAX1(H0P4H2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLH3P=VFLW*AZMAX1(H3P4H2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLF1P=VFLW*AZMAX1(ZF1PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLF2P=VFLW*AZMAX1(ZF2PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLC0P=VFLW*AZMAX1(ZC0PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLC1P=VFLW*AZMAX1(ZC1PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLC2P=VFLW*AZMAX1(ZC2PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLM1P=VFLW*AZMAX1(ZM1PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLH0B=VFLW*AZMAX1(H0PBH2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLH3B=VFLW*AZMAX1(H3PBH2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLF1B=VFLW*AZMAX1(ZF1BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLF2B=VFLW*AZMAX1(ZF2BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLC0B=VFLW*AZMAX1(ZC0BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLC1B=VFLW*AZMAX1(ZC1BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLC2B=VFLW*AZMAX1(ZC2BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLM1B=VFLW*AZMAX1(ZM1BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
!
!     MICROPORE TO MACROPORE TRANSFER
!
  ELSEIF(FINHM(M,N6,N5,N4).LT.0.0)THEN
    ...
    RFLNAS=VFLW*AZMAX1(ZNAS2(N6,N5,N4))
    RFLKAS=VFLW*AZMAX1(ZKAS2(N6,N5,N4))
    RFLH0P=VFLW*AZMAX1(H0PO42(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLH3P=VFLW*AZMAX1(H3PO42(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLF1P=VFLW*AZMAX1(ZFE1P2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLF2P=VFLW*AZMAX1(ZFE2P2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLC0P=VFLW*AZMAX1(ZCA0P2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLC1P=VFLW*AZMAX1(ZCA1P2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLC2P=VFLW*AZMAX1(ZCA2P2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLM1P=VFLW*AZMAX1(ZMG1P2(N6,N5,N4))*VLPO4(N6,N5,N4)
    RFLH0B=VFLW*AZMAX1(H0POB2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLH3B=VFLW*AZMAX1(H3POB2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLF1B=VFLW*AZMAX1(ZF1PB2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLF2B=VFLW*AZMAX1(ZF2PB2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLC0B=VFLW*AZMAX1(ZC0PB2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLC1B=VFLW*AZMAX1(ZC1PB2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLC2B=VFLW*AZMAX1(ZC2PB2(N6,N5,N4))*VLPOB(N6,N5,N4)
    RFLM1B=VFLW*AZMAX1(ZM1PB2(N6,N5,N4))*VLPOB(N6,N5,N4)
!
!     NO MACROPORE TO MICROPORE TRANSFER
!
  ELSE
...
!
  IF(VOLWHM(M,N6,N5,N4).GT.ZEROS2(NY,NX))THEN
    ...
    DFVNAC=XNPH*(AZMAX1(ZNACH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZNAC2(N6,N5,N4))*VOLWHS)/VOLWT
    DFVH0P=XNPH*(AZMAX1(H0P4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(H0PO42(N6,N5,N4))*VOLWHS)/VOLWT*VLPO4(N6,N5,N4)
    DFVH3P=XNPH*(AZMAX1(H3P4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(H3PO42(N6,N5,N4))*VOLWHS)/VOLWT*VLPO4(N6,N5,N4)
    DFVF1P=XNPH*(AZMAX1(ZF1PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZFE1P2(N6,N5,N4))*VOLWHS)/VOLWT*VLPO4(N6,N5,N4)
    DFVF2P=XNPH*(AZMAX1(ZF2PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZFE2P2(N6,N5,N4))*VOLWHS)/VOLWT*VLPO4(N6,N5,N4)
    DFVC0P=XNPH*(AZMAX1(ZC0PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZCA0P2(N6,N5,N4))*VOLWHS)/VOLWT*VLPO4(N6,N5,N4)
    DFVC1P=XNPH*(AZMAX1(ZC1PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZCA1P2(N6,N5,N4))*VOLWHS)/VOLWT*VLPO4(N6,N5,N4)
    DFVC2P=XNPH*(AZMAX1(ZC2PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZCA2P2(N6,N5,N4))*VOLWHS)/VOLWT*VLPO4(N6,N5,N4)
    DFVM1P=XNPH*(AZMAX1(ZM1PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZMG1P2(N6,N5,N4))*VOLWHS)/VOLWT*VLPO4(N6,N5,N4)
    DFVH0B=XNPH*(AZMAX1(H0PBH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(H0POB2(N6,N5,N4))*VOLWHS)/VOLWT*VLPOB(N6,N5,N4)
    DFVH3B=XNPH*(AZMAX1(H3PBH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(H3POB2(N6,N5,N4))*VOLWHS)/VOLWT*VLPOB(N6,N5,N4)
    DFVF1B=XNPH*(AZMAX1(ZF1BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZF1PB2(N6,N5,N4))*VOLWHS)/VOLWT*VLPOB(N6,N5,N4)
    DFVF2B=XNPH*(AZMAX1(ZF2BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZF2PB2(N6,N5,N4))*VOLWHS)/VOLWT*VLPOB(N6,N5,N4)
    DFVC0B=XNPH*(AZMAX1(ZC0BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZC0PB2(N6,N5,N4))*VOLWHS)/VOLWT*VLPOB(N6,N5,N4)
    DFVC1B=XNPH*(AZMAX1(ZC1BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZC1PB2(N6,N5,N4))*VOLWHS)/VOLWT*VLPOB(N6,N5,N4)
    DFVC2B=XNPH*(AZMAX1(ZC2BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZC2PB2(N6,N5,N4))*VOLWHS)/VOLWT*VLPOB(N6,N5,N4)
    DFVM1B=XNPH*(AZMAX1(ZM1BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(ZM1PB2(N6,N5,N4))*VOLWHS)/VOLWT*VLPOB(N6,N5,N4)
  ELSE
    DFVAL=0.0_r8
    DFVFE=0.0_r8
    DFVHY=0.0_r8
