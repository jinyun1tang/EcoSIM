...
!
  ...
  RFLH0P=VFLW*AZMAX1(H0PO42(0,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLH3P=VFLW*AZMAX1(H3PO42(0,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLF1P=VFLW*AZMAX1(ZFE1P2(0,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLF2P=VFLW*AZMAX1(ZFE2P2(0,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLC0P=VFLW*AZMAX1(ZCA0P2(0,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLC1P=VFLW*AZMAX1(ZCA1P2(0,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLC2P=VFLW*AZMAX1(ZCA2P2(0,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLM1P=VFLW*AZMAX1(ZMG1P2(0,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLH0B=VFLW*AZMAX1(H0PO42(0,NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLH3B=VFLW*AZMAX1(H3PO42(0,NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLF1B=VFLW*AZMAX1(ZFE1P2(0,NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLF2B=VFLW*AZMAX1(ZFE2P2(0,NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLC0B=VFLW*AZMAX1(ZCA0P2(0,NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLC1B=VFLW*AZMAX1(ZCA1P2(0,NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLC2B=VFLW*AZMAX1(ZCA2P2(0,NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLM1B=VFLW*AZMAX1(ZMG1P2(0,NY,NX))*VLPOB(NU(NY,NX),NY,NX)
...
!     begin_execution
  ...
  RFLH0P=VFLW*AZMAX1(H0P4H2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLH3P=VFLW*AZMAX1(H3P4H2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLF1P=VFLW*AZMAX1(ZF1PH2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLF2P=VFLW*AZMAX1(ZF2PH2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLC0P=VFLW*AZMAX1(ZC0PH2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLC1P=VFLW*AZMAX1(ZC1PH2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLC2P=VFLW*AZMAX1(ZC2PH2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLM1P=VFLW*AZMAX1(ZM1PH2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLH0B=VFLW*AZMAX1(H0PBH2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLH3B=VFLW*AZMAX1(H3PBH2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLF1B=VFLW*AZMAX1(ZF1BH2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLF2B=VFLW*AZMAX1(ZF2BH2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLC0B=VFLW*AZMAX1(ZC0BH2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLC1B=VFLW*AZMAX1(ZC1BH2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLC2B=VFLW*AZMAX1(ZC2BH2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLM1B=VFLW*AZMAX1(ZM1BH2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
...
!     begin_execution
  ...
  RFLNAS=VFLW*AZMAX1(ZNAS2(NU(NY,NX),NY,NX))
  RFLKAS=VFLW*AZMAX1(ZKAS2(NU(NY,NX),NY,NX))
  RFLH0P=VFLW*AZMAX1(H0PO42(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLH3P=VFLW*AZMAX1(H3PO42(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLF1P=VFLW*AZMAX1(ZFE1P2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLF2P=VFLW*AZMAX1(ZFE2P2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLC0P=VFLW*AZMAX1(ZCA0P2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLC1P=VFLW*AZMAX1(ZCA1P2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLC2P=VFLW*AZMAX1(ZCA2P2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLM1P=VFLW*AZMAX1(ZMG1P2(NU(NY,NX),NY,NX))*VLPO4(NU(NY,NX),NY,NX)
  RFLH0B=VFLW*AZMAX1(H0POB2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLH3B=VFLW*AZMAX1(H3POB2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLF1B=VFLW*AZMAX1(ZF1PB2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLF2B=VFLW*AZMAX1(ZF2PB2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLC0B=VFLW*AZMAX1(ZC0PB2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLC1B=VFLW*AZMAX1(ZC1PB2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLC2B=VFLW*AZMAX1(ZC2PB2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
  RFLM1B=VFLW*AZMAX1(ZM1PB2(NU(NY,NX),NY,NX))*VLPOB(NU(NY,NX),NY,NX)
...
!     *H2,*2=macropore,micropore solute content
  ...
  DFVAL=XNPH*(AZMAX1(ZALH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZAL2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVFE=XNPH*(AZMAX1(ZFEH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZFE2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVHY=XNPH*(AZMAX1(ZHYH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZHY2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCA=XNPH*(AZMAX1(ZCCH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZCA2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVMG=XNPH*(AZMAX1(ZMAH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZMG2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVNA=XNPH*(AZMAX1(ZNAH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZNA2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVKA=XNPH*(AZMAX1(ZKAH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZKA2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVOH=XNPH*(AZMAX1(ZOHH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZOH2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVSO=XNPH*(AZMAX1(ZSO4H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZSO42(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCL=XNPH*(AZMAX1(ZCLH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZCL2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVC3=XNPH*(AZMAX1(ZCO3H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZCO32(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVHC=XNPH*(AZMAX1(ZHCOH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZHCO32(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVAL1=XNPH*(AZMAX1(ZAL1H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZAL12(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVAL2=XNPH*(AZMAX1(ZAL2H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZAL22(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVAL3=XNPH*(AZMAX1(ZAL3H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZAL32(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVAL4=XNPH*(AZMAX1(ZAL4H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZAL42(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVALS=XNPH*(AZMAX1(ZALSH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZALS2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVFE1=XNPH*(AZMAX1(ZFE1H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZFE12(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVF22=XNPH*(AZMAX1(ZFE2H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZFE22(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVFE3=XNPH*(AZMAX1(ZFE3H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZFE32(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVFE4=XNPH*(AZMAX1(ZFE4H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZFE42(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVFES=XNPH*(AZMAX1(ZFESH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZFES2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCAO=XNPH*(AZMAX1(ZCAOH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZCAO2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCAC=XNPH*(AZMAX1(ZCACH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZCAC2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCAH=XNPH*(AZMAX1(ZCAHH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZCAH2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCAS=XNPH*(AZMAX1(ZCASH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZCAS2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVMGO=XNPH*(AZMAX1(ZMGOH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZMGO2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVMGC=XNPH*(AZMAX1(ZMGCH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZMGC2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVMGH=XNPH*(AZMAX1(ZMGHH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZMGH2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVMGS=XNPH*(AZMAX1(ZMGSH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZMGS2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVNAC=XNPH*(AZMAX1(ZNACH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZNAC2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVNAS=XNPH*(AZMAX1(ZNASH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZNAS2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVKAS=XNPH*(AZMAX1(ZKASH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZKAS2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVNAC=XNPH*(AZMAX1(ZNACH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZNAC2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVH0P=XNPH*(AZMAX1(H0P4H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(H0PO42(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVH3P=XNPH*(AZMAX1(H3P4H2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(H3PO42(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVF1P=XNPH*(AZMAX1(ZF1PH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZFE1P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVF2P=XNPH*(AZMAX1(ZF2PH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZFE2P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVC0P=XNPH*(AZMAX1(ZC0PH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZCA0P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVC1P=XNPH*(AZMAX1(ZC1PH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZCA1P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVC2P=XNPH*(AZMAX1(ZC2PH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZCA2P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVM1P=XNPH*(AZMAX1(ZM1PH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZMG1P2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPO4(NU(NY,NX),NY,NX)
  DFVH0B=XNPH*(AZMAX1(H0PBH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(H0POB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVH3B=XNPH*(AZMAX1(H3PBH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(H3POB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVF1B=XNPH*(AZMAX1(ZF1BH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZF1PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVF2B=XNPH*(AZMAX1(ZF2BH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZF2PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVC0B=XNPH*(AZMAX1(ZC0BH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZC0PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVC1B=XNPH*(AZMAX1(ZC1BH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZC1PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVC2B=XNPH*(AZMAX1(ZC2BH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZC2PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
  DFVM1B=XNPH*(AZMAX1(ZM1BH2(NU(NY,NX),NY,NX))*VOLWM(M,NU(NY,NX),NY,NX) &
    -AZMAX1(ZM1PB2(NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*VLPOB(NU(NY,NX),NY,NX)
...
!
        ELSEIF(QSM(M,N,N5,N4).GT.0.0)THEN
          ...
          ELSE
            VFLW=VFLWX
          ENDIF
          RQSAL(N,N5,N4)=VFLW*AZMAX1(ZALW2(1,N2,N1))
          RQSFE(N,N5,N4)=VFLW*AZMAX1(ZFEW2(1,N2,N1))
          RQSHY(N,N5,N4)=VFLW*AZMAX1(ZHYW2(1,N2,N1))
          RQSCA(N,N5,N4)=VFLW*AZMAX1(ZCAW2(1,N2,N1))
          RQSMG(N,N5,N4)=VFLW*AZMAX1(ZMGW2(1,N2,N1))
          RQSNA(N,N5,N4)=VFLW*AZMAX1(ZNAW2(1,N2,N1))
          RQSKA(N,N5,N4)=VFLW*AZMAX1(ZKAW2(1,N2,N1))
          RQSOH(N,N5,N4)=VFLW*AZMAX1(ZOHW2(1,N2,N1))
          RQSSO(N,N5,N4)=VFLW*AZMAX1(ZSO4W2(1,N2,N1))
          RQSCL(N,N5,N4)=VFLW*AZMAX1(ZCLW2(1,N2,N1))
          RQSC3(N,N5,N4)=VFLW*AZMAX1(ZCO3W2(1,N2,N1))
          RQSHC(N,N5,N4)=VFLW*AZMAX1(ZHCO3W2(1,N2,N1))
          RQSAL1(N,N5,N4)=VFLW*AZMAX1(ZALH1W2(1,N2,N1))
          RQSAL2(N,N5,N4)=VFLW*AZMAX1(ZALH2W2(1,N2,N1))
          RQSAL3(N,N5,N4)=VFLW*AZMAX1(ZALH3W2(1,N2,N1))
          RQSAL4(N,N5,N4)=VFLW*AZMAX1(ZALH4W2(1,N2,N1))
          RQSALS(N,N5,N4)=VFLW*AZMAX1(ZALSW2(1,N2,N1))
          RQSFE1(N,N5,N4)=VFLW*AZMAX1(ZFEH1W2(1,N2,N1))
          RQSFE2(N,N5,N4)=VFLW*AZMAX1(ZFEH2W2(1,N2,N1))
          RQSFE3(N,N5,N4)=VFLW*AZMAX1(ZFEH3W2(1,N2,N1))
          RQSFE4(N,N5,N4)=VFLW*AZMAX1(ZFEH4W2(1,N2,N1))
          RQSFES(N,N5,N4)=VFLW*AZMAX1(ZFESW2(1,N2,N1))
          RQSCAO(N,N5,N4)=VFLW*AZMAX1(ZCAOW2(1,N2,N1))
          RQSCAC(N,N5,N4)=VFLW*AZMAX1(ZCACW2(1,N2,N1))
          RQSCAH(N,N5,N4)=VFLW*AZMAX1(ZCAHW2(1,N2,N1))
          RQSCAS(N,N5,N4)=VFLW*AZMAX1(ZCASW2(1,N2,N1))
          RQSMGO(N,N5,N4)=VFLW*AZMAX1(ZMGOW2(1,N2,N1))
          RQSMGC(N,N5,N4)=VFLW*AZMAX1(ZMGCW2(1,N2,N1))
          RQSMGH(N,N5,N4)=VFLW*AZMAX1(ZMGHW2(1,N2,N1))
          RQSMGS(N,N5,N4)=VFLW*AZMAX1(ZMGSW2(1,N2,N1))
          RQSNAC(N,N5,N4)=VFLW*AZMAX1(ZNACW2(1,N2,N1))
          RQSNAS(N,N5,N4)=VFLW*AZMAX1(ZNASW2(1,N2,N1))
          RQSKAS(N,N5,N4)=VFLW*AZMAX1(ZKASW2(1,N2,N1))
          RQSH0P(N,N5,N4)=VFLW*AZMAX1(H0PO4W2(1,N2,N1))
          RQSH3P(N,N5,N4)=VFLW*AZMAX1(H3PO4W2(1,N2,N1))
          RQSF1P(N,N5,N4)=VFLW*AZMAX1(ZFE1PW2(1,N2,N1))
          RQSF2P(N,N5,N4)=VFLW*AZMAX1(ZFE2PW2(1,N2,N1))
          RQSC0P(N,N5,N4)=VFLW*AZMAX1(ZCA0PW2(1,N2,N1))
          RQSC1P(N,N5,N4)=VFLW*AZMAX1(ZCA1PW2(1,N2,N1))
          RQSC2P(N,N5,N4)=VFLW*AZMAX1(ZCA2PW2(1,N2,N1))
          RQSM1P(N,N5,N4)=VFLW*AZMAX1(ZMG1PW2(1,N2,N1))
!
...
!
        ELSEIF(QSM(M,N,N5,N4).LT.-ZEROS2(N2,N1))THEN
          ...
          ELSE
            VFLW=-VFLWX
          ENDIF
          RQSAL(N,N5,N4)=VFLW*AZMAX1(ZALW2(1,N5,N4))
          RQSFE(N,N5,N4)=VFLW*AZMAX1(ZFEW2(1,N5,N4))
          RQSHY(N,N5,N4)=VFLW*AZMAX1(ZHYW2(1,N5,N4))
          RQSCA(N,N5,N4)=VFLW*AZMAX1(ZCAW2(1,N5,N4))
          RQSMG(N,N5,N4)=VFLW*AZMAX1(ZMGW2(1,N5,N4))
          RQSNA(N,N5,N4)=VFLW*AZMAX1(ZNAW2(1,N5,N4))
          RQSKA(N,N5,N4)=VFLW*AZMAX1(ZKAW2(1,N5,N4))
          RQSOH(N,N5,N4)=VFLW*AZMAX1(ZOHW2(1,N5,N4))
          RQSSO(N,N5,N4)=VFLW*AZMAX1(ZSO4W2(1,N5,N4))
          RQSCL(N,N5,N4)=VFLW*AZMAX1(ZCLW2(1,N5,N4))
          RQSC3(N,N5,N4)=VFLW*AZMAX1(ZCO3W2(1,N5,N4))
          RQSHC(N,N5,N4)=VFLW*AZMAX1(ZHCO3W2(1,N5,N4))
          RQSAL1(N,N5,N4)=VFLW*AZMAX1(ZALH1W2(1,N5,N4))
          RQSAL2(N,N5,N4)=VFLW*AZMAX1(ZALH2W2(1,N5,N4))
          RQSAL3(N,N5,N4)=VFLW*AZMAX1(ZALH3W2(1,N5,N4))
          RQSAL4(N,N5,N4)=VFLW*AZMAX1(ZALH4W2(1,N5,N4))
          RQSALS(N,N5,N4)=VFLW*AZMAX1(ZALSW2(1,N5,N4))
          RQSFE1(N,N5,N4)=VFLW*AZMAX1(ZFEH1W2(1,N5,N4))
          RQSFE2(N,N5,N4)=VFLW*AZMAX1(ZFEH2W2(1,N5,N4))
          RQSFE3(N,N5,N4)=VFLW*AZMAX1(ZFEH3W2(1,N5,N4))
          RQSFE4(N,N5,N4)=VFLW*AZMAX1(ZFEH4W2(1,N5,N4))
          RQSFES(N,N5,N4)=VFLW*AZMAX1(ZFESW2(1,N5,N4))
          RQSCAO(N,N5,N4)=VFLW*AZMAX1(ZCAOW2(1,N5,N4))
          RQSCAC(N,N5,N4)=VFLW*AZMAX1(ZCACW2(1,N5,N4))
          RQSCAH(N,N5,N4)=VFLW*AZMAX1(ZCAHW2(1,N5,N4))
          RQSCAS(N,N5,N4)=VFLW*AZMAX1(ZCASW2(1,N5,N4))
          RQSMGO(N,N5,N4)=VFLW*AZMAX1(ZMGOW2(1,N5,N4))
          RQSMGC(N,N5,N4)=VFLW*AZMAX1(ZMGCW2(1,N5,N4))
          RQSMGH(N,N5,N4)=VFLW*AZMAX1(ZMGHW2(1,N5,N4))
          RQSMGS(N,N5,N4)=VFLW*AZMAX1(ZMGSW2(1,N5,N4))
          RQSNAC(N,N5,N4)=VFLW*AZMAX1(ZNACW2(1,N5,N4))
          RQSNAS(N,N5,N4)=VFLW*AZMAX1(ZNASW2(1,N5,N4))
          RQSKAS(N,N5,N4)=VFLW*AZMAX1(ZKASW2(1,N5,N4))
          RQSH0P(N,N5,N4)=VFLW*AZMAX1(H0PO4W2(1,N5,N4))
          RQSH3P(N,N5,N4)=VFLW*AZMAX1(H3PO4W2(1,N5,N4))
          RQSF1P(N,N5,N4)=VFLW*AZMAX1(ZFE1PW2(1,N5,N4))
          RQSF2P(N,N5,N4)=VFLW*AZMAX1(ZFE2PW2(1,N5,N4))
          RQSC0P(N,N5,N4)=VFLW*AZMAX1(ZCA0PW2(1,N5,N4))
          RQSC1P(N,N5,N4)=VFLW*AZMAX1(ZCA1PW2(1,N5,N4))
          RQSC2P(N,N5,N4)=VFLW*AZMAX1(ZCA2PW2(1,N5,N4))
          RQSM1P(N,N5,N4)=VFLW*AZMAX1(ZMG1PW2(1,N5,N4))
        ENDIF
!
!     ACCUMULATE HOURLY FLUXES FOR USE IN REDIST.F
!
...
!
            ...
            RFLH0P=VFLW*AZMAX1(H0PO42(N3,N2,N1))*VLPO4(N3,N2,N1)
            RFLH3P=VFLW*AZMAX1(H3PO42(N3,N2,N1))*VLPO4(N3,N2,N1)
            RFLF1P=VFLW*AZMAX1(ZFE1P2(N3,N2,N1))*VLPO4(N3,N2,N1)
            RFLF2P=VFLW*AZMAX1(ZFE2P2(N3,N2,N1))*VLPO4(N3,N2,N1)
            RFLC0P=VFLW*AZMAX1(ZCA0P2(N3,N2,N1))*VLPO4(N3,N2,N1)
            RFLC1P=VFLW*AZMAX1(ZCA1P2(N3,N2,N1))*VLPO4(N3,N2,N1)
            RFLC2P=VFLW*AZMAX1(ZCA2P2(N3,N2,N1))*VLPO4(N3,N2,N1)
            RFLM1P=VFLW*AZMAX1(ZMG1P2(N3,N2,N1))*VLPO4(N3,N2,N1)
            RFLH0B=VFLW*AZMAX1(H0POB2(N3,N2,N1))*VLPOB(N3,N2,N1)
            RFLH3B=VFLW*AZMAX1(H3POB2(N3,N2,N1))*VLPOB(N3,N2,N1)
            RFLF1B=VFLW*AZMAX1(ZF1PB2(N3,N2,N1))*VLPOB(N3,N2,N1)
            RFLF2B=VFLW*AZMAX1(ZF2PB2(N3,N2,N1))*VLPOB(N3,N2,N1)
            RFLC0B=VFLW*AZMAX1(ZC0PB2(N3,N2,N1))*VLPOB(N3,N2,N1)
            RFLC1B=VFLW*AZMAX1(ZC1PB2(N3,N2,N1))*VLPOB(N3,N2,N1)
            RFLC2B=VFLW*AZMAX1(ZC2PB2(N3,N2,N1))*VLPOB(N3,N2,N1)
            RFLM1B=VFLW*AZMAX1(ZM1PB2(N3,N2,N1))*VLPOB(N3,N2,N1)
!
...
!
      ...
      VFLW=AZMAX1(AMIN1(VFLWX,FLWHM(M,N,N6,N5,N4) &
      /VOLWHM(M,N3,N2,N1)))
      ELSE
      VFLW=VFLWX
      ENDIF
...
!
      ...
      RFHNAS=VFLW*AZMAX1(ZNASH2(N3,N2,N1))
      RFHKAS=VFLW*AZMAX1(ZKASH2(N3,N2,N1))
      RFHH0P=VFLW*AZMAX1(H0P4H2(N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHH3P=VFLW*AZMAX1(H3P4H2(N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHF1P=VFLW*AZMAX1(ZF1PH2(N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHF2P=VFLW*AZMAX1(ZF2PH2(N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHC0P=VFLW*AZMAX1(ZC0PH2(N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHC1P=VFLW*AZMAX1(ZC1PH2(N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHC2P=VFLW*AZMAX1(ZC2PH2(N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHM1P=VFLW*AZMAX1(ZM1PH2(N3,N2,N1))*VLPO4(N6,N5,N4)
      RFHH0B=VFLW*AZMAX1(H0PBH2(N3,N2,N1))*VLPOB(N6,N5,N4)
      RFHH3B=VFLW*AZMAX1(H3PBH2(N3,N2,N1))*VLPOB(N6,N5,N4)
      RFHF1B=VFLW*AZMAX1(ZF1BH2(N3,N2,N1))*VLPOB(N6,N5,N4)
      RFHF2B=VFLW*AZMAX1(ZF2BH2(N3,N2,N1))*VLPOB(N6,N5,N4)
      RFHC0B=VFLW*AZMAX1(ZC0BH2(N3,N2,N1))*VLPOB(N6,N5,N4)
      RFHC1B=VFLW*AZMAX1(ZC1BH2(N3,N2,N1))*VLPOB(N6,N5,N4)
      RFHC2B=VFLW*AZMAX1(ZC2BH2(N3,N2,N1))*VLPOB(N6,N5,N4)
      RFHM1B=VFLW*AZMAX1(ZM1BH2(N3,N2,N1))*VLPOB(N6,N5,N4)
      ENDIF
...
!
      ...
      RFHH0P=VFLW*AZMAX1(H0P4H2(N6,N5,N4))*VLPO4(N6,N5,N4)
      RFHH3P=VFLW*AZMAX1(H3P4H2(N6,N5,N4))*VLPO4(N6,N5,N4)
      RFHF1P=VFLW*AZMAX1(ZF1PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
      RFHF2P=VFLW*AZMAX1(ZF2PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
      RFHC0P=VFLW*AZMAX1(ZC0PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
      RFHC1P=VFLW*AZMAX1(ZC1PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
      RFHC2P=VFLW*AZMAX1(ZC2PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
      RFHM1P=VFLW*AZMAX1(ZM1PH2(N6,N5,N4))*VLPO4(N6,N5,N4)
      RFHH0B=VFLW*AZMAX1(H0PBH2(N6,N5,N4))*VLPOB(N6,N5,N4)
      RFHH3B=VFLW*AZMAX1(H3PBH2(N6,N5,N4))*VLPOB(N6,N5,N4)
      RFHF1B=VFLW*AZMAX1(ZF1BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
      RFHF2B=VFLW*AZMAX1(ZF2BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
      RFHC0B=VFLW*AZMAX1(ZC0BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
      RFHC1B=VFLW*AZMAX1(ZC1BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
      RFHC2B=VFLW*AZMAX1(ZC2BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
      RFHM1B=VFLW*AZMAX1(ZM1BH2(N6,N5,N4))*VLPOB(N6,N5,N4)
!
!     NO MACROPORE FLUX
!
      ELSE
...
!
      ...
      VFLW=AZMAX1(AMIN1(VFLWX,FINHM(M,N6,N5,N4) &
      /VOLWHM(M,N6,N5,N4)))
      ELSE
      VFLW=VFLWX
      ENDIF
      ...
      RFLH0P=VFLW*AZMAX1(H0P4H2(N6,N5,N4)) &
      *VLPO4(N6,N5,N4)
      RFLH3P=VFLW*AZMAX1(H3P4H2(N6,N5,N4)) &
      *VLPO4(N6,N5,N4)
      RFLF1P=VFLW*AZMAX1(ZF1PH2(N6,N5,N4)) &
      *VLPO4(N6,N5,N4)
      RFLF2P=VFLW*AZMAX1(ZF2PH2(N6,N5,N4)) &
      *VLPO4(N6,N5,N4)
      RFLC0P=VFLW*AZMAX1(ZC0PH2(N6,N5,N4)) &
      *VLPO4(N6,N5,N4)
      RFLC1P=VFLW*AZMAX1(ZC1PH2(N6,N5,N4)) &
      *VLPO4(N6,N5,N4)
      RFLC2P=VFLW*AZMAX1(ZC2PH2(N6,N5,N4)) &
      *VLPO4(N6,N5,N4)
      RFLM1P=VFLW*AZMAX1(ZM1PH2(N6,N5,N4)) &
      *VLPO4(N6,N5,N4)
      RFLH0B=VFLW*AZMAX1(H0PBH2(N6,N5,N4)) &
      *VLPOB(N6,N5,N4)
      RFLH3B=VFLW*AZMAX1(H3PBH2(N6,N5,N4)) &
      *VLPOB(N6,N5,N4)
      RFLF1B=VFLW*AZMAX1(ZF1BH2(N6,N5,N4)) &
      *VLPOB(N6,N5,N4)
      RFLF2B=VFLW*AZMAX1(ZF2BH2(N6,N5,N4)) &
      *VLPOB(N6,N5,N4)
      RFLC0B=VFLW*AZMAX1(ZC0BH2(N6,N5,N4)) &
      *VLPOB(N6,N5,N4)
      RFLC1B=VFLW*AZMAX1(ZC1BH2(N6,N5,N4)) &
      *VLPOB(N6,N5,N4)
      RFLC2B=VFLW*AZMAX1(ZC2BH2(N6,N5,N4)) &
      *VLPOB(N6,N5,N4)
      RFLM1B=VFLW*AZMAX1(ZM1BH2(N6,N5,N4)) &
      *VLPOB(N6,N5,N4)
!
!     MICROPORE TO MACROPORE TRANSFER
!
...
!
      ...
      DFVAL=XNPH*(AZMAX1(ZALH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZAL2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVFE=XNPH*(AZMAX1(ZFEH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZFE2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVHY=XNPH*(AZMAX1(ZHYH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZHY2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVCA=XNPH*(AZMAX1(ZCCH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZCA2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVMG=XNPH*(AZMAX1(ZMAH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZMG2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVNA=XNPH*(AZMAX1(ZNAH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZNA2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVKA=XNPH*(AZMAX1(ZKAH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZKA2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVOH=XNPH*(AZMAX1(ZOHH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZOH2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVSO=XNPH*(AZMAX1(ZSO4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZSO42(N6,N5,N4))*VOLWHS)/VOLWT
      DFVCL=XNPH*(AZMAX1(ZCLH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZCL2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVC3=XNPH*(AZMAX1(ZCO3H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZCO32(N6,N5,N4))*VOLWHS)/VOLWT
      DFVHC=XNPH*(AZMAX1(ZHCOH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZHCO32(N6,N5,N4))*VOLWHS)/VOLWT
      DFVAL1=XNPH*(AZMAX1(ZAL1H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZAL12(N6,N5,N4))*VOLWHS)/VOLWT
      DFVAL2=XNPH*(AZMAX1(ZAL2H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZAL22(N6,N5,N4))*VOLWHS)/VOLWT
      DFVAL3=XNPH*(AZMAX1(ZAL3H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZAL32(N6,N5,N4))*VOLWHS)/VOLWT
      DFVAL4=XNPH*(AZMAX1(ZAL4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZAL42(N6,N5,N4))*VOLWHS)/VOLWT
      DFVALS=XNPH*(AZMAX1(ZALSH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZALS2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVFE1=XNPH*(AZMAX1(ZFE1H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZFE12(N6,N5,N4))*VOLWHS)/VOLWT
      DFVF22=XNPH*(AZMAX1(ZFE2H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZFE22(N6,N5,N4))*VOLWHS)/VOLWT
      DFVFE3=XNPH*(AZMAX1(ZFE3H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZFE32(N6,N5,N4))*VOLWHS)/VOLWT
      DFVFE4=XNPH*(AZMAX1(ZFE4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZFE42(N6,N5,N4))*VOLWHS)/VOLWT
      DFVFES=XNPH*(AZMAX1(ZFESH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZFES2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVCAO=XNPH*(AZMAX1(ZCAOH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZCAO2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVCAC=XNPH*(AZMAX1(ZCACH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZCAC2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVCAH=XNPH*(AZMAX1(ZCAHH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZCAH2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVCAS=XNPH*(AZMAX1(ZCASH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZCAS2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVMGO=XNPH*(AZMAX1(ZMGOH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZMGO2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVMGC=XNPH*(AZMAX1(ZMGCH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZMGC2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVMGH=XNPH*(AZMAX1(ZMGHH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZMGH2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVMGS=XNPH*(AZMAX1(ZMGSH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZMGS2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVNAC=XNPH*(AZMAX1(ZNACH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZNAC2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVNAS=XNPH*(AZMAX1(ZNASH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZNAS2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVKAS=XNPH*(AZMAX1(ZKASH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZKAS2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVNAC=XNPH*(AZMAX1(ZNACH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZNAC2(N6,N5,N4))*VOLWHS)/VOLWT
      DFVH0P=XNPH*(AZMAX1(H0P4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(H0PO42(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
      DFVH3P=XNPH*(AZMAX1(H3P4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(H3PO42(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
      DFVF1P=XNPH*(AZMAX1(ZF1PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZFE1P2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
      DFVF2P=XNPH*(AZMAX1(ZF2PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZFE2P2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
      DFVC0P=XNPH*(AZMAX1(ZC0PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZCA0P2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
      DFVC1P=XNPH*(AZMAX1(ZC1PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZCA1P2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
      DFVC2P=XNPH*(AZMAX1(ZC2PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZCA2P2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
      DFVM1P=XNPH*(AZMAX1(ZM1PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZMG1P2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPO4(N6,N5,N4)
      DFVH0B=XNPH*(AZMAX1(H0PBH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(H0POB2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
      DFVH3B=XNPH*(AZMAX1(H3PBH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(H3POB2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
      DFVF1B=XNPH*(AZMAX1(ZF1BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZF1PB2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
      DFVF2B=XNPH*(AZMAX1(ZF2BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZF2PB2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
      DFVC0B=XNPH*(AZMAX1(ZC0BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZC0PB2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
      DFVC1B=XNPH*(AZMAX1(ZC1BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZC1PB2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
      DFVC2B=XNPH*(AZMAX1(ZC2BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZC2PB2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
      DFVM1B=XNPH*(AZMAX1(ZM1BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4) &
      -AZMAX1(ZM1PB2(N6,N5,N4))*VOLWHS)/VOLWT &
      *VLPOB(N6,N5,N4)
      ELSE
      DFVAL=0.0_r8
      DFVFE=0.0_r8
