...
!
  ...
  trcsa_XFLS(idsa_H0PO4B,N,N6,N5,N4)=trcsa_XFLS(idsa_H0PO4B,N,N6,N5,N4)+RH0BFB(N,N6,N5,N4)
  trcsa_XFLS(idsa_H3PO4B,N,N6,N5,N4)=trcsa_XFLS(idsa_H3PO4B,N,N6,N5,N4)+RH3BFB(N,N6,N5,N4)
  trcsa_XFLS(idsa_FeHPO4B,N,N6,N5,N4)=trcsa_XFLS(idsa_FeHPO4B,N,N6,N5,N4)+RF1BFB(N,N6,N5,N4)
  trcsa_XFLS(idsa_FeH2PO4B,N,N6,N5,N4)=trcsa_XFLS(idsa_FeH2PO4B,N,N6,N5,N4)+RF2BFB(N,N6,N5,N4)
  trcsa_XFLS(idsa_CaPO4B,N,N6,N5,N4)=trcsa_XFLS(idsa_CaPO4B,N,N6,N5,N4)+RC0BFB(N,N6,N5,N4)
  trcsa_XFLS(idsa_CaHPO4B,N,N6,N5,N4)=trcsa_XFLS(idsa_CaHPO4B,N,N6,N5,N4)+RC1BFB(N,N6,N5,N4)
  trcsa_XFLS(idsa_CaH2PO4B,N,N6,N5,N4)=trcsa_XFLS(idsa_CaH2PO4B,N,N6,N5,N4)+RC2BFB(N,N6,N5,N4)
  trcsa_XFLS(idsa_MgHPO4B,N,N6,N5,N4)=trcsa_XFLS(idsa_MgHPO4B,N,N6,N5,N4)+RM1BFB(N,N6,N5,N4)
