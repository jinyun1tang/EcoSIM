...
!
  DO L=NU(NY,NX),NL(NY,NX)
    trcsa_solml2(idsa_Al,L,NY,NX)=trcsa_solml2(idsa_Al,L,NY,NX)-trcsa_solml2R(idsa_Al,L,NY,NX)
    trcsa_solml2(idsa_Fe,L,NY,NX)=trcsa_solml2(idsa_Fe,L,NY,NX)-trcsa_solml2R(idsa_Fe,L,NY,NX)
    trcsa_solml2(idsa_Hp,L,NY,NX)=trcsa_solml2(idsa_Hp,L,NY,NX)-trcsa_solml2R(idsa_Hp,L,NY,NX)
    trcsa_solml2(idsa_Ca,L,NY,NX)=trcsa_solml2(idsa_Ca,L,NY,NX)-trcsa_solml2R(idsa_Ca,L,NY,NX)
    trcsa_solml2(idsa_Mg,L,NY,NX)=trcsa_solml2(idsa_Mg,L,NY,NX)-trcsa_solml2R(idsa_Mg,L,NY,NX)
    trcsa_solml2(idsa_Na,L,NY,NX)=trcsa_solml2(idsa_Na,L,NY,NX)-trcsa_solml2R(idsa_Na,L,NY,NX)
    trcsa_solml2(idsa_K,L,NY,NX)=trcsa_solml2(idsa_K,L,NY,NX)-trcsa_solml2R(idsa_K,L,NY,NX)
    trcsa_solml2(idsa_OH,L,NY,NX)=trcsa_solml2(idsa_OH,L,NY,NX)-trcsa_solml2R(idsa_OH,L,NY,NX)
    trcsa_solml2(idsa_SO4,L,NY,NX)=trcsa_solml2(idsa_SO4,L,NY,NX)-trcsa_solml2R(idsa_SO4,L,NY,NX)
    trcsa_solml2(idsa_Cl,L,NY,NX)=trcsa_solml2(idsa_Cl,L,NY,NX)-trcsa_solml2R(idsa_Cl,L,NY,NX)
    trcsa_solml2(idsa_CO3,L,NY,NX)=trcsa_solml2(idsa_CO3,L,NY,NX)-trcsa_solml2R(idsa_CO3,L,NY,NX)
    trcsa_solml2(idsa_HCO3,L,NY,NX)=trcsa_solml2(idsa_HCO3,L,NY,NX)-trcsa_solml2R(idsa_HCO3,L,NY,NX)
    trcsa_solml2(idsa_AlOH,L,NY,NX)=trcsa_solml2(idsa_AlOH,L,NY,NX)-trcsa_solml2R(idsa_AlOH,L,NY,NX)
    trcsa_solml2(idsa_AlOH2,L,NY,NX)=trcsa_solml2(idsa_AlOH2,L,NY,NX)-trcsa_solml2R(idsa_AlOH2,L,NY,NX)
    trcsa_solml2(idsa_AlOH3,L,NY,NX)=trcsa_solml2(idsa_AlOH3,L,NY,NX)-trcsa_solml2R(idsa_AlOH3,L,NY,NX)
    trcsa_solml2(idsa_AlOH4,L,NY,NX)=trcsa_solml2(idsa_AlOH4,L,NY,NX)-trcsa_solml2R(idsa_AlOH4,L,NY,NX)
    trcsa_solml2(idsa_AlSO4,L,NY,NX)=trcsa_solml2(idsa_AlSO4,L,NY,NX)-trcsa_solml2R(idsa_AlSO4,L,NY,NX)
    trcsa_solml2(idsa_FeOH,L,NY,NX)=trcsa_solml2(idsa_FeOH,L,NY,NX)-trcsa_solml2R(idsa_FeOH,L,NY,NX)
    trcsa_solml2(idsa_FeOH2,L,NY,NX)=trcsa_solml2(idsa_FeOH2,L,NY,NX)-trcsa_solml2R(idsa_FeOH2,L,NY,NX)
    trcsa_solml2(idsa_FeOH3,L,NY,NX)=trcsa_solml2(idsa_FeOH3,L,NY,NX)-trcsa_solml2R(idsa_FeOH3,L,NY,NX)
    trcsa_solml2(idsa_FeOH4,L,NY,NX)=trcsa_solml2(idsa_FeOH4,L,NY,NX)-trcsa_solml2R(idsa_FeOH4,L,NY,NX)
    trcsa_solml2(idsa_FeSO4,L,NY,NX)=trcsa_solml2(idsa_FeSO4,L,NY,NX)-trcsa_solml2R(idsa_FeSO4,L,NY,NX)
    trcsa_solml2(idsa_CaOH2,L,NY,NX)=trcsa_solml2(idsa_CaOH2,L,NY,NX)-trcsa_solml2R(idsa_CaOH2,L,NY,NX)
    trcsa_solml2(idsa_CaCO3,L,NY,NX)=trcsa_solml2(idsa_CaCO3,L,NY,NX)-trcsa_solml2R(idsa_CaCO3,L,NY,NX)
    trcsa_solml2(idsa_CaHCO3,L,NY,NX)=trcsa_solml2(idsa_CaHCO3,L,NY,NX)-trcsa_solml2R(idsa_CaHCO3,L,NY,NX)
    trcsa_solml2(idsa_CaSO4,L,NY,NX)=trcsa_solml2(idsa_CaSO4,L,NY,NX)-trcsa_solml2R(idsa_CaSO4,L,NY,NX)
    trcsa_solml2(idsa_MgOH2,L,NY,NX)=trcsa_solml2(idsa_MgOH2,L,NY,NX)-trcsa_solml2R(idsa_MgOH2,L,NY,NX)
    trcsa_solml2(idsa_MgCO3,L,NY,NX)=trcsa_solml2(idsa_MgCO3,L,NY,NX)-trcsa_solml2R(idsa_MgCO3,L,NY,NX)
    trcsa_solml2(idsa_MgHCO3,L,NY,NX)=trcsa_solml2(idsa_MgHCO3,L,NY,NX)-trcsa_solml2R(idsa_MgHCO3,L,NY,NX)
    trcsa_solml2(idsa_MgSO4,L,NY,NX)=trcsa_solml2(idsa_MgSO4,L,NY,NX)-trcsa_solml2R(idsa_MgSO4,L,NY,NX)
    trcsa_solml2(idsa_NaCO3,L,NY,NX)=trcsa_solml2(idsa_NaCO3,L,NY,NX)-trcsa_solml2R(idsa_NaCO3,L,NY,NX)
    trcsa_solml2(idsa_NaSO4,L,NY,NX)=trcsa_solml2(idsa_NaSO4,L,NY,NX)-trcsa_solml2R(idsa_NaSO4,L,NY,NX)
    trcsa_solml2(idsa_KSO4,L,NY,NX)=trcsa_solml2(idsa_KSO4,L,NY,NX)-trcsa_solml2R(idsa_KSO4,L,NY,NX)
    trcsa_solml2(idsa_H0PO4,L,NY,NX)=trcsa_solml2(idsa_H0PO4,L,NY,NX)-trcsa_solml2R(idsa_H0PO4,L,NY,NX)
    trcsa_solml2(idsa_H3PO4,L,NY,NX)=trcsa_solml2(idsa_H3PO4,L,NY,NX)-trcsa_solml2R(idsa_H3PO4,L,NY,NX)
    trcsa_solml2(idsa_FeHPO4,L,NY,NX)=trcsa_solml2(idsa_FeHPO4,L,NY,NX)-trcsa_solml2R(idsa_FeHPO4,L,NY,NX)
    trcsa_solml2(idsa_FeH2PO4,L,NY,NX)=trcsa_solml2(idsa_FeH2PO4,L,NY,NX)-trcsa_solml2R(idsa_FeH2PO4,L,NY,NX)
    trcsa_solml2(idsa_CaPO4,L,NY,NX)=trcsa_solml2(idsa_CaPO4,L,NY,NX)-trcsa_solml2R(idsa_CaPO4,L,NY,NX)
    trcsa_solml2(idsa_CaHPO4,L,NY,NX)=trcsa_solml2(idsa_CaHPO4,L,NY,NX)-trcsa_solml2R(idsa_CaHPO4,L,NY,NX)
    trcsa_solml2(idsa_CaH2PO4,L,NY,NX)=trcsa_solml2(idsa_CaH2PO4,L,NY,NX)-trcsa_solml2R(idsa_CaH2PO4,L,NY,NX)
    trcsa_solml2(idsa_MgHPO4,L,NY,NX)=trcsa_solml2(idsa_MgHPO4,L,NY,NX)-trcsa_solml2R(idsa_MgHPO4,L,NY,NX)
    trcsa_solml2(idsa_H0PO4B,L,NY,NX)=trcsa_solml2(idsa_H0PO4B,L,NY,NX)-trcsa_solml2R(idsa_H0PO4B,L,NY,NX)
    trcsa_solml2(idsa_H3PO4B,L,NY,NX)=trcsa_solml2(idsa_H3PO4B,L,NY,NX)-trcsa_solml2R(idsa_H3PO4B,L,NY,NX)
    trcsa_solml2(idsa_FeHPO4B,L,NY,NX)=trcsa_solml2(idsa_FeHPO4B,L,NY,NX)-trcsa_solml2R(idsa_FeHPO4B,L,NY,NX)
    trcsa_solml2(idsa_FeH2PO4B,L,NY,NX)=trcsa_solml2(idsa_FeH2PO4B,L,NY,NX)-trcsa_solml2R(idsa_FeH2PO4B,L,NY,NX)
    trcsa_solml2(idsa_CaPO4B,L,NY,NX)=trcsa_solml2(idsa_CaPO4B,L,NY,NX)-trcsa_solml2R(idsa_CaPO4B,L,NY,NX)
    trcsa_solml2(idsa_CaHPO4B,L,NY,NX)=trcsa_solml2(idsa_CaHPO4B,L,NY,NX)-trcsa_solml2R(idsa_CaHPO4B,L,NY,NX)
    trcsa_solml2(idsa_CaH2PO4B,L,NY,NX)=trcsa_solml2(idsa_CaH2PO4B,L,NY,NX)-trcsa_solml2R(idsa_CaH2PO4B,L,NY,NX)
    trcsa_solml2(idsa_MgHPO4B,L,NY,NX)=trcsa_solml2(idsa_MgHPO4B,L,NY,NX)-trcsa_solml2R(idsa_MgHPO4B,L,NY,NX)
  ENDDO
...
!
  ...
  RFLH0B=VFLW*AZMAX1(trcsa_solml2(idsa_H0PO4,0,NY,NX))*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  RFLH3B=VFLW*AZMAX1(trcsa_solml2(idsa_H3PO4,0,NY,NX))*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  RFLF1B=VFLW*AZMAX1(trcsa_solml2(idsa_FeHPO4,0,NY,NX))*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  RFLF2B=VFLW*AZMAX1(trcsa_solml2(idsa_FeH2PO4,0,NY,NX))*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  RFLC0B=VFLW*AZMAX1(trcsa_solml2(idsa_CaPO4,0,NY,NX))*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  RFLC1B=VFLW*AZMAX1(trcsa_solml2(idsa_CaHPO4,0,NY,NX))*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  RFLC2B=VFLW*AZMAX1(trcsa_solml2(idsa_CaH2PO4,0,NY,NX))*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  RFLM1B=VFLW*AZMAX1(trcsa_solml2(idsa_MgHPO4,0,NY,NX))*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
...
!
  trcsa_RFLS(idsa_Al,3,0,NY,NX)=RALFL0(NY,NX)+RALFLS0-RFLAL-DFVAL
  trcsa_RFLS(idsa_Fe,3,0,NY,NX)=RFEFL0(NY,NX)+RFEFLS0-RFLFE-DFVFE
  trcsa_RFLS(idsa_Hp,3,0,NY,NX)=RHYFL0(NY,NX)+RHYFLS0-RFLHY-DFVHY
  trcsa_RFLS(idsa_Ca,3,0,NY,NX)=RCAFL0(NY,NX)+RCAFLS0-RFLCA-DFVCA
  trcsa_RFLS(idsa_Mg,3,0,NY,NX)=RMGFL0(NY,NX)+RMGFLS0-RFLMG-DFVMG
  trcsa_RFLS(idsa_Na,3,0,NY,NX)=RNAFL0(NY,NX)+RNAFLS0-RFLNA-DFVNA
  trcsa_RFLS(idsa_K,3,0,NY,NX)=RKAFL0(NY,NX)+RKAFLS0-RFLKA-DFVKA
  trcsa_RFLS(idsa_OH,3,0,NY,NX)=ROHFL0(NY,NX)+ROHFLS0-RFLOH-DFVOH
  trcsa_RFLS(idsa_SO4,3,0,NY,NX)=RSOFL0(NY,NX)+RSOFLS0-RFLSO-DFVSO
  trcsa_RFLS(idsa_Cl,3,0,NY,NX)=RCLFL0(NY,NX)+RCLFLS0-RFLCL-DFVCL
  trcsa_RFLS(idsa_CO3,3,0,NY,NX)=RC3FL0(NY,NX)+RC3FLS0-RFLC3-DFVC3
  trcsa_RFLS(idsa_HCO3,3,0,NY,NX)=RHCFL0(NY,NX)+RHCFLS0-RFLHC-DFVHC
  trcsa_RFLS(idsa_AlOH,3,0,NY,NX)=RAL1F0(NY,NX)+RAL1FS0-RFLAL1-DFVAL1
  trcsa_RFLS(idsa_AlOH2,3,0,NY,NX)=RAL2F0(NY,NX)+RAL2FS0-RFLAL2-DFVAL2
  trcsa_RFLS(idsa_AlOH3,3,0,NY,NX)=RAL3F0(NY,NX)+RAL3FS0-RFLAL3-DFVAL3
  trcsa_RFLS(idsa_AlOH4,3,0,NY,NX)=RAL4F0(NY,NX)+RAL4FS0-RFLAL4-DFVAL4
  trcsa_RFLS(idsa_AlSO4,3,0,NY,NX)=RALSF0(NY,NX)+RALSFS0-RFLALS-DFVALS
  trcsa_RFLS(idsa_FeOH,3,0,NY,NX)=RFE1F0(NY,NX)+RFE1FS0-RFLFE1-DFVFE1
  trcsa_RFLS(idsa_FeOH2,3,0,NY,NX)=RFE2F0(NY,NX)+RFE2FS0-RFLFE2-DFVFE2
  trcsa_RFLS(idsa_FeOH3,3,0,NY,NX)=RFE3F0(NY,NX)+RFE3FS0-RFLFE3-DFVFE3
  trcsa_RFLS(idsa_FeOH4,3,0,NY,NX)=RFE4F0(NY,NX)+RFE4FS0-RFLFE4-DFVFE4
  trcsa_RFLS(idsa_FeSO4,3,0,NY,NX)=RFESF0(NY,NX)+RFESFS0-RFLFES-DFVFES
  trcsa_RFLS(idsa_CaOH2,3,0,NY,NX)=RCAOF0(NY,NX)+RCAOFS0-RFLCAO-DFVCAO
  trcsa_RFLS(idsa_CaCO3,3,0,NY,NX)=RCACF0(NY,NX)+RCACFS0-RFLCAC-DFVCAC
  trcsa_RFLS(idsa_CaHCO3,3,0,NY,NX)=RCAHF0(NY,NX)+RCAHFS0-RFLCAH-DFVCAH
  trcsa_RFLS(idsa_CaSO4,3,0,NY,NX)=RCASF0(NY,NX)+RCASFS0-RFLCAS-DFVCAS
  trcsa_RFLS(idsa_MgOH2,3,0,NY,NX)=RMGOF0(NY,NX)+RMGOFS0-RFLMGO-DFVMGO
  trcsa_RFLS(idsa_MgCO3,3,0,NY,NX)=RMGCF0(NY,NX)+RMGCFS0-RFLMGC-DFVMGC
  trcsa_RFLS(idsa_MgHCO3,3,0,NY,NX)=RMGHF0(NY,NX)+RMGHFS0-RFLMGH-DFVMGH
  trcsa_RFLS(idsa_MgSO4,3,0,NY,NX)=RMGSF0(NY,NX)+RMGSFS0-RFLMGS-DFVMGS
  trcsa_RFLS(idsa_NaCO3,3,0,NY,NX)=RNACF0(NY,NX)+RNACFS0-RFLNAC-DFVNAC
  trcsa_RFLS(idsa_NaSO4,3,0,NY,NX)=RNASF0(NY,NX)+RNASFS0-RFLNAS-DFVNAS
  trcsa_RFLS(idsa_KSO4,3,0,NY,NX)=RKASF0(NY,NX)+RKASFS0-RFLKAS-DFVKAS
  trcsa_RFLS(idsa_H0PO4,3,0,NY,NX)=RH0PF0(NY,NX)+RH0PFS0-RFLH0P-DFVH0P-RFLH0B-DFVH0B
  trcsa_RFLS(idsa_H3PO4,3,0,NY,NX)=RH3PF0(NY,NX)+RH3PFS0-RFLH3P-DFVH3P-RFLH3B-DFVH3B
  trcsa_RFLS(idsa_FeHPO4,3,0,NY,NX)=RF1PF0(NY,NX)+RF1PFS0-RFLF1P-DFVF1P-RFLF1B-DFVF1B
  trcsa_RFLS(idsa_FeH2PO4,3,0,NY,NX)=RF2PF0(NY,NX)+RF2PFS0-RFLF2P-DFVF2P-RFLF2B-DFVF2B
  trcsa_RFLS(idsa_CaPO4,3,0,NY,NX)=RC0PF0(NY,NX)+RC0PFS0-RFLC0P-DFVC0P-RFLC0B-DFVC0B
  trcsa_RFLS(idsa_CaHPO4,3,0,NY,NX)=RC1PF0(NY,NX)+RC1PFS0-RFLC1P-DFVC1P-RFLC1B-DFVC1B
  trcsa_RFLS(idsa_CaH2PO4,3,0,NY,NX)=RC2PF0(NY,NX)+RC2PFS0-RFLC2P-DFVC2P-RFLC2B-DFVC2B
  trcsa_RFLS(idsa_MgHPO4,3,0,NY,NX)=RM1PF0(NY,NX)+RM1PFS0-RFLM1P-DFVM1P-RFLM1B-DFVM1B
...
!     *H2,*2=macropore,micropore solute content
  ...
  DFVAL=XNPH*(AZMAX1(ZALH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_Al,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVFE=XNPH*(AZMAX1(ZFEH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_Fe,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVHY=XNPH*(AZMAX1(ZHYH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_Hp,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCA=XNPH*(AZMAX1(ZCCH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_Ca,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVMG=XNPH*(AZMAX1(ZMAH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_Mg,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVNA=XNPH*(AZMAX1(ZNAH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_Na,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVKA=XNPH*(AZMAX1(ZKAH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_K,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVOH=XNPH*(AZMAX1(ZOHH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_OH,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVSO=XNPH*(AZMAX1(ZSO4H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_SO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCL=XNPH*(AZMAX1(ZCLH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_Cl,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVC3=XNPH*(AZMAX1(ZCO3H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CO3,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVHC=XNPH*(AZMAX1(ZHCOH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_HCO3,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVAL1=XNPH*(AZMAX1(ZAL1H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_AlOH,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVAL2=XNPH*(AZMAX1(ZAL2H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_AlOH2,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVAL3=XNPH*(AZMAX1(ZAL3H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_AlOH3,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVAL4=XNPH*(AZMAX1(ZAL4H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_AlOH4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVALS=XNPH*(AZMAX1(ZALSH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_AlSO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVFE1=XNPH*(AZMAX1(ZFE1H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_FeOH,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVF22=XNPH*(AZMAX1(ZFE2H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_FeOH2,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVFE3=XNPH*(AZMAX1(ZFE3H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_FeOH3,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVFE4=XNPH*(AZMAX1(ZFE4H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_FeOH4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVFES=XNPH*(AZMAX1(ZFESH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_FeSO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCAO=XNPH*(AZMAX1(ZCAOH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CaOH2,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCAC=XNPH*(AZMAX1(ZCACH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CaCO3,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCAH=XNPH*(AZMAX1(ZCAHH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CaHCO3,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVCAS=XNPH*(AZMAX1(ZCASH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CaSO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVMGO=XNPH*(AZMAX1(ZMGOH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_MgOH2,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVMGC=XNPH*(AZMAX1(ZMGCH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_MgCO3,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVMGH=XNPH*(AZMAX1(ZMGHH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_MgHCO3,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVMGS=XNPH*(AZMAX1(ZMGSH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_MgSO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVNAC=XNPH*(AZMAX1(ZNACH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_NaCO3,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVNAS=XNPH*(AZMAX1(ZNASH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_NaSO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVKAS=XNPH*(AZMAX1(ZKASH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_KSO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVNAC=XNPH*(AZMAX1(ZNACH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_NaCO3,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT
  DFVH0P=XNPH*(AZMAX1(H0P4H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_H0PO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,NU(NY,NX),NY,NX)
  DFVH3P=XNPH*(AZMAX1(H3P4H2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_H3PO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,NU(NY,NX),NY,NX)
  DFVF1P=XNPH*(AZMAX1(ZF1PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_FeHPO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,NU(NY,NX),NY,NX)
  DFVF2P=XNPH*(AZMAX1(ZF2PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_FeH2PO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,NU(NY,NX),NY,NX)
  DFVC0P=XNPH*(AZMAX1(ZC0PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CaPO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,NU(NY,NX),NY,NX)
  DFVC1P=XNPH*(AZMAX1(ZC1PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CaHPO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,NU(NY,NX),NY,NX)
  DFVC2P=XNPH*(AZMAX1(ZC2PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CaH2PO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,NU(NY,NX),NY,NX)
  DFVM1P=XNPH*(AZMAX1(ZM1PH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_MgHPO4,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,NU(NY,NX),NY,NX)
  DFVH0B=XNPH*(AZMAX1(H0PBH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_H0PO4B,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  DFVH3B=XNPH*(AZMAX1(H3PBH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_H3PO4B,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  DFVF1B=XNPH*(AZMAX1(ZF1BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_FeHPO4B,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  DFVF2B=XNPH*(AZMAX1(ZF2BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_FeH2PO4B,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  DFVC0B=XNPH*(AZMAX1(ZC0BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CaPO4B,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  DFVC1B=XNPH*(AZMAX1(ZC1BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CaHPO4B,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  DFVC2B=XNPH*(AZMAX1(ZC2BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_CaH2PO4B,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
  DFVM1B=XNPH*(AZMAX1(ZM1BH2(NU(NY,NX),NY,NX))*VOLWMNU-AZMAX1(trcsa_solml2(idsa_MgHPO4B,NU(NY,NX),NY,NX))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,NU(NY,NX),NY,NX)
...
!          :*1=non-band,*B=band
!
  trcsa_XFXS(idsa_Al,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_Al,NU(NY,NX),NY,NX)+RALFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_Fe,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_Fe,NU(NY,NX),NY,NX)+RFEFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_Hp,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_Hp,NU(NY,NX),NY,NX)+RHYFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_Ca,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_Ca,NU(NY,NX),NY,NX)+RCAFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_Mg,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_Mg,NU(NY,NX),NY,NX)+RMGFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_Na,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_Na,NU(NY,NX),NY,NX)+RNAFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_K,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_K,NU(NY,NX),NY,NX)+RKAFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_OH,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_OH,NU(NY,NX),NY,NX)+ROHFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_SO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_SO4,NU(NY,NX),NY,NX)+RSOFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_Cl,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_Cl,NU(NY,NX),NY,NX)+RCLFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CO3,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CO3,NU(NY,NX),NY,NX)+RC3FXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_HCO3,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_HCO3,NU(NY,NX),NY,NX)+RHCFXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_AlOH,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_AlOH,NU(NY,NX),NY,NX)+RAL1XS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_AlOH2,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_AlOH2,NU(NY,NX),NY,NX)+RAL2XS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_AlOH3,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_AlOH3,NU(NY,NX),NY,NX)+RAL3XS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_AlOH4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_AlOH4,NU(NY,NX),NY,NX)+RAL4XS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_AlSO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_AlSO4,NU(NY,NX),NY,NX)+RALSXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_FeOH,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_FeOH,NU(NY,NX),NY,NX)+RFE1XS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_FeOH2,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_FeOH2,NU(NY,NX),NY,NX)+RFE2XS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_FeOH3,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_FeOH3,NU(NY,NX),NY,NX)+RFE3XS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_FeOH4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_FeOH4,NU(NY,NX),NY,NX)+RFE4XS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_FeSO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_FeSO4,NU(NY,NX),NY,NX)+RFESXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CaOH2,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CaOH2,NU(NY,NX),NY,NX)+RCAOXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CaCO3,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CaCO3,NU(NY,NX),NY,NX)+RCACXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CaHCO3,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CaHCO3,NU(NY,NX),NY,NX)+RCAHXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CaSO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CaSO4,NU(NY,NX),NY,NX)+RCASXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_MgOH2,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_MgOH2,NU(NY,NX),NY,NX)+RMGOXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_MgCO3,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_MgCO3,NU(NY,NX),NY,NX)+RMGCXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_MgHCO3,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_MgHCO3,NU(NY,NX),NY,NX)+RMGHXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_MgSO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_MgSO4,NU(NY,NX),NY,NX)+RMGSXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_NaCO3,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_NaCO3,NU(NY,NX),NY,NX)+RNACXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_NaSO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_NaSO4,NU(NY,NX),NY,NX)+RNASXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_KSO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_KSO4,NU(NY,NX),NY,NX)+RKASXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_H0PO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_H0PO4,NU(NY,NX),NY,NX)+RH0PXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_H3PO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_H3PO4,NU(NY,NX),NY,NX)+RH3PXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_FeHPO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_FeHPO4,NU(NY,NX),NY,NX)+RF1PXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_FeH2PO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_FeH2PO4,NU(NY,NX),NY,NX)+RF2PXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CaPO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CaPO4,NU(NY,NX),NY,NX)+RC0PXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CaHPO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CaHPO4,NU(NY,NX),NY,NX)+RC1PXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CaH2PO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CaH2PO4,NU(NY,NX),NY,NX)+RC2PXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_MgHPO4,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_MgHPO4,NU(NY,NX),NY,NX)+RM1PXS(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_H0PO4B,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_H0PO4B,NU(NY,NX),NY,NX)+RH0BXB(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_H3PO4B,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_H3PO4B,NU(NY,NX),NY,NX)+RH3BXB(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_FeHPO4B,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_FeHPO4B,NU(NY,NX),NY,NX)+RF1BXB(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_FeH2PO4B,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_FeH2PO4B,NU(NY,NX),NY,NX)+RF2BXB(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CaPO4B,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CaPO4B,NU(NY,NX),NY,NX)+RC0BXB(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CaHPO4B,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CaHPO4B,NU(NY,NX),NY,NX)+RC1BXB(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_CaH2PO4B,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_CaH2PO4B,NU(NY,NX),NY,NX)+RC2BXB(NU(NY,NX),NY,NX)
  trcsa_XFXS(idsa_MgHPO4B,NU(NY,NX),NY,NX)=trcsa_XFXS(idsa_MgHPO4B,NU(NY,NX),NY,NX)+RM1BXB(NU(NY,NX),NY,NX)
...
!     begin_execution
  ...
  ELSE
    VFLW=VFLWX
  ENDIF
  RQRAL0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_Al,0,N2,N1))
  RQRFE0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_Fe,0,N2,N1))
  RQRHY0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_Hp,0,N2,N1))
  RQRCA0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_Ca,0,N2,N1))
  RQRMG0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_Mg,0,N2,N1))
  RQRNA0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_Na,0,N2,N1))
  RQRKA0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_K,0,N2,N1))
  RQROH0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_OH,0,N2,N1))
  RQRSO0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_SO4,0,N2,N1))
  RQRCL0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_Cl,0,N2,N1))
  RQRC30(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_CO3,0,N2,N1))
  RQRHC0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_HCO3,0,N2,N1))
  RQRAL10(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_AlOH,0,N2,N1))
  RQRAL20(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_AlOH2,0,N2,N1))
  RQRAL30(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_AlOH3,0,N2,N1))
  RQRAL40(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_AlOH4,0,N2,N1))
  RQRALS0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_AlSO4,0,N2,N1))
  RQRFE10(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_FeOH,0,N2,N1))
  RQRFE20(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_FeOH2,0,N2,N1))
  RQRFE30(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_FeOH3,0,N2,N1))
  RQRFE40(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_FeOH4,0,N2,N1))
  RQRFES0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_FeSO4,0,N2,N1))
  RQRCAO0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_CaOH2,0,N2,N1))
  RQRCAC0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_CaCO3,0,N2,N1))
  RQRCAH0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_CaHCO3,0,N2,N1))
  RQRCAS0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_CaSO4,0,N2,N1))
  RQRMGO0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_MgOH2,0,N2,N1))
  RQRMGC0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_MgCO3,0,N2,N1))
  RQRMGH0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_MgHCO3,0,N2,N1))
  RQRMGS0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_MgSO4,0,N2,N1))
  RQRNAC0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_NaCO3,0,N2,N1))
  RQRNAS0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_NaSO4,0,N2,N1))
  RQRKAS0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_KSO4,0,N2,N1))
  RQRH0P0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_H0PO4,0,N2,N1))
  RQRH3P0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_H3PO4,0,N2,N1))
  RQRF1P0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_FeHPO4,0,N2,N1))
  RQRF2P0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_FeH2PO4,0,N2,N1))
  RQRC0P0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_CaPO4,0,N2,N1))
  RQRC1P0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_CaHPO4,0,N2,N1))
  RQRC2P0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_CaH2PO4,0,N2,N1))
  RQRM1P0(N2,N1)=VFLW*AZMAX1(trcsa_solml2(idsa_MgHPO4,0,N2,N1))
...
!
  IF(VOLWHM(M,N6,N5,N4).GT.ZEROS2(NY,NX))THEN
    ...
    DFVAL=XNPH*(AZMAX1(ZALH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_Al,N6,N5,N4))*VOLWHS)/VOLWT
    DFVFE=XNPH*(AZMAX1(ZFEH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_Fe,N6,N5,N4))*VOLWHS)/VOLWT
    DFVHY=XNPH*(AZMAX1(ZHYH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_Hp,N6,N5,N4))*VOLWHS)/VOLWT
    DFVCA=XNPH*(AZMAX1(ZCCH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_Ca,N6,N5,N4))*VOLWHS)/VOLWT
    DFVMG=XNPH*(AZMAX1(ZMAH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_Mg,N6,N5,N4))*VOLWHS)/VOLWT
    DFVNA=XNPH*(AZMAX1(ZNAH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_Na,N6,N5,N4))*VOLWHS)/VOLWT
    DFVKA=XNPH*(AZMAX1(ZKAH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_K,N6,N5,N4))*VOLWHS)/VOLWT
    DFVOH=XNPH*(AZMAX1(ZOHH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_OH,N6,N5,N4))*VOLWHS)/VOLWT
    DFVSO=XNPH*(AZMAX1(ZSO4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_SO4,N6,N5,N4))*VOLWHS)/VOLWT
    DFVCL=XNPH*(AZMAX1(ZCLH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_Cl,N6,N5,N4))*VOLWHS)/VOLWT
    DFVC3=XNPH*(AZMAX1(ZCO3H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CO3,N6,N5,N4))*VOLWHS)/VOLWT
    DFVHC=XNPH*(AZMAX1(ZHCOH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_HCO3,N6,N5,N4))*VOLWHS)/VOLWT
    DFVAL1=XNPH*(AZMAX1(ZAL1H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_AlOH,N6,N5,N4))*VOLWHS)/VOLWT
    DFVAL2=XNPH*(AZMAX1(ZAL2H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_AlOH2,N6,N5,N4))*VOLWHS)/VOLWT
    DFVAL3=XNPH*(AZMAX1(ZAL3H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_AlOH3,N6,N5,N4))*VOLWHS)/VOLWT
    DFVAL4=XNPH*(AZMAX1(ZAL4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_AlOH4,N6,N5,N4))*VOLWHS)/VOLWT
    DFVALS=XNPH*(AZMAX1(ZALSH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_AlSO4,N6,N5,N4))*VOLWHS)/VOLWT
    DFVFE1=XNPH*(AZMAX1(ZFE1H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_FeOH,N6,N5,N4))*VOLWHS)/VOLWT
    DFVF22=XNPH*(AZMAX1(ZFE2H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_FeOH2,N6,N5,N4))*VOLWHS)/VOLWT
    DFVFE3=XNPH*(AZMAX1(ZFE3H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_FeOH3,N6,N5,N4))*VOLWHS)/VOLWT
    DFVFE4=XNPH*(AZMAX1(ZFE4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_FeOH4,N6,N5,N4))*VOLWHS)/VOLWT
    DFVFES=XNPH*(AZMAX1(ZFESH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_FeSO4,N6,N5,N4))*VOLWHS)/VOLWT
    DFVCAO=XNPH*(AZMAX1(ZCAOH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CaOH2,N6,N5,N4))*VOLWHS)/VOLWT
    DFVCAC=XNPH*(AZMAX1(ZCACH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CaCO3,N6,N5,N4))*VOLWHS)/VOLWT
    DFVCAH=XNPH*(AZMAX1(ZCAHH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CaHCO3,N6,N5,N4))*VOLWHS)/VOLWT
    DFVCAS=XNPH*(AZMAX1(ZCASH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CaSO4,N6,N5,N4))*VOLWHS)/VOLWT
    DFVMGO=XNPH*(AZMAX1(ZMGOH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_MgOH2,N6,N5,N4))*VOLWHS)/VOLWT
    DFVMGC=XNPH*(AZMAX1(ZMGCH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_MgCO3,N6,N5,N4))*VOLWHS)/VOLWT
    DFVMGH=XNPH*(AZMAX1(ZMGHH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_MgHCO3,N6,N5,N4))*VOLWHS)/VOLWT
    DFVMGS=XNPH*(AZMAX1(ZMGSH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_MgSO4,N6,N5,N4))*VOLWHS)/VOLWT
    DFVNAC=XNPH*(AZMAX1(ZNACH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_NaCO3,N6,N5,N4))*VOLWHS)/VOLWT
    DFVNAS=XNPH*(AZMAX1(ZNASH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_NaSO4,N6,N5,N4))*VOLWHS)/VOLWT
    DFVKAS=XNPH*(AZMAX1(ZKASH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_KSO4,N6,N5,N4))*VOLWHS)/VOLWT
    DFVNAC=XNPH*(AZMAX1(ZNACH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_NaCO3,N6,N5,N4))*VOLWHS)/VOLWT
    DFVH0P=XNPH*(AZMAX1(H0P4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_H0PO4,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,N6,N5,N4)
    DFVH3P=XNPH*(AZMAX1(H3P4H2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_H3PO4,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,N6,N5,N4)
    DFVF1P=XNPH*(AZMAX1(ZF1PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_FeHPO4,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,N6,N5,N4)
    DFVF2P=XNPH*(AZMAX1(ZF2PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_FeH2PO4,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,N6,N5,N4)
    DFVC0P=XNPH*(AZMAX1(ZC0PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CaPO4,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,N6,N5,N4)
    DFVC1P=XNPH*(AZMAX1(ZC1PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CaHPO4,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,N6,N5,N4)
    DFVC2P=XNPH*(AZMAX1(ZC2PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CaH2PO4,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,N6,N5,N4)
    DFVM1P=XNPH*(AZMAX1(ZM1PH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_MgHPO4,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4,N6,N5,N4)
    DFVH0B=XNPH*(AZMAX1(H0PBH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_H0PO4B,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,N6,N5,N4)
    DFVH3B=XNPH*(AZMAX1(H3PBH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_H3PO4B,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,N6,N5,N4)
    DFVF1B=XNPH*(AZMAX1(ZF1BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_FeHPO4B,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,N6,N5,N4)
    DFVF2B=XNPH*(AZMAX1(ZF2BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_FeH2PO4B,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,N6,N5,N4)
    DFVC0B=XNPH*(AZMAX1(ZC0BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CaPO4B,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,N6,N5,N4)
    DFVC1B=XNPH*(AZMAX1(ZC1BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CaHPO4B,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,N6,N5,N4)
    DFVC2B=XNPH*(AZMAX1(ZC2BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_CaH2PO4B,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,N6,N5,N4)
    DFVM1B=XNPH*(AZMAX1(ZM1BH2(N6,N5,N4))*VOLWM(M,N6,N5,N4)-AZMAX1(trcsa_solml2(idsa_MgHPO4B,N6,N5,N4))*VOLWHS)/VOLWT*trcs_VLN(ids_H1PO4B,N6,N5,N4)
  ELSE
    DFVAL=0.0_r8
    DFVFE=0.0_r8
    DFVHY=0.0_r8
...
!
  trcsa_XFXS(idsa_Al,N6,N5,N4)=trcsa_XFXS(idsa_Al,N6,N5,N4)+RALFXS(N6,N5,N4)
  trcsa_XFXS(idsa_Fe,N6,N5,N4)=trcsa_XFXS(idsa_Fe,N6,N5,N4)+RFEFXS(N6,N5,N4)
  trcsa_XFXS(idsa_Hp,N6,N5,N4)=trcsa_XFXS(idsa_Hp,N6,N5,N4)+RHYFXS(N6,N5,N4)
  trcsa_XFXS(idsa_Ca,N6,N5,N4)=trcsa_XFXS(idsa_Ca,N6,N5,N4)+RCAFXS(N6,N5,N4)
  trcsa_XFXS(idsa_Mg,N6,N5,N4)=trcsa_XFXS(idsa_Mg,N6,N5,N4)+RMGFXS(N6,N5,N4)
  trcsa_XFXS(idsa_Na,N6,N5,N4)=trcsa_XFXS(idsa_Na,N6,N5,N4)+RNAFXS(N6,N5,N4)
  trcsa_XFXS(idsa_K,N6,N5,N4)=trcsa_XFXS(idsa_K,N6,N5,N4)+RKAFXS(N6,N5,N4)
  trcsa_XFXS(idsa_OH,N6,N5,N4)=trcsa_XFXS(idsa_OH,N6,N5,N4)+ROHFXS(N6,N5,N4)
  trcsa_XFXS(idsa_SO4,N6,N5,N4)=trcsa_XFXS(idsa_SO4,N6,N5,N4)+RSOFXS(N6,N5,N4)
  trcsa_XFXS(idsa_Cl,N6,N5,N4)=trcsa_XFXS(idsa_Cl,N6,N5,N4)+RCLFXS(N6,N5,N4)
  trcsa_XFXS(idsa_CO3,N6,N5,N4)=trcsa_XFXS(idsa_CO3,N6,N5,N4)+RC3FXS(N6,N5,N4)
  trcsa_XFXS(idsa_HCO3,N6,N5,N4)=trcsa_XFXS(idsa_HCO3,N6,N5,N4)+RHCFXS(N6,N5,N4)
  trcsa_XFXS(idsa_AlOH,N6,N5,N4)=trcsa_XFXS(idsa_AlOH,N6,N5,N4)+RAL1XS(N6,N5,N4)
  trcsa_XFXS(idsa_AlOH2,N6,N5,N4)=trcsa_XFXS(idsa_AlOH2,N6,N5,N4)+RAL2XS(N6,N5,N4)
  trcsa_XFXS(idsa_AlOH3,N6,N5,N4)=trcsa_XFXS(idsa_AlOH3,N6,N5,N4)+RAL3XS(N6,N5,N4)
  trcsa_XFXS(idsa_AlOH4,N6,N5,N4)=trcsa_XFXS(idsa_AlOH4,N6,N5,N4)+RAL4XS(N6,N5,N4)
  trcsa_XFXS(idsa_AlSO4,N6,N5,N4)=trcsa_XFXS(idsa_AlSO4,N6,N5,N4)+RALSXS(N6,N5,N4)
  trcsa_XFXS(idsa_FeOH,N6,N5,N4)=trcsa_XFXS(idsa_FeOH,N6,N5,N4)+RFE1XS(N6,N5,N4)
  trcsa_XFXS(idsa_FeOH2,N6,N5,N4)=trcsa_XFXS(idsa_FeOH2,N6,N5,N4)+RFE2XS(N6,N5,N4)
  trcsa_XFXS(idsa_FeOH3,N6,N5,N4)=trcsa_XFXS(idsa_FeOH3,N6,N5,N4)+RFE3XS(N6,N5,N4)
  trcsa_XFXS(idsa_FeOH4,N6,N5,N4)=trcsa_XFXS(idsa_FeOH4,N6,N5,N4)+RFE4XS(N6,N5,N4)
  trcsa_XFXS(idsa_FeSO4,N6,N5,N4)=trcsa_XFXS(idsa_FeSO4,N6,N5,N4)+RFESXS(N6,N5,N4)
  trcsa_XFXS(idsa_CaOH2,N6,N5,N4)=trcsa_XFXS(idsa_CaOH2,N6,N5,N4)+RCAOXS(N6,N5,N4)
  trcsa_XFXS(idsa_CaCO3,N6,N5,N4)=trcsa_XFXS(idsa_CaCO3,N6,N5,N4)+RCACXS(N6,N5,N4)
  trcsa_XFXS(idsa_CaHCO3,N6,N5,N4)=trcsa_XFXS(idsa_CaHCO3,N6,N5,N4)+RCAHXS(N6,N5,N4)
  trcsa_XFXS(idsa_CaSO4,N6,N5,N4)=trcsa_XFXS(idsa_CaSO4,N6,N5,N4)+RCASXS(N6,N5,N4)
  trcsa_XFXS(idsa_MgOH2,N6,N5,N4)=trcsa_XFXS(idsa_MgOH2,N6,N5,N4)+RMGOXS(N6,N5,N4)
  trcsa_XFXS(idsa_MgCO3,N6,N5,N4)=trcsa_XFXS(idsa_MgCO3,N6,N5,N4)+RMGCXS(N6,N5,N4)
  trcsa_XFXS(idsa_MgHCO3,N6,N5,N4)=trcsa_XFXS(idsa_MgHCO3,N6,N5,N4)+RMGHXS(N6,N5,N4)
  trcsa_XFXS(idsa_MgSO4,N6,N5,N4)=trcsa_XFXS(idsa_MgSO4,N6,N5,N4)+RMGSXS(N6,N5,N4)
  trcsa_XFXS(idsa_NaCO3,N6,N5,N4)=trcsa_XFXS(idsa_NaCO3,N6,N5,N4)+RNACXS(N6,N5,N4)
  trcsa_XFXS(idsa_NaSO4,N6,N5,N4)=trcsa_XFXS(idsa_NaSO4,N6,N5,N4)+RNASXS(N6,N5,N4)
  trcsa_XFXS(idsa_KSO4,N6,N5,N4)=trcsa_XFXS(idsa_KSO4,N6,N5,N4)+RKASXS(N6,N5,N4)
  trcsa_XFXS(idsa_H0PO4,N6,N5,N4)=trcsa_XFXS(idsa_H0PO4,N6,N5,N4)+RH0PXS(N6,N5,N4)
  trcsa_XFXS(idsa_H3PO4,N6,N5,N4)=trcsa_XFXS(idsa_H3PO4,N6,N5,N4)+RH3PXS(N6,N5,N4)
  trcsa_XFXS(idsa_FeHPO4,N6,N5,N4)=trcsa_XFXS(idsa_FeHPO4,N6,N5,N4)+RF1PXS(N6,N5,N4)
  trcsa_XFXS(idsa_FeH2PO4,N6,N5,N4)=trcsa_XFXS(idsa_FeH2PO4,N6,N5,N4)+RF2PXS(N6,N5,N4)
  trcsa_XFXS(idsa_CaPO4,N6,N5,N4)=trcsa_XFXS(idsa_CaPO4,N6,N5,N4)+RC0PXS(N6,N5,N4)
  trcsa_XFXS(idsa_CaHPO4,N6,N5,N4)=trcsa_XFXS(idsa_CaHPO4,N6,N5,N4)+RC1PXS(N6,N5,N4)
  trcsa_XFXS(idsa_CaH2PO4,N6,N5,N4)=trcsa_XFXS(idsa_CaH2PO4,N6,N5,N4)+RC2PXS(N6,N5,N4)
  trcsa_XFXS(idsa_MgHPO4,N6,N5,N4)=trcsa_XFXS(idsa_MgHPO4,N6,N5,N4)+RM1PXS(N6,N5,N4)
  trcsa_XFXS(idsa_H0PO4B,N6,N5,N4)=trcsa_XFXS(idsa_H0PO4B,N6,N5,N4)+RH0BXB(N6,N5,N4)
  trcsa_XFXS(idsa_H3PO4B,N6,N5,N4)=trcsa_XFXS(idsa_H3PO4B,N6,N5,N4)+RH3BXB(N6,N5,N4)
  trcsa_XFXS(idsa_FeHPO4B,N6,N5,N4)=trcsa_XFXS(idsa_FeHPO4B,N6,N5,N4)+RF1BXB(N6,N5,N4)
  trcsa_XFXS(idsa_FeH2PO4B,N6,N5,N4)=trcsa_XFXS(idsa_FeH2PO4B,N6,N5,N4)+RF2BXB(N6,N5,N4)
  trcsa_XFXS(idsa_CaPO4B,N6,N5,N4)=trcsa_XFXS(idsa_CaPO4B,N6,N5,N4)+RC0BXB(N6,N5,N4)
  trcsa_XFXS(idsa_CaHPO4B,N6,N5,N4)=trcsa_XFXS(idsa_CaHPO4B,N6,N5,N4)+RC1BXB(N6,N5,N4)
  trcsa_XFXS(idsa_CaH2PO4B,N6,N5,N4)=trcsa_XFXS(idsa_CaH2PO4B,N6,N5,N4)+RC2BXB(N6,N5,N4)
  trcsa_XFXS(idsa_MgHPO4B,N6,N5,N4)=trcsa_XFXS(idsa_MgHPO4B,N6,N5,N4)+RM1BXB(N6,N5,N4)
