...
!
    TKY=(TKXR*VHeatCapacity1_vr(0,NY,NX)+TK1X*VHeatCapacity1_vr(NUM(NY,NX),NY,NX))/(VHeatCapacity1_vr(0,NY,NX)+VHeatCapacity1_vr(NUM(NY,NX),NY,NX))
...
!
    ...
    write(111,*)I+J/24.,M,L,'TKXR',TKXR,TK1X,TK0X,VHeatCapacity1_vr(0,NY,NX)
    endif
