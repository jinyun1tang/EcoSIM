...
!
        ...
        IF(ABS(WX).GT.ZEROS(N2,N1))THEN
          ECHY  = 0.337*AZMAX1((trcSalt_TransptMicP_3D(idsalt_Hp,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_Hp,N,N6,N5,N4))/WX)
          ECOH  = 0.192*AZMAX1((trcSalt_TransptMicP_3D(idsalt_OH,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_OH,N,N6,N5,N4))/WX)
          ECAL  = 0.056*AZMAX1((trcSalt_TransptMicP_3D(idsalt_Al,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_Ca,N,N6,N5,N4))*3.0/WX)
          ECFE  = 0.051*AZMAX1((trcSalt_TransptMicP_3D(idsalt_Fe,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_Fe,N,N6,N5,N4))*3.0/WX)
          ECCA  = 0.060*AZMAX1((trcSalt_TransptMicP_3D(idsalt_Ca,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_Ca,N,N6,N5,N4))*2.0/WX)
          ECMG  = 0.053*AZMAX1((trcSalt_TransptMicP_3D(idsalt_Mg,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_Mg,N,N6,N5,N4))*2.0/WX)
          ECNA  = 0.050*AZMAX1((trcSalt_TransptMicP_3D(idsalt_Na,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_Na,N,N6,N5,N4))/WX)
          ECKA  = 0.070*AZMAX1((trcSalt_TransptMicP_3D(idsalt_K,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_K,N,N6,N5,N4))/WX)
          ECCO  = 0.072*AZMAX1((trcSalt_TransptMicP_3D(idsalt_CO3,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_CO3,N,N6,N5,N4))*2.0/WX)
          ECHC  = 0.044*AZMAX1((trcSalt_TransptMicP_3D(idsalt_HCO3,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_HCO3,N,N6,N5,N4))/WX)
          ECSO  = 0.080*AZMAX1((trcSalt_TransptMicP_3D(idsalt_SO4,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_SO4,N,N6,N5,N4))*2.0/WX)
          ECCL  = 0.076*AZMAX1((trcSalt_TransptMicP_3D(idsalt_Cl,N,N6,N5,N4)+trcSalt_XFHS_3D(idsalt_Cl,N,N6,N5,N4))/WX)
