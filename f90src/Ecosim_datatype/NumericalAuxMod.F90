...
!
  ...
  real(r8),target,allocatable ::  trcs_Soil2plant_uptk_drib_vr(:,:,:,:)          !dribbling flux for total root-soil solute flux, [g d-2 h-1]
  ...
  allocate(trcs_Soil2plant_uptk_drib_vr(ids_beg:ids_end,JZ,JY,JX));    trcs_Soil2plant_uptk_drib_vr=0._r8
...
!----------------------------------------------------------------------
  ...
  call destroy(trcs_Soil2plant_uptk_drib_vr)
