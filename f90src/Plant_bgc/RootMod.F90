...
!
  ...
  ENDIF
!  if(N==ipltroot)write(3101,*)I*1000+J/24.,NR,L,NZ,RootMycoNonstElms_rpvr(:,N,L,NZ),'nst',RNonstCO2_OUltd,RGrowCO2_Oltd,RAutoRootO2Limter_rpvr(N,L,NZ),'FNP',FNP,FracRoot2ndCSinkL,RootSinkC_vr(N,L)
  !active growth
