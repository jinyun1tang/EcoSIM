...
!----------------------------------------------------------------------------------------------------
  ...
  associate(                                                               &
    ...
    FracShootStalkElmAlloc2Litr => plt_allom%FracShootStalkElmAlloc2Litr  ,& !input  :leaf element allocation,[-]
...
! begin_execution
  associate(                                                           &
    ...
    StalkLiveBiomassC_brch    => plt_biom%StalkLiveBiomassC_brch      ,& !output :branch live stalk C, [gC d-2]
