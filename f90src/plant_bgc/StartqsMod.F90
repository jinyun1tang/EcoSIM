...
!
  ...
  plt_biom%BranchStalkChemElms_pft(1:NumPlantChemElms,1:MaxNumBranches,NZ)=0._r8
...
!
  ...
  LeafPetolBiomassC_brch(1,NZ)=LeafChemElms_brch(ielmc,1,NZ)+PetoleChemElmnt_brch(ielmc,1,NZ)
