...
!
  D9000: DO L=NU,MaxNumRootLays
    ...
    IF(SoiBulkDensity(L).GT.ZERO)THEN
      ...
      AirPoreAvail4Fill(L)=AZMAX1(VLMicP(L)-VLWatMicP_vr(L)-VLiceMicP(L))  !air volume
    ELSE
...
!
    HeatAdd2Can=RadNet2Canopy_pft(NZ)+EvapTransHeat_pft(NZ)+VFLXC+PrecHeatIntcptByCanP1
!
