...
!
  ...
  WTRT1E(ielmn,ifineroot,NG(NZ,NY,NX),1,NZ,NY,NX)=CNGR(NZ,NY,NX)*WTRT1E(ielmc,ifineroot,NG(NZ,NY,NX),1,NZ,NY,NX)
  WTRT1E(ielmp,ifineroot,NG(NZ,NY,NX),1,NZ,NY,NX)=CPGR(NZ,NY,NX)*WTRT1E(ielmc,ifineroot,NG(NZ,NY,NX),1,NZ,NY,NX)
  ...
  WTRTL(ifineroot,NG(NZ,NY,NX),NZ,NY,NX)=WTRT1E(ielmc,ifineroot,NG(NZ,NY,NX),1,NZ,NY,NX)
  WTRTD(ifineroot,NG(NZ,NY,NX),NZ,NY,NX)=WTRT1E(ielmc,ifineroot,NG(NZ,NY,NX),1,NZ,NY,NX)
  WSRTL(1,NG(NZ,NY,NX),NZ,NY,NX)=WTRTL(ifineroot,NG(NZ,NY,NX),NZ,NY,NX)*CWSRT(NZ,NY,NX)
