...
!begin_data
  ...
  real(r8), pointer :: SeasonNonStrutElms_pft(:,:)     => null()  !plant stored nonstructural element, [gC d-2]
...
!----------------------------------------------------------------------
  ...
  allocate(this%SeasonNonStrutElms_pft(NumPlantChemElms,JP1));this%SeasonNonStrutElms_pft=spval
