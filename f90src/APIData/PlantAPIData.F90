...
!begin_data
  ...
  real(r8), allocatable :: COXYGs1(:)
  real(r8), allocatable :: COXYSs1(:)
...
!----------------------------------------------------------------------
  ...
  allocate(IYRHs1(JP1))
  allocate(IHVSTs1(JP1,366))
  allocate(IWTYPs1(JP1))
  allocate(JHVSTs1(JP1,366))
  allocate(NB1s1(JP1))
  ...
  allocate(COXYGs1(0:JZ1))
  allocate(COXYSs1(0:JZ1))
  ...
  allocate(FLWCs1(JP1))
  allocate(EHVSTs1(1:2,1:4,JP1,366))
  allocate(HVSTs1(JP1,366))
  allocate(THINs1(JP1,366))
  ...
  allocate(COMPLs1(25,JC1,JP1))
  allocate(CBXNs1(25,JC1,JP1))
  allocate(CBXN4s1(25,JC1,JP1))
  allocate(ETGROs1(25,JC1,JP1))
  allocate(ETGR4s1(25,JC1,JP1))
  allocate(FDBK4s1(25,JC1,JP1))
  allocate(HCOBs1(25,JC1,JP1))
  allocate(VCGROs1(25,JC1,JP1))
...
!----------------------------------------------------------------------
  ...
  implicit none
  if(allocated(ITILLs1))deallocate(ITILLs1)
  ...
  if(allocated(COXYGs1))deallocate(COXYGs1)
  if(allocated(COXYSs1))deallocate(COXYSs1)
