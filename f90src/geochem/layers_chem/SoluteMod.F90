...
!
  IF(VOLWNH.GT.ZEROS2(NY,NX))THEN
    ...
    CN41=AMAX1(0.0_r8,ZNH4S(L,NY,NX)/VOLWNX+RN4X)
    CN31=AMAX1(0.0_r8,ZNH3S(L,NY,NX)/VOLWNX+RN3X)
    XN41=AMAX1(0.0_r8,XN4(L,NY,NX)/BKVLNH)
  ELSE
    RN4X=0._r8
    RN3X=0._r8
    CN41=0._r8
  ...
  IF(VOLWNB.GT.ZEROS2(NY,NX))THEN
    ...
    CN4B=AMAX1(0.0_r8,ZNH4B(L,NY,NX)/VOLWNX+RNBX)
    CN3B=AMAX1(0.0_r8,ZNH3B(L,NY,NX)/VOLWNX+R3BX)
    XN4B=AMAX1(0.0_r8,XNB(L,NY,NX)/BKVLNB)
  ELSE
    RNBX=0._r8
    R3BX=0._r8
    CN4B=0._r8
...
!
  IF(VOLWPO.GT.ZEROS2(NY,NX))THEN
    ...
    CH1P1=AMAX1(0.0_r8,H1PO4(L,NY,NX)/VOLWPX+RH1PX)
    CH2P1=AMAX1(0.0_r8,H2PO4(L,NY,NX)/VOLWPX+RH2PX)
    XOH01=AMAX1(0.0_r8,XOH0(L,NY,NX))/BKVLPO
    XOH11=AMAX1(0.0_r8,XOH1(L,NY,NX))/BKVLPO
    XOH21=AMAX1(0.0_r8,XOH2(L,NY,NX))/BKVLPO
    XH1P1=AMAX1(0.0_r8,XH1P(L,NY,NX))/BKVLPO
    XH2P1=AMAX1(0.0_r8,XH2P(L,NY,NX))/BKVLPO
    PALPO1=AMAX1(0.0_r8,PALPO(L,NY,NX))/BKVLPO
    PFEPO1=AMAX1(0.0_r8,PFEPO(L,NY,NX))/BKVLPO
    PCAPM1=AMAX1(0.0_r8,PCAPM(L,NY,NX))/BKVLPO
    PCAPD1=AMAX1(0.0_r8,PCAPD(L,NY,NX))/BKVLPO
    PCAPH1=AMAX1(0.0_r8,PCAPH(L,NY,NX))/BKVLPO
  ELSE
    RH1PX=0._r8
    RH2PX=0._r8
    CH1P1=0._r8
  ...
  IF(VOLWPB.GT.ZEROS2(NY,NX))THEN
    ...
    CH1PB=AMAX1(0.0_r8,H1POB(L,NY,NX)/VOLWPX+RH1BX)
    CH2PB=AMAX1(0.0_r8,H2POB(L,NY,NX)/VOLWPX+RH2BX)
    XH01B=AMAX1(0.0_r8,XOH0B(L,NY,NX))/BKVLPB
    XH11B=AMAX1(0.0_r8,XOH1B(L,NY,NX))/BKVLPB
    XH21B=AMAX1(0.0_r8,XOH2B(L,NY,NX))/BKVLPB
    X1P1B=AMAX1(0.0_r8,XH1PB(L,NY,NX))/BKVLPB
    X2P1B=AMAX1(0.0_r8,XH2PB(L,NY,NX))/BKVLPB
    PALPOB=AMAX1(0.0_r8,PALPB(L,NY,NX))/BKVLPB
    PFEPOB=AMAX1(0.0_r8,PFEPB(L,NY,NX))/BKVLPB
    PCAPMB=AMAX1(0.0_r8,PCPMB(L,NY,NX))/BKVLPB
    PCAPDB=AMAX1(0.0_r8,PCPDB(L,NY,NX))/BKVLPB
    PCAPHB=AMAX1(0.0_r8,PCPHB(L,NY,NX))/BKVLPB
  ELSE
    RH1BX=0._r8
    RH2BX=0._r8
    CH1PB=0._r8
...
!
      ...
      IF(DLYR(3,L,NY,NX).GT.ZERO)THEN
        VLNHB(L,NY,NX)=AMAX1(0.0_r8,AMIN1(0.999_r8,WDNHB(L,NY,NX) &
...
!
      ...
      IF(DLYR(3,L,NY,NX).GT.ZERO)THEN
        VLPOB(L,NY,NX)=AMAX1(0.0_r8,AMIN1(0.999,WDPOB(L,NY,NX) &
...
!
      ...
      IF(DLYR(3,L,NY,NX).GT.ZERO)THEN
        VLNOB(L,NY,NX)=AMAX1(0.0_r8,AMIN1(0.999,WDNOB(L,NY,NX) &
...
!
      ...
      CH1P1=AMAX1(0.0_r8,H1PO4(0,NY,NX)/VOLWMP+RH1PX)
      CH2P1=AMAX1(0.0_r8,H2PO4(0,NY,NX)/VOLWMP+RH2PX)
    ELSE
      RN4X=0._r8
      RN3X=0._r8
      CN41=0._r8
...
!
    IF(BKVLX.GT.ZEROS(NY,NX))THEN
      PALPO1=AMAX1(0.0_r8,PALPO(0,NY,NX)/BKVLX)
      PFEPO1=AMAX1(0.0_r8,PFEPO(0,NY,NX)/BKVLX)
      PCAPM1=AMAX1(0.0_r8,PCAPM(0,NY,NX)/BKVLX)
      PCAPD1=AMAX1(0.0_r8,PCAPD(0,NY,NX)/BKVLX)
      PCAPH1=AMAX1(0.0_r8,PCAPH(0,NY,NX)/BKVLX)
    ELSE
      PALPO1=0._r8
      PFEPO1=0._r8
      PCAPM1=0._r8
...
!
    ...
    RPALPX=AMIN1(AMAX1(0.0_r8,4.0E-08*ORGC(0,NY,NX)-PALPO1),AMAX1(-PALPO1,TPD*(CH2P1-CH2PA)))
!
...
!
    ...
    RPFEPX=AMIN1(AMAX1(0.0_r8,2.0E-06*ORGC(0,NY,NX)-PFEPO1),AMAX1(-PFEPO1,TPD*(CH2P1-CH2PF)))
!
!     DICALCIUM PHOSPHATE
!
...
!
    ...
    RPCAHX=AMIN1(AMAX1(0.0_r8,5.0E-05*ORGC(0,NY,NX)-PCAPH1),AMAX1(-PCAPH1,TPD*(CH2P1-CH2PH)))
!
...
!
    ...
    RPCAMX=AMIN1(AMAX1(0.0_r8,5.0E-05_r8*ORGC(0,NY,NX)-PCAPM1),AMAX1(-PCAPM1*SPPO4,TPD*(CH2P1-CH2PM)))
...
!
    DP=DPH2P
    S0=CH1P1+CHY1+DP
    S1=AMAX1(0.0_r8,S0**2-4.0*(CH1P1*CHY1-DP*CH2P1))
    RH2P=TSL*(S0-SQRT(S1))
!
