...
!------------------------------------------------------------------------------------------
  ...
  real(r8) :: RYH2P,S0,S1,VLWatMicPBK,RCA,RCAC,RCAH
...
!
    IF(VLWatMicP.GT.ZEROS)THEN
      VLWatMicPBK=AMIN1(1.0_r8,BKVLX/VLWatMicP)
    ELSE
      VLWatMicPBK=1.0_r8
    ENDIF
    IF(XAEC.GT.ZEROS)THEN
      RXOH2=TAD*(XOH11*AHY1-SXOH2*XOH21)/(XOH11+SPOH2)*VLWatMicPBK
      RXOH1=TAD*(XOH01*AHY1-SXOH1*XOH11)/(XOH01+SPOH1)*VLWatMicPBK
      SPH2P=SXH2P*DPH2O
      RXH2P=TAD*(XOH21*AH2P1-SPH2P*XH2P1)/(XOH21+SPH2P)*VLWatMicPBK
      RYH2P=TAD*(XOH11*AH2P1-SXH2P*XH2P1*AOH1)/(XOH11+SXH2P*AOH1)*VLWatMicPBK
!
!     HPO4 EXCHANGE
!
      SPH1P=SXH1P*DPH2O/DPH2P
      RXH1P=TAD*(XOH11*AH2P1-SPH1P*XH1P1)/(XOH11+SPH1P)*VLWatMicPBK
      XOH01=XOH01-RXOH1
...
!------------------------------------------------------------------------------------------
  ...
  real(r8) :: RXN4,RYH2P,SPH2P,VLWatMicPBK,S0,S1
...
!
    IF(VLWatMicP.GT.ZEROS)THEN
      VLWatMicPBK=AMIN1(1.0,BKVLX/VLWatMicP)
    ELSE
      VLWatMicPBK=1.0
    ENDIF
    IF(XAEC.GT.ZEROS)THEN
      SPH2P=SXH2P*DPH2O
      RXH2P=TAD*(XOH21*CH2P1-SPH2P*XH2P1)/(XOH21+SPH2P)*VLWatMicPBK
      RYH2P=TAD*(XOH11*CH2P1-SXH2P*COH1*XH2P1) &
        /(XOH11+SXH2P*COH1)*VLWatMicPBK
      SPH1P=SXH1P*DPH2O/DPH2P
      RXH1P=TAD*(XOH11*CH1P1-SPH1P*XH1P1)/(XOH11+SPH1P)*VLWatMicPBK
