module SaltChemEquilibriaMod
  ...
  real(r8), pointer :: VWatMicPNO
  real(r8), pointer :: VWatMicPNZ
...
!     begin_execution
  ...
  BKVLX  => chemvar%BKVLX
  VWatMicPNZ => chemvar%VWatMicPNZ
  VWatMicPNO => chemvar%VWatMicPNO
...
!
!     VWatMicPNO,VWatMicPNZ=soil water volume in NO3 non-band,band
!     ZNO3S,ZNO3B=NO3 mass in non-band,band
!     CNO1,CNOB=NO3 concentrations in non-band,band
!
  IF(VWatMicPNO.GT.ZEROS2)THEN
    CNO1=AMAX1(0._r8,ZNO3S/(natomw*VWatMicPNO))
  ELSE
    CNO1=0._r8
  ENDIF

  IF(VWatMicPNZ.GT.ZEROS2)THEN
    CNOB=AMAX1(0._r8,ZNO3B/(natomw*VWatMicPNZ))
  ELSE
    CNOB=0._r8
  ENDIF
!
...
!
  CHY1=AMAX1(0._r8,ZHY+XZHYS)/VWatMicPM
!
...
!
  ...
  IF(VWatMicPM.GT.ZEROS2)THEN
    COH1=AMAX1(0._r8,ZOH/VWatMicPM)
    CAL1=AMAX1(0._r8,ZAL/VWatMicPM)
    CFE1=AMAX1(0._r8,ZFE/VWatMicPM)
    CCA1=AMAX1(0._r8,ZCA/VWatMicPM)
    CMG1=AMAX1(0._r8,ZMG/VWatMicPM)
    CNA1=AMAX1(0._r8,ZNA/VWatMicPM)
    CKA1=AMAX1(0._r8,ZKA/VWatMicPM)
    CSO41=AMAX1(0._r8,ZSO4/VWatMicPM)
    CCL1=AMAX1(0._r8,ZCL/VWatMicPM)
    CCO31=AMAX1(0._r8,ZCO3/VWatMicPM)
    CHCO31=AMAX1(0._r8,ZHCO3/VWatMicPM)
    CCO21=AMAX1(0._r8,CO2S/(catomw*VWatMicPM))
    CALO1=AMAX1(0._r8,ZALOH1/VWatMicPM)
    CALO2=AMAX1(0._r8,ZALOH2/VWatMicPM)
    CALO3=AMAX1(0._r8,ZALOH3/VWatMicPM)
    CALO4=AMAX1(0._r8,ZALOH4/VWatMicPM)
    CALS1=AMAX1(0._r8,ZALS/VWatMicPM)
    CFEO1=AMAX1(0._r8,ZFEOH1/VWatMicPM)
    CFEO2=AMAX1(0._r8,ZFEOH2/VWatMicPM)
    CFEO3=AMAX1(0._r8,ZFEOH3/VWatMicPM)
    CFEO4=AMAX1(0._r8,ZFEOH4/VWatMicPM)
    CFES1=AMAX1(0._r8,ZFES/VWatMicPM)
    CCAO1=AMAX1(0._r8,ZCAO/VWatMicPM)
    CCAC1=AMAX1(0._r8,ZCAC/VWatMicPM)
    CCAH1=AMAX1(0._r8,ZCAH/VWatMicPM)
    CCAS1=AMAX1(0._r8,ZCAS/VWatMicPM)
    CMGO1=AMAX1(0._r8,ZMGO/VWatMicPM)
    CMGC1=AMAX1(0._r8,ZMGC/VWatMicPM)
    CMGH1=AMAX1(0._r8,ZMGH/VWatMicPM)
    CMGS1=AMAX1(0._r8,ZMGS/VWatMicPM)
    CNAC1=AMAX1(0._r8,ZNAC/VWatMicPM)
    CNAS1=AMAX1(0._r8,ZNAS/VWatMicPM)
    CKAS1=AMAX1(0._r8,ZKAS/VWatMicPM)
  ELSE
    COH1=0._r8
    CAL1=0._r8
    CFE1=0._r8
...
!
!     VWatMicPPO,VWatMicPPB=water volume in PO4 non-band,band
!
  IF(VWatMicPPO.GT.ZEROS2)THEN
    VWatMicPPX=patomw*VWatMicPPO
    CH0P1=AMAX1(0._r8,H0PO4/VWatMicPPO)
    CH3P1=AMAX1(0._r8,H3PO4/VWatMicPPO)
    CF1P1=AMAX1(0._r8,ZFE1P/VWatMicPPO)
    CF2P1=AMAX1(0._r8,ZFE2P/VWatMicPPO)
    CC0P1=AMAX1(0._r8,ZCA0P/VWatMicPPO)
    CC1P1=AMAX1(0._r8,ZCA1P/VWatMicPPO)
    CC2P1=AMAX1(0._r8,ZCA2P/VWatMicPPO)
    CM1P1=AMAX1(0._r8,ZMG1P/VWatMicPPO)
  ELSE
    CH0P1=0._r8
    CH3P1=0._r8
    CF1P1=0._r8
  ...
  IF(VWatMicPPB.GT.ZEROS2)THEN
    CH0PB=AMAX1(0._r8,H0POB/VWatMicPPB)
    CH3PB=AMAX1(0._r8,H3POB/VWatMicPPB)
    CF1PB=AMAX1(0._r8,ZFE1PB/VWatMicPPB)
    CF2PB=AMAX1(0._r8,ZFE2PB/VWatMicPPB)
    CC0PB=AMAX1(0._r8,ZCA0PB/VWatMicPPB)
    CC1PB=AMAX1(0._r8,ZCA1PB/VWatMicPPB)
    CC2PB=AMAX1(0._r8,ZCA2PB/VWatMicPPB)
    CM1PB=AMAX1(0._r8,ZMG1PB/VWatMicPPB)
  ELSE
    CH0PB=0._r8
    CH3PB=0._r8
    CF1PB=0._r8
...
!    2,CSTR2,CC3,CA3,CC2,CA2,CC1,CA1,VWatMicPM
...
!
  TRN4S=TRN4S*VWatMicPNH
  TRN4B=TRN4B*VWatMicPNB
  TRN3S=TRN3S*VWatMicPNH
  TRN3B=TRN3B*VWatMicPNB
  TRAL=TRAL*VWatMicPM
  TRFE=TRFE*VWatMicPM
  TRHY=TRHY*VWatMicPM
  TRCA=TRCA*VWatMicPM
  ...
  TRKA=TRKA*VWatMicPM
  TROH=TROH*VWatMicPM
  TRSO4=TRSO4*VWatMicPM
  TRCO3=TRCO3*VWatMicPM
  TRHCO=TRHCO*VWatMicPM
  TRCO2=TRCO2*VWatMicPM
  TRAL1=TRAL1*VWatMicPM
  TRAL2=TRAL2*VWatMicPM
  TRAL3=TRAL3*VWatMicPM
  TRAL4=TRAL4*VWatMicPM
  TRALS=TRALS*VWatMicPM
  TRFE1=TRFE1*VWatMicPM
  TRFE2=TRFE2*VWatMicPM
  TRFE3=TRFE3*VWatMicPM
  TRFE4=TRFE4*VWatMicPM
  TRFES=TRFES*VWatMicPM
  TRCAO=TRCAO*VWatMicPM
  TRCAC=TRCAC*VWatMicPM
  TRCAH=TRCAH*VWatMicPM
  TRCAS=TRCAS*VWatMicPM
  TRMGO=TRMGO*VWatMicPM
  TRMGC=TRMGC*VWatMicPM
  TRMGH=TRMGH*VWatMicPM
  TRMGS=TRMGS*VWatMicPM
  TRNAC=TRNAC*VWatMicPM
  TRNAS=TRNAS*VWatMicPM
  TRKAS=TRKAS*VWatMicPM
  TRH0P=TRH0P*VWatMicPPO
  TRH1P=TRH1P*VWatMicPPO
  TRH2P=TRH2P*VWatMicPPO
  TRH3P=TRH3P*VWatMicPPO
  TRF1P=TRF1P*VWatMicPPO
  TRF2P=TRF2P*VWatMicPPO
  TRC0P=TRC0P*VWatMicPPO
  TRC1P=TRC1P*VWatMicPPO
  TRC2P=TRC2P*VWatMicPPO
  TRM1P=TRM1P*VWatMicPPO
  TRH0B=TRH0B*VWatMicPPB
  TRH1B=TRH1B*VWatMicPPB
  TRH2B=TRH2B*VWatMicPPB
  TRH3B=TRH3B*VWatMicPPB
  TRF1B=TRF1B*VWatMicPPB
  TRF2B=TRF2B*VWatMicPPB
  TRC0B=TRC0B*VWatMicPPB
  TRC1B=TRC1B*VWatMicPPB
  TRC2B=TRC2B*VWatMicPPB
  TRM1B=TRM1B*VWatMicPPB
  TRXN4=TRXN4*VWatMicPNH
  TRXNB=TRXNB*VWatMicPNB
  TRXHY=TRXHY*VWatMicPM
  TRXAL=TRXAL*VWatMicPM
  TRXFE=TRXFE*VWatMicPM
  TRXCA=TRXCA*VWatMicPM
  TRXMG=TRXMG*VWatMicPM
  TRXNA=TRXNA*VWatMicPM
  TRXKA=TRXKA*VWatMicPM
  TRXHC=TRXHC*VWatMicPM
  TRXAL2=TRXAL2*VWatMicPM
  TRXFE2=TRXFE2*VWatMicPM
  TRXH0=TRXH0*VWatMicPPO
  TRXH1=TRXH1*VWatMicPPO
  TRXH2=TRXH2*VWatMicPPO
  TRX1P=TRX1P*VWatMicPPO
  TRX2P=TRX2P*VWatMicPPO
  TRBH0=TRBH0*VWatMicPPB
  TRBH1=TRBH1*VWatMicPPB
  TRBH2=TRBH2*VWatMicPPB
  TRB1P=TRB1P*VWatMicPPB
  TRB2P=TRB2P*VWatMicPPB
  TRALOH=TRALOH*VWatMicPM
  TRFEOH=TRFEOH*VWatMicPM
  TRCACO=TRCACO*VWatMicPM
  TRCASO=TRCASO*VWatMicPM
  TRALPO=TRALPO*VWatMicPPO
  TRFEPO=TRFEPO*VWatMicPPO
  TRCAPD=TRCAPD*VWatMicPPO
  TRCAPH=TRCAPH*VWatMicPPO
  TRCAPM=TRCAPM*VWatMicPPO
  TRALPB=TRALPB*VWatMicPPB
  TRFEPB=TRFEPB*VWatMicPPB
  TRCPDB=TRCPDB*VWatMicPPB
  TRCPHB=TRCPHB*VWatMicPPB
  TRCPMB=TRCPMB*VWatMicPPB
!
...
!     VWatMicPPO=soil water volume in non-band
...
!
  ...
  ELSE
    VWatMicPBK=1._r8
  ENDIF
  IF(VWatMicPPO.GT.ZEROS2.AND.XAEC.GT.ZEROS)THEN
    RXOH2=TADAX*(XOH11*AHY1-SXOH2*XOH21)/(XOH11+SXOH2)*VWatMicPBK
    RXOH1=TADAX*(XOH01*AHY1-SXOH1*XOH11)/(XOH01+SXOH1)*VWatMicPBK
!
...
!
    SPH2P=SXH2P*DPH2O
    RXH2P=TADAX*(XOH21*AH2P1-SPH2P*XH2P1)/(XOH21+SPH2P)*VWatMicPBK
    RYH2P=TADAX*(XOH11*AH2P1-SXH2P*XH2P1*AOH1)/(XOH11+SXH2P)*VWatMicPBK
!
...
!
    ...
    RXH1P=TADAX*(XOH11*AH1P1-SPH1P*XH1P1)/(XOH11+SPH1P)*VWatMicPBK
  ELSE
    RXOH2=0._r8
    RXOH1=0._r8
    RXH2P=0._r8
...
!     EXCHANGE SITES
!
  IF(VWatMicPPB.GT.ZEROS2.AND.XAEC.GT.ZEROS)THEN
!
!     RXO2B,RXO1B=OH2,OH exchange with R-OH2,R-OH in band
!     SXOH2,SXOH1=equilibrium constant for OH2,OH exchange with R-OH2,R-OH
!
    RXO2B=TADAX*(XH11B*AHY1-SXOH2*XH21B)/(XH11B+SXOH2)*VWatMicPBK
    RXO1B=TADAX*(XH01B*AHY1-SXOH1*XH11B)/(XH01B+SXOH1)*VWatMicPBK
!
...
!
    SPH2P=SXH2P*DPH2O
    RXH2B=TADAX*(XH21B*AH2PB-SPH2P*X2P1B)/(XH21B+SPH2P)*VWatMicPBK
    RYH2B=TADAX*(XH11B*AH2PB-SXH2P*X2P1B*AOH1)/(XH11B+SXH2P)*VWatMicPBK
!
...
!
    SPH1P=SXH1P*DPH2O/DPH2P
    RXH1B=TADAX*(XH11B*AH1PB-SPH1P*X1P1B)/(XH11B+SPH1P)*VWatMicPBK
