...
implicit none
  ...
  allocate(this%ROXSK(NPH))
  allocate(this%XOQCS(0:JCPLX1))
  allocate(this%XOQNS(0:JCPLX1))
  allocate(this%XOQPS(0:JCPLX1))
  allocate(this%XOQAS(0:JCPLX1))
  allocate(this%ROXYS(JG,NFGs,0:JCPLX1))
  allocate(this%ROQCS(JG,NFGs,0:JCPLX1))
  allocate(this%ROQAS(JG,NFGs,0:JCPLX1))
  allocate(this%RVMX3(JG,NFGs,0:JCPLX1))
  allocate(this%RVMB3(JG,NFGs,0:JCPLX1))
  allocate(this%RVMX2(JG,NFGs,0:JCPLX1))
  allocate(this%RVMB2(JG,NFGs,0:JCPLX1))
  allocate(this%RVMX1(JG,NFGs,0:JCPLX1))
  allocate(this%RVMX4(JG,NFGs,0:JCPLX1))
  allocate(this%RVMB4(JG,NFGs,0:JCPLX1))
  allocate(this%RINHO(JG,NFGs,0:JCPLX1))
  allocate(this%RINHB(JG,NFGs,0:JCPLX1))
  allocate(this%RINOO(JG,NFGs,0:JCPLX1))
  allocate(this%RINOB(JG,NFGs,0:JCPLX1))
  allocate(this%RIPOO(JG,NFGs,0:JCPLX1))
  allocate(this%RIPBO(JG,NFGs,0:JCPLX1))
  allocate(this%RIPO1(JG,NFGs,0:JCPLX1))
  allocate(this%RIPB1(JG,NFGs,0:JCPLX1))
  allocate(this%RINHOR(JG,NFGs,0:JCPLX1))
  allocate(this%RINOOR(JG,NFGs,0:JCPLX1))
  allocate(this%RIPOOR(JG,NFGs,0:JCPLX1))
  allocate(this%RIPO1R(JG,NFGs,0:JCPLX1))
  allocate(this%ROXYSff(JG,NFGs))
  allocate(this%RINHOff(JG,NFGs))
  allocate(this%RINHBff(JG,NFGs))
  allocate(this%RINOOff(JG,NFGs))
  allocate(this%RINOBff(JG,NFGs))
  allocate(this%RIPOOff(JG,NFGs))
  allocate(this%RIPBOff(JG,NFGs))
  allocate(this%RIPO1ff(JG,NFGs))
  allocate(this%RIPB1ff(JG,NFGs))
  allocate(this%RINHORff(JG,NFGs))
  allocate(this%RINOORff(JG,NFGs))
  allocate(this%RIPOORff(JG,NFGs))
  allocate(this%RIPO1Rff(JG,NFGs))
  allocate(this%RVMX4ff(JG,NFGs))
  allocate(this%RVMB4ff(JG,NFGs))
  allocate(this%RVMX2ff(JG,NFGs))
  allocate(this%RVMB2ff(JG,NFGs))
