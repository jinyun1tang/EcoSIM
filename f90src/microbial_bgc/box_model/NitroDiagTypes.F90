...
!------------------------------------------------------------------------------------------
  ...
  integer :: jcplx1,ndbiomcp
  integer :: NMICBSA
  integer :: NMICBSO
  jcplx1=jcplx-1;ndbiomcp=micpar%ndbiomcp
  NMICBSA=micpar%NMICBSA
  NMICBSO=micpar%NMICBSO
  allocate(this%RUPOX(NMICBSO,0:jcplx1))
  allocate(this%RGN2F(NMICBSO,0:jcplx1))
  allocate(this%RGOMO(NMICBSO,0:jcplx1))
  allocate(this%ROXYM(NMICBSO,0:jcplx1))
  allocate(this%ROXYP(NMICBSO,0:jcplx1))
  allocate(this%ROXYO(NMICBSO,0:jcplx1))
  allocate(this%RDNO3(NMICBSO,0:jcplx1))
  allocate(this%RDNOB(NMICBSO,0:jcplx1))
  allocate(this%RDNO2(NMICBSO,0:jcplx1))
  allocate(this%RDN2B(NMICBSO,0:jcplx1))
  allocate(this%RDN2O(NMICBSO,0:jcplx1))
  allocate(this%RGOMD(NMICBSO,0:jcplx1))
  allocate(this%RMOMC(2,NMICBSO,0:jcplx1))
  allocate(this%RINH4(NMICBSO,0:jcplx1))
  allocate(this%RINO3(NMICBSO,0:jcplx1))
  allocate(this%RIPO4(NMICBSO,0:jcplx1))
  allocate(this%RINB4(NMICBSO,0:jcplx1))
  allocate(this%RINB3(NMICBSO,0:jcplx1))
  allocate(this%RIPOB(NMICBSO,0:jcplx1))
  allocate(this%RDOMC(2,NMICBSO,0:jcplx1))
  allocate(this%RDOMN(2,NMICBSO,0:jcplx1))
  allocate(this%RDOMP(2,NMICBSO,0:jcplx1))
  allocate(this%RHOMC(2,NMICBSO,0:jcplx1))
  allocate(this%RHOMN(2,NMICBSO,0:jcplx1))
  allocate(this%RHOMP(2,NMICBSO,0:jcplx1))
  allocate(this%RCOMC(2,NMICBSO,0:jcplx1))
  allocate(this%RCOMN(2,NMICBSO,0:jcplx1))
  allocate(this%RCOMP(2,NMICBSO,0:jcplx1))
  allocate(this%CGOMC(NMICBSO,0:jcplx1))
  allocate(this%CGOMN(NMICBSO,0:jcplx1))
  allocate(this%RH2GX(NMICBSO,0:jcplx1))
  allocate(this%CGOMP(NMICBSO,0:jcplx1))
  allocate(this%RDMMC(2,NMICBSO,0:jcplx1))
  allocate(this%RHMMC(2,NMICBSO,0:jcplx1))
  allocate(this%RCMMC(2,NMICBSO,0:jcplx1))
  allocate(this%RDMMN(2,NMICBSO,0:jcplx1))
  allocate(this%RHMMN(2,NMICBSO,0:jcplx1))
  allocate(this%RCMMN(2,NMICBSO,0:jcplx1))
  allocate(this%RDMMP(2,NMICBSO,0:jcplx1))
  allocate(this%RHMMP(2,NMICBSO,0:jcplx1))
  allocate(this%RCMMP(2,NMICBSO,0:jcplx1))
  allocate(this%RN2FX(NMICBSO,0:jcplx1))
  allocate(this%RXOMC(2,NMICBSO,0:jcplx1))
  allocate(this%RXOMN(2,NMICBSO,0:jcplx1))
  allocate(this%RXOMP(2,NMICBSO,0:jcplx1))
  allocate(this%R3OMC(2,NMICBSO,0:jcplx1))
  allocate(this%R3OMN(2,NMICBSO,0:jcplx1))
  allocate(this%R3OMP(2,NMICBSO,0:jcplx1))
  allocate(this%RXMMC(2,NMICBSO,0:jcplx1))
  allocate(this%RXMMN(2,NMICBSO,0:jcplx1))
  allocate(this%RXMMP(2,NMICBSO,0:jcplx1))
  allocate(this%R3MMC(2,NMICBSO,0:jcplx1))
  allocate(this%R3MMN(2,NMICBSO,0:jcplx1))
  allocate(this%R3MMP(2,NMICBSO,0:jcplx1))
  allocate(this%CGOQC(NMICBSO,0:jcplx1))
  allocate(this%CGOAC(NMICBSO,0:jcplx1))
  allocate(this%RINH4R(NMICBSO,0:jcplx1))
  allocate(this%RINO3R(NMICBSO,0:jcplx1))
  allocate(this%RIPO4R(NMICBSO,0:jcplx1))
  allocate(this%FNH4XR(NMICBSO,0:jcplx1))
  allocate(this%FNO3XR(NMICBSO,0:jcplx1))
  allocate(this%FPO4XR(NMICBSO,0:jcplx1))
  allocate(this%RGOMY(NMICBSO,0:jcplx1))
  allocate(this%CGOMS(2,NMICBSO,0:jcplx1))
  allocate(this%CGONS(2,NMICBSO,0:jcplx1))
  allocate(this%CGOPS(2,NMICBSO,0:jcplx1))
  allocate(this%FP14XR(NMICBSO,0:jcplx1))
  allocate(this%RCO2X(NMICBSO,0:jcplx1))
  allocate(this%RCH3X(NMICBSO,0:jcplx1))
  allocate(this%RCH4X(NMICBSO,0:jcplx1))
  allocate(this%RIP14(NMICBSO,0:jcplx1))
  allocate(this%RIP1B(NMICBSO,0:jcplx1))
  allocate(this%RIP14R(NMICBSO,0:jcplx1))

  allocate(this%RVOXA(NMICBSA))
  allocate(this%RVOXB(NMICBSA))
  allocate(this%XOMCZ(3,NMICBSO,0:jcplx1))
  allocate(this%XOMNZ(3,NMICBSO,0:jcplx1))
  allocate(this%XOMPZ(3,NMICBSO,0:jcplx1))
  allocate(this%ROQCD(NMICBSO,0:jcplx1))
  allocate(this%RCCMC(ndbiomcp,NMICBSO,0:jcplx1))
  allocate(this%RCCMN(ndbiomcp,NMICBSO,0:jcplx1))
  allocate(this%RCCMP(ndbiomcp,NMICBSO,0:jcplx1))
...
!------------------------------------------------------------------------------------------
  ...
  integer, intent(in) :: JG, jcplx,NFGS
  integer :: jcplx1,NMICBSA,NMICBSO
  jcplx1=jcplx-1
  NMICBSA=micpar%NMICBSA
  NMICBSO=micpar%NMICBSO

  allocate(this%CNOMA(NMICBSO,0:jcplx1))
  allocate(this%CPOMA(NMICBSO,0:jcplx1))
  allocate(this%OMA(NMICBSO,0:jcplx1))
  allocate(this%FOMA(NMICBSO,0:jcplx1))
  allocate(this%FOMN(NMICBSO,0:jcplx1))
  allocate(this%FOMK(NMICBSO,0:jcplx1))
  allocate(this%OMC2(NMICBSO,0:jcplx1))
  allocate(this%TFNG(NMICBSO,0:jcplx1))
  allocate(this%TFNR(NMICBSO,0:jcplx1))
  allocate(this%OMN2(NMICBSO,0:jcplx1))
  allocate(this%FOM2(NMICBSO,0:jcplx1))
  allocate(this%WFN(NMICBSO,0:jcplx1))
  allocate(this%FCN(NMICBSO,0:jcplx1))
  allocate(this%FCP(NMICBSO,0:jcplx1))
  allocate(this%FCNP(NMICBSO,0:jcplx1))
...
!------------------------------------------------------------------------------------------
  ...
  allocate(this%RDORC(ndbiomcp,0:ncplx))
  allocate(this%RDORN(ndbiomcp,0:ncplx))
  allocate(this%RDORP(ndbiomcp,0:ncplx))
