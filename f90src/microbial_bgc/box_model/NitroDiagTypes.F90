...
!------------------------------------------------------------------------------------------
  ...
  integer :: ndbiomcp
  integer :: NumOfMicrobsInAutotrophCmplx
  integer :: NumOfMicrobs1HetertrophCmplx
  ...
  allocate(this%RUPOX(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RGN2F(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RGOMO(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%ROXYM(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%ROXYP(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%ROXYO(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDNO3(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDNOB(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDNO2(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDN2B(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDN2O(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RGOMD(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RMOMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RINH4(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RINO3(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RIPO4(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RINB4(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RINB3(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RIPOB(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDOMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDOMN(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDOMP(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RHOMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RHOMN(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RHOMP(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCOMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCOMN(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCOMP(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%CGOMC(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%CGOMN(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RH2GX(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%CGOMP(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDMMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RHMMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCMMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDMMN(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RHMMN(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCMMN(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RDMMP(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RHMMP(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCMMP(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RN2FX(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RXOMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RXOMN(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RXOMP(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%R3OMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%R3OMN(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%R3OMP(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RXMMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RXMMN(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RXMMP(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%R3MMC(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%R3MMN(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%R3MMP(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%CGOQC(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%CGOAC(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RINH4R(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RINO3R(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RIPO4R(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FNH4XR(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FNO3XR(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FPO4XR(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RGOMY(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%CGOMS(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%CGONS(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%CGOPS(2,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FP14XR(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCO2X(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCH3X(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCH4X(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RIP14(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RIP1B(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RIP14R(NumOfMicrobs1HetertrophCmplx,1:jcplx))

  allocate(this%RVOXA(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RVOXB(NumOfMicrobsInAutotrophCmplx))
  allocate(this%XOMCZ(3,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%XOMNZ(3,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%XOMPZ(3,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%ROQCD(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCCMC(ndbiomcp,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCCMN(ndbiomcp,NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%RCCMP(ndbiomcp,NumOfMicrobs1HetertrophCmplx,1:jcplx))

  allocate(this%RUPOXff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RGN2Fff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RGOMOff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%ROXYMff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%ROXYPff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%ROXYOff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDNO3ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDNOBff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDNO2ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDN2Bff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDN2Off(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RGOMDff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RMOMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RINH4ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RINO3ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RIPO4ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RINB4ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RINB3ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RIPOBff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDOMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDOMNff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDOMPff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RHOMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RHOMNff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RHOMPff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RCOMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RCOMNff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RCOMPff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%CGOMCff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%CGOMNff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RH2GXff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%CGOMPff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDMMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RHMMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RCMMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDMMNff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RHMMNff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RCMMNff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RDMMPff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RHMMPff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RCMMPff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RN2FXff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RXOMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RXOMNff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RXOMPff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%R3OMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%R3OMNff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%R3OMPff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RXMMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RXMMNff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%RXMMPff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%R3MMCff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%R3MMNff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%R3MMPff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%CGOQCff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%CGOACff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RINH4Rff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RINO3Rff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RIPO4Rff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%FNH4XRff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%FNO3XRff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%FPO4XRff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RGOMYff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%CGOMSff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%CGONSff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%CGOPSff(2,NumOfMicrobsInAutotrophCmplx))
  allocate(this%FP14XRff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RCO2Xff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RCH3Xff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RCH4Xff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RIP14ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RIP1Bff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%RIP14Rff(NumOfMicrobsInAutotrophCmplx))
...
!------------------------------------------------------------------------------------------
  ...
  allocate(this%CNOMA(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%CPOMA(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%OMA(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FOMA(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FOMN(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FOMK(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%OMC2(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%TFNG(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%TFNR(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%OMN2(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FOM2(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%WFN(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FCN(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FCP(NumOfMicrobs1HetertrophCmplx,1:jcplx))
  allocate(this%FCNP(NumOfMicrobs1HetertrophCmplx,1:jcplx))

  allocate(this%CNOMAff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%CPOMAff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%OMAff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%FOMAff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%FOMNff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%FOMKff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%OMC2ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%TFNGff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%TFNRff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%OMN2ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%FOM2ff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%WFNff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%FCNff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%FCPff(NumOfMicrobsInAutotrophCmplx))
  allocate(this%FCNPff(NumOfMicrobsInAutotrophCmplx))
