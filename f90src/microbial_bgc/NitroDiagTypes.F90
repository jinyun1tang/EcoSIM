...
!------------------------------------------------------------------------------------------
  ...
  allocate(this%RUPOX(JG,7,0:5))
  allocate(this%RGN2F(JG,7,0:5))
  allocate(this%RGOMO(JG,7,0:5))
  allocate(this%ROXYM(JG,7,0:5))
  allocate(this%ROXYP(JG,7,0:5))
  allocate(this%ROXYO(JG,7,0:5))
  allocate(this%RDNO3(JG,7,0:5))
  allocate(this%RDNOB(JG,7,0:5))
  allocate(this%RDNO2(JG,7,0:5))
  allocate(this%RDN2B(JG,7,0:5))
  allocate(this%RDN2O(JG,7,0:5))
  allocate(this%RGOMD(JG,7,0:5))
  allocate(this%RMOMC(2,JG,7,0:5))
  allocate(this%RINH4(JG,7,0:5))
  allocate(this%RINO3(JG,7,0:5))
  allocate(this%RIPO4(JG,7,0:5))
  allocate(this%RINB4(JG,7,0:5))
  allocate(this%RINB3(JG,7,0:5))
  allocate(this%RIPOB(JG,7,0:5))
  allocate(this%RDOMC(2,JG,7,0:5))
  allocate(this%RDOMN(2,JG,7,0:5))
  allocate(this%RDOMP(2,JG,7,0:5))
  allocate(this%RHOMC(2,JG,7,0:5))
  allocate(this%RHOMN(2,JG,7,0:5))
  allocate(this%RHOMP(2,JG,7,0:5))
  allocate(this%RCOMC(2,JG,7,0:5))
  allocate(this%RCOMN(2,JG,7,0:5))
  allocate(this%RCOMP(2,JG,7,0:5))
  allocate(this%CGOMC(JG,7,0:5))
  allocate(this%CGOMN(JG,7,0:5))
  allocate(this%RH2GX(JG,7,0:5))
  allocate(this%CGOMP(JG,7,0:5))
  allocate(this%RDMMC(2,JG,7,0:5))
  allocate(this%RHMMC(2,JG,7,0:5))
  allocate(this%RCMMC(2,JG,7,0:5))
  allocate(this%RDMMN(2,JG,7,0:5))
  allocate(this%RHMMN(2,JG,7,0:5))
  allocate(this%RCMMN(2,JG,7,0:5))
  allocate(this%RDMMP(2,JG,7,0:5))
  allocate(this%RHMMP(2,JG,7,0:5))
  allocate(this%RCMMP(2,JG,7,0:5))
  allocate(this%RCCMC(2,JG,7,0:4))
  allocate(this%RCCMN(2,JG,7,0:4))
  allocate(this%RCCMP(2,JG,7,0:4))
  allocate(this%RN2FX(JG,7,0:5))

  allocate(this%RXOMC(2,JG,7,0:5))
  allocate(this%RXOMN(2,JG,7,0:5))
  allocate(this%RXOMP(2,JG,7,0:5))
  allocate(this%R3OMC(2,JG,7,0:5))
  allocate(this%R3OMN(2,JG,7,0:5))
  allocate(this%R3OMP(2,JG,7,0:5))
  allocate(this%RXMMC(2,JG,7,0:5))
  allocate(this%RXMMN(2,JG,7,0:5))
  allocate(this%RXMMP(2,JG,7,0:5))
  allocate(this%R3MMC(2,JG,7,0:5))
  allocate(this%R3MMN(2,JG,7,0:5))
  allocate(this%R3MMP(2,JG,7,0:5))
  allocate(this%CGOQC(JG,7,0:5))
  allocate(this%CGOAC(JG,7,0:5))
  allocate(this%RINH4R(JG,7,0:5))
  allocate(this%RINO3R(JG,7,0:5))
  allocate(this%RIPO4R(JG,7,0:5))
  allocate(this%FNH4XR(JG,7,0:5))
  allocate(this%FNO3XR(JG,7,0:5))
  allocate(this%FPO4XR(JG,7,0:5))
  allocate(this%RGOMY(JG,7,0:5))
  allocate(this%ROQCD(JG,7,0:4))
  allocate(this%CGOMS(2,JG,7,0:5))
  allocate(this%CGONS(2,JG,7,0:5))
  allocate(this%CGOPS(2,JG,7,0:5))
  allocate(this%FP14XR(JG,7,0:5))
  allocate(this%RCO2X(JG,7,0:5))
  allocate(this%RCH3X(JG,7,0:5))
  allocate(this%RCH4X(JG,7,0:5))
  allocate(this%RVOXA(JG,7))
  allocate(this%RVOXB(JG,7))
  allocate(this%XOMCZ(3,JG,7,0:4))
  allocate(this%XOMNZ(3,JG,7,0:4))
  allocate(this%XOMPZ(3,JG,7,0:4))
  allocate(this%RIP14(JG,7,0:5))
  allocate(this%RIP1B(JG,7,0:5))
  allocate(this%RIP14R(JG,7,0:5))
...
!------------------------------------------------------------------------------------------
  ...
  allocate(this%CNOMA(JG,7,0:5))
  allocate(this%CPOMA(JG,7,0:5))
  allocate(this%OMA(JG,7,0:5))
  allocate(this%FOMA(JG,7,0:5))
  allocate(this%FOMN(JG,7,0:5))
  allocate(this%FOMK(JG,7,0:5))
  allocate(this%OMC2(JG,7,0:5))
  allocate(this%TFNG(JG,7,0:5))
  allocate(this%TFNR(JG,7,0:5))
  allocate(this%OMN2(JG,7,0:5))
  allocate(this%FOM2(JG,7,0:5))
  allocate(this%WFN(JG,7,0:5))
  allocate(this%FCN(JG,7,0:5))
  allocate(this%FCP(JG,7,0:5))
  allocate(this%FCNP(JG,7,0:5))
