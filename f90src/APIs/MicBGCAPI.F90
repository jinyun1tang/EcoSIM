...
!------------------------------------------------------------------------------------------
  ...
  if(micfor%litrm)then
    micstt%ZNH4TU=AZMAX1(trc_solml(ids_NH4,NU(NY,NX),NY,NX))+AZMAX1(ZNH4B(NU(NY,NX),NY,NX))
    ...
    micstt%H2P4TU=AZMAX1(H2PO4(NU(NY,NX),NY,NX))+AZMAX1(trc_solml(ids_H2PO4B,NU(NY,NX),NY,NX))
