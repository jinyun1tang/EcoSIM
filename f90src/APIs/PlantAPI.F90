...
!------------------------------------------------------------------------------------------
  ...
  DO NZ=1,NP0_col(NY,NX)
    ...
    DynCi2CaRatio_pft(NZ,NY,NX)        = plt_photo%DynCi2CaRatio_pft(NZ)
    ...
    CanopySeedNumX_pft(NZ,NY,NX)         = plt_morph%CanopySeedNumX_pft(NZ)    
...
!    plt_soilchem%trcs_RMicbUptake_vr(idg_beg:idg_NH3-1,L) = trcs_RMicbUptake_vr(idg_beg:idg_NH3-1,L,NY,NX)
  ...
  NZ100: DO NZ=1,NP0_col(NY,NX)
    ...
    plt_biom%PetolShethStrutElms_pft(1:NumPlantChemElms,NZ)            = PetolShethStrutElms_pft(1:NumPlantChemElms,NZ,NY,NX)
    ...
    plt_pheno%isPlantShootAlive_pft(NZ) = isPlantShootAlive_pft(NZ,NY,NX)
    ...
    plt_morph%CRootLigVolPerMassC_pft(NZ) = CRootLigVolPerMassC_pft(NZ,NY,NX)
    ...
    plt_morph%CanopySeedNumX_pft(NZ)    = CanopySeedNumX_pft(NZ,NY,NX)         
    ...
    plt_morph%MaxSoilLays4Root_pft(NZ)                           = MaxSoilLays4Root_pft(NZ,NY,NX)
    ...
    plt_ew%CanopyEvapTransLHeat_pft(NZ)                             = CanopyEvapTransLHeat_pft(NZ,NY,NX)
    ...
    plt_ew%RawIsoTCanopy2Atm_pft(NZ)                        = RawIsoTCanopy2Atm_pft(NZ,NY,NX)
