...
! sent variables also modified
  ...
  DO NZ=1,NP0(NY,NX)
    ...
    ShootElmsBeg_pft(1:NumPlantChemElms,NZ,NY,NX)=ShootElms_pft(1:NumPlantChemElms,NZ,NY,NX)
    RootElmsBeg_pft(1:NumPlantChemElms,NZ,NY,NX)=RootElms_pft(1:NumPlantChemElms,NZ,NY,NX)    
