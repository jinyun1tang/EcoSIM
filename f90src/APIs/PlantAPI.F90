  ...
  DO NZ=1,NP0_col(NY,NX)
    ...
    DO NB=1,NumOfBranches_pft(NZ,NY,NX)
      ...
      DO K=0,MaxNodesPerBranch
        ...
        DeadInternodeHeight_brch(K,NB,NZ,NY,NX)                  = plt_morph%DeadInternodeHeight_brch(K,NB,NZ)
...
!      plt_photo%RubiscoActivity_brch(NB,NZ)  = RubiscoActivity_brch(NB,NZ,NY,NX)
      ...
      DO K=0,MaxNodesPerBranch
        ...
        plt_morph%DeadInternodeHeight_brch(K,NB,NZ)                 = DeadInternodeHeight_brch(K,NB,NZ,NY,NX)
