...
!        plt_rbgc%RootUptkSoiSol_vr(idg_CO2,N,L,NZ)=RootUptkSoiSol_vr(idg_CO2,N,L,NZ,NY,NX)
!        plt_rbgc%RootUptkSoiSol_vr(idg_O2,N,L,NZ)=RootUptkSoiSol_vr(idg_O2,N,L,NZ,NY,NX)
!        plt_rbgc%RootUptkSoiSol_vr(idg_CH4,N,L,NZ)=RootUptkSoiSol_vr(idg_CH4,N,L,NZ,NY,NX)
!        plt_rbgc%RootUptkSoiSol_vr(idg_N2O,N,L,NZ)=RootUptkSoiSol_vr(idg_N2O,N,L,NZ,NY,NX)
!        plt_rbgc%RootUptkSoiSol_vr(idg_NH3,N,L,NZ)=RootUptkSoiSol_vr(idg_NH3,N,L,NZ,NY,NX)
!        plt_rbgc%RootUptkSoiSol_vr(idg_NH3B,N,L,NZ)=RootUptkSoiSol_vr(idg_NH3B,N,L,NZ,NY,NX)
!        plt_rbgc%RootUptkSoiSol_vr(idg_H2,N,L,NZ)=RootUptkSoiSol_vr(idg_H2,N,L,NZ,NY,NX)

!        plt_rbgc%trcg_air2root_flx_pvr(idg_beg:idg_end-1,N,L,NZ)=trcg_air2root_flx_pvr(idg_beg:idg_end-1,N,L,NZ,NY,NX)
!        plt_rbgc%trcg_Root_gas2aqu_flx_vr(idg_beg:idg_end-1,N,L,NZ)=trcg_Root_gas2aqu_flx_vr(idg_beg:idg_end-1,N,L,NZ,NY,NX)
