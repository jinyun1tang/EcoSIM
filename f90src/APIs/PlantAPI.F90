...
!------------------------------------------------------------------------------------------
  ...
  DO NZ=1,NP0(NY,NX)
    ...
    SeasonNonStrutElms_pft(1:NumPlantChemElms,NZ,NY,NX)  =plt_biom%SeasonNonStrutElms_pft(1:NumPlantChemElms,NZ)
...
! sent variables also modified
  ...
  DO NZ=1,NP0(NY,NX)
    ...
    plt_biom%SeasonNonStrutElms_pft(1:NumPlantChemElms,NZ) =SeasonNonStrutElms_pft(1:NumPlantChemElms,NZ,NY,NX)
    ...
    plt_biom%ShootElmsBeg_pft(1:NumPlantChemElms,NZ)=ShootElms_pft(1:NumPlantChemElms,NZ,NY,NX)
    plt_biom%RootElmsBeg_pft(1:NumPlantChemElms,NZ)=RootElms_pft(1:NumPlantChemElms,NZ,NY,NX)
