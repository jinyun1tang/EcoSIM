...
!  solflx%TR_H1PO4_band_soil =trcn_RChem_band_soil(ids_H1PO4B,L,NY,NX)
!  solflx%TR_H2PO4_band_soil =trcn_RChem_band_soil(ids_H2PO4B,L,NY,NX)
!  solflx%TR_H1PO4_soil =trcn_RChem_soil(ids_H1PO4,L,NY,NX)
!  solflx%TR_H2PO4_soil =trcn_RChem_soil(ids_H2PO4,L,NY,NX)
...
!  solflx%TR_NH4_band_soil =trcn_RChem_band_soil(ids_NH4B,L,NY,NX)
!  solflx%TR_NH4_soil =trcn_RChem_soil(ids_NH4,L,NY,NX)
...
!-----------------------------------------------------------------------
  ...
  trcn_RChem_soil(ids_NH4,L,NY,NX)=solflx%TR_NH4_soil
  trcn_RChem_band_soil(ids_NH4B,L,NY,NX)=solflx%TR_NH4_band_soil
  TR_NH3_soil(L,NY,NX)=solflx%TR_NH3_soil
  TR_NH3_band_soil(L,NY,NX)=solflx%TR_NH3_band_soil
  trcn_RChem_soil(ids_H1PO4,L,NY,NX)=solflx%TR_H1PO4_soil
  trcn_RChem_soil(ids_H2PO4,L,NY,NX)=solflx%TR_H2PO4_soil
  trcn_RChem_band_soil(ids_H1PO4B,L,NY,NX)=solflx%TR_H1PO4_band_soil
  trcn_RChem_band_soil(ids_H2PO4B,L,NY,NX)=solflx%TR_H2PO4_band_soil
