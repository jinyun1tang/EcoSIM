...
!  solflx%TR_NaCO3_soil=trcSalt_TR_vr(idsalt_NaCO3,L,NY,NX)
!  solflx%TR_MgCO3_soil=trcSalt_TR_vr(idsalt_MgCO3,L,NY,NX)
!  solflx%TR_CaCO3_soil=trcSalt_TR_vr(idsalt_CaCO3,L,NY,NX)
!  solflx%TR_MgHCO3_soil=trcSalt_TR_vr(idsalt_MgHCO3,L,NY,NX)
!  solflx%TR_CaHCO3_soil=trcSalt_TR_vr(idsalt_CaHCO3,L,NY,NX)
!  solflx%TR_HCO3=trcSalt_TR_vr(idsalt_HCO3,L,NY,NX)
!  solflx%TR_HCO3_sorbed_soil=TR_HCO3_sorbed_soil_vr(L,NY,NX)
!  solflx%TR_CaH4P2O8_soil=trcSalt_TR_vr(idsalt_CaH4P2O8,L,NY,NX)
!  solflx%TR_FeH2PO4_soil=trcSalt_TR_vr(idsalt_FeH2PO4,L,NY,NX)
!  solflx%TR_CaH4P2O8_band_soil=trcSalt_TR_vr(idsalt_CaH4P2O8B,L,NY,NX)
!  solflx%TR_FeH2PO4_band_soil=trcSalt_TR_vr(idsalt_FeH2PO4B,L,NY,NX)
!  solflx%TR_MgHPO4_soil=trcSalt_TR_vr(idsalt_MgHPO4,L,NY,NX)
!  solflx%TR_CaHPO4_soil=trcSalt_TR_vr(idsalt_CaHPO4,L,NY,NX)
!  solflx%TR_FeHPO4_soil=trcSalt_TR_vr(idsalt_FeHPO4,L,NY,NX)
!  solflx%TR_MgHPO4_band_soil=trcSalt_TR_vr(idsalt_MgHPO4B,L,NY,NX)
!  solflx%TR_CaHPO4_band_soil=trcSalt_TR_vr(idsalt_CaHPO4B,L,NY,NX)
!  solflx%TR_FeHPO4_band_soil=trcSalt_TR_vr(idsalt_FeHPO4B,L,NY,NX)
!  solflx%TR_CaPO4_band_soil=trcSalt_TR_vr(idsalt_CaPO4B,L,NY,NX)
!  solflx%TR_PO4_band_soil=trcSalt_TR_vr(idsalt_H0PO4B,L,NY,NX)
!  solflx%TR_CaPO4_soil=trcSalt_TR_vr(idsalt_CaPO4,L,NY,NX)
!  solflx%TR_PO4_soil=trcSalt_TR_vr(idsalt_H0PO4,L,NY,NX)
...
!  solflx%TR_FeOH_soil=trcSalt_TR_vr(idsalt_FeOH,L,NY,NX)
!  solflx%TR_Al_3p_soil=trcSalt_TR_vr(idsalt_Al,L,NY,NX)
!  solflx%TR_AlOH_soil=trcSalt_TR_vr(idsalt_AlOH,L,NY,NX)
!  solflx%TR_FeO2H2_soil=trcSalt_TR_vr(idsalt_FeOH2,L,NY,NX)
!  solflx%TR_AlO2H2_soil=trcSalt_TR_vr(idsalt_AlOH2,L,NY,NX)
!  solflx%TR_FeO3H3_soil_vr=trcSalt_TR_vr(idsalt_FeOH3,L,NY,NX)
!  solflx%TR_AlO3H3_soil=trcSalt_TR_vr(idsalt_AlOH3,L,NY,NX)
!  solflx%TR_FeO4H4_soil=trcSalt_TR_vr(idsalt_FeOH4,L,NY,NX)
!  solflx%TR_AlO4H4_soil=trcSalt_TR_vr(idsalt_AlOH4,L,NY,NX)
!  solflx%TR_MgOH_soil=trcSalt_TR_vr(idsalt_MgOH2,L,NY,NX)
!  solflx%TR_CaOH_soil=trcSalt_TR_vr(idsalt_CaOH,L,NY,NX)
...
!  solflx%TR_AlSO4_soil =trcSalt_TR_vr(idsalt_AlSO4,L,NY,NX)
...
!  solflx%TR_H3PO4_band_soil =trcSalt_TR_vr(idsalt_H3PO4B,L,NY,NX)
!  solflx%TR_H3PO4_sorbed_soil =trcSalt_TR_vr(idsalt_H3PO4,L,NY,NX)
!  solflx%TR_H_p_soil  =trcSalt_TR_vr(idsalt_Hp,L,NY,NX)
!  solflx%TR_K_1p_soil  =trcSalt_TR_vr(idsalt_K,L,NY,NX)
!  solflx%TR_KSO4_soil =trcSalt_TR_vr(idsalt_KSO4,L,NY,NX)
!  solflx%TR_Mg_2p_soil  =trcSalt_TR_vr(idsalt_Mg,L,NY,NX)
!  solflx%TR_MgSO4_soil =trcSalt_TR_vr(idsalt_MgSO4,L,NY,NX)
...
!  solflx%TR_Na_p_soil  =trcSalt_TR_vr(idsalt_Na,L,NY,NX)
!  solflx%TR_NaSO4_soil =trcSalt_TR_vr(idsalt_NaSO4,L,NY,NX)
!  solflx%TR_OH_1e_soil  =trcSalt_TR_vr(idsalt_OH,L,NY,NX)
!  solflx%TR_SO4_2e_soil =trcSalt_TR_vr(idsalt_SO4,L,NY,NX)
...
!-----------------------------------------------------------------------
  ...
  if(salt_model)then
    ...
    trcSalt_TR_vr(idsalt_Hp,L,NY,NX)        = solflx%TR_H_p_soil
    trcSalt_TR_vr(idsalt_Ca,L,NY,NX)        = solflx%TR_Ca_2p_soil
    trcSalt_TR_vr(idsalt_Mg,L,NY,NX)        = solflx%TR_Mg_2p_soil
    trcSalt_TR_vr(idsalt_Na,L,NY,NX)        = solflx%TR_Na_p_soil
    trcSalt_TR_vr(idsalt_K,L,NY,NX)         = solflx%TR_K_1p_soil
    trcSalt_TR_vr(idsalt_OH,L,NY,NX)        = solflx%TR_OH_1e_soil
    trcSalt_TR_vr(idsalt_SO4,L,NY,NX)       = solflx%TR_SO4_2e_soil
    trcSalt_TR_vr(idsalt_CO3,L,NY,NX)       = solflx%TR_CO3_2e_soil
    trcSalt_TR_vr(idsalt_HCO3,L,NY,NX)      = solflx%TR_HCO3_soil
    trcSalt_TR_vr(idsalt_AlOH,L,NY,NX)      = solflx%TR_AlOH_soil
    trcSalt_TR_vr(idsalt_AlOH2,L,NY,NX)     = solflx%TR_AlO2H2_soil
    trcSalt_TR_vr(idsalt_AlOH3,L,NY,NX)     = solflx%TR_AlO3H3_soil
    trcSalt_TR_vr(idsalt_AlOH4,L,NY,NX)     = solflx%TR_AlO4H4_soil
    trcSalt_TR_vr(idsalt_AlSO4,L,NY,NX)     = solflx%TR_AlSO4_soil
    trcSalt_TR_vr(idsalt_FeOH,L,NY,NX)      = solflx%TR_FeOH_soil
    trcSalt_TR_vr(idsalt_FeOH2,L,NY,NX)     = solflx%TR_FeO2H2_soil
    trcSalt_TR_vr(idsalt_FeOH3,L,NY,NX)     = solflx%TR_FeO3H3_soil_vr
    trcSalt_TR_vr(idsalt_FeOH4,L,NY,NX)     = solflx%TR_FeO4H4_soil
    trcSalt_TR_vr(idsalt_FeSO4,L,NY,NX)     = solflx%TR_FeSO4_soil
    trcSalt_TR_vr(idsalt_CaOH,L,NY,NX)      = solflx%TR_CaOH_soil
    trcSalt_TR_vr(idsalt_CaCO3,L,NY,NX)     = solflx%TR_CaCO3_soil
    trcSalt_TR_vr(idsalt_CaHCO3,L,NY,NX)    = solflx%TR_CaHCO3_soil
    trcSalt_TR_vr(idsalt_CaSO4,L,NY,NX)     = solflx%TR_CaSO4_soil
    trcSalt_TR_vr(idsalt_MgOH2,L,NY,NX)     = solflx%TR_MgOH_soil
    trcSalt_TR_vr(idsalt_MgCO3,L,NY,NX)     = solflx%TR_MgCO3_soil
    trcSalt_TR_vr(idsalt_MgHCO3,L,NY,NX)    = solflx%TR_MgHCO3_soil
    trcSalt_TR_vr(idsalt_MgSO4,L,NY,NX)     = solflx%TR_MgSO4_soil
    trcSalt_TR_vr(idsalt_NaCO3,L,NY,NX)     = solflx%TR_NaCO3_soil
    trcSalt_TR_vr(idsalt_NaSO4,L,NY,NX)     = solflx%TR_NaSO4_soil
    trcSalt_TR_vr(idsalt_KSO4,L,NY,NX)      = solflx%TR_KSO4_soil
    trcSalt_TR_vr(idsalt_H0PO4,L,NY,NX)     = solflx%TR_PO4_soil
    trcSalt_TR_vr(idsalt_H3PO4,L,NY,NX)     = solflx%TR_H3PO4_sorbed_soil
    trcSalt_TR_vr(idsalt_FeHPO4,L,NY,NX)    = solflx%TR_FeHPO4_soil
    trcSalt_TR_vr(idsalt_FeH2PO4,L,NY,NX)   = solflx%TR_FeH2PO4_soil
    trcSalt_TR_vr(idsalt_CaPO4,L,NY,NX)     = solflx%TR_CaPO4_soil
    trcSalt_TR_vr(idsalt_CaHPO4,L,NY,NX)    = solflx%TR_CaHPO4_soil
    trcSalt_TR_vr(idsalt_CaH4P2O8,L,NY,NX)  = solflx%TR_CaH4P2O8_soil
    trcSalt_TR_vr(idsalt_MgHPO4,L,NY,NX)    = solflx%TR_MgHPO4_soil
    trcSalt_TR_vr(idsalt_H0PO4B,L,NY,NX)    = solflx%TR_PO4_band_soil
    trcSalt_TR_vr(idsalt_H3PO4B,L,NY,NX)    = solflx%TR_H3PO4_band_soil
    trcSalt_TR_vr(idsalt_FeHPO4B,L,NY,NX)   = solflx%TR_FeHPO4_band_soil
    trcSalt_TR_vr(idsalt_FeH2PO4B,L,NY,NX)  = solflx%TR_FeH2PO4_band_soil
    trcSalt_TR_vr(idsalt_CaPO4B,L,NY,NX)    = solflx%TR_CaPO4_band_soil
    trcSalt_TR_vr(idsalt_CaHPO4B,L,NY,NX)   = solflx%TR_CaHPO4_band_soil
    trcSalt_TR_vr(idsalt_CaH4P2O8B,L,NY,NX) = solflx%TR_CaH4P2O8_band_soil
    trcSalt_TR_vr(idsalt_MgHPO4B,L,NY,NX)   = solflx%TR_MgHPO4_band_soil
  endif
