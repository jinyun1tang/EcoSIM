module RedistMod
  ...
  real(r8) :: DPTWI,DDLYXF,DDLYXE,DDLYXC,DLYRXX,DLYR0,DCORPZ
  real(r8) :: ECHY,ECOH,ECAL,ECFE,ECCA,ECMG,ECNA,ECKA,ECCO,ECHC
  real(r8) :: ECSO,ECCL,ECNO,ECNDQ,ER,ECNDX,ENGYW,ENGYS,ENGY1
  real(r8) :: ENGY,ENGY2,ENGYZ,ENGYR,ENGY1X,ENGY0X,ENGY0,ENGYM
  real(r8) :: ENGYV,ENGYL,FSINK,FSAN,FSIL,FCLA,FCEC,FAEC,FNH4
  real(r8) :: FNH3,FNHU,FNO3,FN4,FHY,FAL,FFE,FCA,FMG,FNA,FKA
  real(r8) :: FHC,FAL2,FFE2,FOH0,FOH1,FOH2,FH1P,FH2P,FALO,FFEO
  real(r8) :: FCAC,FCAS,FALP,FFEP,FCPD,FCPH,FCPM,FOMC,FOMN,FOMP
  real(r8) :: FORC,FORN,FORP,FOHC,FOHN,FOHP,FOHA,FOSC,FOSA,FOSN
  real(r8) :: FOSP,FLWS,FLWW,FLWI,FX,FY,FO,FXWDNHB,FXDPNHB,FXWDNOB
  real(r8) :: FXDPNOB,FXWDPOB,FXDPPOB,FBO,FXSAND,FXSILT,FXCLAY
  real(r8) :: FXROCK,FHO,FXVOLWH,FXVOLIH,FXVOLAH,FWO,FXVOLW
  real(r8) :: FXVOLI,FXVOLY,FXVOLWX,FXVHCM,FXENGY,FXZNH4FA,FXZNH3FA
  ...
  real(r8) :: FI,HRAINR,HQRN,HGR,HOD,HQRS,HFLWS,HFLXO,HI,HO
  real(r8) :: HS,HGB,HOB,HFLXD,OXR,OOD,OXS,OI,OO,OS,OIB,OOB
  real(r8) :: OC,ON,OP,PXR,POR,PSS,PXE,PPE,POE,POD,PXD,PQD,PHD
  ...
  real(r8) :: TENGYR,TL,TI,TX,UDVOLI,UDLYXF,VOLISO,VOLPT,VOLTT
  real(r8) :: VCO2G2,VCH4G2,VOXYG2,VZ2GG2,VZ2OG2,VNH3G2,VH2GG2
  real(r8) :: VTATM,VTGAS,VOLSWI,VOLSF,VHCPZ,VHCPY,VHCPO,VHCPX
  real(r8) :: VOLWXX,VOLIXX,VOLSLX,VOLXX,VOLTX,WQRN,WX,WO,WQRS
  real(r8) :: WI,WS,WDNHBDL,WDNHBD0,WDNHBD1,WDNOBDL,WDNOBD0
  real(r8) :: WDNOBD1,WDPOBDL,WDPOBD0,WDPOBD1,XN,XVOLWP,XCORP0
  real(r8) :: ZXR,ZGR,ZOR,ZXE,ZPE,ZOE,ZOD,ZXD,ZGD,ZXS,ZGS,ZSI
  ...
  real(r8) :: TCOFLS(JZ,JY,JX) &
    ...
    ,TH1BHB(JZ,JY,JX),VOLW1(JZ,JY,JX),VOLI1(JZ,JY,JX) &
    ,VOLWH1(JZ,JY,JX),VOLIH1(JZ,JY,JX),CDPTHX(JZ,JY,JX) &
    ,CDPTHY(0:JZ,JY,JX)
  real(r8) :: TQR(JY,JX),THQR(JY,JX),TQS(JY,JX),TQW(JY,JX) &
    ...
    ,TQSH0P(JY,JX),TQSH1P(JY,JX),TQSH3P(JY,JX),TQSF1P(JY,JX) &
  ...
  real(r8) :: TALFLS(JZ,JY,JX),TFEFLS(JZ,JY,JX) &
    ...
    ,TH1PFS(JZ,JY,JX),TH3PFS(JZ,JY,JX),TF1PFS(JZ,JY,JX) &
  ...
  real(r8) :: TOSGC(4,0:2) &
    ...
    ,THGFLG(JZ,JY,JX),THGFLS(JZ,JY,JX),TXCO2(JY,JX),DORGC(JZ,JY,JX) &
    ,DORGE(JY,JX),OMCL(0:JZ,JY,JX),OMNL(0:JZ,JY,JX) &
    ,THETCX(0:1),DDLYR(0:JZ,6),DDLYX(0:JZ,6) &
    ,DVOLW(JZ,JY,JX),DVOLI(JZ,JY,JX),VHCPWZ(JZ,JY,JX) &
    ,DDLYRX(3),DDLYRY(JZ)
...
!
        ...
        DO 9980 N=1,3
          DO 9975 NN=1,2
            ...
            ENDIF
!
            call RunoffXBoundaryFluxes(L,N,NY,NX,N1,N2,N4,N5,NN)
    !
            call SubsurfaceBoundaryFluxes(I,J,N,NY,NX,N1,N2,N3,N4,N5,N6)
9975      CONTINUE
!
    !     WATER, HEAT, SOLUTES IN SNOW DRIFT
          call WaterHeatSoluteBySnowDrift(N,N4,N5,L,NY,NX)
9980    CONTINUE
9985  CONTINUE
!
!     CHANGE EXTERNAL WATER TABLE DEPTH THROUGH DISTURBANCE
!
      call ModifyExWaterTBLByDisturbance(I,J,NY,NX)

      call ZeroFluxArrays(NY,NX)
      LG=0
      LX=0
      !if(curday>=170)print*,J,'line',__LINE__,'redist',TKS(0,NY,NX)
...
!     WRITE(*,5431)'LG',I,J,NX,NY,L,LG,LX,THETP(L,NY,NX),THETX
!    2,VOLP(L,NY,NX),TKS(L,NY,NX),VTGAS,VTATM
!5431  FORMAT(A8,7I4,12E12.4)
        ...
        call ZeroFluxAccumulators(L,NY,NX)
!
...
!
      ...
      ENDIF
!     WRITE(*,7752)'TQS',I,J,NX,NY,TKW(1,NY,NX)
!    3,VOLSSL(1,NY,NX),VOLWSL(1,NY,NX),VOLISL(1,NY,NX),VOLSL(1,NY,NX)
!    3,TQS(NY,NX),FLWS(NY,NX),TQW(NY,NX),FLWW(NY,NX)
!    4,TQI(NY,NX),FLWI(NY,NX),THQS(NY,NX),VHCPW(1,NY,NX)
!7752  FORMAT(A8,4I4,20E12.4)
!
      !if(curday>=170)write(*,*)'NU,NUM,NL',NU(NY,NX),NUM(NY,NX),NL(NY,NX)
      !if(curday>=170)print*,J,'line',__LINE__,'redist',TKS(0,NY,NX)
...
!            padr('VOLWSL',10),padr('VOLISL',10),padr('DENSI',10)/), &
!          (/VOLSSL(L,NY,NX),VOLWSL(L,NY,NX),VOLISL(L,NY,NX),DENSI/))
!        endif
        VOLWSO=VOLWSO+WS
...
!     watch out 'L' in the following call
      call RelayerSoilProfile(L,NY,NX)
...
!    2-0.00167*(DTBLX(NY,NX)-DTBLZ(NY,NX)-CDPTH(NU(NY,NX)-1,NY,NX))
      ...
      ENDIF
      end subroutine ModifyExWaterTBLByDisturbance
!------------------------------------------------------------------------------------------
...
!
      ...
      TCABLS(L,NY,NX)=0.0_r8
      TMGBLS(L,NY,NX)=0.0_r8
      TNABLS(L,NY,NX)=0.0_r8
      TKABLS(L,NY,NX)=0.0_r8
      TOHBLS(L,NY,NX)=0.0_r8
      TSOBLS(L,NY,NX)=0.0_r8
      TCLBLS(L,NY,NX)=0.0_r8
      TC3BLS(L,NY,NX)=0.0_r8
      THCBLS(L,NY,NX)=0.0_r8
      TAL1BS(L,NY,NX)=0.0_r8
      TAL2BS(L,NY,NX)=0.0_r8
      TAL3BS(L,NY,NX)=0.0_r8
      TAL4BS(L,NY,NX)=0.0_r8
      TALSBS(L,NY,NX)=0.0_r8
      TFE1BS(L,NY,NX)=0.0_r8
      TFE2BS(L,NY,NX)=0.0_r8
      TFE3BS(L,NY,NX)=0.0_r8
      TFE4BS(L,NY,NX)=0.0_r8
      TFESBS(L,NY,NX)=0.0_r8
      TCAOBS(L,NY,NX)=0.0_r8
      TCACBS(L,NY,NX)=0.0_r8
      TCAHBS(L,NY,NX)=0.0_r8
      TCASBS(L,NY,NX)=0.0_r8
      TMGOBS(L,NY,NX)=0.0_r8
      TMGCBS(L,NY,NX)=0.0_r8
      TMGHBS(L,NY,NX)=0.0_r8
      TMGSBS(L,NY,NX)=0.0_r8
      TNACBS(L,NY,NX)=0.0_r8
      TNASBS(L,NY,NX)=0.0_r8
      TKASBS(L,NY,NX)=0.0_r8
      TH0PBS(L,NY,NX)=0.0_r8
      TH3PBS(L,NY,NX)=0.0_r8
      TF1PBS(L,NY,NX)=0.0_r8
      TF2PBS(L,NY,NX)=0.0_r8
      TC0PBS(L,NY,NX)=0.0_r8
...
!------------------------------------------------------------------------------------------
      ...
      subroutine ZeroFluxAccumulators(L,NY,NX)
      implicit none
...
8585  CONTINUE
      TCOFLS(N3,N2,N1)=TCOFLS(N3,N2,N1)+XCOFLS(N,N3,N2,N1)-XCOFLS(N,N6,N5,N4)
      TCHFLS(N3,N2,N1)=TCHFLS(N3,N2,N1)+XCHFLS(N,N3,N2,N1)-XCHFLS(N,N6,N5,N4)
      TOXFLS(N3,N2,N1)=TOXFLS(N3,N2,N1)+XOXFLS(N,N3,N2,N1)-XOXFLS(N,N6,N5,N4)
      TNGFLS(N3,N2,N1)=TNGFLS(N3,N2,N1)+XNGFLS(N,N3,N2,N1)-XNGFLS(N,N6,N5,N4)
      TN2FLS(N3,N2,N1)=TN2FLS(N3,N2,N1)+XN2FLS(N,N3,N2,N1)-XN2FLS(N,N6,N5,N4)
      THGFLS(N3,N2,N1)=THGFLS(N3,N2,N1)+XHGFLS(N,N3,N2,N1)-XHGFLS(N,N6,N5,N4)
      TN4FLS(N3,N2,N1)=TN4FLS(N3,N2,N1)+XN4FLW(N,N3,N2,N1)-XN4FLW(N,N6,N5,N4)
      TN3FLS(N3,N2,N1)=TN3FLS(N3,N2,N1)+XN3FLW(N,N3,N2,N1)-XN3FLW(N,N6,N5,N4)
      TNOFLS(N3,N2,N1)=TNOFLS(N3,N2,N1)+XNOFLW(N,N3,N2,N1)-XNOFLW(N,N6,N5,N4)
      TNXFLS(N3,N2,N1)=TNXFLS(N3,N2,N1)+XNXFLS(N,N3,N2,N1)-XNXFLS(N,N6,N5,N4)
      TP1FLS(N3,N2,N1)=TP1FLS(N3,N2,N1)+XH1PFS(N,N3,N2,N1)-XH1PFS(N,N6,N5,N4)
      TPOFLS(N3,N2,N1)=TPOFLS(N3,N2,N1)+XH2PFS(N,N3,N2,N1)-XH2PFS(N,N6,N5,N4)
      TN4FLB(N3,N2,N1)=TN4FLB(N3,N2,N1)+XN4FLB(N,N3,N2,N1)-XN4FLB(N,N6,N5,N4)
      TN3FLB(N3,N2,N1)=TN3FLB(N3,N2,N1)+XN3FLB(N,N3,N2,N1)-XN3FLB(N,N6,N5,N4)
      TNOFLB(N3,N2,N1)=TNOFLB(N3,N2,N1)+XNOFLB(N,N3,N2,N1)-XNOFLB(N,N6,N5,N4)
      TNXFLB(N3,N2,N1)=TNXFLB(N3,N2,N1)+XNXFLB(N,N3,N2,N1)-XNXFLB(N,N6,N5,N4)
      TH1BFB(N3,N2,N1)=TH1BFB(N3,N2,N1)+XH1BFB(N,N3,N2,N1)-XH1BFB(N,N6,N5,N4)
      TH2BFB(N3,N2,N1)=TH2BFB(N3,N2,N1)+XH2BFB(N,N3,N2,N1)-XH2BFB(N,N6,N5,N4)
...
!
      TCOFLG(N3,N2,N1)=TCOFLG(N3,N2,N1)+XCOFLG(N,N3,N2,N1)-XCOFLG(N,N6,N5,N4)
      TCHFLG(N3,N2,N1)=TCHFLG(N3,N2,N1)+XCHFLG(N,N3,N2,N1)-XCHFLG(N,N6,N5,N4)
      TOXFLG(N3,N2,N1)=TOXFLG(N3,N2,N1)+XOXFLG(N,N3,N2,N1)-XOXFLG(N,N6,N5,N4)
      TNGFLG(N3,N2,N1)=TNGFLG(N3,N2,N1)+XNGFLG(N,N3,N2,N1)-XNGFLG(N,N6,N5,N4)
      TN2FLG(N3,N2,N1)=TN2FLG(N3,N2,N1)+XN2FLG(N,N3,N2,N1)-XN2FLG(N,N6,N5,N4)
      TNHFLG(N3,N2,N1)=TNHFLG(N3,N2,N1)+XN3FLG(N,N3,N2,N1)-XN3FLG(N,N6,N5,N4)
      THGFLG(N3,N2,N1)=THGFLG(N3,N2,N1)+XHGFLG(N,N3,N2,N1)-XHGFLG(N,N6,N5,N4)
!
...
!     ENDIF
      TCOBLS(LS,N2,N1)=TCOBLS(LS,N2,N1)+XCOBLS(LS,N2,N1) &
      -XCOFLS(3,0,N2,N1)-XCOFLS(3,NUM(N2,N1),N2,N1) &
      -XCOFHS(3,NUM(N2,N1),N2,N1)
      TCHBLS(LS,N2,N1)=TCHBLS(LS,N2,N1)+XCHBLS(LS,N2,N1) &
      -XCHFLS(3,0,N2,N1)-XCHFLS(3,NUM(N2,N1),N2,N1) &
      -XCHFHS(3,NUM(N2,N1),N2,N1)
      TOXBLS(LS,N2,N1)=TOXBLS(LS,N2,N1)+XOXBLS(LS,N2,N1) &
      -XOXFLS(3,0,N2,N1)-XOXFLS(3,NUM(N2,N1),N2,N1) &
      -XOXFHS(3,NUM(N2,N1),N2,N1)
      TNGBLS(LS,N2,N1)=TNGBLS(LS,N2,N1)+XNGBLS(LS,N2,N1) &
      -XNGFLS(3,0,N2,N1)-XNGFLS(3,NUM(N2,N1),N2,N1) &
      -XNGFHS(3,NUM(N2,N1),N2,N1)
      TN2BLS(LS,N2,N1)=TN2BLS(LS,N2,N1)+XN2BLS(LS,N2,N1) &
      -XN2FLS(3,0,N2,N1)-XN2FLS(3,NUM(N2,N1),N2,N1) &
      -XN2FHS(3,NUM(N2,N1),N2,N1)
      TN4BLW(LS,N2,N1)=TN4BLW(LS,N2,N1)+XN4BLW(LS,N2,N1) &
      -XN4FLW(3,0,N2,N1)-XN4FLW(3,NUM(N2,N1),N2,N1) &
      -XN4FHW(3,NUM(N2,N1),N2,N1)-XN4FLB(3,NUM(N2,N1),N2,N1) &
      -XN4FHB(3,NUM(N2,N1),N2,N1)
      TN3BLW(LS,N2,N1)=TN3BLW(LS,N2,N1)+XN3BLW(LS,N2,N1) &
      -XN3FLW(3,0,N2,N1)-XN3FLW(3,NUM(N2,N1),N2,N1) &
      -XN3FHW(3,NUM(N2,N1),N2,N1)-XN3FLB(3,NUM(N2,N1),N2,N1) &
      -XN3FHB(3,NUM(N2,N1),N2,N1)
      TNOBLW(LS,N2,N1)=TNOBLW(LS,N2,N1)+XNOBLW(LS,N2,N1) &
      -XNOFLW(3,0,N2,N1)-XNOFLW(3,NUM(N2,N1),N2,N1) &
      -XNOFHW(3,NUM(N2,N1),N2,N1)-XNOFLB(3,NUM(N2,N1),N2,N1) &
      -XNOFHB(3,NUM(N2,N1),N2,N1)
      TH1PBS(LS,N2,N1)=TH1PBS(LS,N2,N1)+XH1PBS(LS,N2,N1) &
      -XH1PFS(3,0,N2,N1)-XH1PFS(3,NUM(N2,N1),N2,N1) &
      -XH1PHS(3,NUM(N2,N1),N2,N1)-XH1BFB(3,NUM(N2,N1),N2,N1) &
      -XH1BHB(3,NUM(N2,N1),N2,N1)
      TH2PBS(LS,N2,N1)=TH2PBS(LS,N2,N1)+XH2PBS(LS,N2,N1) &
      -XH2PFS(3,0,N2,N1)-XH2PFS(3,NUM(N2,N1),N2,N1) &
      -XH2PHS(3,NUM(N2,N1),N2,N1)-XH2BFB(3,NUM(N2,N1),N2,N1) &
...
!6646  FORMAT(A8,4I4,60E12.4)
  ...
  !     IF(I.EQ.168)THEN
  !     WRITE(*,6644)'HNH3G',I,J,NX,NY,NU(NY,NX),HNH3G(NY,NX),ZNH3IN
  !    2,XN3DFS(NY,NX),XNBDFS(NY,NX),XN3FLG(3,NU(NY,NX),NY,NX)
  !    2,XN3DFG(0,NY,NX)
  !     WRITE(*,6644)'ZN2GIN',I,J,NX,NY,NU(NY,NX),ZN2GIN,XNGDFS(NY,NX)
  !    3,XN2DFS(NY,NX),XN3DFS(NY,NX)
  !    2,XNBDFS(NY,NX),XNGFLG(3,NU(NY,NX),NY,NX)
  !    2,XN2FLG(3,NU(NY,NX),NY,NX)
...
!------------------------------------------------------------------------------------------
  ...
  subroutine UpdateChemInLayers(NY,NX)
  implicit none
  integer, intent(in) :: NY,NX
...
!------------------------------------------------------------------------------------------
  ...
  subroutine RelayerSoilProfile(L,NY,NX)
  !
  !Description:
  ...
  IF(IERSNG.GE.0)THEN
    ...
    DO 225 LX=NL(NY,NX),NU(NY,NX),-1
      ...
      DDLYR(LX,6)=0.0_r8
      IFLGL(LX,6)=0
      !     WRITE(*,1123)'LAKE',I,J,NX,NY,LX,IFLGL(LX,1),ICHKLX
      !    2,DDLYXP,DDLYX(LX,1),DDLYR(LX,1),VOLAI(LX,NY,NX),VOLY(LX,NY,NX)
      !    3,VOLT(LX,NY,NX),VOLA(LX,NY,NX),VOLW(LX,NY,NX),VOLI(LX,NY,NX)
      !     3,DPTWI,POROS(LX,NY,NX),DLYR(3,LX,NY,NX),BKDS(LX,NY,NX)
      !    4,CDPTH(LX-1,NY,NX),CDPTH(LX,NY,NX)
      !    4,CDPTH(LX,NY,NX)-CDPTH(LX-1,NY,NX)
      !    5,VOLW(LX,NY,NX)+VOLI(LX,NY,NX),DLYR(3,LX,NY,NX)
      !    6-(VOLW(LX,NY,NX)+VOLI(LX,NY,NX))/AREA(3,LX,NY,NX)
      !    7,DVOLI(LX,NY,NX)
!1123  FORMAT(A8,7I4,20E16.8)
    ...
    ELSE
      ...
      IF(ABS(DVOLI(LX,NY,NX)).GT.ZEROS(NY,NX))THEN
        ...
        ENDIF
        !     IF(LX.EQ.5)THEN
        !     WRITE(*,1126)'FREEZ',I,J,NX,NY,LX
        !    2,DDLYX(LX,4),DDLYR(LX,4),DDLYXF
        !    2,VOLP(LX,NY,NX),VOLT(LX,NY,NX),DVOLI(LX,NY,NX),DVOLW(LX,NY,NX)
        !    5,TFLW(LX,NY,NX),FINH(LX,NY,NX)
        !    2,TTHAW(LX,NY,NX),TUPWTR(LX,NY,NX),FLU(LX,NY,NX)
        !    2,VOLA(LX,NY,NX)-VOLI(LX,NY,NX)-VOLW(LX,NY,NX)
        !    4+VOLAH(LX,NY,NX)-VOLIH(LX,NY,NX)-VOLWH(LX,NY,NX)
        !    3,BKDSI(LX,NY,NX),BKDS(LX,NY,NX)
        !    4,DLYR(3,LX,NY,NX),CDPTH(LX,NY,NX)
        !     IF(LX.EQ.NU(NY,NX))THEN
        !     WRITE(*,1111)'FREEZ0',I,J,NX,NY,LX
        !    2,DDLYX(LX-1,4),DDLYR(LX-1,4)
        !    2,DDLYX(LX,4),DDLYR(LX,4),DDLYXF,DDLYX0,DVOLI(LX,NY,NX)*DENSJ
        !    2,BKDS(LX,NY,NX),BKDSI(LX,NY,NX)
        !    4,DLYR(3,LX,NY,NX),CDPTH(LX-1,NY,NX),CDPTH(LX,NY,NX)
        !    5,DVOLI(LX,NY,NX),DVOLW(LX,NY,NX),VOLI(LX,NY,NX),VOLW(LX,NY,NX)
!1126  FORMAT(A8,5I4,30E14.6)
        ...
        !     IF(I.EQ.365.AND.J.EQ.24.AND.LX.EQ.NU(NY,NX))THEN
        !     WRITE(*,1111)'VOLISO',I,J,NX,NY,LX,IFLGL(LX,NN)
        !    5,VOLISO,TDVOLI,TDLYXF,UDVOLI,UDLYXF
        !     ENDIF
        !
        !     EROSION
        !
        ...
        ENDIF
        !     IF(LX.EQ.NU(NY,NX))THEN
        !     WRITE(*,1121)'SED',I,J,NX,NY,LX,DDLYXE,DDLYX(LX,5)
        !    2,TSEDER(NY,NX),BKDS(NU(NY,NX),NY,NX),DLYR(3,LX,NY,NX)
        !    3,BKVLNU(NY,NX),VOLX(NU(NY,NX),NY,NX)
        !    4,BKVLNU(NY,NX)/VOLX(NU(NY,NX),NY,NX)
...
!
        ...
        IFLGL(LX,1)=0
        !     IF(LX.LE.4)THEN
        !     WRITE(*,1111)'SOC',I,J,NX,NY,LX,IFLGL(LX,6),DDLYX(LX,6)
        !    2,DDLYR(LX,6),DDLYXC,DORGC(LX,NY,NX),BKDS(LX,NY,NX)
        !    3,DLYRI(3,LX,NY,NX),DLYR(3,LX,NY,NX)
        !    4,DLYRI(3,LX,NY,NX)-DLYR(3,LX,NY,NX)
        !    5,TDORGC,TDYLXC,CDPTH(0,NY,NX)
!1111  FORMAT(A8,6I4,40E16.8)
        !     IF(LX.EQ.NU(NY,NX).OR.BKDS(LX-1,NY,NX).LE.ZERO)THEN
        !     WRITE(*,1111)'SOC0',I,J,NX,NY,LX,IFLGL(LX-1,6),DDLYX(LX-1,6)
        !    2,DDLYR(LX-1,6),DDLYXC,DORGC(LX,NY,NX),BKDS(LX,NY,NX)
        !    3,DLYRI(3,LX,NY,NX),DLYR(3,LX,NY,NX)
        !    4,DLYRI(3,LX,NY,NX)-DLYR(3,LX,NY,NX)
        !    5,TDORGC,TDYLXC,CDPTH(0,NY,NX)
        !     ENDIF
            ...
            IF(IFLGL(LX,NN).NE.0)THEN
              ...
              IF(LX.NE.NU(NY,NX).AND.IFLGL(LX,1).EQ.2)THEN
                DO 201 LL=LX-1,0,-1
                  ...
                  !     WRITE(*,1116)'DDLYRZ',I,J,NX,NY,LX,LL,IFLGL(LX,1),IFLGL(LX-1,1)
                  !    2,DDLYX(LX,NN),CDPTH(LL,NY,NX),DLYR(3,LX,NY,NX)
                  !    2,VOLW(LX,NY,NX),DVOLW(LX,NY,NX),AREA(3,LX,NY,NX)
...
201             CONTINUE
              ...
              !     ENDIF
              !     IF(J.EQ.24)THEN
              !     WRITE(*,1117)'POND',I,J,NX,NY,LX,NN,IFLGL(LX,NN),ICHKLX
              !     2,DDLYXP,DDLYX(LX,NN),DDLYR(LX,NN),DLYR(3,LX,NY,NX)
              !    3,VOLW(LX,NY,NX),VOLI(LX,NY,NX)
              !    4,CDPTH(LX-1,NY,NX),CDPTH(LX,NY,NX)
              !    4,CDPTH(LX,NY,NX)-CDPTH(LX-1,NY,NX)
              !    5,VOLW(LX,NY,NX)+VOLI(LX,NY,NX)
!1117  FORMAT(A8,8I4,12E16.8)
              ...
              IF(LX.EQ.NU(NY,NX))THEN
                ...
                CDPTHY(LX-1,NY,NX)=CDPTHY(LX,NY,NX) &
                  -(VOLW(LX,NY,NX)+VOLI(LX,NY,NX))/AREA(3,LX,NY,NX)
                !     WRITE(*,1128)'POND0',I,J,NX,NY,LX,NN,IFLGL(LX-1,NN)
                !    2,DDLYR(LX-1,NN),DDLYR(LX,NN),CDPTH(LX-1,NY,NX),CDPTH(LX,NY,NX)
                !    4,DLYR(3,LX,NY,NX)
              ENDIF
            ENDIF
            !
          ...
          ELSE
            ...
            IF(NN.EQ.4)THEN
              CDPTH(LX,NY,NX)=CDPTH(LX,NY,NX)+DDLYR(LX,NN)
              !     CDPTHY(LX,NY,NX)=CDPTHY(LX,NY,NX)+DDLYR(LX,NN)
              !     WRITE(*,1127)'DFREEZ',I,J,NX,NY,LX,IFLGL(LX,NN)
              !    2,DDLYR(LX,NN),CDPTH(LX,NY,NX),DLYR(3,LX,NY,NX),DDLYXF
              !    5,CDPTH(LX,NY,NX)-CDPTH(LX-1,NY,NX)
              IF(LX.EQ.NU(NY,NX))THEN
                CDPTH(LX-1,NY,NX)=CDPTH(LX-1,NY,NX)+DDLYR(LX-1,NN)
                !     CDPTHY(LX-1,NY,NX)=CDPTHY(LX-1,NY,NX)+DDLYR(LX-1,NN)
                !     WRITE(*,1127)'DFREEZ0',I,J,NX,NY,LX,IFLGL(LX-1,NN)
                !    2,DDLYR(LX-1,NN),DDLYR(LX,NN),CDPTH(LX-1,NY,NX)
                !    3,CDPTH(LX,NY,NX),DLYR(3,LX,NY,NX),DDLYXF
                !    5,CDPTH(LX,NY,NX)-CDPTH(LX-1,NY,NX)
!1127  FORMAT(A8,6I4,30E16.8)
            ...
            IF(NN.EQ.5.AND.IFLGL(LX,NN).EQ.1)THEN
              CDPTH(LX,NY,NX)=CDPTH(LX,NY,NX)+DDLYR(LX,NN)
              CDPTHY(LX,NY,NX)=CDPTHY(LX,NY,NX)+DDLYR(LX,NN)
              !     WRITE(*,1122)'CDSED',I,J,NX,NY,LX,IFLGL(LX,5),DDLYR(LX,5)
              !    2,CDPTH(LX,NY,NX),DLYR(3,LX,NY,NX)
!1122  FORMAT(A8,6I4,12E16.8)
              IF(LX.EQ.NU(NY,NX))THEN
                CDPTH(LX-1,NY,NX)=CDPTH(LX-1,NY,NX)+DDLYR(LX,NN)
                CDPTHY(LX-1,NY,NX)=CDPTHY(LX-1,NY,NX)+DDLYR(LX,NN)
                !     WRITE(*,1122)'CDSED0',I,J,NX,NY,LX,IFLGL(LX,5),DDLYR(LX,5)
                !    2,CDPTH(LX-1,NY,NX),CDPTH(LX,NY,NX),DLYR(3,LX,NY,NX)
              ENDIF
            ENDIF
            !
            ...
            IF(NN.EQ.6.AND.IFLGL(LX,NN).EQ.1)THEN
              ...
              CDPTHY(LX,NY,NX)=CDPTHY(LX,NY,NX)+DDLYR(LX,NN)
              !     IF(NX.EQ.1)THEN
              !     WRITE(*,1128)'DSOC',I,J,NX,NY,LX,NN,IFLGL(LX,NN)
              !    2,DDLYR(LX,NN),DDLYXC,CDPTH(LX,NY,NX),DLYR(3,LX,NY,NX)
              !    3,CDPTH(0,NY,NX)
!1128  FORMAT(A8,7I4,30E16.8)
              ...
              IF(LX.EQ.NU(NY,NX).OR.BKDS(LX-1,NY,NX).LE.ZERO)THEN
                ...
                CDPTHY(LX-1,NY,NX)=CDPTHY(LX-1,NY,NX)+DDLYR(LX-1,NN)
                !     IF(NX.EQ.1)THEN
                !     WRITE(*,1128)'DSOC0',I,J,NX,NY,LX,NN,IFLGL(LX-1,NN)
                !    2,DDLYR(LX-1,NN),DDLYXC,CDPTH(LX-1,NY,NX)
                !    3,DLYR(3,LX-1,NY,NX),CDPTH(0,NY,NX)
                !     ENDIF
                IF(BKDS(LX-1,NY,NX).LE.ZERO)THEN
                  DO 255 LY=LX-2,0,-1
                    IF(BKDS(LY+1,NY,NX).LE.ZERO)THEN
                      ...
                      !     WRITE(*,1129)'DCDPTH',I,J,NX,NY,LX,LY,NN,IFLGL(LX,NN)
                      !    2,DDLYR(LX-1,NN),CDPTH(LY,NY,NX),DLYR(3,LY,NY,NX)
                      !    3,CDPTH(0,NY,NX)
    ...
    DO 245 L=NU(NY,NX),NL(NY,NX)-1
      DO 230 NN=1,3
        IF(NN.EQ.1)THEN
          ...
          ENDIF
            !     IF(NX.EQ.1)THEN
            !     WRITE(*,1114)'DDLYR',I,J,NX,NY,L,NN,IFLGL(L,1),IFLGL(L+1,1)
          !    2,ICHKL,DDLYRX(NN),DDLYRY(L),(DDLYR(L,NM),NM=1,6)
          !    2,DVOLI(L,NY,NX),TSEDER(NY,NX),DORGC(L,NY,NX),DORGE(NY,NX)
          !    4,VOLTI(L,NY,NX),VOLT(L,NY,NX),VOLA(L,NY,NX),VOLW(L,NY,NX)
          !    4,VOLI(L,NY,NX),VOLP(L,NY,NX),DVOLW(L,NY,NX),DVOLI(L,NY,NX)
          !    5,DLYRI(3,L,NY,NX),DLYR(3,L,NY,NX),DLYRI(3,L+1,NY,NX)
          !    5,DLYR(3,L+1,NY,NX),CDPTH(L-1,NY,NX),CDPTH(L,NY,NX)
          !    4,VOLI(L,NY,NX),VOLP(L,NY,NX),DVOLW(L,NY,NX)
          !    5,VOLW(L,NY,NX)+VOLI(L,NY,NX)
          !    5,BKDS(L,NY,NX),BKDSI(L,NY,NX)
          !    6,DTBLZ(NY,NX),DTBLX(NY,NX)
          !    7,VOLAH(L,NY,NX),VOLWH(L,NY,NX),VOLIH(L,NY,NX)
          !    8,ORGCX(L,NY,NX),ORGC(L,NY,NX)
          ...
          IF((L.EQ.NU(NY,NX).AND.BKDS(NU(NY,NX),NY,NX).LE.ZERO) &
            ...
            DO 9970 LL=NUX+1,NL(NY,NX)
              IF(VOLX(LL,NY,NX).GT.ZEROS2(NY,NX))THEN
                ...
                ENDIF
                !     WRITE(*,5598)'SURFX',I,J,NX,NY,L,LL,NUX,NU(NY,NX),NUM(NY,NX)
...
260           CONTINUE
            ...
            !     WRITE(*,5597)'SURFY',I,J,NX,NY,L,NUI(NY,NX),NU(NY,NX)
            !    2,NUM(NY,NX),IFLGL(L,NN),VOLWD(NY,NX),XVOLWP,DDLYRX(NN)
            !    2,DLYR0,DLYR(3,0,NY,NX),DLYR(3,NU(NY,NX),NY,NX),ORGC(0,NY,NX)
            !    2,VOLW(0,NY,NX),VOLX(0,NY,NX),VOLW(NU(NY,NX),NY,NX)
            !    3,CDPTH(0,NY,NX),CDPTH(NU(NY,NX),NY,NX),VOLR(NY,NX)
!5597  FORMAT(A8,9I4,20E16.8)
      ...
      IF(ABS(DDLYRX(NN)).GT.ZERO)THEN
        ...
        ENDIF
      ENDIF
      !     WRITE(*,5601)'FX',I,J,NX,NY,L,L0,L1,NN,FO,FX
      !    2,DDLYRX(NN),VOLW(L0,NY,NX),BKDS(L0,NY,NX),DPTWI
      !    3,DLYR(3,L1,NY,NX),DLYR(3,L0,NY,NX)
!5601  FORMAT(A8,8I4,20E12.4)
      IF(FX.GT.ZERO)THEN
        ...
        IF(BKDS(L0,NY,NX).LE.ZERO)THEN
          !     IF(NX.EQ.1)THEN
          !     WRITE(*,5599)'POND1',I,J,NX,NY,L,L0,L1,NU(NY,NX),NN,FX,FY
              ...
              IF(WTRTL(1,L0,NZ,NY,NX).GT.ZEROP(NZ,NY,NX) &
                ...
                DO 8895 N=1,MY(NZ,NY,NX)
                  ...
                  DO 8870 NR=1,NRT(NZ,NY,NX)
                    WTRT1(N,L1,NR,NZ,NY,NX)=WTRT1(N,L1,NR,NZ,NY,NX)+FX*WTRT1(N,L0,NR,NZ,NY,NX)
                    WTRT1N(N,L1,NR,NZ,NY,NX)=WTRT1N(N,L1,NR,NZ,NY,NX)+FX*WTRT1N(N,L0,NR,NZ,NY,NX)
                    WTRT1P(N,L1,NR,NZ,NY,NX)=WTRT1P(N,L1,NR,NZ,NY,NX)+FX*WTRT1P(N,L0,NR,NZ,NY,NX)
                    WTRT2(N,L1,NR,NZ,NY,NX)=WTRT2(N,L1,NR,NZ,NY,NX)+FX*WTRT2(N,L0,NR,NZ,NY,NX)
                    WTRT2N(N,L1,NR,NZ,NY,NX)=WTRT2N(N,L1,NR,NZ,NY,NX)+FX*WTRT2N(N,L0,NR,NZ,NY,NX)
                    WTRT2P(N,L1,NR,NZ,NY,NX)=WTRT2P(N,L1,NR,NZ,NY,NX)+FX*WTRT2P(N,L0,NR,NZ,NY,NX)
...
8870              CONTINUE
                  CPOOLR(N,L1,NZ,NY,NX)=CPOOLR(N,L1,NZ,NY,NX)+FX*CPOOLR(N,L0,NZ,NY,NX)
                  ZPOOLR(N,L1,NZ,NY,NX)=ZPOOLR(N,L1,NZ,NY,NX)+FX*ZPOOLR(N,L0,NZ,NY,NX)
                  PPOOLR(N,L1,NZ,NY,NX)=PPOOLR(N,L1,NZ,NY,NX)+FX*PPOOLR(N,L0,NZ,NY,NX)
...
8895            CONTINUE
                WTNDL(L1,NZ,NY,NX)=WTNDL(L1,NZ,NY,NX)+FX*WTNDL(L0,NZ,NY,NX)
                WTNDLN(L1,NZ,NY,NX)=WTNDLN(L1,NZ,NY,NX)+FX*WTNDLN(L0,NZ,NY,NX)
                WTNDLP(L1,NZ,NY,NX)=WTNDLP(L1,NZ,NY,NX)+FX*WTNDLP(L0,NZ,NY,NX)
                CPOOLN(L1,NZ,NY,NX)=CPOOLN(L1,NZ,NY,NX)+FX*CPOOLN(L0,NZ,NY,NX)
                ZPOOLN(L1,NZ,NY,NX)=ZPOOLN(L1,NZ,NY,NX)+FX*ZPOOLN(L0,NZ,NY,NX)
                PPOOLN(L1,NZ,NY,NX)=PPOOLN(L1,NZ,NY,NX)+FX*PPOOLN(L0,NZ,NY,NX)
              ENDIF
8900        CONTINUE
          ENDIF
!
...
!
        ...
        IF(L0.NE.0)THEN
          IF(DLYR(3,L1,NY,NX).GT.ZERO &
            .AND.DLYR(3,L0,NY,NX).GT.ZERO)THEN
    !
    ...
    !
            IF(IFNHB(NY,NX).EQ.1.AND.ROWN(NY,NX).GT.0.0)THEN
              IF(L.EQ.NU(NY,NX).OR.CDPTH(L-1,NY,NX).LT.DPNH4(NY,NX))THEN
                ...
                !     WRITE(*,6601)'VLNHB',I,J,NX,NY,L,L0,L1,FX
                !    2,WDNHB(L0,NY,NX),WDNHB(L1,NY,NX),DPNHB(L0,NY,NX),DPNHB(L1,NY,NX)
                !    2,VLNHB(L0,NY,NX),DLYR(3,L0,NY,NX),VLNHB(L1,NY,NX),DLYR(3,L1,NY,NX)
                !    2,VLNHB(L0,NY,NX)*DLYR(3,L0,NY,NX)+VLNHB(L1,NY,NX)*DLYR(3,L1,NY,NX)
                !    3,WDNHBDL,WDNHBD0,WDNHBD1,FXWDNHB,FXDPNHB,DPNH4(NY,NX)
!6601  FORMAT(A8,7I4,30E16.8)
            ...
            IF(IFNOB(NY,NX).EQ.1.AND.ROWO(NY,NX).GT.0.0)THEN
              IF(L.EQ.NU(NY,NX).OR.CDPTH(L-1,NY,NX).LT.DPNO3(NY,NX))THEN
                ...
                !     WRITE(*,6601)'VLNOB',I,J,NX,NY,L,L0,L1,FX
                !    2,WDNOB(L0,NY,NX),WDNOB(L1,NY,NX),DPNOB(L0,NY,NX),DPNOB(L1,NY,NX)
                !    2,VLNOB(L0,NY,NX),DLYR(3,L0,NY,NX),VLNOB(L1,NY,NX),DLYR(3,L1,NY,NX)
                !    2,VLNOB(L0,NY,NX)*DLYR(3,L0,NY,NX)+VLNOB(L1,NY,NX)*DLYR(3,L1,NY,NX)
                !    3,WDNOBDL,WDNOBD0,WDNOBD1,FXWDNOB,FXDPNOB,DPNO3(NY,NX)
              ENDIF
            ENDIF
            IF(IFPOB(NY,NX).EQ.1.AND.ROWP(NY,NX).GT.0.0)THEN
              IF(L.EQ.NU(NY,NX).OR.CDPTH(L-1,NY,NX).LT.DPPO4(NY,NX))THEN
                ...
                !     WRITE(*,6601)'VLPOB',I,J,NX,NY,L,L0,L1,FX
                !    2,WDPOB(L0,NY,NX),WDPOB(L1,NY,NX),DPPOB(L0,NY,NX),DPPOB(L1,NY,NX)
                !    2,VLPOB(L0,NY,NX),DLYR(3,L0,NY,NX),VLPOB(L1,NY,NX),DLYR(3,L1,NY,NX)
                !    2,VLPOB(L0,NY,NX)*DLYR(3,L0,NY,NX)+VLPOB(L1,NY,NX)*DLYR(3,L1,NY,NX)
                !    3,WDPOBDL,WDPOBD0,WDPOBD1,FXWDPOB,FXDPPOB,DPPO4(NY,NX)
              ENDIF
            ENDIF
          ENDIF
          !
...
6005  CONTINUE
      ...
      ENDIF
!     IF(NX.EQ.1)THEN
!     WRITE(*,5591)'SOIL2',I,J,NX,NY,L,L0,L1,NN,DDLYRX(NN),FX,FO
!    1,ZNH4SH(L0,NY,NX),ZNH4SH(L1,NY,NX),FXZNH4SH
...
!    3,VOLY(L0,NY,NX),VOLY(L1,NY,NX),VOLY(L0,NY,NX)+VOLY(L1,NY,NX)
!    6,DLYR(3,L0,NY,NX),DLYR(3,L1,NY,NX)
...
!    7,VHCM(L0,NY,NX),VHCM(L1,NY,NX),ENGY0,ENGY1,FXENGY
!    6,ZNH4S(L0,NY,NX),ZNH4B(L0,NY,NX),ZNH3S(L0,NY,NX),ZNH3B(L0,NY,NX)
!    6,ZNH4S(L1,NY,NX),ZNH4B(L1,NY,NX),ZNH3S(L1,NY,NX),ZNH3B(L1,NY,NX)
...
!
      ...
      NL(NY,NX)=L
!     WRITE(*,5595)'ERSNX2',I,J,NX,NY,L,NLI(NY,NX),NL(NY,NX)
!    2,DLYR(3,NL(NY,NX)+1,NY,NX),CDPTH(NL(NY,NX),NY,NX)
