...
!
  ...
  implicit none
      ...
      real(r8) :: CC0PB1,CC1PB1,CC2PB1,CM1PB1,DLYR0,DLYR1,DISPN
      real(r8) :: DIFPO,DIFAL,DIFFE,DIFHY,DIFCA,DIFMG,DIFNA,DIFKA
      real(r8) :: DIFOH,DIFSO,DIFCL,DIFC3,DIFHC,DFVAL,DFVFE,DFVHY
      ...
      real(r8) :: DFVC1B,DFVC2B,DFVM1B,DFVF22,DLYR2,DFHAL,DFHFE
      ...
      real(r8) :: DFHC0B,DFHC1B,DFHC2B,DFHM1B,FLWRM1,FQRM,RALFLS0
      ...
      real(r8) :: RF2BFB1,RC0BFB1,RC1BFB1,RC2BFB1,RM1BFB1,RFLAL
      real(r8) :: RFLFE,RFLHY,RFLCA,RFLMG,RFLNA,RFLKA,RFLOH,RFLSO
      real(r8) :: RFLCL,RFLC3,RFLHC,RFLAL1,RFLAL2,RFLAL3,RFLAL4
      ...
      real(r8) :: RFLF2B,RFLC0B,RFLC1B,RFLC2B,RFLM1B,RFHAL,RFHFE
      ...
      real(r8) :: RFHC0B,RFHC1B,RFHC2B,RFHM1B,RCHQF,RCHGFU,RCHGFT
      real(r8) :: TORT0,TORT1,TORTL,VFLWW,VFLWR,VFLWS,VFLWPO4,VFLWPOB
      ...
      ,ZCA2(0:JZ,JY,JX),ZMG2(0:JZ,JY,JX),ZNA2(0:JZ,JY,JX) &
      ,ZKA2(0:JZ,JY,JX),ZOH2(0:JZ,JY,JX),ZSO42(0:JZ,JY,JX) &
      ,ZHCO32(0:JZ,JY,JX),ZCL2(0:JZ,JY,JX),ZCO32(0:JZ,JY,JX) &
      ,ZAL12(0:JZ,JY,JX),ZAL22(0:JZ,JY,JX),ZAL32(0:JZ,JY,JX) &
      ,ZAL42(0:JZ,JY,JX),ZALS2(0:JZ,JY,JX),ZFE12(0:JZ,JY,JX) &
      ,ZFE22(0:JZ,JY,JX),ZFE32(0:JZ,JY,JX),ZFE42(0:JZ,JY,JX) &
      ,ZFES2(0:JZ,JY,JX),ZCAO2(0:JZ,JY,JX),ZCAC2(0:JZ,JY,JX) &
      ,ZCAH2(0:JZ,JY,JX),ZCAS2(0:JZ,JY,JX),ZMGO2(0:JZ,JY,JX) &
      ,ZMGC2(0:JZ,JY,JX),ZMGH2(0:JZ,JY,JX),ZMGS2(0:JZ,JY,JX) &
      ,ZNAC2(0:JZ,JY,JX),ZNAS2(0:JZ,JY,JX),ZKAS2(0:JZ,JY,JX) &
      ,H0PO42(0:JZ,JY,JX),H3PO42(0:JZ,JY,JX) &
      ,ZFE1P2(0:JZ,JY,JX),ZFE2P2(0:JZ,JY,JX),ZCA0P2(0:JZ,JY,JX) &
      ,ZCA1P2(0:JZ,JY,JX),ZCA2P2(0:JZ,JY,JX),ZMG1P2(0:JZ,JY,JX) &
      ,H0POB2(JZ,JY,JX),H3POB2(JZ,JY,JX) &
      ,ZF1PB2(JZ,JY,JX),ZF2PB2(JZ,JY,JX),ZC0PB2(JZ,JY,JX) &
      ,ZC1PB2(JZ,JY,JX),ZC2PB2(JZ,JY,JX),ZM1PB2(JZ,JY,JX)
      real(r8) :: RZAL2(0:JZ,JY,JX),RZFE2(0:JZ,JY,JX),RZHY2(0:JZ,JY,JX) &
      ,RZCA2(0:JZ,JY,JX),RZMG2(0:JZ,JY,JX),RZNA2(0:JZ,JY,JX) &
      ,RZKA2(0:JZ,JY,JX),RZOH2(0:JZ,JY,JX),RZSO42(0:JZ,JY,JX) &
      ,RZHCO32(0:JZ,JY,JX),RZCL2(0:JZ,JY,JX),RZCO32(0:JZ,JY,JX) &
      ,RZAL12(0:JZ,JY,JX),RZAL22(0:JZ,JY,JX),RZAL32(0:JZ,JY,JX) &
      ,RZAL42(0:JZ,JY,JX),RZALS2(0:JZ,JY,JX),RZFE12(0:JZ,JY,JX) &
      ,RZFE22(0:JZ,JY,JX),RZFE32(0:JZ,JY,JX),RZFE42(0:JZ,JY,JX) &
      ,RZFES2(0:JZ,JY,JX),RZCAO2(0:JZ,JY,JX),RZCAC2(0:JZ,JY,JX) &
      ,RZCAH2(0:JZ,JY,JX),RZCAS2(0:JZ,JY,JX),RZMGO2(0:JZ,JY,JX) &
      ,RZMGC2(0:JZ,JY,JX),RZMGH2(0:JZ,JY,JX),RZMGS2(0:JZ,JY,JX) &
      ,RZNAC2(0:JZ,JY,JX),RZNAS2(0:JZ,JY,JX),RZKAS2(0:JZ,JY,JX) &
      ,RH0PO42(0:JZ,JY,JX),RH3PO42(0:JZ,JY,JX) &
      ,RZFE1P2(0:JZ,JY,JX),RZFE2P2(0:JZ,JY,JX),RZCA0P2(0:JZ,JY,JX) &
      ,RZCA1P2(0:JZ,JY,JX),RZCA2P2(0:JZ,JY,JX),RZMG1P2(0:JZ,JY,JX) &
      ,RH0POB2(JZ,JY,JX),RH3POB2(JZ,JY,JX) &
      ,RZF1PB2(JZ,JY,JX),RZF2PB2(JZ,JY,JX),RZC0PB2(JZ,JY,JX) &
      ,RZC1PB2(JZ,JY,JX),RZC2PB2(JZ,JY,JX),RZM1PB2(JZ,JY,JX)
      real(r8) :: ZALW2(JS,JY,JX),ZFEW2(JS,JY,JX),ZHYW2(JS,JY,JX) &
      ,ZCAW2(JS,JY,JX),ZMGW2(JS,JY,JX),ZNAW2(JS,JY,JX) &
      ,ZKAW2(JS,JY,JX),ZOHW2(JS,JY,JX),ZSO4W2(JS,JY,JX) &
      ,ZCLW2(JS,JY,JX),ZCO3W2(JS,JY,JX),ZHCO3W2(JS,JY,JX) &
      ,ZALH1W2(JS,JY,JX),ZALH2W2(JS,JY,JX),ZALH3W2(JS,JY,JX) &
      ,ZALH4W2(JS,JY,JX),ZALSW2(JS,JY,JX),ZFEH1W2(JS,JY,JX) &
      ,ZFEH2W2(JS,JY,JX),ZFEH3W2(JS,JY,JX),ZFEH4W2(JS,JY,JX) &
      ,ZFESW2(JS,JY,JX),ZCAOW2(JS,JY,JX),ZCACW2(JS,JY,JX) &
      ,ZCAHW2(JS,JY,JX),ZCASW2(JS,JY,JX),ZMGOW2(JS,JY,JX) &
      ,ZMGCW2(JS,JY,JX),ZMGHW2(JS,JY,JX),ZMGSW2(JS,JY,JX) &
      ,ZNACW2(JS,JY,JX),ZNASW2(JS,JY,JX),ZKASW2(JS,JY,JX) &
      ,H0PO4W2(JS,JY,JX),H3PO4W2(JS,JY,JX),ZFE1PW2(JS,JY,JX) &
      ,ZFE2PW2(JS,JY,JX),ZCA0PW2(JS,JY,JX),ZCA1PW2(JS,JY,JX) &
      ,ZCA2PW2(JS,JY,JX),ZMG1PW2(JS,JY,JX)
      real(r8) :: ZALH2(JZ,JY,JX),ZFEH2(JZ,JY,JX),ZHYH2(JZ,JY,JX) &
      ,ZCCH2(JZ,JY,JX),ZMAH2(JZ,JY,JX),ZNAH2(JZ,JY,JX) &
      ,ZKAH2(JZ,JY,JX),ZOHH2(JZ,JY,JX),ZSO4H2(JZ,JY,JX) &
      ,ZCLH2(JZ,JY,JX),ZCO3H2(JZ,JY,JX),ZHCOH2(JZ,JY,JX) &
      ,ZAL1H2(JZ,JY,JX),ZAL2H2(JZ,JY,JX),ZAL3H2(JZ,JY,JX) &
      ,ZAL4H2(JZ,JY,JX),ZALSH2(JZ,JY,JX),ZFE1H2(JZ,JY,JX) &
      ,ZFE2H2(JZ,JY,JX),ZFE3H2(JZ,JY,JX),ZFE4H2(JZ,JY,JX) &
      ,ZFESH2(JZ,JY,JX),ZCAOH2(JZ,JY,JX),ZCACH2(JZ,JY,JX) &
      ,ZCAHH2(JZ,JY,JX),ZCASH2(JZ,JY,JX),ZMGOH2(JZ,JY,JX) &
      ,ZMGCH2(JZ,JY,JX),ZMGHH2(JZ,JY,JX),ZMGSH2(JZ,JY,JX) &
      ,ZNACH2(JZ,JY,JX),ZNASH2(JZ,JY,JX),ZKASH2(JZ,JY,JX) &
      ,H0P4H2(JZ,JY,JX),H3P4H2(JZ,JY,JX) &
      ,ZF1PH2(JZ,JY,JX),ZF2PH2(JZ,JY,JX),ZC0PH2(JZ,JY,JX) &
      ,ZC1PH2(JZ,JY,JX),ZC2PH2(JZ,JY,JX),ZM1PH2(JZ,JY,JX) &
      ,H0PBH2(JZ,JY,JX),H3PBH2(JZ,JY,JX) &
      ,ZF1BH2(JZ,JY,JX),ZF2BH2(JZ,JY,JX),ZC0BH2(JZ,JY,JX) &
      ,ZC1BH2(JZ,JY,JX),ZC2BH2(JZ,JY,JX),ZM1BH2(JZ,JY,JX)
      real(r8) :: ALSGL2(JZ,JY,JX),FESGL2(JZ,JY,JX),HYSGL2(JZ,JY,JX) &
      ,CASGL2(JZ,JY,JX),GMSGL2(JZ,JY,JX),ANSGL2(JZ,JY,JX) &
      ,AKSGL2(JZ,JY,JX),OHSGL2(JZ,JY,JX),C3SGL2(JZ,JY,JX) &
      ,HCSGL2(JZ,JY,JX),SOSGL2(JZ,JY,JX),CLSXL2(JZ,JY,JX) &
      ,RQRAL(2,2,JV,JH),RQRFE(2,2,JV,JH),RQRHY(2,2,JV,JH) &
      ,RQRCA(2,2,JV,JH),RQRMG(2,2,JV,JH),RQRNA(2,2,JV,JH) &
      ,RQRKA(2,2,JV,JH),RQROH(2,2,JV,JH),RQRSO(2,2,JV,JH) &
      ,RQRCL(2,2,JV,JH),RQRC3(2,2,JV,JH),RQRHC(2,2,JV,JH) &
      ,RQRAL1(2,2,JV,JH),RQRAL2(2,2,JV,JH),RQRAL3(2,2,JV,JH) &
      ,RQRAL4(2,2,JV,JH),RQRALS(2,2,JV,JH),RQRFE1(2,2,JV,JH) &
      ,RQRFE2(2,2,JV,JH),RQRFE3(2,2,JV,JH),RQRFE4(2,2,JV,JH) &
      ,RQRFES(2,2,JV,JH),RQRCAO(2,2,JV,JH),RQRCAC(2,2,JV,JH) &
      ,RQRCAH(2,2,JV,JH),RQRCAS(2,2,JV,JH),RQRMGO(2,2,JV,JH) &
      ,RQRMGC(2,2,JV,JH),RQRMGH(2,2,JV,JH),RQRMGS(2,2,JV,JH) &
      ,RQRNAC(2,2,JV,JH),RQRNAS(2,2,JV,JH),RQRKAS(2,2,JV,JH) &
      ,RQRH0P(2,2,JV,JH),RQRH3P(2,2,JV,JH),RQRF1P(2,2,JV,JH) &
      ,RQRF2P(2,2,JV,JH),RQRC0P(2,2,JV,JH),RQRC1P(2,2,JV,JH) &
      ,RQRC2P(2,2,JV,JH),RQRM1P(2,2,JV,JH) &
      ,RQSAL(2,JV,JH),RQSFE(2,JV,JH),RQSHY(2,JV,JH),RQSCA(2,JV,JH) &
      ,RQSMG(2,JV,JH),RQSNA(2,JV,JH),RQSKA(2,JV,JH),RQSOH(2,JV,JH) &
      ,RQSSO(2,JV,JH),RQSCL(2,JV,JH),RQSC3(2,JV,JH),RQSHC(2,JV,JH) &
      ,RQSAL1(2,JV,JH),RQSAL2(2,JV,JH),RQSAL3(2,JV,JH) &
      ,RQSAL4(2,JV,JH),RQSALS(2,JV,JH),RQSFE1(2,JV,JH) &
      ,RQSFE2(2,JV,JH),RQSFE3(2,JV,JH),RQSFE4(2,JV,JH) &
      ,RQSFES(2,JV,JH),RQSCAO(2,JV,JH),RQSCAC(2,JV,JH) &
      ,RQSCAH(2,JV,JH),RQSCAS(2,JV,JH),RQSMGO(2,JV,JH),RQSMGC(2,JV,JH) &
      ,RQSMGH(2,JV,JH),RQSMGS(2,JV,JH),RQSNAC(2,JV,JH),RQSNAS(2,JV,JH) &
      ,RQSKAS(2,JV,JH),RQSH0P(2,JV,JH),RQSH3P(2,JV,JH) &
      ,RQSF1P(2,JV,JH),RQSF2P(2,JV,JH),RQSC0P(2,JV,JH),RQSC1P(2,JV,JH) &
      ,RQSC2P(2,JV,JH),RQSM1P(2,JV,JH)
      real(r8) :: RALFLS(3,0:JD,JV,JH),RFEFLS(3,0:JD,JV,JH) &
      ,RHYFLS(3,0:JD,JV,JH),RCAFLS(3,0:JD,JV,JH),RMGFLS(3,0:JD,JV,JH) &
      ,RNAFLS(3,0:JD,JV,JH),RKAFLS(3,0:JD,JV,JH),ROHFLS(3,0:JD,JV,JH) &
      ,RSOFLS(3,0:JD,JV,JH),RCLFLS(3,0:JD,JV,JH),RC3FLS(3,0:JD,JV,JH) &
      ,RHCFLS(3,0:JD,JV,JH),RAL1FS(3,0:JD,JV,JH),RAL2FS(3,0:JD,JV,JH) &
      ,RAL3FS(3,0:JD,JV,JH),RAL4FS(3,0:JD,JV,JH),RALSFS(3,0:JD,JV,JH) &
      ,RFE1FS(3,0:JD,JV,JH),RFE2FS(3,0:JD,JV,JH),RFE3FS(3,0:JD,JV,JH) &
      ,RFE4FS(3,0:JD,JV,JH),RFESFS(3,0:JD,JV,JH),RCAOFS(3,0:JD,JV,JH) &
      ,RCACFS(3,0:JD,JV,JH),RCAHFS(3,0:JD,JV,JH) &
      ,RCASFS(3,0:JD,JV,JH),RMGOFS(3,0:JD,JV,JH),RMGCFS(3,0:JD,JV,JH) &
      ,RMGHFS(3,0:JD,JV,JH),RMGSFS(3,0:JD,JV,JH),RNACFS(3,0:JD,JV,JH) &
      ,RNASFS(3,0:JD,JV,JH),RKASFS(3,0:JD,JV,JH),RH0PFS(3,0:JD,JV,JH) &
      ,RH3PFS(3,0:JD,JV,JH),RF1PFS(3,0:JD,JV,JH) &
      ,RF2PFS(3,0:JD,JV,JH),RC0PFS(3,0:JD,JV,JH),RC1PFS(3,0:JD,JV,JH) &
      ,RC2PFS(3,0:JD,JV,JH),RM1PFS(3,0:JD,JV,JH),RH0BFB(3,0:JD,JV,JH) &
      ,RH3BFB(3,0:JD,JV,JH),RF1BFB(3,0:JD,JV,JH) &
      ,RF2BFB(3,0:JD,JV,JH),RC0BFB(3,0:JD,JV,JH),RC1BFB(3,0:JD,JV,JH) &
      ,RC2BFB(3,0:JD,JV,JH),RM1BFB(3,0:JD,JV,JH)
      real(r8) :: RALFHS(3,JD,JV,JH),RFEFHS(3,JD,JV,JH) &
      ,RHYFHS(3,JD,JV,JH),RCAFHS(3,JD,JV,JH),RMGFHS(3,JD,JV,JH) &
      ,RNAFHS(3,JD,JV,JH),RKAFHS(3,JD,JV,JH),ROHFHS(3,JD,JV,JH) &
      ,RC3FHS(3,JD,JV,JH),RHCFHS(3,JD,JV,JH),RSOFHS(3,JD,JV,JH) &
      ,RCLFHS(3,JD,JV,JH),RAL1HS(3,JD,JV,JH),RAL2HS(3,JD,JV,JH) &
      ,RAL3HS(3,JD,JV,JH),RAL4HS(3,JD,JV,JH),RALSHS(3,JD,JV,JH) &
      ,RFE1HS(3,JD,JV,JH),RFE2HS(3,JD,JV,JH),RFE3HS(3,JD,JV,JH) &
      ,RFE4HS(3,JD,JV,JH),RFESHS(3,JD,JV,JH),RCAOHS(3,JD,JV,JH) &
      ,RCACHS(3,JD,JV,JH),RCAHHS(3,JD,JV,JH) &
      ,RCASHS(3,JD,JV,JH),RMGOHS(3,JD,JV,JH),RMGCHS(3,JD,JV,JH) &
      ,RMGHHS(3,JD,JV,JH),RMGSHS(3,JD,JV,JH),RNACHS(3,JD,JV,JH) &
      ,RNASHS(3,JD,JV,JH),RKASHS(3,JD,JV,JH),RH0PHS(3,JD,JV,JH) &
      ,RH3PHS(3,JD,JV,JH),RF1PHS(3,JD,JV,JH) &
      ,RF2PHS(3,JD,JV,JH),RC0PHS(3,JD,JV,JH),RC1PHS(3,JD,JV,JH) &
      ,RC2PHS(3,JD,JV,JH),RM1PHS(3,JD,JV,JH),RH0BHB(3,JD,JV,JH) &
      ,RH3BHB(3,JD,JV,JH),RF1BHB(3,JD,JV,JH) &
      ,RF2BHB(3,JD,JV,JH),RC0BHB(3,JD,JV,JH),RC1BHB(3,JD,JV,JH) &
      ,RC2BHB(3,JD,JV,JH),RM1BHB(3,JD,JV,JH)
      ...
      ,RFEFXS(JZ,JY,JX),RHYFXS(JZ,JY,JX),RCAFXS(JZ,JY,JX) &
      ,RMGFXS(JZ,JY,JX),RNAFXS(JZ,JY,JX),RKAFXS(JZ,JY,JX) &
      ,ROHFXS(JZ,JY,JX),RSOFXS(JZ,JY,JX),RCLFXS(JZ,JY,JX) &
      ,RC3FXS(JZ,JY,JX),RHCFXS(JZ,JY,JX),RAL1XS(JZ,JY,JX) &
      ,RAL2XS(JZ,JY,JX),RAL3XS(JZ,JY,JX),RAL4XS(JZ,JY,JX) &
      ,RALSXS(JZ,JY,JX),RFE1XS(JZ,JY,JX),RFE2XS(JZ,JY,JX) &
      ,RFE3XS(JZ,JY,JX),RFE4XS(JZ,JY,JX),RFESXS(JZ,JY,JX) &
      ,RCACXS(JZ,JY,JX),RCAOXS(JZ,JY,JX),RCAHXS(JZ,JY,JX) &
      ,RCASXS(JZ,JY,JX),RMGOXS(JZ,JY,JX),RMGCXS(JZ,JY,JX) &
      ,RMGHXS(JZ,JY,JX),RMGSXS(JZ,JY,JX),RNACXS(JZ,JY,JX) &
      ,RNASXS(JZ,JY,JX),RKASXS(JZ,JY,JX)
      real(r8) :: RH0PXS(JZ,JY,JX),RH3PXS(JZ,JY,JX) &
      ,RF1PXS(JZ,JY,JX),RF2PXS(JZ,JY,JX),RC0PXS(JZ,JY,JX) &
      ,RC1PXS(JZ,JY,JX),RC2PXS(JZ,JY,JX),RM1PXS(JZ,JY,JX) &
      ,RH0BXB(JZ,JY,JX),RH3BXB(JZ,JY,JX) &
      ,RF1BXB(JZ,JY,JX),RF2BXB(JZ,JY,JX),RC0BXB(JZ,JY,JX) &
      ,RC1BXB(JZ,JY,JX),RC2BXB(JZ,JY,JX),RM1BXB(JZ,JY,JX)
      real(r8) :: RALBLS(JS,JY,JX),RFEBLS(JS,JY,JX),RHYBLS(JS,JY,JX) &
      ,RCABLS(JS,JY,JX),RMGBLS(JS,JY,JX),RNABLS(JS,JY,JX) &
      ,RKABLS(JS,JY,JX),ROHBLS(JS,JY,JX),RSOBLS(JS,JY,JX) &
      ,RCLBLS(JS,JY,JX),RC3BLS(JS,JY,JX),RHCBLS(JS,JY,JX) &
      ,RAL1BS(JS,JY,JX),RAL2BS(JS,JY,JX),RAL3BS(JS,JY,JX) &
      ,RAL4BS(JS,JY,JX),RALSBS(JS,JY,JX),RFE1BS(JS,JY,JX) &
      ,RFE2BS(JS,JY,JX),RFE3BS(JS,JY,JX),RFE4BS(JS,JY,JX) &
      ,RFESBS(JS,JY,JX),RCAOBS(JS,JY,JX),RCACBS(JS,JY,JX) &
      ,RCAHBS(JS,JY,JX),RCASBS(JS,JY,JX),RMGOBS(JS,JY,JX) &
      ,RMGCBS(JS,JY,JX),RMGHBS(JS,JY,JX),RMGSBS(JS,JY,JX) &
      ,RNACBS(JS,JY,JX),RNASBS(JS,JY,JX),RKASBS(JS,JY,JX) &
      ,RH0PBS(JS,JY,JX),RH3PBS(JS,JY,JX),RF1PBS(JS,JY,JX) &
      ,RF2PBS(JS,JY,JX),RC0PBS(JS,JY,JX),RC1PBS(JS,JY,JX) &
      ,RC2PBS(JS,JY,JX),RM1PBS(JS,JY,JX),TALBLS(JS,JY,JX) &
      ,TFEBLS(JS,JY,JX),THYBLS(JS,JY,JX),TCABLS(JS,JY,JX) &
      ,TMGBLS(JS,JY,JX),TNABLS(JS,JY,JX),TKABLS(JS,JY,JX) &
      ,TOHBLS(JS,JY,JX),TSOBLS(JS,JY,JX),TCLBLS(JS,JY,JX) &
      ,TC3BLS(JS,JY,JX),THCBLS(JS,JY,JX),TAL1BS(JS,JY,JX) &
      ,TAL2BS(JS,JY,JX),TAL3BS(JS,JY,JX),TAL4BS(JS,JY,JX) &
      ,TALSBS(JS,JY,JX),TFE1BS(JS,JY,JX),TFE2BS(JS,JY,JX) &
      ,TFE3BS(JS,JY,JX),TFE4BS(JS,JY,JX),TFESBS(JS,JY,JX) &
      ,TCAOBS(JS,JY,JX),TCACBS(JS,JY,JX),TCAHBS(JS,JY,JX) &
      ,TCASBS(JS,JY,JX),TMGOBS(JS,JY,JX),TMGCBS(JS,JY,JX) &
      ,TMGHBS(JS,JY,JX),TMGSBS(JS,JY,JX),TNACBS(JS,JY,JX) &
      ,TNASBS(JS,JY,JX),TKASBS(JS,JY,JX),TH0PBS(JS,JY,JX) &
      ,TH3PBS(JS,JY,JX),TF1PBS(JS,JY,JX),TF2PBS(JS,JY,JX) &
      ,TC0PBS(JS,JY,JX),TC1PBS(JS,JY,JX),TC2PBS(JS,JY,JX) &
      ,TM1PBS(JS,JY,JX)
      real(r8) :: RALFL0(JY,JX),RFEFL0(JY,JX),RHYFL0(JY,JX) &
      ,RCAFL0(JY,JX),RMGFL0(JY,JX),RNAFL0(JY,JX),RKAFL0(JY,JX) &
      ,ROHFL0(JY,JX),RSOFL0(JY,JX),RCLFL0(JY,JX),RC3FL0(JY,JX) &
      ,RHCFL0(JY,JX),RAL1F0(JY,JX),RAL2F0(JY,JX),RAL3F0(JY,JX) &
      ,RAL4F0(JY,JX),RALSF0(JY,JX),RFE1F0(JY,JX),RFE2F0(JY,JX) &
      ,RFE3F0(JY,JX),RFE4F0(JY,JX),RFESF0(JY,JX),RCAOF0(JY,JX) &
      ,RCACF0(JY,JX),RCAHF0(JY,JX),RCASF0(JY,JX),RMGOF0(JY,JX) &
      ,RMGCF0(JY,JX),RMGHF0(JY,JX),RMGSF0(JY,JX),RNACF0(JY,JX) &
      ,RNASF0(JY,JX),RKASF0(JY,JX),RH0PF0(JY,JX),RH3PF0(JY,JX) &
      ,RF1PF0(JY,JX),RF2PF0(JY,JX),RC0PF0(JY,JX),RC1PF0(JY,JX) &
      ,RC2PF0(JY,JX),RM1PF0(JY,JX),RALFL1(JY,JX),RFEFL1(JY,JX) &
      ,RHYFL1(JY,JX),RCAFL1(JY,JX),RMGFL1(JY,JX),RNAFL1(JY,JX) &
      ,RKAFL1(JY,JX),ROHFL1(JY,JX),RSOFL1(JY,JX),RCLFL1(JY,JX) &
      ,RC3FL1(JY,JX),RHCFL1(JY,JX),RAL1F1(JY,JX),RAL2F1(JY,JX) &
      ,RAL3F1(JY,JX),RAL4F1(JY,JX),RALSF1(JY,JX),RFE1F1(JY,JX) &
      ,RFE2F1(JY,JX),RFE3F1(JY,JX),RFE4F1(JY,JX),RFESF1(JY,JX) &
      ,RCAOF1(JY,JX),RCACF1(JY,JX),RCAHF1(JY,JX),RCASF1(JY,JX) &
      ,RMGOF1(JY,JX),RMGCF1(JY,JX),RMGHF1(JY,JX),RMGSF1(JY,JX) &
      ,RNACF1(JY,JX),RNASF1(JY,JX),RKASF1(JY,JX),RH0PF1(JY,JX) &
      ,RH3PF1(JY,JX),RF1PF1(JY,JX),RF2PF1(JY,JX),RC0PF1(JY,JX) &
      ,RC1PF1(JY,JX),RC2PF1(JY,JX),RM1PF1(JY,JX),RH0BF2(JY,JX) &
      ,RH3BF2(JY,JX),RF1BF2(JY,JX),RF2BF2(JY,JX),RC0BF2(JY,JX) &
      ,RC1BF2(JY,JX),RC2BF2(JY,JX),RM1BF2(JY,JX)
      real(r8) :: RQRAL0(JY,JX),RQRFE0(JY,JX),RQRHY0(JY,JX) &
      ,RQRCA0(JY,JX),RQRMG0(JY,JX),RQRNA0(JY,JX),RQRKA0(JY,JX) &
      ,RQROH0(JY,JX),RQRSO0(JY,JX),RQRCL0(JY,JX),RQRC30(JY,JX) &
      ,RQRHC0(JY,JX),RQRAL10(JY,JX),RQRAL20(JY,JX),RQRAL30(JY,JX) &
      ,RQRAL40(JY,JX),RQRALS0(JY,JX),RQRFE10(JY,JX),RQRFE20(JY,JX) &
      ,RQRFE30(JY,JX),RQRFE40(JY,JX),RQRFES0(JY,JX),RQRCAO0(JY,JX) &
      ,RQRCAC0(JY,JX),RQRCAH0(JY,JX),RQRCAS0(JY,JX),RQRMGO0(JY,JX) &
      ,RQRMGC0(JY,JX),RQRMGH0(JY,JX),RQRMGS0(JY,JX),RQRNAC0(JY,JX) &
      ,RQRNAS0(JY,JX),RQRKAS0(JY,JX),RQRH0P0(JY,JX),RQRH3P0(JY,JX) &
      ,RQRF1P0(JY,JX),RQRF2P0(JY,JX),RQRC0P0(JY,JX),RQRC1P0(JY,JX) &
      ,RQRC2P0(JY,JX),RQRM1P0(JY,JX)
...
!
      ...
      *CH0PQ(I,NY,NX))*VLPO4(NU(NY,NX),NY,NX)
