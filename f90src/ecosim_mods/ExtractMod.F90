...
!    2+0.0714*(TUPNH4(L,NY,NX)+TUPNHB(L,NY,NX))
!    3-0.0714*(TUPNO3(L,NY,NX)+TUPNOB(L,NY,NX))
!     ENDIF
...
!     WRITE(*,5566)'TLOXYP',I,J,NX,NY,NZ,L,N
!    2,TLOXYP(L,NY,NX),OXYP(N,L,NZ,NY,NX),OXYA(N,L,NZ,NY,NX)
!    3,ROXDFA(N,L,NZ,NY,NX),RUPOXP(N,L,NZ,NY,NX),ROXFLA(N,L,NZ,NY,NX)
!    4,TLCO2P(L,NY,NX),CO2P(N,L,NZ,NY,NX),CO2A(N,L,NZ,NY,NX)
!    5,RCODFA(N,L,NZ,NY,NX),RCO2P(N,L,NZ,NY,NX)
...
!     WRITE(*,4141)'TCO2S',I,J,NX,NY,L,NZ,N,TCO2S(L,NY,NX)
!    2,RCO2S(N,L,NZ,NY,NX),TCO2P(L,NY,NX),RCO2P(N,L,NZ,NY,NX)
!     WRITE(*,4141)'TUPOX',I,J,NX,NY,L,NZ,N,TUPOXS(L,NY,NX)
!    2,RUPOXS(N,L,NZ,NY,NX),TUPOXP(L,NY,NX),RUPOXP(N,L,NZ,NY,NX)
!     WRITE(*,4141)'TCHFLA',I,J,NX,NY,L,NZ,N,TCHFLA(L,NY,NX)
