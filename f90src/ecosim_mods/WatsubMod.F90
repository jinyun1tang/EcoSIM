      ...
      ,FLWXNX(JY,JX),FLWHNX(JY,JX),HFLWNX(JY,JX) &
      ,PSISA1(JZ,JY,JX)
...
!
      VPR=2.173E-03/TKR1 &
      *0.61*EXP(5360.0*(3.661E-03-1.0/TKR1)) &
      *EXP(18.0*PSISM1(0,NY,NX)/(8.3143*TKR1))
      VP1=2.173E-03/TKS1 &
      *0.61*EXP(5360.0*(3.661E-03-1.0/TKS1)) &
...
!
      ...
      *THETPM(M,NUM(NY,NX),NY,NX)/POROS(NUM(NY,NX),NY,NX)
      ...
      /(CNVR*DLYR(3,NUM(NY,NX),NY,NX)+CNV1*DLYRR(NY,NX))
      ELSE
      ATCNVR=2.0*CNVR &
      /(DLYR(3,NUM(NY,NX),NY,NX)+DLYRR(NY,NX))*CVRD(NY,NX)
      ENDIF
      ELSE
      ATCNVR=0.0
      ENDIF
...
!     IF(NX.EQ.1.AND.NY.EQ.1.AND.TFLX1.NE.0.0)THEN
