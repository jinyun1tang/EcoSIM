...
!     end_include_section
      ...
      real(r8) :: AKAS1,AALX,AFEX,ACAX,AMGX,BKVLX,BKVLNH,BKVLNB
      real(r8) :: BKVLNO,BKVLNZ,BKVLPO,BKVLPB,COMA,CNHUA,CH1P1,CH2P1
      real(r8) :: CHY1,COH1,CAL1,CFE1,CCO20,CCO31,CCA1,CH2PA,CH2PF
      real(r8) :: CH2PD,CH2PH,CH2PM,CCEC0,CALX,CFEX,CCAX,CNHUB,CH1PB
      real(r8) :: CH2PB,CCEC,CMG1,CNA1,CKA1,CCO21,CMGX,CNO1,CNOB
      ...
      real(r8) :: CC3,CA3,CC2,CA2,CC1,CA1,CSTR1,CSTR2,CHY2,COH2
      ...
      real(r8) :: DPALP,DPFEP,DPCDP,DPCHP,DPCMP,DUKD,DFNSA,DP,DFNSB
      real(r8) :: FLWD,FVLNH4,FVLNO3,FVLPO4,FX,FSTR2,PALPO1,PFEPO1
      real(r8) :: PCAPM1,PCAPD1,PCAPH1,PALPOB,PFEPOB,PCAPMB,PCAPDB
      real(r8) :: PCAPHB,PALOH1,PFEOH1,PCACO1,PCASO1,PX,P1,P2,PY
      real(r8) :: P3,RSN4AA,RSN4BA,RSN3AA,RSN3BA,RSNUAA,RSNUBA,RSNOAA
      real(r8) :: RSNOBA,RSN4BB,RSN3BB,RSNUBB,RSNOBB,RN4X,RN3X,RH1PX
      real(r8) :: RH2PX,RPALPX,RPFEPX,RPCADX,RPCAHX,RPCAMX,RH2P
      real(r8) :: RXN4,RNH4,RN4S,RN3S,RHP1,RHP2,RNBX,R3BX,RH1BX
      real(r8) :: RH2BX,RXH2P,RYH2P,RXH1P,RPALBX,RPFEBX,RPCDBX,RPCHBX
      real(r8) :: RPCMBX,RXH2B,RYH2B,RXH1B,RH2B,RXNB,RNHB,RN4B,RN3B
      real(r8) :: RHB1,RHB2,RXH1,RXH2,RX1P,RX2P,RBH1,RBH2,RB1P,RB2P
      real(r8) :: R1,RHAL1,RHALO1,RHALO2,RHALO3,RHALO4,RPALOX,RHFE1
      real(r8) :: RHFEO1,RHFEO2,RHFEO3,RHFEO4,RPFEOX,RHCAC3,RHCACH
      real(r8) :: RHCACO,RPCACX,RPCASO,RHA0P1,RHA1P1,RHA2P1,RHA3P1
      ...
      real(r8) :: RHCO3,RALO1,RALO2,RALO3,RALO4,RALS,RFEO1,RFEO2
      real(r8) :: RFEO3,RFEO4,RFES,RCAO,RCAC,RCAH,RCAS,RMGO,RMGC
      real(r8) :: RMGH,RMGS,RNAC,RNAS,RKAS,RH1P,RH3P,RF1P,RF2P,RC0P
      real(r8) :: RC1P,RC2P,RM1P,RH1B,RH3B,RF1B,RF2B,RC0B,RC1B,RC2B
      real(r8) :: RM1B,RAL,RFE,RHY,RCA,RMG,RNA,RKA,ROH,RSO4,RCO3
      real(r8) :: RHCO,RCO2,RAL1,RAL2,RAL3,RAL4,RFE1,RFE2,RFE3,RFE4
      real(r8) :: RHP0,RHP3,RXH0,RHB0,RHB3,RBH0,RHHY,RHOH
      real(r8) :: S0,S1,SPH2P,SPH1P,SP,SPX
      real(r8) :: THETWR,VOLWNH,VOLWNB,VOLWNO,VOLWNZ,VOLWPO
      real(r8) :: VOLWPB,VOLWMX,VOLWMP,VOLWNX,VOLWPX,VOLWBK,XVLNH4
      real(r8) :: XVLNO3,XVLPO4,XCAX,XN4Q,XHYQ,XALQ,XFEQ,XCAQ,XTLQ
...
!
      ...
      ,SPNHU*TOQCK(L,NY,NX)*DFNSA*TFNQ(L,NY,NX))*(1.0-ZNHUI(L,NY,NX))
!
...
!
      ...
      ,SPNHU*TOQCK(L,NY,NX)*DFNSB*TFNQ(L,NY,NX))*(1.0-ZNHUI(L,NY,NX))
...
!    2,CN41,CN31,CN4B,CN3B,ZNH4S(L,NY,NX),ZNH3S(L,NY,NX)
!    3,RSN4AA,TUPN3S(L,NY,NX),RSNUAA,TUPNHB(L,NY,NX)
...
!
      ...
      -RPALPX-RPFEPX-RPCADX-2.0*RPCAMX-3.0*RPCAHX
      RHB1=-RH2B-RXH1B
      RHB2=RH2B-RXH2B-RYH2B &
      -RPALBX-RPFEBX-RPCDBX-2.0*RPCMBX-3.0*RPCHBX
      RXH1=-RYH2P-RXH1P
      RXH2=-RXH2P
      RX1P=RXH1P
      RX2P=RXH2P+RYH2P
...
!
      ...
      ,AMAX1(0.025,WDNHB(L,NY,NX))+DWNH4)
!
!     NH4 BAND DEPTH
!
...
!
      ...
      ,AMAX1(-PCAPM1*SPPO4,TPD*(CH2P1-CH2PM)))
!     IF(I.GT.315)THEN
