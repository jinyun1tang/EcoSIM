      ...
      real(r8), PARAMETER :: DPH2O=6.5E-09,SPALO=6.5E-22,SPFEO=6.5E-27 &
      ,SPCAC=3.8E-03,SPCAS=1.4E+01,SPALP=1.0E-15,SPFEP=1.0E-20 &
      ,SPCAM=7.0E+07,SPCAD=1.0E-01,SPCAH=2.3E-31,SXOH2=4.5E-05 &
      ,SXOH1=1.1E-06,SXH2P=2.0E+07,SXH1P=2.0E+07 &
      ,DPCO2=4.2E-04,DPHCO=5.6E-08,DPN4=5.7E-07 &
      ,DPAL1=4.6E-07,DPAL2=7.3E-07,DPAL3=1.8E-05 &
      ,DPAL4=1.2E-05,DPALS=0.16,DPFE1=4.6E-07,DPFE2=7.3E-07 &
      ,DPFE3=1.8E-05,DPFE4=1.2E-05,DPFES=7.1E-02,DPCAO=12.5 &
      ,DPCAC=4.2E-02,DPCAH=13.5,DPCAS=1.2,DPMGO=0.7,DPMGC=0.3 &
      ,DPMGH=67.0,DPMGS=2.1,DPNAC=0.45,DPNAS=3.3E+02,DPKAS=5.0E+01 &
      ,DPH1P=4.5E-10,DPH2P=6.3E-05,DPH3P=7.1,DPF1P=4.5E-02 &
      ,DPF2P=3.7E-03,DPC0P=3.5E-04,DPC1P=1.82,DPC2P=40.0 &
      ,DPM1P=1.23,DPCOH=1.0E-02,DPALO=6.3E+04,DPFEO=6.3E+04

      real(r8), PARAMETER :: DPCO3=DPCO2*DPHCO,SHALO=SPALO/DPH2O**3 &
      ,SYAL1=SPALO/DPAL1,SHAL1=SYAL1/DPH2O**2,SYAL2=SYAL1/DPAL2 &
      ,SHAL2=SYAL2/DPH2O,SPAL3=SYAL2/DPAL3,SYAL4=SPAL3/DPAL4 &
      ,SHAL4=SYAL4*DPH2O,SHFEO=SPFEO/DPH2O**3,SYFE1=SPFEO/DPFE1 &
      ,SHFE1=SYFE1/DPH2O**2,SYFE2=SYFE1/DPFE2,SHFE2=SYFE2/DPH2O &
      ,SPFE3=SYFE2/DPFE3,SYFE4=SPFE3/DPFE4,SHFE4=SYFE4*DPH2O &
      ,SHCAC1=SPCAC/DPHCO,SYCAC1=SHCAC1*DPH2O,SHCAC2=SHCAC1/DPCO2 &
      ,SYCAC2=SHCAC2*DPH2O**2,SHA0P1=SPALP/DPH1P,SYA0P1=SHA0P1*DPH2O &
      ,SPA1P1=SYA0P1/DPAL1,SYA2P1=SPA1P1/DPAL2,SHA2P1=SYA2P1*DPH2O &
      ,SYA3P1=SYA2P1/DPAL3,SHA3P1=SYA3P1*DPH2O**2,SYA4P1=SYA3P1/DPAL4 &
      ,SHA4P1=SYA4P1*DPH2O**3,SHA0P2=SHA0P1/DPH2P &
      ,SYA0P2=SHA0P2*DPH2O**2,SYA1P2=SYA0P2/DPAL1,SHA1P2=SYA1P2/DPH2O &
      ,SPA2P2=SYA1P2/DPAL2,SYA3P2=SPA2P2/DPAL3,SHA3P2=SYA3P2*DPH2O &
      ,SYA4P2=SYA3P2/DPAL4,SHA4P2=SYA4P2*DPH2O**2

      real(r8), PARAMETER :: SHF0P1=SPFEP/DPH1P,SYF0P1=SHF0P1*DPH2O &
      ,SPF1P1=SYF0P1/DPFE1,SYF2P1=SPF1P1/DPFE2,SHF2P1=SYF2P1*DPH2O &
      ,SYF3P1=SYF2P1/DPFE3,SHF3P1=SYF3P1*DPH2O**2,SYF4P1=SYF3P1/DPFE4 &
      ,SHF4P1=SYF4P1*DPH2O**3,SHF0P2=SHF0P1/DPH2P,SYF0P2=SHF0P2*DPH2O**2 &
      ,SYF1P2=SYF0P2/DPFE1,SHF1P2=SYF1P2/DPH2O,SPF2P2=SYF1P2/DPFE2 &
      ,SYF3P2=SPF2P2/DPFE3,SHF3P2=SYF3P2*DPH2O,SYF4P2=SYF3P2/DPFE4 &
      ,SHF4P2=SYF4P2*DPH2O**2,SHCAD2=SPCAD/DPH2P,SYCAD2=SHCAD2*DPH2O &
      ,SHCAH1=SPCAH/(DPH2O*DPH1P**3),SYCAH1=SHCAH1*DPH2O**4 &
      ,SHCAH2=SHCAH1/DPH2P**3,SYCAH2=SHCAH2*DPH2O**7

      real(r8), PARAMETER :: TPD=2.5E-02,TAD=5.0E-02,TSL=0.5,A0=1.0 &
      ,COOH=2.5E-02,CALMX=10.0,CFEMX=10.0,CCAMX=10.0
      ...
      real(r8) :: AC0P1,AC1P1,AC2P1,AM1P1,AN41,AN31,AMG1,ANA1,AKA1
      real(r8) :: AALX,AFEX,ACAX,AMGX,AALS1,AFES1,ACAO1,ACAC1,ACAS1
      real(r8) :: ACAH1,AMGO1,AMGC1,AMGH1,AMGS1,ANAC1,ANAS1,AKAS1
      real(r8) :: BKVLX,CCO2M,CCH4M,COXYM,CZ2GM,CZ2OM,CHY1,COH1
      real(r8) :: CN4Z,CNOZ,CPOZ,CALZ,CFEZ,CCAZ,CMGZ,CNAZ,CKAZ,CSOZ
      real(r8) :: CCLZ,CN4X,CNOX,CPOX,CALX,CFEX,CCAX,CMGX,CNAX,CKAX
      real(r8) :: CSOX,CCLX,CALPOX,CFEPOX,CCAPDX,CCAPHX,CALOHX,CFEOHX
      real(r8) :: CCACOX,CCASOX,CC3,CA3,CC2,CA2,CC1,CA1,CX2,CX1
      real(r8) :: CN,CION2,CSTR1,CSTRZ,CSTR2,CCO2X,CCO2Y,CCO2Z,CCO21
      real(r8) :: CCH41,COXY1,CZ2G1,CZ2O1,CCO31,CHCO31,CNO1,CN41
      real(r8) :: CN31,CAL1,CFE1,CCA1,CMG1,CNA1,CKA1,CSO41,CCL1
      real(r8) :: CALO1,CALO2,CALO3,CALO4,CALS1,CFEO1,CFEO2,CFEO3
      real(r8) :: CFEO4,CFES1,CCAO1,CCAC1,CCAH1,CCAS1,CMGO1,CMGC1
      real(r8) :: CMGH1,CMGS1,CNAC1,CNAS1,CKAS1,CF1P1,CF2P1,CC0P1
      real(r8) :: CC1P1,CC2P1,CM1P1,CH3P1,CH2P1,CH1P1,CH0P1,CCEC
      real(r8) :: CH2PA,CH2PF,CH2PD,CH2PH,DP,FSTR2,FH2O,FCO3,FHCO
      real(r8) :: FHP3,FHP2,FHP1,FHP0,FXH2,FXH1,FXH0,FXP2,FXP1,FHPA
      real(r8) :: FX,PH1,PALOH1,PFEOH1,PCACO1,PCASO1,PALPO1,PFEPO1
      real(r8) :: PCAPD1,PCAPH1,PX,P1,P2,PY,P3,R,R1,RHAL1,RHALO1
      real(r8) :: RHALO2,RHALO3,RHALO4,RPALOX,RHFE1,RHFEO1,RHFEO2
      real(r8) :: RHFEO3,RHFEO4,RPFEOX,RHCAC3,RHCACH,RHCACO,RPCACX
      real(r8) :: RPCASO,RHA0P1,RHA1P1,RHA2P1,RHA3P1,RHA4P1,RHA0P2
      real(r8) :: RHA1P2,RHA2P2,RHA3P2,RHA4P2,RPALPX,RHF0P1,RHF1P1
      real(r8) :: RHF2P1,RHF3P1,RHF4P1,RHF0P2,RHF1P2,RHF2P2,RHF3P2
      real(r8) :: RHF4P2,RPFEPX,RPCAD1,RHCAD2,RPCADX,RHCAH1,RHCAH2
      real(r8) :: RPCAHX,RXOH2,RXOH1,RXH2P,RYH2P,RXH1P,RXN4,RXHY
      real(r8) :: RXAL,RXFE,RXCA,RXMG,RXNA,RXKA,RNH4,RALO1,RALO2
      real(r8) :: RALO3,RALO4,RALS,RFEO1,RFEO2,RFEO3,RFEO4,RFES
      real(r8) :: RCAO,RCAC,RCAH,RCAS,RMGO,RMGC,RMGH,RMGS,RNAC,RNAS
      real(r8) :: RKAS,RH1P,RH2P,RH3P,RF1P,RF2P,RC0P,RC1P,RC2P,RM1P
      real(r8) :: RN4S,RN3S,RAL,RFE,RCA,RMG,RNA,RKA,RSO4,RAL1,RAL2
      real(r8) :: RAL3,RAL4,RFE1,RFE2,RFE3,RFE4,RHP0,RHP1,RHP2,RHP3
      real(r8) :: SPOH2,SPOH1,SPH2P,SPH1P,SP,SPX,S0,S1,VOLWBK
      real(r8) :: VOLWW,XHP,XOH,XPT,XOH21,XOH11,XOH01,XH1P1,XH2P1
      real(r8) :: XCECQ,XN4Q,XHYQ,XALQ,XFEQ,XCAQ,XMGQ,XNAQ,XKAQ
      real(r8) :: XHC1,XALO21,XFEO21,XCOOH,XCAX,XTLQ,XN41,XHY1,XAL1
      real(r8) :: XFE1,XCA1,XMG1,XNA1,XKA1,XCOO,Z
...
!
      ...
      *EXP(0.843-0.0281*ATCA(NY,NX))*FH2O
      CCO2Y=LOG(CCO2X)
      CCO2Z=ABS(CCO2Y)
      CCO21=CCO2X
...
3030  CONTINUE
      ...
      *EXP(0.597-0.0199*ATCA(NY,NX))*FH2O
      COXY1=COXYM*SOXYX/(EXP(AOXYX*CSTR1)) &
      *EXP(0.516-0.0172*ATCA(NY,NX))*FH2O
      CZ2G1=CZ2GM*SN2GX/(EXP(AN2GX*CSTR1)) &
      *EXP(0.456-0.0152*ATCA(NY,NX))*FH2O
      CZ2O1=CZ2OM*SN2OX/(EXP(AN2OX*CSTR1)) &
      *EXP(0.897-0.0299*ATCA(NY,NX))*FH2O
...
!
      ...
      XNA1=FX*XNAQ
      XKA1=FX*XKAQ
!     WRITE(*,2222)'XN4S',K,L,CN4X,XN4Q,XN41,CNH4(L,NY,NX)
!    2,BKVL(L,NY,NX),XCECQ,XCEC(L,NY,NX),BKVLX,FX
!     WRITE(*,2222)'XOH2S',K,L,XOH21,XOH11,XOH01,XH2P1,XH1P1,XOH,XPT
!    2,CH3P1,CH2P1,CH1P1,CH0P1,CHY1,XHP,FHP3,FHP2,FHP1,FHP0
...
!
      ...
      RHALO4=RPALOX
      ENDIF
!     IF((M/25)*25.EQ.M)THEN
!     WRITE(*,1112)'ALOHI',I,NX,NY,L,K,M,PALOH1,AAL1
!    2,AALO1,AALO2,AALO3,AALO4,AOH1,CAL1,CALO1,CALO2,CALO3,CALO4
!    2,COH1,R1,P1,P2,SP,SPX,RPALOX,RHAL1,RHALO1,RHALO2,RHALO3,RHALO4
!    3,AAL1*AOH1**3,SPALO,A1
!     ENDIF
!
!     IRON HYDROXIDE
!
      ...
      ENDIF
!     IF((M/25)*25.EQ.M)THEN
!     WRITE(*,1112)'FEOHI',I,NX,NY,L,K,M,PFEOH1,AFE1
...
!     WRITE(*,1112)'CALC',I,J,NX,NY,,L,K,M,PCASO1
!    2,ACO31,AHCO31,ACO21,CHY1
...
!
      ...
      ENDIF
!     IF((M/10)*10.EQ.M)THEN
!     WRITE(*,1112)'CAPO4',I,J,NX,NY,L,M,PCAPM1,PCAPD1,CCA1
...
!
      ...
      ENDIF
!     IF((M/25)*25.EQ.M)THEN
!     WRITE(*,1112)'RXALI',I,NX,NY,L,K,M
!    2,RXAL,TAD,XALQ,XAL1,AALX,CCEC,XCAX,FX
!    3,GKCA(L,NY,NX),XCEC(L,NY,NX),BKVLX,VOLA(L,NY,NX)
!     ENDIF
!
!     ORGANIC MATTER
!
...
!
      ...
      -RCAO-RCAC-RCAH-RCAS-RC0P-RC1P-RC2P
...
!
      ...
      *EXP(0.516-0.0172*ATCA(NY,NX))*FH2O*VOLW(L,NY,NX)
      ELSE
      OXYS(L,NY,NX)=0.0
      ENDIF
      CO2S(L,NY,NX)=CCO2EI(NY,NX)*SCO2X/(EXP(ACO2X*CSTR1)) &
      *EXP(0.843-0.0281*ATCA(NY,NX))*FH2O*VOLW(L,NY,NX)
      CH4S(L,NY,NX)=CCH4E(NY,NX)*SCH4X/(EXP(ACH4X*CSTR1)) &
      *EXP(0.597-0.0199*ATCA(NY,NX))*FH2O*VOLW(L,NY,NX)
      Z2GS(L,NY,NX)=CZ2GE(NY,NX)*SN2GX/(EXP(AN2GX*CSTR1)) &
      *EXP(0.456-0.0152*ATCA(NY,NX))*FH2O*VOLW(L,NY,NX)
      Z2OS(L,NY,NX)=CZ2OE(NY,NX)*SN2OX/(EXP(AN2OX*CSTR1)) &
      *EXP(0.897-0.0299*ATCA(NY,NX))*FH2O*VOLW(L,NY,NX)
