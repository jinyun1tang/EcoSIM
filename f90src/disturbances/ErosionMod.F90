                  ...
                  DO NGL=JGnio(NO),JGnfo(NO)
                    DO M=1,nlbiomcp
                      ...
                      DO NE=1,NumPlantChemElms
                        OMEERhetr(NE,MID,K,N,2,N5,N4)=FSEDER*mBOMHeter_vr(NE,MID,K,NU(N2,N1),N2,N1)
                      ENDDO
                    ENDDO
                  ENDDO
                ENDDO
              ...
              DO NO=1,NumMicbFunGrupsPerCmplx
                DO NGL=JGniA(NO),JGnfA(NO)
                  DO M=1,nlbiomcp
                    MID=micpar%get_micb_id(M,NGL)
                    DO NE=1,NumPlantChemElms
                      OMEERauto(NE,MID,N,2,N5,N4)=FSEDER*mBOMAutor_vr(NE,MID,NU(N2,N1),N2,N1)
                    ENDDO
                  ENDDO
                ENDDO
              ENDDO
                  ...
                  DO  NO=1,NumMicbFunGrupsPerCmplx
                    DO NGL=JGnio(NO),JGnfo(NO)
                      DO  M=1,nlbiomcp
                        MID=micpar%get_micb_id(M,NGL)      
                        DO NE=1,NumPlantChemElms                                                 
                          OMEERhetr(NE,MID,K,N,1,N5B,N4B)=FSEDER*mBOMHeter_vr(NE,MID,K,NU(N2,N1),N2,N1)
                        ENDDO
                      enddo
                    enddo
                  ENDDO
                ...
                DO  NO=1,NumMicbFunGrupsPerCmplx
                  DO NGL=JGniA(NO),JGnfA(NO)
                    DO  M=1,nlbiomcp
                      MID=micpar%get_micb_id(M,NGL)
                      DO NE=1,NumPlantChemElms         
                        OMEERauto(NE,MID,N,1,N5B,N4B)=FSEDER*mBOMAutor_vr(NE,MID,NU(N2,N1),N2,N1)
                      ENDDO
                    enddo
                  enddo
                ENDDO
                ...
                DO NO=1,NumMicbFunGrupsPerCmplx
                  DO NGL=JGnio(NO),JGnfo(NO)
                    DO M=1,nlbiomcp
                      MID=micpar%get_micb_id(M,NGL)                    
                      DO NE=1,NumPlantChemElms                       
                        OMEERhetr(NE,MID,K,N,NN,M5,M4)=FSEDER*mBOMHeter_vr(NE,MID,K,NU(N2,N1),N2,N1)
                      ENDDO
                    ENDDO
                  ENDDO
                ENDDO
              ...
              DO NO=1,NumMicbFunGrupsPerCmplx
                DO NGL=JGniA(NO),JGnfo(NO)
                  DO M=1,nlbiomcp
                    MID=micpar%get_micb_id(M,NGL)
                    DO NE=1,NumPlantChemElms                       
                      OMEERauto(NE,MID,N,NN,M5,M4)=FSEDER*mBOMAutor_vr(NE,MID,NU(N2,N1),N2,N1)
                    ENDDO
                  ENDDO
                ENDDO
              ENDDO
