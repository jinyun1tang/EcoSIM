...
implicit none
  ...
  integer :: LL,NN,K,M,N,NR,NZ
  integer :: L0,L1,NUX,ICHKLX,ICHKL,NGL
  real(r8) :: FX,FY
  real(r8) :: FXZSO4H,FXZSO4,FXZOH,FXZCO3
  ...
  real(r8) :: FXZCA,FXCO2A,FXOXYA,FXCH4A,FXZ2OA,FXZH3A,FXH2GA
