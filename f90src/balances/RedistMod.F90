...
!
    trc_gasml(idg_CO2,L,NY,NX)=trc_gasml(idg_CO2,L,NY,NX)+TCOFLG(L,NY,NX)-XCODFG(L,NY,NX)
    trc_gasml(idg_CH4,L,NY,NX)=trc_gasml(idg_CH4,L,NY,NX)+TCHFLG(L,NY,NX)-XCHDFG(L,NY,NX)
    trc_gasml(idg_O2,L,NY,NX)=trc_gasml(idg_O2,L,NY,NX)+TOXFLG(L,NY,NX)-XOXDFG(L,NY,NX)
    trc_gasml(idg_N2,L,NY,NX)=trc_gasml(idg_N2,L,NY,NX)+TNGFLG(L,NY,NX)-XNGDFG(L,NY,NX)
    trc_gasml(idg_N2O,L,NY,NX)=trc_gasml(idg_N2O,L,NY,NX)+TN2FLG(L,NY,NX)-XN2DFG(L,NY,NX)
    trc_gasml(idg_NH3,L,NY,NX)=trc_gasml(idg_NH3,L,NY,NX)+TNHFLG(L,NY,NX)-XN3DFG(L,NY,NX) &
      -XNBDFG(L,NY,NX)+TRN3G(L,NY,NX)
    trc_gasml(idg_H2,L,NY,NX)=trc_gasml(idg_H2,L,NY,NX)+THGFLG(L,NY,NX)-XHGDFG(L,NY,NX)
