...
! HCO2G: hourly soil CO2 flux, [g d-2 h-1]
  ...
  !
  XCSN=XCSN+ZESNC(NY,NX,ielmc)
  XZSN=XZSN+ZESNC(NY,NX,ielmn)
  XPSN=XPSN+ZESNC(NY,NX,ielmp)
  UXCSN(NY,NX)=UXCSN(NY,NX)+ZESNC(NY,NX,ielmc)
  UXZSN(NY,NX)=UXZSN(NY,NX)+ZESNC(NY,NX,ielmn)
  UXPSN(NY,NX)=UXPSN(NY,NX)+ZESNC(NY,NX,ielmp)
  !
