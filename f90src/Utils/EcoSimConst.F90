module EcosimConst
  ...
  real(r8), parameter :: orgcden              = 0.55E+06_r8                 !density of organic carbon,                                                 [gC m-3]
  ...
  real(r8), parameter :: MWC2Soil             = 1.82E-06_r8                 !multiplier to convert organic carbon (g C/d2) to soil mass (Mg/d2),        [Mg soil/gC]
