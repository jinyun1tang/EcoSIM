...
contains
  ...
  allocate(RRAD1X(jroots,JP,JY,JX)); RRAD1X=0._r8
  allocate(RRAD2X(jroots,JP,JY,JX)); RRAD2X=0._r8
  allocate(RTAR1X(jroots,JP,JY,JX)); RTAR1X=0._r8
  allocate(RTAR2X(jroots,JP,JY,JX)); RTAR2X=0._r8
  allocate(TFN4(JZ,JP,JY,JX));  TFN4=0._r8
  allocate(CNRT(JP,JY,JX));     CNRT=0._r8
  allocate(CPRT(JP,JY,JX));     CPRT=0._r8
  allocate(PORT(jroots,JP,JY,JX));   PORT=0._r8
  ...
  allocate(RRAD1M(jroots,JP,JY,JX)); RRAD1M=0._r8
  ...
  allocate(RTDNP(jroots,JZ,JP,JY,JX));RTDNP=0._r8
  allocate(RTN1(jroots,JZ,JP,JY,JX));RTN1=0._r8
  allocate(RTNL(jroots,JZ,JP,JY,JX));RTNL=0._r8
  allocate(RTN2(jroots,JZ,JC,JP,JY,JX));RTN2=0._r8
  allocate(RTLGA(jroots,JZ,JP,JY,JX));RTLGA=0._r8
  allocate(RTARP(jroots,JZ,JP,JY,JX));RTARP=0._r8
  allocate(RTVLW(jroots,JZ,JP,JY,JX));RTVLW=0._r8
  allocate(RRAD1(jroots,JZ,JP,JY,JX));RRAD1=0._r8
  allocate(RTVLP(jroots,JZ,JP,JY,JX));RTVLP=0._r8
  allocate(RTDP1(jroots,JC,JP,JY,JX));RTDP1=0._r8
