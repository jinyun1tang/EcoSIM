module MicrobialDataType
  ...
  use EcoSIMConfig, only : jcplx1=> jcplx1c,nlbiomcp=>nlbiomcpc,NFGs=> NFGsc
  use GridConsts
implicit none
  public
  save
  ...
  implicit none
  allocate(OMC(nlbiomcp,JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(OMN(nlbiomcp,JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(OMP(nlbiomcp,JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(ROXYS(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(ROQCS(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(ROQAS(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RINHO(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RINOO(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RIPOO(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RINHOR(JG,NFGs,0:jcplx1,JY,JX))
  allocate(RIPOOR(JG,NFGs,0:jcplx1,JY,JX))
  allocate(RINOOR(JG,NFGs,0:jcplx1,JY,JX))
  allocate(RVMX4(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMX3(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMX2(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMB4(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMB3(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMB2(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMX1(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RINHB(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RINOB(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RIPBO(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RIPO1(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RIPB1(JG,NFGs,0:jcplx1,0:JZ,JY,JX))
  allocate(RIPO1R(JG,NFGs,0:jcplx1,JY,JX))
  allocate(OMCER(nlbiomcp*JG,NFGs,0:jcplx1,2,2,JV,JH))
  allocate(OMNER(nlbiomcp*JG,NFGs,0:jcplx1,2,2,JV,JH))
  allocate(OMPER(nlbiomcp*JG,NFGs,0:jcplx1,2,2,JV,JH))

  allocate(OMCff(nlbiomcp,JG,NFGs,0:JZ,JY,JX))
  allocate(OMNff(nlbiomcp,JG,NFGs,0:JZ,JY,JX))
  allocate(OMPff(nlbiomcp,JG,NFGs,0:JZ,JY,JX))
  allocate(ROXYSff(JG,NFGs,0:JZ,JY,JX))
  allocate(RINHOff(JG,NFGs,0:JZ,JY,JX))
  allocate(RINOOff(JG,NFGs,0:JZ,JY,JX))
  allocate(RIPOOff(JG,NFGs,0:JZ,JY,JX))
  allocate(RINHORff(JG,NFGs,JY,JX))
  allocate(RIPOORff(JG,NFGs,JY,JX))
  allocate(RINOORff(JG,NFGs,JY,JX))
  allocate(RVMX4ff(JG,NFGs,0:JZ,JY,JX))
  allocate(RVMX3ff(JG,NFGs,0:JZ,JY,JX))
  allocate(RVMX2ff(JG,NFGs,0:JZ,JY,JX))
  allocate(RVMB4ff(JG,NFGs,0:JZ,JY,JX))
  allocate(RVMB3ff(JG,NFGs,0:JZ,JY,JX))
  allocate(RVMB2ff(JG,NFGs,0:JZ,JY,JX))
  allocate(RVMX1ff(JG,NFGs,0:JZ,JY,JX))
  allocate(RINHBff(JG,NFGs,0:JZ,JY,JX))
  allocate(RINOBff(JG,NFGs,0:JZ,JY,JX))
  allocate(RIPBOff(JG,NFGs,0:JZ,JY,JX))
  allocate(RIPO1ff(JG,NFGs,0:JZ,JY,JX))
  allocate(RIPB1ff(JG,NFGs,0:JZ,JY,JX))
  allocate(RIPO1Rff(JG,NFGs,JY,JX))
  allocate(OMCERff(nlbiomcp*JG,NFGs,2,2,JV,JH))
  allocate(OMNERff(nlbiomcp*JG,NFGs,2,2,JV,JH))
  allocate(OMPERff(nlbiomcp*JG,NFGs,2,2,JV,JH))
