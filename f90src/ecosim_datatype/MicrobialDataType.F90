...
implicit none
  ...
  allocate(OMC(3,JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(OMN(3,JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(OMP(3,JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(ROXYS(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(ROQCS(JG,7,0:jcplx1,0:JZ,JY,JX))
  allocate(ROQAS(JG,7,0:jcplx1,0:JZ,JY,JX))
  allocate(CNOMC(3,JG,7,0:jcplx))
  allocate(CPOMC(3,JG,7,0:jcplx))
  allocate(RINHO(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RINOO(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RIPOO(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RINHOR(JG,7,0:jcplx,JY,JX))
  allocate(RIPOOR(JG,7,0:jcplx,JY,JX))
  allocate(RINOOR(JG,7,0:jcplx,JY,JX))
  allocate(RVMX4(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RVMX3(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RVMX2(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RVMB4(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RVMB3(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RVMB2(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RVMX1(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RINHB(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RINOB(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RIPBO(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RIPO1(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RIPB1(JG,7,0:jcplx,0:JZ,JY,JX))
  allocate(RIPO1R(JG,7,0:jcplx,JY,JX))
  allocate(OMCER(3*JG,7,0:jcplx,2,2,JV,JH))
  allocate(OMNER(3*JG,7,0:jcplx,2,2,JV,JH))
  allocate(OMPER(3*JG,7,0:jcplx,2,2,JV,JH))
