...
implicit none
  ...
  implicit none
  allocate(OMC(nlbiomcp,NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(OMN(nlbiomcp,NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(OMP(nlbiomcp,NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(ROXYS(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(ROQCS(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(ROQAS(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RINHO(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RINOO(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RIPOO(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RINHOR(NMICBSO,0:jcplx1,JY,JX))
  allocate(RIPOOR(NMICBSO,0:jcplx1,JY,JX))
  allocate(RINOOR(NMICBSO,0:jcplx1,JY,JX))
  allocate(RVMX4(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMX3(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMX2(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMB4(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMB3(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMB2(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RVMX1(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RINHB(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RINOB(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RIPBO(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RIPO1(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RIPB1(NMICBSO,0:jcplx1,0:JZ,JY,JX))
  allocate(RIPO1R(NMICBSO,0:jcplx1,JY,JX))
  allocate(OMCER(nlbiomcp*NMICBSO,0:jcplx1,2,2,JV,JH))
  allocate(OMNER(nlbiomcp*NMICBSO,0:jcplx1,2,2,JV,JH))
  allocate(OMPER(nlbiomcp*NMICBSO,0:jcplx1,2,2,JV,JH))
