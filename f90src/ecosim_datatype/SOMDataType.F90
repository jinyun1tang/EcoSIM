module SOMDataType
  ...
  real(r8),target,allocatable ::  FracBulkSOM_vr(:,:,:,:)                    !fraction of total organic C in complex, [-]
...
!------------------------------------------------------------------------------------------
  ...
  allocate(FracBulkSOM_vr(1:jcplx,0:JZ,JY,JX));FracBulkSOM_vr=0._r8
