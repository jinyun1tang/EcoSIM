...
!Carbon
  ...
  real(r8) :: WGLFL(JC,0:25,JC,JP,JY,JX)        !layer leaf C, [g d-2]
  real(r8) :: ARLFL(JC,0:25,JC,JP,JY,JX)        !layer leaf area, [m2 d-2]
  real(r8) :: WGLFLN(JC,0:25,JC,JP,JY,JX)       !layer leaf N, [g d-2]
...
!Phosphorus
  ...
  real(r8) :: WGLFLP(JC,0:25,JC,JP,JY,JX)       !leaf layer P, [g d-2]
