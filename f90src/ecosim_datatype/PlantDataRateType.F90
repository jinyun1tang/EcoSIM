...
!----------------------------------------------------------------------
  ...
  allocate(EcoHavstElmnt_pft(NumOfPlantChemElmnts,JP,JY,JX));    EcoHavstElmnt_pft=0._r8
  allocate(EcoHavstElmntCum_pft(NumOfPlantChemElmnts,JP,JY,JX));   EcoHavstElmntCum_pft=0._r8
