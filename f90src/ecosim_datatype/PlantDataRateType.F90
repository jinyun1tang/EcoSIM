...
!----------------------------------------------------------------------
  ...
  allocate(UPOME(1:NumOfPlantChemElmnts,JP,JY,JX));    UPOME=0._r8
  ...
  allocate(HEUPTK(NumOfPlantChemElmnts,JP,JY,JX));   HEUPTK=0._r8
  allocate(PlantExudChemElmnts_pft(NumOfPlantChemElmnts,JP,JY,JX));   PlantExudChemElmnts_pft=0._r8
