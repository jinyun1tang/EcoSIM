...
=WTSHTE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)  !canopy shoot C, SHOOT_C
=WTLFE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)   !canopy leaf C, LEAF_C
=WTSHEE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)  !canopy sheath C, SHTH_C
=WTSTKE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)  !STALK_C
=WTRSVE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)  !RESERVE_C
=(WTHSKE(NZ,NY,NX,ielmc)+WTEARE(NZ,NY,NX,ielmc))/AREA(3,NU(NY,NX),NY,NX) !REPRO_C, reproduction C
=WTGRE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)   !GRAIN_C
=WTRTE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)   !ROOT_C
=WTNDE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)   !NDL_C, nodule C
=WTRVE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)  !STORED_C
...
=TEUPTK(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX) !EXUD_C, plant C exudation, gC/m2
=TESNC(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)  !LITTER_C, total plant litterfall C, gC/m2
=TESN0(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)  !SF_LIT_C, plant literfall to surface, gC/m2
...
=CEPOLP(NZ,NY,NX,ielmc)                         ![SOL._C], canopy nonstructural C concentration, gC/m2
=HVSTE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)  !HVST_C
=RTDNP(1,1:JZ,NZ,NY,NX)*PP(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)  !DNS_RT, root layer length density, m m^-3

=BALE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)  !C_BALANCE
=WTSTGE(NZ,NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX) !STG_DEAD_C
...
!
=WTSHTE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)    !SHOOT_N
=WTLFE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)    !LEAF_N
=WTSHEE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)   !SHTH_N
=WTSTKE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)   !STALK_N
=WTRSVE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)   !RESERVE_N
=(WTHSKE(NZ,NY,NX,ielmn)+WTEARE(NZ,NY,NX,ielmn))/AREA(3,NU(NY,NX),NY,NX)  !HUSK_N
=WTGRE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)  !GRAIN_N
=WTRTE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)    !ROOT_N
=WTNDE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)    !NDL_N
=WTRVE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)    !STORED_N
=TEUPTK(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)   !UPTK_N
=TESNC(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)    !LITTER_N
=TZUPFX(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)   !TL_N_FIXED

=CZPOLP(NZ,NY,NX)   ![SOL_N]
=(WTLFN(NZ,NY,NX)+EPOOLP(NZ,NY,NX,ielmn))/(WTLF(NZ,NY,NX)+EPOOLP(NZ,NY,NX,ielmc))  !N_STRESS, NC ratio

=CPPOLP(NZ,NY,NX)  ![SOL_P]

=(WTLFP(NZ,NY,NX)+EPOOLP(NZ,NY,NX,ielmp))/(WTLF(NZ,NY,NX)+EPOOLP(NZ,NY,NX,ielmc))  !'P_STRESS', PC ratio

=TNH3C(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)   !NH3_FLUX
=HVSTE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)   !HVST_N
=BALE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)    !N_BALANCE
=WTSTGE(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)  !STG_DEAD_N
=VNH3F(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)   !FIRE_N
=TESN0(NZ,NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)   !SF_LIT_N

=WTSHTE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)   !SHOOT_P
=WTLFE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)   !LEAF_P
=WTSHEE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)  !SHTH_P
=WTSTKE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)  !STALK_P
=WTRSVE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)  !RESERVE_P
=(WTHSKE(NZ,NY,NX,ielmp)+WTEARE(NZ,NY,NX,ielmp))/AREA(3,NU(NY,NX),NY,NX)  !HUSK_P
=WTGRE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)  !GRAIN_P
=WTRTE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)   !ROOT_P
=WTNDE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)   !NDL_P, nodule P
=WTRVE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)   !STORED_P
=TEUPTK(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)  !UPTK_P
=TESNC(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)   !LITTER_P
=CPPOLP(NZ,NY,NX)                          ![SOL_P]

cancp(NZ,NY,NX)=(WTLFP(NZ,NY,NX)+EPOOLP(NZ,NY,NX,ielmp))/(WTLF(NZ,NY,NX)+EPOOLP(NZ,NY,NX,ielmc))  !P_STRESS

=HVSTE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)  !HVST_P
=BALE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)   !P_BALANCE
WTSTGPXY(NZ,NY,NX)=WTSTGE(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)  !STG_DEAD_P
VPO4FXY(NZ,NY,NX)=VPO4F(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)  !FIRE_P
TPSN0XY(NZ,NY,NX)=TESN0(NZ,NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)  !SF_LIT_P, surface P litterfall
!
...
CANNC(NZ,NY,NC)=(WTLFN(NZ,NY,NX)+EPOOLP(NZ,NY,NX,ielmn))/(WTLF(NZ,NY,NX)+EPOOLP(NZ,NY,NX,ielmc))  !LEAF_N/C

CANPC(NZ,NY,NX)=(WTLFP(NZ,NY,NX)+EPOOLP(NZ,NY,NX,ielmp))/(WTLF(NZ,NY,NX)+EPOOLP(NZ,NY,NX,ielmc))  !LEAF_P/C
...
XHVSTCXY(NY,NX)=XHVSTE(NY,NX,ielmc)/AREA(3,NU(NY,NX),NY,NX)
...
XHVSTNXY(NY,NX)=XHVSTE(NY,NX,ielmn)/AREA(3,NU(NY,NX),NY,NX)    !ECO_HVST_N
...
XHVSTPXY(NY,NX)=XHVSTE(NY,NX,ielmp)/AREA(3,NU(NY,NX),NY,NX)   !ECO_HVST_P
