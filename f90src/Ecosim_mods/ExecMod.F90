...
!    endif
    ...
    TLO = TSoilO2G_lnd-SurfGas_lnd(idg_O2)+OXYGOU
    TLC = LitRMStoreLndscap(ielmc)+POMHumStoreLndscap(ielmc)+TGasC_lnd-SurfGas_lnd(idg_CO2)+TOMOU_lnds(ielmc)-tAmendOrgC_lnd-Litrfall_lnds(ielmc)
    TLN = LitRMStoreLndscap(ielmn)+POMHumStoreLndscap(ielmn)+TGasN_lnd+TDisolNH4_lnd+tNO3_lnd-SurfGas_lnd(idg_N2)-TZIN+TOMOU_lnds(ielmn)-TORGN-Litrfall_lnds(ielmn)
...
!
  IF(etimer%its_time_to_diag())THEN
    ...
    DIFFO = (TSoilO2G_lnd-SurfGas_lnd(idg_O2)+OXYGOU-TLO)/TAREA
    DIFFC = (LitRMStoreLndscap(ielmc)+POMHumStoreLndscap(ielmc)+TGasC_lnd-SurfGas_lnd(idg_CO2)+TOMOU_lnds(ielmc)-tAmendOrgC_lnd-Litrfall_lnds(ielmc)-TLC)/TAREA
    DIFFN = (LitRMStoreLndscap(ielmn)+POMHumStoreLndscap(ielmn)+TGasN_lnd+TDisolNH4_lnd+tNO3_lnd-SurfGas_lnd(idg_N2)-TZIN+TOMOU_lnds(ielmn) &
