...
! ----------------------------------------------------------------------
  ...
  if(VOLPM>ZEROS2)then
    ...
    CCO2G2=AZMAX1(ystates0l(cid_CO2G)/VOLPM)
    CCH4G2=AZMAX1(ystates0l(cid_CH4G)/VOLPM)
    COXYG2=AZMAX1(ystates0l(cid_OXYG)/VOLPM)
    CZ2GG2=AZMAX1(ystates0l(cid_Z2GG)/VOLPM)
    CZ2OG2=AZMAX1(ystates0l(cid_Z2OG)/VOLPM)
    CNH3G2=AZMAX1(ystates0l(cid_ZN3G)/VOLPM)
    CH2GG2=AZMAX1(ystates0l(cid_H2GG)/VOLPM)
...
!   between atmosphere and topsoil
    DLYR1=forc%DLYR3
    TORT1=forc%TORT*forc%AREA3/(0.5*DLYR1)
