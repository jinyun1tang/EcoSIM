...
implicit none
  ...
  real(r8),pointer   :: histr_1D_SUR_DIP_FLX_col(:)    !HydroSufDIPFlx_col(NY,NX)/TAREA
  real(r8),pointer   :: histr_1D_SUB_DIP_FLX_col(:)    !HydroSubsDIPFlx_col(NY,NX)/TAREA
  ...
  real(r8),pointer   :: histr_1D_SUR_DIC_FLX_col(:)    !HydroSufDICFlx_col(NY,NX)/TAREA
  real(r8),pointer   :: histr_1D_SUB_DIC_FLX_col(:)    !HydroSubsDICFlx_col(NY,NX)/TAREA
  ...
  real(r8),pointer   :: histr_1D_ROOT_C_ptc(:)        !RootElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: histr_1D_NODULE_C_ptc(:)      !NoduleChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX), nodule
  real(r8),pointer   :: histr_1D_STORED_C_ptc(:)      !NonstructalElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  ...
  real(r8),pointer   :: histr_1D_ROOT_N_ptc(:)        !RootElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: histr_1D_NODULE_N_ptc(:)         !NoduleChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: histr_1D_STORED_N_ptc(:)      !NonstructalElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  ...
  real(r8),pointer   :: histr_1D_ROOT_P_ptc(:)        !RootElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: histr_1D_NODULE_P_ptc(:)         !NoduleChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: histr_1D_STORED_P_ptc(:)      !NonstructalElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  ...
  allocate(this%histr_1D_SUR_DIP_FLX_col(beg_col:end_col))     !HydroSufDIPFlx_col(NY,NX)/TAREA
  allocate(this%histr_1D_SUB_DIP_FLX_col(beg_col:end_col))     !HydroSubsDIPFlx_col(NY,NX)/TAREA
  allocate(this%histr_1d_HeatFlx2G_col(beg_col:end_col))
  allocate(this%histr_1d_Qinfl2soi_col(beg_col:end_col))
  allocate(this%histr_1D_tSALT_DISCHG_FLX_col(beg_col:end_col)) !HydroIonFlx_col(NY,NX)/TAREA
  allocate(this%histr_1D_SUR_DON_FLX_col(beg_col:end_col))     !HydroSufDONFlx_col(NY,NX)/TAREA, daily flux
  allocate(this%histr_1D_SUB_DON_FLX_col(beg_col:end_col))     !HydroSubsDONFlx_col(NY,NX)/TAREA, daily flux
  allocate(this%histr_1D_SUR_DIN_FLX_col(beg_col:end_col))     !HydroSufDINFlx_col(NY,NX)/TAREA
  allocate(this%histr_1D_SUB_DIN_FLX_col(beg_col:end_col))     !HydroSubsDINFlx_col(NY,NX)/TAREA
  allocate(this%histr_1D_SUR_DOC_FLX_col(beg_col:end_col))     !HydroSufDOCFlx_col(NY,NX)/TAREA
  allocate(this%histr_1D_SUB_DOC_FLX_col(beg_col:end_col))     !HydroSubsDOCFlx_col(NY,NX)/TAREA
  allocate(this%histr_1D_SUR_DIC_FLX_col(beg_col:end_col))     !HydroSufDICFlx_col(NY,NX)/TAREA
  ...
  allocate(this%histr_1D_ROOT_C_ptc(beg_ptc:end_ptc))       !RootElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  allocate(this%histr_1D_NODULE_C_ptc(beg_ptc:end_ptc))        !NoduleChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX), nodule
  allocate(this%histr_1D_STORED_C_ptc(beg_ptc:end_ptc))     !NonstructalElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  ...
  allocate(this%histr_1D_ROOT_N_ptc(beg_ptc:end_ptc))        !RootElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  allocate(this%histr_1D_NODULE_N_ptc(beg_ptc:end_ptc))         !NoduleChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  allocate(this%histr_1D_STORED_N_ptc(beg_ptc:end_ptc))      !NonstructalElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  ...
  allocate(this%histr_1D_ROOT_P_ptc(beg_ptc:end_ptc))        !RootElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  allocate(this%histr_1D_NODULE_P_ptc(beg_ptc:end_ptc))         !NoduleChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  allocate(this%histr_1D_STORED_P_ptc(beg_ptc:end_ptc))      !NonstructalElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
...
!----------------------------------------------------------------------
  ...
  DO NX=bounds%NHW,bounds%NHE   
    DO NY=bounds%NVN,bounds%NVS
      ...
      this%histr_1D_SUR_DIN_FLX_col(ncol) = HydroSufDINFlx_col(NY,NX)/TAREA
      this%histr_1D_SUB_DIN_FLX_col(ncol) = HydroSubsDINFlx_col(NY,NX)/TAREA
      this%histr_1D_SUR_DOC_FLX_col(ncol) = HydroSufDOCFlx_col(NY,NX)/TAREA
      this%histr_1D_SUB_DOC_FLX_col(ncol) = HydroSubsDOCFlx_col(NY,NX)/TAREA
      this%histr_1D_SUR_DIC_FLX_col(ncol) = HydroSufDICFlx_col(NY,NX)/TAREA
      ...
      DO NZ=1,NP0(NY,NX)
        ...
        this%histr_1D_Plant_C_ptc(nptc)      = (ShootChemElmnts_pft(ielmc,NZ,NY,NX)+RootElmnts_pft(ielmc,NZ,NY,NX))/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%histr_1D_ROOT_C_ptc(nptc)       = RootElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%histr_1D_NODULE_C_ptc(nptc)        = NoduleChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%histr_1D_STORED_C_ptc(nptc)     = NonstructalElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%histr_1D_Plant_N_ptc(nptc)      = (ShootChemElmnts_pft(ielmn,NZ,NY,NX)+RootElmnts_pft(ielmn,NZ,NY,NX))/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%histr_1D_ROOT_N_ptc(nptc)       = RootElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%histr_1D_NODULE_N_ptc(nptc)        = NoduleChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%histr_1D_STORED_N_ptc(nptc)     = NonstructalElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%histr_1D_Plant_P_ptc(nptc)      = (ShootChemElmnts_pft(ielmp,NZ,NY,NX)+RootElmnts_pft(ielmp,NZ,NY,NX))/AREA(3,NU(NY,NX),NY,NX)        
        ...
        this%histr_1D_ROOT_P_ptc(nptc)       = RootElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%histr_1D_NODULE_P_ptc(nptc)        = NoduleChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%histr_1D_STORED_P_ptc(nptc)     = NonstructalElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
