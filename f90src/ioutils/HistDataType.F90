  ...
  DO NX=bounds%NHW,bounds%NHE   
    DO NY=bounds%NVN,bounds%NVS
      ...
      DO NZ=1,NP0(NY,NX)
        ...
        this%h1D_STORED_C_ptc(nptc)     = SeasonNonStrutElms_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%h1D_STORED_N_ptc(nptc)     = SeasonNonStrutElms_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%h1D_STORED_P_ptc(nptc)     = SeasonNonStrutElms_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
