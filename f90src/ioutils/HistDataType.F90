...
implicit none
  ...
  real(r8),pointer   :: h1D_tSTANDING_DEAD_C_col(:)       !StandingDeadChemElmnt_col(ielmc,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_tSTANDING_DEAD_N_col(:)       !StandingDeadChemElmnt_col(ielmn,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_tSTANDING_DEAD_P_col(:)       !StandingDeadChemElmnt_col(ielmp,NY,NX)/AREA(3,NU(NY,NX),NY,NX)    
  ...
  real(r8),pointer   :: h1D_LEAF_PC_ptc(:)       !(LeafChemElmnts_pft(ielmp,NZ,NY,NX)+CanopyNonstructElements_pft(ielmp,NZ,NY,NX))/(LeafChemElmnts_pft(ielmc,NZ,NY,NX)+CanopyNonstructElements_pft(ielmc,NZ,NY,NX)),mass based CP ratio of leaf
  ...
  real(r8),pointer   :: h1D_CAN_LE_ptc(:)        !277.8*EvapTransHeatP(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  ...
  real(r8),pointer   :: h1D_cNH3_FLX_ptc(:)       !RNH3C(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_PO4_UPTK_FLX_ptc(:)      !RootH2PO4Uptake_pft(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_SHOOT_C_ptc(:)       !ShootChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_LEAF_C_ptc(:)        !LeafChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_Petiole_C_ptc(:)        !PetioleChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX), canopy sheath element
  real(r8),pointer   :: h1D_STALK_C_ptc(:)       !StalkChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_RESERVE_C_ptc(:)     !ReserveChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_HUSK_C_ptc(:)        !(HuskChemElmnts_pft(ielmc,NZ,NY,NX)+EarChemElmnts_pft(ielmc,NZ,NY,NX))/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_GRAIN_C_ptc(:)       !GrainChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_ROOT_C_ptc(:)        !RootElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_NODULE_C_ptc(:)      !NoduleChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX), nodule
  ...
  real(r8),pointer   :: h1D_EXUD_C_FLX_ptc(:)        !PlantExudChemElmntCum_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_LITRf_C_FLX_ptc(:)       !LitrfallChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_LITRf_P_FLX_ptc(:)       !LitrfallChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_SURF_LITRf_C_FLX_ptc(:)  !SurfLitrfallChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  ...
  real(r8),pointer   :: h1D_PLANT_BALANCE_C_ptc(:)     !ElmntBalanceCum_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_STANDING_DEAD_C_ptc(:)    !StandingDeadChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  ...
  real(r8),pointer   :: h1D_NPP_ptc(:)           !NetPrimaryProductvity_pft(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  ...
  real(r8),pointer   :: h1D_SHOOT_N_ptc(:)       !ShootChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_LEAF_N_ptc(:)        !LeafChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_Petiole_N_ptc(:)        !PetioleChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_STALK_N_ptc(:)       !StalkChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_RESERVE_N_ptc(:)     !ReserveChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_HUSK_N_ptc(:)        !(HuskChemElmnts_pft(ielmn,NZ,NY,NX)+EarChemElmnts_pft(ielmn,NZ,NY,NX))/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_GRAIN_N_ptc(:)       !GrainChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_ROOT_N_ptc(:)        !RootElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_NODULE_N_ptc(:)         !NoduleChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_STORED_N_ptc(:)      !NonstructalElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_EXUD_N_FLX_ptc(:)        !PlantExudChemElmntCum_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_LITRf_N_FLX_ptc(:)       !LitrfallChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX), total plant litterfall N
  ...
  real(r8),pointer   :: h1D_PLANT_BALANCE_N_ptc(:)     !ElmntBalanceCum_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_STANDING_DEAD_N_ptc(:)    !StandingDeadChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_FIREp_N_FLX_ptc(:)        !NH3byFire_pft(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX), plant N emission from fire
  real(r8),pointer   :: h1D_SURF_LITRf_N_FLX_ptc(:)   !SurfLitrfallChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX), surface litter fall
  real(r8),pointer   :: h1D_SHOOT_P_ptc(:)       !ShootChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_LEAF_P_ptc(:)        !LeafChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_Petiole_P_ptc(:)        !PetioleChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_STALK_P_ptc(:)       !StalkChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_RESERVE_P_ptc(:)     !ReserveChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_HUSK_P_ptc(:)        !(HuskChemElmnts_pft(ielmp,NZ,NY,NX)+EarChemElmnts_pft(ielmp,NZ,NY,NX))/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_GRAIN_P_ptc(:)       !GrainChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_ROOT_P_ptc(:)        !RootElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_NODULE_P_ptc(:)         !NoduleChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_STORED_P_ptc(:)      !NonstructalElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_EXUD_P_FLX_ptc(:)        !PlantExudChemElmntCum_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_LITTERf_P_ptc(:)     !LitrfallChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_HVST_P_FLX_ptc(:)        !EcoHavstElmnt_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_PLANT_BALANCE_P_ptc(:)     !ElmntBalanceCum_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_STANDING_DEAD_P_ptc(:)    !StandingDeadChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_FIREp_P_FLX_ptc(:)        !PO4byFire_pft(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_SURF_LITRf_P_FLX_ptc(:)  !SurfLitrfallChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
  real(r8),pointer   :: h1D_BRANCH_NO_ptc(:)     !NumOfBranches_pft(NZ,NY,NX)
  real(r8),pointer   :: h1D_LEAF_NC_ptc(:)       !(LeafChemElmnts_pft(ielmn,NZ,NY,NX)+CanopyNonstructElements_pft(ielmn,NZ,NY,NX))/(LeafChemElmnts_pft(ielmc,NZ,NY,NX)+CanopyNonstructElements_pft(ielmc,NZ,NY,NX)),mass based CN ratio of leaf  
  ...
  real(r8),pointer   :: h2D_PSI_RT_vr_ptc(:,:)     !PSIRoot_vr(1,1:JZ,NZ,NY,NX), root total water potential , MPa
  ...
  data1d_ptr => this%h1D_SURF_LITRf_P_FLX_ptc(beg_ptc:end_ptc)         !SurfLitrfallChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
...
!----------------------------------------------------------------------
  ...
  DO NX=bounds%NHW,bounds%NHE   
    DO NY=bounds%NVN,bounds%NVS
      ...
      this%h1D_tSTANDING_DEAD_C_col(ncol)    = StandingDeadChemElmnt_col(ielmc,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      this%h1D_tSTANDING_DEAD_N_col(ncol)    = StandingDeadChemElmnt_col(ielmn,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      this%h1D_tSTANDING_DEAD_P_col(ncol)    = StandingDeadChemElmnt_col(ielmp,NY,NX)/AREA(3,NU(NY,NX),NY,NX)            
      ...
      DO NZ=1,NP0(NY,NX)
        ...
        this%h1D_cNH3_FLX_ptc(nptc)      = RNH3C(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%h1D_SHOOT_C_ptc(nptc)      = ShootChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_Plant_C_ptc(nptc)      = (ShootChemElmnts_pft(ielmc,NZ,NY,NX)+RootElmnts_pft(ielmc,NZ,NY,NX))/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_LEAF_C_ptc(nptc)       = LeafChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_Petiole_C_ptc(nptc)       = PetioleChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_STALK_C_ptc(nptc)      = StalkChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_RESERVE_C_ptc(nptc)    = ReserveChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_HUSK_C_ptc(nptc)       = (HuskChemElmnts_pft(ielmc,NZ,NY,NX)+EarChemElmnts_pft(ielmc,NZ,NY,NX))/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_GRAIN_C_ptc(nptc)      = GrainChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_ROOT_C_ptc(nptc)       = RootElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_NODULE_C_ptc(nptc)        = NoduleChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%h1D_EXUD_C_FLX_ptc(nptc)       = PlantExudChemElmntCum_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_LITRf_C_FLX_ptc(nptc)      = LitrfallChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_SURF_LITRf_C_FLX_ptc(nptc) = SurfLitrfallChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%h1D_PLANT_BALANCE_C_ptc(nptc) = ElmntBalanceCum_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_PLANT_BALANCE_N_ptc(nptc)    = ElmntBalanceCum_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_PLANT_BALANCE_P_ptc(nptc)    = ElmntBalanceCum_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_STANDING_DEAD_C_ptc(nptc)   = StandingDeadChemElmnts_pft(ielmc,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%h1D_NPP_ptc(nptc)          = NetPrimaryProductvity_pft(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%h1D_STANDING_DEAD_N_ptc(nptc)   = StandingDeadChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_FIREp_N_FLX_ptc(nptc)       = NH3byFire_pft(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_SURF_LITRf_N_FLX_ptc(nptc)  = SurfLitrfallChemElmnts_pft(ielmn,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        ...
        this%h1D_STANDING_DEAD_P_ptc(nptc)   = StandingDeadChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_FIREp_P_FLX_ptc(nptc)       = PO4byFire_pft(NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_SURF_LITRf_P_FLX_ptc(nptc) = SurfLitrfallChemElmnts_pft(ielmp,NZ,NY,NX)/AREA(3,NU(NY,NX),NY,NX)
        this%h1D_BRANCH_NO_ptc(nptc)    = NumOfBranches_pft(NZ,NY,NX)
        this%h1D_LEAF_NC_ptc(nptc)      = safe_adb(LeafChemElmnts_pft(ielmn,NZ,NY,NX)+CanopyNonstructElements_pft(ielmn,NZ,NY,NX),&
                                                 LeafChemElmnts_pft(ielmc,NZ,NY,NX)+CanopyNonstructElements_pft(ielmc,NZ,NY,NX))
