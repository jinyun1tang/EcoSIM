      ...
      IF(IFLGT(NY,NX).GT.0)THEN
        DO 9980 NZ=1,NP(NY,NX)
          IF(IFLGC(NZ,NY,NX).NE.0)THEN
            ...
            ENDDO
            WRITE(27,96)I,IDATA(3),NZ,EPOOLP(NZ,ielmc,NY,NX),CPOLNP(NZ,NY,NX) &
            ...
            DO 9945 NB=1,NBR(NZ,NY,NX)
              ...
              WRITE(28,93)I,IDATA(3),NZ,(WGLF(K,NB,NZ,NY,NX),K=0,JNODS)
              WRITE(28,93)I,IDATA(3),NZ,(WSLF(K,NB,NZ,NY,NX),K=0,JNODS)
              WRITE(28,93)I,IDATA(3),NZ,(HTSHE(K,NB,NZ,NY,NX),K=0,JNODS)
              WRITE(28,93)I,IDATA(3),NZ,(WGSHE(K,NB,NZ,NY,NX),K=0,JNODS)
              ...
              WRITE(28,93)I,IDATA(3),NZ,(WGNODE(K,NB,NZ,NY,NX),K=0,JNODS)
              WRITE(28,93)I,IDATA(3),NZ,(WGLFN(K,NB,NZ,NY,NX),K=0,JNODS)
              WRITE(28,93)I,IDATA(3),NZ,(WGSHN(K,NB,NZ,NY,NX),K=0,JNODS)
              WRITE(28,93)I,IDATA(3),NZ,(WGNODN(K,NB,NZ,NY,NX),K=0,JNODS)
              WRITE(28,93)I,IDATA(3),NZ,(WGLFP(K,NB,NZ,NY,NX),K=0,JNODS)
              WRITE(28,93)I,IDATA(3),NZ,(WGSHP(K,NB,NZ,NY,NX),K=0,JNODS)
...
9945        CONTINUE
            DO 9970 N=1,MY(NZ,NY,NX)
              ...
              WRITE(29,94)I,IDATA(3),NZ,(RTWT1P(N,NR,NZ,NY,NX),NR=1,NRT(NZ,NY,NX))
