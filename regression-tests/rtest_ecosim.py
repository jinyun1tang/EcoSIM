...
def setup_log(test_dir):
    ...
    # log_filename = 'ecosim-tests-{0}.log'.format(time_stamp)
    log_filename = 'ecosim-tests.testlog'
...
def convert_input_data(ncgen, input_dir, dry_run):
    ...
    tempfile = "{0}/tmp-ecosim-test-info.txt".format(input_dir)
...
def main(options):
    print(BANNER)
    print('EcoSIM regression test driver')
...
#####
#turn off ncdf support at the moment
#    import subprocess
