...
#     set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -W -Wall -std=gnu -pedantic -finit-local-zero -Wall -cpp -g -fbacktrace -fmax-stack-var-size=524288 ")
     set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -W -Wall -std=gnu -pedantic -fcheck=all -Wall -cpp -g -fbacktrace -fmax-stack-var-size=524288 ")
    else()
  ...
  elseif (CMAKE_Fortran_COMPILER_ID STREQUAL "Intel")
    ...
    elseif (HOSTNAME MATCHES "[scs]")
      ...
      if (CMAKE_BUILD_TYPE MATCHES "Debug")
        set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -g -debug -r8 -i4 -align dcommons -auto-scalar -fimf-arch-consistency=true -fpe-all=0 -check=all")
      else()
        set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -O2 -mp1 -r8 -i4 -align dcommons -auto-scalar -fimf-arch-consistency=true")
      endif()
    endif()
