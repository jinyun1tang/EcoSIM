...
C
      ...
      real(r8) :: RYLXA0,RYLXW1,RYLXA1,RYLNW0,RYLNA0,RYLNW1,RYLNA1
      real(r8) :: RFLXR2,R,RYLXW2,RYLXA2,RYLNW2,RYLNA2,RCHQF,RCHGFU
      real(r8) :: RCHGFT,SFLXW,SFLXW2,SFLXG,SFLXR,SFLXR2,SS,TVOLWI
      real(r8) :: THRYX,THETPX0,THETPL,THETWA,THETWT,THETWH,THRMX
      real(r8) :: THETP1,TCND1W,THETP2,TCND2W,TCNDS,TKWX1,THETRR
      real(r8) :: TCNDR,TFLWSX,TFLWWX,TFLWIX,THFLWWX,TFLX1,TVOLWS
      real(r8) :: TFLX0X,THRMA,THRMZ,TCNDW0,TCNDA0,TCNDW1,TCNDA1
      real(r8) :: TCND1,THRMZ2,TFREEZ,TFLX,TCNDW2,TCNDA2,TCND2,TKLX
      real(r8) :: THETAX,TFLXH1,TFLXH,TK0XX,TKXX,UAG,VOLTX,VOLWRZ
      real(r8) :: VOLIRZ,VOLAT0,VOLWT,VOLAT,VFLXW,VP0,VFLXW2,VOLP01
      real(r8) :: VP1,VOLP02,VP2,VPY,VPR,VOLS0X,VOLW0X,VOLI0X,VHCPWMX
      real(r8) :: VOLWXG,VOLIXG,VFLXG,VFLXR,VOLWR2,VHCPR2,VOLW12
      real(r8) :: VHCP12,VFLXR2,VOLW1X,VHCP1X,VX,V,VPL,VOLP2,VOLPX2
      real(r8) :: VOLPH2,VOLP1X,VOLWH1X,VOLPH1X,VHCP1AX,VHCP1BX
      real(r8) :: VHCPXX,VHXX,WPX,WPLX,WTHET2,WFLXSX,WFLXIX,WTHET0
      real(r8) :: WTHET1,XNUSW0,XNUSA0,XNUSW1,XNUSA1,XNUSW2,XNUSA2
      real(r8) :: XN,Z3S
      
      integer :: ICHKL,IFLGH,IFLGU,IFLGUH,IFLGD,IFLGDH,K0,K1,KL
      integer :: L,LWDPTH,L2,LL,M,MM,M1,M2,M3,M4,M5,M6,NX,NY,N,N1
      integer :: N2,N3,N4,N5,N6,NN,N4B,N5B,NUX
