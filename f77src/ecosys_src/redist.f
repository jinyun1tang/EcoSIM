...
C
     ...
     4,TOSC(4,0:4),TOSA(4,0:4),TOSN(4,0:4),TOSP(4,0:4),TOSGC(4,0:2)
     5,TOSGA(4,0:2),TOSGN(4,0:2),TOSGP(4,0:2),TOMGC(3,7,0:5)
     5,TOMGN(3,7,0:5),TOMGP(3,7,0:5),TORXC(2,0:2),TORXN(2,0:2)
     6,TORXP(2,0:2),TOQGC(0:2),TOQGN(0:2),TOQGP(0:2),TOQHC(0:2)
     7,TOQHN(0:2),TOQHP(0:2),TOHGC(0:2),TOHGN(0:2),TOHGP(0:2)
     8,TOHGA(0:2),TOQGA(0:2),TOQHA(0:2),THGQRS(JY,JX),THGFHS(JZ,JY,JX)
     ...
     8,TC1PBS(JS,JY,JX),TC2PBS(JS,JY,JX),TM1PBS(JS,JY,JX)
      ...
      real(r8), PARAMETER :: ZEROC=0.1E-03
      DATA SG/0.0/
