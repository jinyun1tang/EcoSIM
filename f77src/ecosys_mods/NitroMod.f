...
C
     ...
     2,VMXH=0.375,VMXN=0.25,VMX4=0.375,VMXC=0.125,OQKM=1.2E+01
     3,OQKA=1.2E+01,OQKAM=1.2E+01,CCKM=0.15,CCK4=1.2E-03,ZHKM=1.4
...
C
     ...
     2,EOMH=25.0,EOMN=75.0,GO2X=37.5,GH4X=66.5,GCHX=4.50
...
C     ENDIF
      ...
      ENDIF
998   CONTINUE
      end subroutine biochem_1D_soil
      end module NitroMod
