...
C
C     CO2Q,CO2E=CO2 concentrations in canopy air,atmosphere, umol mol-1 (ppmv)
C     CNETX=net CO2 flux in canopy air from soil,plants, g d-2 h-1
C
...
C     FCO2=intercellular:atmospheric CO2 concn ratio from PFT file, parameter
