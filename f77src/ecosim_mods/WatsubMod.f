...
C     RARX=boundary layer resistance (blr) of litter surface
...
C     boundary flow involes exchange with external water table, and through
C     tile drainage
      implicit none
...
C     Watch out for L, is its value defined?
