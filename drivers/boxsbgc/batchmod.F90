...
!
    ...
    micstt%OSC13U=forc%SolidOM(ielmc,iprotein,k_POM)
    micstt%OSN13U=forc%SolidOM(ielmn,iprotein,k_POM)
    micstt%OSP13U=forc%SolidOM(ielmp,iprotein,k_POM)
    micstt%OSC14U=forc%SolidOM(ielmc,iprotein,k_humus)
    micstt%OSN14U=forc%SolidOM(ielmn,iprotein,k_humus)
    micstt%OSP14U=forc%SolidOM(ielmp,iprotein,k_humus)
