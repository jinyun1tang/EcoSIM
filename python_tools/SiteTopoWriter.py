...
sfilenm=mdir+config_dict['sitef']
...
'DHI':'Width of each W-E landscape column:m:f4',
#(DHI(NX),NX=1,NHE)
'DVI':'Width of each N-S landscape row:m:f4'
#(DVI(NY),NY=1,NVS)
}
