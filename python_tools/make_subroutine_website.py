...
#
# Input:
#    -dir : the location of the ecosim_mods directory
#    -f77 or -f90 : specifies fortran 77 or fortran 90
#
#    The program also requires the preamble.html file to
#    be in the same directory as the script. This file
#    contains the beginning of the html file. Which contains
#    CSS and Java functions for making the table.
#
# Output: 
#    A main html file called ecosim_subroutines.html, and a directory
